...
ILINE void CContextViewStateUpr::Dump(const char* s)
{
...
void CContextViewStateUpr::DumpLockers(const char* name)
{
...
void CContextViewStateUpr::Verify(bool condition, const char* message)
{
