...
#include  <DinrusX/DinrusXNetwork/Config.h>
	...
	#include  <DinrusX/DinrusXNetwork/ByteStream.h>
...
ESerializeChunkResult CNetOutputSerializeImpl::SerializeChunk(ChunkID chunk, uint8 profile, TMemHdl* phData, CTimeValue* pTimeInfo, CMementoMemoryUpr& mmm)
{
	CTimeValue temp;
...
ESerializeChunkResult CNetInputSerializeImpl::SerializeChunk(ChunkID chunk, uint8 profile, TMemHdl* phData, CTimeValue* pTimeInfo, CMementoMemoryUpr& mmm)
{
	if (!Ok())
		return eSCR_Failed;
