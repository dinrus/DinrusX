...
#include  <DinrusX/DinrusXNetwork/SocketIOUprNull.h>
#include  <DinrusX/DinrusXNetwork/SocketIOUprSelect.h>
#include  <DinrusX/DinrusXNetwork/SocketIOUprLobbyIDAddr.h>
#if DRX_PLATFORM_DURANGO
	#include  <DinrusX/DinrusXNetwork/SocketIOUprDurango.h>
#endif

IDatagramSocketPtr CSocketIOUpr::CreateDatagramSocket(const TNetAddress& addr, uint32 flags)
{
	SCOPED_GLOBAL_LOCK;
...
void CSocketIOUpr::RecordPacketSendStatistics(const uint8* pData, size_t len)
{
...
bool CreateSocketIOUpr(int ncpus, ISocketIOUpr** ppExternal, ISocketIOUpr** ppInternal)
{
	bool created = false;
