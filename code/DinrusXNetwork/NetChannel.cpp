...
#include  <DinrusX/DinrusXNetwork/FixedSizeArena.h>
...
CNetChannel::CNetChannel(const TNetAddress& ipRemote, const CExponentialKeyExchange::KEY_TYPE& key, uint32 remoteSocketCaps, DrxSessionHandle session) :
	m_privateKey(key),
	m_ip(ipRemote),
