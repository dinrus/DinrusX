...
#include  <DinrusX/DinrusXNetwork/Utils.h>

//#include  <DinrusX/DinrusXNetwork/platform.h>
...
#include  <DinrusX/DinrusXNetwork/NetworkInspector.h>

#include  <DinrusX/DinrusXNetwork/NetNub.h>
#include  <DinrusX/DinrusXNetwork/NetChannel.h>
#include  <DinrusX/DinrusXNetwork/Serialize.h>

#include  <DinrusX/DinrusXNetwork/ContextView.h>
#include  <DinrusX/DinrusXNetwork/NetContext.h>

#include  <DinrusX/DinrusXNetwork/CompressionUpr.h>

#include <DinrusX/DinrusXNetwork/ServiceUpr.h>
#include <DinrusX/DinrusXNetwork/LanQueryListener.h>

#include  <DinrusX/DinrusXNetwork/VoiceUpr.h>
#include  <DinrusX/DinrusXNetwork/IVoiceEncoder.h>
#include  <DinrusX/DinrusXNetwork/IVoiceDecoder.h>

#include  <DinrusX/DinrusXNetwork/DistributedLogger.h>
#include  <DinrusX/DinrusXNetwork/DebugKit.h>
#include  <DinrusX/DinrusXNetwork/NetDebugInfo.h>

#include  <DinrusX/DinrusXNetwork/RemoteControl.h>
#include  <DinrusX/DinrusXNetwork/SimpleHttpServer.h>

#include  <DinrusX/DinrusXNetwork/ServerProfiler.h>

#include <DinrusX/DinrusXSys/ThreadProfilerSupport.h>
#include <DinrusX/DinrusXSys/ITextModeConsole.h>
#include  <DinrusX/DinrusXNetwork/AutoConfigDownloader.h>

#include  <DinrusX/DinrusXNetwork/NetProfile.h>

#include  <DinrusX/DinrusXNetwork/StreamCipher.h>
#include  <DinrusX/DinrusXNetwork/rijndael.h>

#include  <DinrusX/DinrusXNetwork/PacketRateCalculator.h>
#if USE_GFWL
	#include <Winxnet.h>
#endif

#if ENABLE_OBJECT_COUNTING
	#include  <DinrusX/DinrusXNetwork/PsApi.h>
#endif

#include <DinrusX/CoreX/Lobby/CommonIDrxMatchMaking.h>
...
const char* GetTimestampString()
{
	...
	{
		drx_sprintf(buffer, "%.2d:%.2d:%.2d.%.3d", st.tm_hour, st.tm_min, st.tm_sec, (int)(now.tv_usec + 500) / 1000);
		return buffer;
	}
	else
	{
...
bool CNetwork::ConvertAddr(const TNetAddress& addrIn, DRXSOCKADDR* pSockAddr, int* addrLen)
{
