...
#include  <DinrusX/DinrusXNetwork/drx_sha1.h>
...
void DrxSHA1::sha1Block(const unsigned char block[64], uint32* digest)
{
...
void DrxSHA1::sha1Calc(const unsigned char* inbuf, const uint64 buflen, uint32* digest)
{
	// initial H[] from RFC
...
void DrxSHA1::sha1Calc(const char* str, uint32* digest)
{
