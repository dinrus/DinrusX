...
#include <DinrusX/DinrusXScript/StackGuard.h>
#include <DinrusX/DinrusXScript/BucketAllocator.h>

#include <DinrusX/DinrusXSys/ISystem.h> // For warning and errors.
// needed for drxpak
...
#pragma warning(pop)
	...
	#include <DinrusX/DinrusXScript/LuaDebugger/LUADBG.h>
	#include <DinrusX/DinrusXScript/LuaDebugger/Coverage.h>
...
#include <DinrusX/CoreX/Memory/BucketAllocatorImpl.h> // needs full implementation before instantiation
...
/* For LuaJIT
   ...
   static const char *progname = "DinrusXScriptSys";
...
bool CScriptSystem::_ExecuteFile(const char* sFileName, bool bRaiseError, IScriptTable* pEnv)
{
	...
	const char* translated = gEnv->pDrxPak->AdjustFileName(sFileName, translatedBuf, IDrxPak::FLAGS_NO_FULL_PATH);
