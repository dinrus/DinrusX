...
{
public:
	CScriptSurfaceType(CScriptSurfaceTypesLoader* pUpr, const char* sName, const char* sFilename, int nFlags);
	~CScriptSurfaceType();
...
//////////////////////////////////////////////////////////////////////////
CScriptSurfaceType::CScriptSurfaceType(CScriptSurfaceTypesLoader* pUpr, const char* sName, const char* sFilename, int nFlags)
	: m_pUpr(pUpr)
	, m_name(sName)
	, m_script(sFilename)
	, m_nId(-1)
