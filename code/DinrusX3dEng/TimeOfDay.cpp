...
#include <DinrusX/CoreX/Math/ISplines.h>
...
#include <DinrusX/DinrusX3dEng/EnvironmentPreset.h>
...
string GetPresetXMLFilenamefromName(const string& presetName, const bool bForWriting)
{
	...
	const char* szTemp = gEnv->pDrxPak->AdjustFileName(filePath.c_str(), szAdjustedFile, bForWriting ? IDrxPak::FLAGS_FOR_WRITING : 0);
