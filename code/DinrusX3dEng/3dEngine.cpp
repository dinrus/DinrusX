...
#include <DinrusX/DinrusX3dEng/terrain_water.h>

#include <DinrusX/DinrusX3dEng/DecalUpr.h>
#include <DinrusX/DinrusX3dEng/Vegetation.h>
#include <DinrusX/DinrusX3dEng/IndexedMesh.h>
...
#include <DinrusX/DinrusX3dEng/ChunkFileWriters.h>
#include <DinrusX/DinrusX3dEng/ReadOnlyChunkFile.h>
...
#include <DinrusX/DinrusX3dEng/DecalRenderNode.h>
#include <DinrusX/DinrusX3dEng/TimeOfDay.h>
#include <DinrusX/DinrusX3dEng/LightEntity.h>
#include <DinrusX/DinrusX3dEng/FogVolumeRenderNode.h>
#include <DinrusX/DinrusX3dEng/ObjectsTree.h>
#include <DinrusX/DinrusX3dEng/WaterVolumeRenderNode.h>
#include <DinrusX/DinrusX3dEng/WaterWaveRenderNode.h>
#include <DinrusX/DinrusX3dEng/DistanceCloudRenderNode.h>
#include <DinrusX/DinrusX3dEng/RopeRenderNode.h>
#include <DinrusX/DinrusX3dEng/RenderMeshMerger.h>
#include <DinrusX/DinrusX3dEng/PhysCallbacks.h>
#include <DinrusX/DinrusX3dEng/DeferredCollisionEvent.h>
#include <DinrusX/DinrusX3dEng/MergedMeshRenderNode.h>
#include <DinrusX/DinrusX3dEng/BreakableGlassRenderNode.h>
#include <DinrusX/DinrusX3dEng/BreezeGenerator.h>
#include <DinrusX/DinrusX3dEng/OpticsUpr.h>
#include <DinrusX/DinrusX3dEng/GeomCacheRenderNode.h>
#include <DinrusX/DinrusX3dEng/GeomCacheUpr.h>
#include <DinrusX/DinrusX3dEng/ClipVolumeUpr.h>
#include <DinrusX/DinrusX3dEng/CharacterRenderNode.h>
#include <DinrusX/DinrusXNetwork/IRemoteCommand.h>
#include <DinrusX/DinrusX3dEng/CloudBlockerRenderNode.h>
#include <DinrusX/DinrusX3dEng/WaterRippleUpr.h>
#include <DinrusX/DinrusX3dEng/ShadowCache.h>

#if defined(FEATURE_SVO_GI)
	#include <DinrusX/DinrusX3dEng/SceneTreeUpr.h>
#endif
...
int DinrusX3dEngBase::m_mergedMeshesPoolSize = 0;
...
int DinrusX3dEngBase::m_arrInstancesCounter[eERType_TypesNum];
...
public:
	...
	virtual void Warning(const char* format) { DinrusX3dEngBase::Warning("%s", format); }
	virtual void Error(const char* format)   { DinrusX3dEngBase::Error("%s", format); }
...
void C3DEngine::StartWindGridJob(const Vec3& vPos)
{
	...
	if (!rWindGrid.m_pData)
	{
		...
		if (!m_pWindField)
		{
			...
			m_pWindAreaFrames = reinterpret_cast<int*>(DrxModuleMemalign(rWindGrid.m_nWidth * rWindGrid.m_nHeight * sizeof(int), DRX_PLATFORM_ALIGNMENT));
...
{
	int nObjectsLoaded = m_pObjUpr ? m_pObjUpr->GetLoadedObjectCount() : 0;
...
ChunkFile::IChunkFileWriter* C3DEngine::CreateChunkFileWriter(EChunkFileFormat eFormat, IDrxPak* pPak, const char* filename) const
{
...
void C3DEngine::GetLayerMemoryUsage(uint16 nLayerId, IDrxSizer* pSizer, int* pNumBrushes, int* pNumDecals) const
{
	if (pNumBrushes)
		*pNumBrushes = 0;
	if (pNumDecals)
...
int C3DEngine::AddPrecachePoint(const Vec3& vPos, const Vec3& vDir, float fTimeOut, float fImportanceFactor)
{
	if (m_pObjUpr)
	{
		if (m_pObjUpr->m_vStreamPreCachePointDefs.size() >= CObjUpr::MaxPrecachePoints)
		{
			...
			m_pObjUpr->m_vStreamPreCachePointDefs.DeleteFastUnsorted((int)nOldestIdx);
			m_pObjUpr->m_vStreamPreCacheCameras.DeleteFastUnsorted((int)nOldestIdx);
		}
...
void C3DEngine::ClearPrecachePoint(int id)
{
	if (m_pObjUpr)
	{
		for (size_t i = 1, c = m_pObjUpr->m_vStreamPreCachePointDefs.size(); i < c; ++i)
		{
			...
			{
				m_pObjUpr->m_vStreamPreCachePointDefs.DeleteFastUnsorted((int)i);
				m_pObjUpr->m_vStreamPreCacheCameras.DeleteFastUnsorted((int)i);
				break;
			}
		}
	}
...
const char* CDebugDrawListMgr::GetStrCurrMode()
{
	...
	uint32 index = DinrusX3dEngBase::GetCVars()->e_DebugDraw - LM_BASENUMBER;
