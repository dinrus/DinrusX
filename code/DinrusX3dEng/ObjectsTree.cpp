...
void COctreeNode::UpdateStaticInstancing()
{
	...
	for (IRenderNode* pObj = m_arrObjects[eRNListType_Vegetation].m_pFirstNode, * pNext; pObj; pObj = pNext)
	{
		...
		/*
		   ...
		   int wantedLod = CObjUpr::GetObjectLOD(pInst, fEntDistance);
...
void COctreeNode::GetLayerMemoryUsage(uint16 nLayerId, IDrxSizer* pSizer, int* pNumBrushes, int* pNumDecals)
{
	for (IRenderNode* pObj = m_arrObjects[eRNListType_Brush].m_pFirstNode; pObj; pObj = pObj->m_pNext)
	{
		if (pObj->GetRenderNodeType() == eERType_Brush)
...
void COctreeNode::StreamingCheckUnload(const SRenderingPassInfo& passInfo, PodArray<SObjManPrecacheCamera>& rPreCacheCameras)
{
	...
	for (int t = 0; t < nMaxTestsPerFrame && m_arrStreamedInNodes.Count(); t++)
	{
		...
		bool bOldRound = CObjUpr::m_nUpdateStreamingPrioriryRoundId > (pNode->m_nUpdateStreamingPrioriryRoundId + (int)2);
...
int FTell(FILE*& f)  { return DinrusX3dEngBase::GetPak()->FTell(f); }
...
//////////////////////////////////////////////////////////////////////////
int16 CObjUpr::GetNearestCubeProbe(PodArray<SRenderLight*>* pAffectingLights, IVisArea* pVisArea, const AABB& objBox, bool bSpecular, Vec4* pEnvProbeMults)
{
...
//////////////////////////////////////////////////////////////////////////
bool CObjUpr::LoadOcclusionMesh(const char* pFileName)
{
...
///////////////////////////////////////////////////////////////////////////////
int CObjUpr::GetObjectLOD(const IRenderNode* pObj, float fDistance)
{
