...
void CompatibilityParticleParams::Correct(CParticleEffect* pEffect)
{
	...
	case 24:
		...
		//   Particle Version < 22, DinrusX < 3.3.3:         Correct
		//   Particle version = 22, DinrusX 3.3.4 .. 3.4.x:  Correct
		//   Particle version = 22, DinrusX 3.5.1 .. 3.5.3:  INCORRECT
		//   Particle version = 23, DinrusX 3.5.4:           INCORRECT
		//   Particle version = 24, DinrusX 3.5.5 .. 3.5.6:  INCORRECT
		//   Particle version = 24, DinrusX 3.5.7 .. 3.5.9:  Correct
		//   Particle version = 25, DinrusX 3.5.10 ..:       Correct
