...
CMaterialSurfaceType* CSurfaceTypeUpr::RegisterDefaultType(const char* szName)
{
...
//////////////////////////////////////////////////////////////////////////
ISurfaceType* CSurfaceTypeUpr::GetSurfaceTypeByName(const char* sName, const char* sWhy, bool warn)
{
...
//////////////////////////////////////////////////////////////////////////
ISurfaceType* CSurfaceTypeUpr::GetSurfaceTypeFast(int nSurfaceId, const char* sWhy)
{
...
//////////////////////////////////////////////////////////////////////////
ISurfaceType* CSurfaceTypeUpr::GetSurfaceType(int nSurfaceId, const char* sWhy)
{
	...
	for (int i = 0, nChilds = root->getChildCount(); i < nChilds; i++)
	{
		...
		if (physNode)
		{
			...
			if (collTypeStr.length())
			{
				...
				for (int j = 0; j < DRX_ARRAY_COUNT(collVals); j++)
