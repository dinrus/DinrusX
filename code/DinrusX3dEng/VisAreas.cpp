...
void CVisAreaUpr::GetNearestCubeProbe(float& fMinDistance, int& nMaxPriority, CLightEntity*& pNearestLight, const AABB* pBBox)
{
...
///////////////////////////////////////////////////////////////////////////////
int CVisAreaUpr::GetObjectsCount(EOcTeeNodeListType eListType)
{
	return HelperGetObjectsCount(m_lstVisAreas, eListType) + HelperGetObjectsCount(m_lstPortals, eListType);
}

///////////////////////////////////////////////////////////////////////////////
void CVisAreaUpr::GetStreamedInNodesNum(int& nAllStreamable, int& nReady)
{
