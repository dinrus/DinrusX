...
void CVisAreaUpr::DrawVisibleSectors(const SRenderingPassInfo& passInfo, uint32 passCullMask)
{
...
void CVisAreaUpr::ActivatePortal(const Vec3& vPos, bool bActivate, const char* szEntityName)
{
	//  bool bFound = false;
...
void CVisAreaUpr::UpdateVisArea(CVisArea* pArea, const Vec3* pPoints, int nCount, const char* szName, const SVisAreaInfo& info)
{
...
bool CVisAreaUpr::IntersectsVisAreas(const AABB& box, void** pNodeCache)
{
	FUNCTION_PROFILER_3DENGINE;
...
bool CVisAreaUpr::ClipOutsideVisAreas(Sphere& sphere, Vec3 const& vNormal, void* pNodeCache)
{
	FUNCTION_PROFILER_3DENGINE;
...
bool CVisAreaUpr::IsEntityVisAreaVisibleReqursive(CVisArea* pVisArea, int nMaxReqursion, PodArray<CVisArea*>* pUnavailableAreas, const SRenderLight* pLight, const SRenderingPassInfo& passInfo)
{
...
bool CVisAreaUpr::IsEntityVisAreaVisible(IRenderNode* pEnt, int nMaxReqursion, const SRenderLight* pLight, const SRenderingPassInfo& passInfo)
{
	if (!pEnt)
		return false;
...
int __cdecl CVisAreaUpr__CmpDistToPortal(const void* v1, const void* v2)
{
 ...
 */
void CVisAreaUpr::GetStreamingStatus(int& nLoadedSectors, int& nTotalSectors)
{
...
void CVisAreaUpr::PrecacheLevel(bool bPrecacheAllVisAreas, Vec3* pPrecachePoints, int nPrecachePointsNum)
{
...
void CVisAreaUpr::AddLightSourceReqursive(SRenderLight* pLight, CVisArea* pArea, const int32 nDeepness, const SRenderingPassInfo& passInfo)
{
	if (pArea->IsObjectsTreeValid())
	{
...
int CVisAreaUpr::GetNumberOfVisArea() const
{
	return m_lstPortals.size() + m_lstVisAreas.size();
}

IVisArea* CVisAreaUpr::GetVisAreaById(int nID) const
{
	if (nID < 0)
		return NULL;
...
void CVisAreaUpr::ActivateObjectsLayer(uint16 nLayerId, bool bActivate, bool bPhys, IGeneralMemoryHeap* pHeap, const AABB& layerBox)
{
...
bool CVisAreaUpr::FindShortestPathToVisArea(CVisArea* pThisArea, CVisArea* pTargetArea, PodArray<CVisArea*>& arrVisitedAreas, int& nRecursion, const Shadowvolume& sv)
{
