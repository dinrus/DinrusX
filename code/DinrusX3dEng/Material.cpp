...
void CMatInfo::PrecacheTextures(const float fMipFactor, const int nFlags, bool bFullUpdate)
{
	...
	int nRoundId = bFullUpdate ? GetObjUpr()->m_nUpdateStreamingPrioriryRoundIdFast : GetObjUpr()->m_nUpdateStreamingPrioriryRoundId;
...
//////////////////////////////////////////////////////////////////////////
int CMatInfo::GetTextureMemoryUsage(IDrxSizer* pSizer, int nSubMtlSlot)
{
	int textureSize = 0;
