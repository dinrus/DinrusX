...
int CDeferredPhysicsEventUpr::HandleEvent(const EventPhys* pEvent, IDeferredPhysicsEventUpr::CreateEventFunc pCreateFunc, IDeferredPhysicsEvent::DeferredEventType type)
{
