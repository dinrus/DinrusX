...
#include <DinrusX/DinrusX3dEng/RenderMeshUtils.h>
...
int __cdecl CDecalUpr__CmpHitPos(const void* v1, const void* v2)
{
...
IMaterial* CDecalUpr::GetMaterialForDecalTexture(const char* pTextureName)
{
