...
//////////////////////////////////////////////////////////////////////////
IStatObj* CObjUpr::GetStaticObjectByTypeID(int nTypeID)
{
...
IStatObj* CObjUpr::FindStaticObjectByFilename(const char* filename)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
CStatObj* CObjUpr::LoadStatObj(const char* __szFileName
...
int CObjUpr::ComputeDissolve(const CLodValue &lodValueIn, SRenderNodeTempData* pTempData, IRenderNode* pEnt, float fEntDistance, CLodValue arrlodValuesOut[2])
{
...
// mostly xy size
float CObjUpr::GetXYRadius(int type)
{
...
bool CObjUpr::GetStaticObjectBBox(int nType, Vec3& vBoxMin, Vec3& vBoxMax)
{
...
//////////////////////////////////////////////////////////////////////////
void CObjUpr::GetLoadedStatObjArray(IStatObj** pObjectsArray, int& nCount)
{
	if (!pObjectsArray)
	{
...
bool CObjUpr::AddOrCreatePersistentRenderObject(SRenderNodeTempData* pTempData, CRenderObject*& pRenderObject, const CLodValue* pLodValue, const Matrix34& transformationMatrix, const SRenderingPassInfo& passInfo) const
{
	...
	if (shouldGetOrCreatePermanentObject)
	{
		...
		int previousMask = DrxInterlockedExchangeOr(reinterpret_cast<volatile LONG*>(&pRenderObject->m_passReadyMask), passMask);
...
//////////////////////////////////////////////////////////////////////////
uint32 CObjUpr::GetResourcesModificationChecksum(IRenderNode* pOwnerNode) const
{
