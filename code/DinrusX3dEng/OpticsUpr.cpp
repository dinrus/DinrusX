...
bool COpticsUpr::Load(const char* fullFlareName, int& nOutIndex)
{
...
bool COpticsUpr::Load(XmlNodeRef& rootNode, int& nOutIndex)
{
...
EFlareType COpticsUpr::GetFlareType(const char* typeStr) const
{
	if (typeStr == NULL)
		return eFT__Base__;
...
int COpticsUpr::FindOpticsIndex(const char* fullFlareName) const
{
...
IOpticsElementBase* COpticsUpr::GetOptics(int nIndex)
{
...
bool COpticsUpr::AddOptics(IOpticsElementBase* pOptics, const char* name, int& nOutNewIndex)
{
	if (name == NULL)
		return false;
...
bool COpticsUpr::Rename(const char* fullFlareName, const char* newFullFlareName)
{
