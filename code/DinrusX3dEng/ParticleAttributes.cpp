...
#include <DinrusX/CoreX/Serialization/DrxName.h>
...
namespace
{
	...
	struct ColorAttr : ColorB
	{
		...
		ColorAttr(int in)      { r = g = b = drxmath::clamp(in, 0, 0xff); a = 0xff; }
...
int CAttributeTable::FindAttributeIdByName(const CDrxName& name) const
{
