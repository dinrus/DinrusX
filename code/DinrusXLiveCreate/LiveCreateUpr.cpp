...
#include <DinrusX/DinrusXLiveCreate/LiveCreate_System.h>
#include <DinrusX/DinrusXLiveCreate/LiveCreate_Objects.h>

#include <DinrusX/DinrusXLiveCreate/PlatformHandler_GamePC.h>
#include <DinrusX/DinrusXLiveCreate/PlatformHandler_Any.h>
...
IHostInfo* CUpr::CreateHost(IPlatformHandler* pPlatform, const char* szValidAddress)
{
...
bool CUpr::LoadPlatformHandlerDLL(const char* pFilename, PlatformDLL& dllInfo)
{
...
void CUpr::LogMessage(ELogMessageType aType, const char* pMessage)
{
...
void CUpr::LogMessagef(ELogMessageType aType, const char* pMessage, ...)
{
