...
#include <DinrusX/DinrusXAnimation/DrxModEffMorph.h>

// starts the morphing sequence
void DrxModEffMorph::StartMorph(int nMorphTargetId, const DrxCharMorphParams& rParams)
{
	m_Params = rParams;
...
int DrxModEffMorph::getMorphTargetId() const
{
