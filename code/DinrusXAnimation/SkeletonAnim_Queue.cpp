...
bool CSkeletonAnim::StartAnimation(const char* szAnimName, const struct DrxCharAnimationParams& Params)
{
	if (szAnimName == 0)
	{
...
bool CSkeletonAnim::StartAnimationById(int32 id, const struct DrxCharAnimationParams& Params)
{
...
uint32 CSkeletonAnim::AnimationToQueue(const ModelAnimationHeader* pAnim, int nAnimID, f32 btime, const DrxCharAnimationParams& AnimParams)
{
