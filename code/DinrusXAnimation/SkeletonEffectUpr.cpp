...
CSkeletonEffectUpr::EffectEntry::EffectEntry(_smart_ptr<IParticleEffect> pEffect, _smart_ptr<IParticleEmitter> pEmitter, int boneID, const Vec3& offset, const Vec3& dir)
...
void CSkeletonEffectUpr::GetEffectJointLocation(ISkeletonPose* pSkeletonPose, QuatTS& loc, int boneID, const Vec3& offset, const Vec3& dir, const QuatTS& entityLoc)
{
	if (dir.len2() > 0)
...
bool CSkeletonEffectUpr::IsPlayingParticlesEffect(const char* effectName)
{
