...
#include <DinrusX/DinrusXAnimation/DrxModEffMorph.h> //embedded
...
void CFacialModel::PushMorphEffectors(int i, const MorphTargetsInfo& morphTargets, f32 fWeight, f32 fBalance, DynArray<DrxModEffMorph>& arrMorphEffectors)
{
