...
#include <DinrusX/DinrusXAnimation/Recoil.h>
...
void CSkeletonPose::SkeletonPostProcess(Skeleton::CPoseData& poseData)
{
	...
	int nCurrentFrameID = g_pCharacterUpr->m_nUpdateCounter;
...
void CSkeletonPose::UpdateBBox(uint32 update)
{
	...
	uint32 nMinBoneAttachments = pAttachmentUpr->GetMinJointAttachments();
	uint32 nMaxBoneAttachments = pAttachmentUpr->GetMaxJointAttachments();
