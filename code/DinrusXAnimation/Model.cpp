...
bool                   CDefaultSkeleton::SetupPhysicalProxies(const DynArray<PhysicalProxy>& arrPhyBoneMeshes, const DynArray<BONE_ENTITY>& arrBoneEntitiesSrc, IMaterial* pIMaterial, const char* filename)
{
	...
	for (uint32 i = 0; i < numBoneEntities; i++)
	{
		...
		else
		{
			...
			if (const char* ptr = DrxStringUtils::strnstr(arrBoneEntitiesSorted[i].prop, "mass", sizeof(arrBoneEntitiesSorted[i].prop)))
			{
...
DynArray<SJointProperty> CDefaultSkeleton::GetPhysInfoProperties_ROPE(const DrxBonePhysics& pi, int32 nRopeOrGrid)
{
...
//////////////////////////////////////////////////////////////////////////
uint32 CDefaultSkeleton::GetTextureMemoryUsage2(IDrxSizer* pSizer) const
{
	uint32 nSize = 0;
	if (pSizer)
	{
...
//////////////////////////////////////////////////////////////////////////
uint32 CDefaultSkeleton::GetMeshMemoryUsage(IDrxSizer* pSizer) const
{
	uint32 nSize = 0;
	if (m_ModelMesh.m_pIRenderMesh)
	{
