#include <DinrusX/DinrusXAnimation/IDrxMannequin.h>
...
void CreateActionController(IEntity* pEntity)
{
	...
	IAnimationDatabaseUpr& databaseUpr = mannequin.GetAnimationDatabaseUpr();

	// Load the controller definition from disk
	const SControllerDef *pControllerDefinition = databaseUpr.LoadControllerDef(szControllerDefinitionPath);
