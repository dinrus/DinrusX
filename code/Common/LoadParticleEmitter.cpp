...
// Creates a particle emitter into the specified entity slot that emits continuously a specific effect
void LoadParticleEmitter(IEntity& entity)
{
	...
	if (IParticleEffect* pEffect = gEnv->pParticleUpr->FindEffect(szParticleEffectPath, "ParticleLoadExample"))
	{
