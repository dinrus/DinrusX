...
#include <DinrusX/DinrusXEntity/BreakableUpr.h>
#include <DinrusX/DinrusXEntity/BreakablePlane.h>
#include <DinrusX/DinrusXEntity/Entity.h>
#include <DinrusX/DinrusXEntity/EntitySystem.h>
#include <DinrusX/DinrusXEntity/EntitySlot.h>
...
#include <DinrusX/DinrusXEntity/RopeProxy.h>
...
void CBreakableUpr::EntityDrawSlot(CEntity* pEntity, int32 slot, int32 flags)
{
...
//////////////////////////////////////////////////////////////////////////
bool CBreakableUpr::CanShatterEntity(IEntity* pEntity, int nSlot)
{
	if (nSlot < 0)
		nSlot = 0;
...
//////////////////////////////////////////////////////////////////////////
void CBreakableUpr::BreakIntoPieces(IEntity* pEntity, int nOrigSlot, int nPiecesSlot, BreakageParams const& Breakage)
{
...
//////////////////////////////////////////////////////////////////////////
void CBreakableUpr::CreateSurfaceEffect(IStatObj* pStatObj, const Matrix34& tm, const char* sType)
{
	GeomRef geo;
...
//////////////////////////////////////////////////////////////////////////
void CBreakableUpr::AttachSurfaceEffect(IEntity* pEntity, int nSlot, const char* sType, SpawnParams const& paramsIn)
{
...
//////////////////////////////////////////////////////////////////////////
bool CBreakableUpr::CheckForPieces(IStatObj* pSrcStatObj, IStatObj::SSubObject* pSubObj, const Matrix34& worldTM, int nMatLayers,
...
void CBreakableUpr::GetBrokenObjectIndicesForCloning(int32* pPartRemovalIndices, int32& iNumPartRemovalIndices,
...
//////////////////////////////////////////////////////////////////////////
void CBreakableUpr::ClonePartRemovedEntitiesByIndex(int32* pBrokenObjIndicies, int32 iNumBrokenObjectIndices,
...
void CBreakableUpr::HideBrokenObjectsByIndex(const int32* pBrokenObjectIndices, const int32 iNumBrokenObjectIndices)
{
...
void CBreakableUpr::UnhidePartRemovedObjectsByIndex(const int32* pPartRemovalIndices, const int32 iNumPartRemovalIndices, const EventPhysRemoveEntityParts* pBreakEvents)
{
	IBreakableUpr* pBreakableMgr = g_pIEntitySystem->GetBreakableUpr();
...
//////////////////////////////////////////////////////////////////////////
void CBreakableUpr::ApplySinglePartRemovalFromEventIndex(int32 iPartRemovalEventIndex, const SRenderNodeCloneLookup& renderNodeLookup, const EventPhysRemoveEntityParts* pBreakEvents)
{
	ApplyPartBreakToClonedObjectFromEvent(renderNodeLookup, pBreakEvents[iPartRemovalEventIndex]);
}

//////////////////////////////////////////////////////////////////////////
void CBreakableUpr::ApplyPartRemovalsUntilIndexToObjectList(int32 iFirstIndex, const SRenderNodeCloneLookup& renderNodeLookup, const EventPhysRemoveEntityParts* pBreakEvents)
{
...
//////////////////////////////////////////////////////////////////////////
int CBreakableUpr::HandlePhysics_UpdateMeshEvent(const EventPhysUpdateMesh* pUpdateEvent)
{
...
//////////////////////////////////////////////////////////////////////////
void CBreakableUpr::GetPlaneMemoryStatistics(void* pPlaneRaw, IDrxSizer* pSizer)
{
	if (!pPlaneRaw)
		return;
