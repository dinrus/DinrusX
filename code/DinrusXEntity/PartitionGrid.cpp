...
DRX_UNIT_TEST(CUT_PartitionGrid)
{
	...
	DRX_UNIT_TEST_ASSERT(pGrid->m_nWidth == (int)(fMetersX / (SECTORS_PER_GROUP * METERS_PER_SECTOR)));
	DRX_UNIT_TEST_ASSERT(pGrid->m_nHeight == (int)(fMetersY / (SECTORS_PER_GROUP * METERS_PER_SECTOR)));
