...
#include <DinrusX/DinrusXEntity/SubstitutionProxy.h>
...
void CEntityComponentSubstitution::Done()
{
	...
	if (m_pSubstitute)
	{
		//gEnv->pLog->Log("DRXSIS-3502: CSubstitutionProxy::Done: Ptr=%d", (int)m_pSubstitute);
...
void CEntityComponentSubstitution::SetSubstitute(IRenderNode* pSubstitute)
{
	...
	//gEnv->pLog->Log("DRXSIS-3502: CSubstitutionProxy::SetSubstitute: Ptr=%d", (int)m_pSubstitute);
...
void CEntityComponentSubstitution::GameSerialize(TSerialize ser)
{
	...
	if (ser.IsReading())
	{
		if (!m_pSubstitute)
		{
			...
			{
				//gEnv->pLog->Log("DRXSIS-3502: CSubstitutionProxy::Serialize: Ptr=%d", (int)m_pSubstitute);
