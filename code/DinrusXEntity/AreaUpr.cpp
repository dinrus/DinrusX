...
IArea const* const CAreaUpr::GetArea(size_t const nAreaIndex) const
{
	...
	{
		DrxFatalError("<AreaUpr>: GetArea index out of bounds (Count: %d Index: %d)!", static_cast<int>(m_areas.size()), static_cast<int>(nAreaIndex));
	}
...
//////////////////////////////////////////////////////////////////////////
bool CAreaUpr::GetLinkedAreas(EntityId linkedId, EntityId* pOutArray, int& outAndMaxResults) const
{
...
//////////////////////////////////////////////////////////////////////////
size_t CAreaUpr::GetLinkedAreas(EntityId linkedId, int areaId, std::vector<CArea*>& areas) const
{
	size_t const nCount = m_areas.size();
...
//////////////////////////////////////////////////////////////////////////
int CAreaUpr::GetNumberOfPlayersNearOrInArea(CArea const* const pArea)
{
	// Find the area index
