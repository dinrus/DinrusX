...
#include <DinrusX/DinrusXFlowGraph/Module.h>
#include <DinrusX/DinrusXFlowGraph/FlowModuleNodes.h>
...
CFlowGraphModule* CFlowGraphModuleUpr::PreLoadModuleFile(const char* moduleName, const char* fileName, bool bGlobal)
{
...
void CFlowGraphModuleUpr::LoadModuleGraph(const char* moduleName, const char* fileName, IFlowGraphModuleListener::ERootGraphChangeReason rootGraphChangeReason)
{
...
IFlowGraphModule* CFlowGraphModuleUpr::LoadModuleFile(const char* moduleName, const char* fileName, bool bGlobal)
{
	// first check for existing module
	CFlowGraphModule* pModule = static_cast<CFlowGraphModule*>(GetModule(moduleName));
	if (pModule)
...
bool CFlowGraphModuleUpr::DeleteModuleXML(const char* moduleName)
{
...
bool CFlowGraphModuleUpr::RenameModuleXML(const char* moduleName, const char* newName)
{
...
void CFlowGraphModuleUpr::RescanModuleNames(bool bGlobal, const char* szLoadedLevelName)
{
...
void CFlowGraphModuleUpr::ScanAndReloadModules(bool bScanGlobalModules, bool bScanLevelModules, const char* szLoadedLevelName)
{
	LOADING_TIME_PROFILE_SECTION;
...
bool CFlowGraphModuleUpr::SaveModule(const char* moduleName, XmlNodeRef saveTo)
{
...
IFlowGraphModule* CFlowGraphModuleUpr::GetModule(const char* moduleName) const
{
...
const char* CFlowGraphModuleUpr::GetModulePath(const char* name)
{
...
const char* CFlowGraphModuleUpr::GetStartNodeName(const char* moduleName) const
{
...
const char* CFlowGraphModuleUpr::GetReturnNodeName(const char* moduleName) const
{
	static DrxFixedStringT<64> temp;
...
const char* CFlowGraphModuleUpr::GetCallerNodeName(const char* moduleName) const
{
	static DrxFixedStringT<64> temp;
...
/* Create Module Nodes */
bool CFlowGraphModuleUpr::CreateModuleNodes(const char* moduleName, TModuleId moduleId)
{
...
bool CFlowGraphModuleUpr::RegisterListener(IFlowGraphModuleListener* pListener, const char* name)
{
