...
private:
	...
	//////////////////////////////////////////////////////////////////////////
	void GetTriggerID(SActivationInfo* const pActInfo, uint32 const portIndex, DrxAudio::ControlId& outTriggerId)
	{
	...
	void ExecuteOnProxy(IEntity* const pIEntity, DrxAudio::ControlId const audioTriggerId, EPlayMode const playMode)
	{
		...
		if (pIEntityAudioComponent != nullptr)
		{
			...
			case ePlayMode_Play:
				{
					DrxAudio::SRequestUserData const userData(DrxAudio::ERequestFlags::DoneCallbackOnExternalThread, this, reinterpret_cast<void*>(static_cast<UINT_PTR>(m_playActivationInfo.pGraph->GetGraphId())), this);
