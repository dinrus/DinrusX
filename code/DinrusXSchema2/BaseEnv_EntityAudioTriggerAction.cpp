/*************************************************************************
Dinrus Source File.
Copyright (C), Dinrus Studios, 2001-2014.
-------------------------------------------------------------------------
$Id$
$DateTime$
Описание: Schematyc entity audio trigger action.
-------------------------------------------------------------------------
History:
...
#include <DinrusX/CoreX/Serialization/Decorators/Range.h>
#include <DinrusX/CoreX/Serialization/Decorators/ResourcesAudio.h>

//#include <DinrusX/DinrusXSchema2/Misc/MathUtils.h>
#include <DinrusX/DinrusXSchema2/BaseEnv_AutoRegistrar.h>
#include <DinrusX/DinrusXSchema2/BaseEnv_EntityActionBase.h>
#include <DinrusX/DinrusXSchema2/BaseEnv_EntityUpdateFilters.h>
#include <DinrusX/DinrusXSchema2/BaseEnv_EntityAudioComponent.h>
