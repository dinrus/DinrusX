...
#include <DinrusX/DinrusXSchema2/Object.h>
...
#include <DinrusX/DinrusXSchema2/ILibRegistry.h>
#include <DinrusX/DinrusXSchema2/IObjectUpr.h>
#include <DinrusX/DinrusXSchema2/LibUtils.h>
#include <DinrusX/DinrusXSchema2/Deprecated/IGlobalFunction.h>
#include <DinrusX/DinrusXSchema2/Deprecated/Stack.h>
#include <DinrusX/DinrusXSchema2/IEnvRegistry.h>
#include <DinrusX/DinrusXSchema2/IRuntime.h>
#include <DinrusX/DinrusXSchema2/RuntimeParams.h>

#include <DinrusX/DinrusXSchema2/CVars.h>
		...
		if(pFunction)
		{
			...
			if(s_recursionDepth >= CVars::sc_MaxRecursionDepth)
			{
				SCHEMATYC2_SYSTEM_METAINFO_CRITICAL_ERROR(
					SCHEMATYC2_LOG_METAINFO(EDrxLinkCommand::Show, SLogMetaItemGUID(pFunction->GetGUID())), 
