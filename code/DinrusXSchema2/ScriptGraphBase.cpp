...
#include <DinrusX/DinrusXSchema2/ScriptGraphCommentNode.h>    // #SchematycTODO : Where should script graph node creators be registered?
#include <DinrusX/DinrusXSchema2/ScriptGraphBeginNode.h>    // #SchematycTODO : Where should script graph node creators be registered?
#include <DinrusX/DinrusXSchema2/ScriptGraphFunctionNode.h> // #SchematycTODO : Where should script graph node creators be registered?
#include <DinrusX/DinrusXSchema2/ScriptGraphGetNode.h>      // #SchematycTODO : Where should script graph node creators be registered?
#include <DinrusX/DinrusXSchema2/ScriptGraphNodeFactory.h>  // #SchematycTODO : Where should the script graph node factory live?
#include <DinrusX/DinrusXSchema2/ScriptGraphSwitchNode.h>   // #SchematycTODO : Where should script graph node creators be registered?
