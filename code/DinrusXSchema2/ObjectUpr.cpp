...
namespace Schematyc2
{
	...
	//////////////////////////////////////////////////////////////////////////
	bool CObjectUpr::CPool::Allocate(void*& ptr, uint32& iBucket, uint32& salt)
	{
	...
	//////////////////////////////////////////////////////////////////////////
	void CObjectUpr::CPool::Free(uint32 iBucket)
	{
	...
	//////////////////////////////////////////////////////////////////////////
	void* CObjectUpr::CPool::Get(uint32 iBucket, uint32 salt)
	{
		DRX_ASSERT(iBucket < POOL_SIZE);
		if(iBucket < POOL_SIZE)
		{
