...
IFunctionDesc* CReflectedTypeDesc::AddFunction(const CMemberFunction& memberFunc, const char* szLabel, const DrxGUID& guid, const SSourceFileInfo& srcPos)
{
...
IVariableDesc* CReflectedTypeDesc::AddVariable(DrxTypeId typeId, ptrdiff_t offset, const char* szLabel, const DrxGUID& guid, const SSourceFileInfo& srcPos)
{
