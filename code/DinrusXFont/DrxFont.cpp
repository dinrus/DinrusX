...
#include <DinrusX/DinrusXFont/StdAfx.h>
	...
	#include <DinrusX/DinrusXFont/FFont.h>
	#include <DinrusX/DinrusXFont/FontTexture.h>
...
IFFont* CDrxFont::NewFont(const char* pFontName)
{
...
IFFont* CDrxFont::GetFont(const char* pFontName) const
{
...
void CDrxFont::UnregisterFont(const char* pFontName)
{
