...
#include "StdAfx.h"
#if DRX_PLATFORM_DURANGO && USE_DURANGOLIVE && !defined(_LIB)
...
RTC_NAME_S(ABI::Windows::Xbox::Management::Deployment::PackageTransferUpr, RuntimeClass_Windows_Xbox_Management_Deployment_PackageTransferUpr);
