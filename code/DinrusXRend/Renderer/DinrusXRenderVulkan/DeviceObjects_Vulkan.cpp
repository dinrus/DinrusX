...
#include <DinrusX/DinrusXRend/xxhash.h>
#include <DinrusX/DinrusXRend/D3DRender/Vulkan/VKInstance.hpp>
#include <DinrusX/DinrusXRend/D3DRender/Vulkan/VKBufferResource.hpp>
#include <DinrusX/DinrusXRend/D3DRender/Vulkan/VKImageResource.hpp>
#include <DinrusX/DinrusXRend/D3DRender/Vulkan/VKSampler.hpp>
#include <DinrusX/DinrusXRend/D3DRender/Vulkan/VKExtensions.hpp>

#include <DinrusX/DinrusXRend/Renderer.h>

#include <DinrusX/DinrusXRend/DeviceResourceSet_Vulkan.h>	
#include <DinrusX/DinrusXRend/DevicePSO_Vulkan.h>
#include <DinrusX/DinrusXRend/DeviceCommandListCommon_Vulkan.h>	
#include <DinrusX/DinrusXRend/DeviceRenderPass_Vulkan.h>
...
void CDeviceObjectFactory::SelectStagingLayout(const NDrxVulkan::CImageResource* pImage, uint32 subResource, SResourceMemoryMapping& result)
{
...
// Shader API
static NDrxVulkan::CShader* CreateShader(NDrxVulkan::CDevice* pDevice, const void* pShaderBytecode, size_t bytecodeLength)
{
