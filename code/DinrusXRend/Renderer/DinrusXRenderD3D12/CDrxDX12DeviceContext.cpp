...
#include <DinrusX/DinrusXRend/CDrxDX12Device.hpp>
#include <DinrusX/DinrusXRend/CDrxDX12DeviceContext.hpp>

#include <DinrusX/DinrusXRend/DX12/Resource/CDrxDX12Resource.hpp>

#include <DinrusX/DinrusXRend/DX12/Resource/Misc/CDrxDX12Buffer.hpp>
#include <DinrusX/DinrusXRend/DX12/Resource/Misc/CDrxDX12Shader.hpp>
#include <DinrusX/DinrusXRend/DX12/Resource/Misc/CDrxDX12Query.hpp>

#include <DinrusX/DinrusXRend/DX12/Resource/State/CDrxDX12SamplerState.hpp>

#include <DinrusX/DinrusXRend/DX12/Resource/Texture/CDrxDX12Texture1D.hpp>
#include <DinrusX/DinrusXRend/DX12/Resource/Texture/CDrxDX12Texture2D.hpp>
#include <DinrusX/DinrusXRend/DX12/Resource/Texture/CDrxDX12Texture3D.hpp>

#include <DinrusX/DinrusXRend/DX12/Resource/View/CDrxDX12DepthStencilView.hpp>
#include <DinrusX/DinrusXRend/DX12/Resource/View/CDrxDX12RenderTargetView.hpp>
#include <DinrusX/DinrusXRend/DX12/Resource/View/CDrxDX12ShaderResourceView.hpp>
#include <DinrusX/DinrusXRend/DX12/Resource/View/CDrxDX12UnorderedAccessView.hpp>

#include <DinrusX/DinrusXRend/DX12/API/DX12Device.hpp>
...
void CDrxDX12DeviceContext::CeaseCommandQueueCallback(int nPoolId)
{
...
void CDrxDX12DeviceContext::ResumeCommandQueueCallback(int nPoolId)
{
...
void CDrxDX12DeviceContext::QueryTimestamp(NDrxDX12::CCommandList* pCmdList, UINT index, void* mem)
{
	if (mem)
	{
		if (!m_TimestampMemory)
...
void CDrxDX12DeviceContext::ResolveOcclusion(NDrxDX12::CCommandList* pCmdList, UINT index, void* mem)
{
	if (mem)
	{
  ...
  _In_reads_opt_(NumRects)  const D3D11_RECT* pRects)
{
	...
	#include <DinrusX/DinrusXRend/D3DRender/DX12/API/Redirections/D3D12Device.inl"
#endif
