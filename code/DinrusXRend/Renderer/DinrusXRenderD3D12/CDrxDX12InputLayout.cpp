...
#include <DinrusX/DinrusXRend/CDrxDX12InputLayout.hpp>
#include <DinrusX/DinrusXRend/../DeviceUpr/DeviceFormats.h> // DeviceFormats::GetSize

CDrxDX12InputLayout* CDrxDX12InputLayout::Create(CDrxDX12Device* pDevice, const D3D11_INPUT_ELEMENT_DESC* pInputElementDescs11, UINT NumElements, const void* pShaderBytecodeWithInputSignature, SIZE_T BytecodeLength)
{
