...
#include <DinrusX/DinrusXRend/NullD3D11Device.h>
...
WIN_HWND CD3D9Renderer::Init(int x, int y, int width, int height, unsigned int colorBits, int depthBits, int stencilBits, WIN_HWND Glhwnd, bool bReInit, bool bShaderCacheGen)
{
	...
	const char* sGameName = gEnv->pSystem->GetIProjectUpr()->GetCurrentProjectName();
...
bool CD3D9Renderer::CreateDevice()
{
	...
	#include <DinrusX/DinrusXRend/dxgi1_4.h>
#endif
...
#include <DinrusX/DinrusXRend/DeviceInfo.inl"
