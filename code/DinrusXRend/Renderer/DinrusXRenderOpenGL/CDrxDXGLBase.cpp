...
HRESULT CDrxDXGLBase::QueryInterface(REFIID riid, void** ppvObject)
{
...
HRESULT CDrxDXGLPrivateDataContainer::GetPrivateData(REFGUID guid, UINT* pDataSize, void* pData)
{
	if (pData == NULL)
	{
		if (*pDataSize != 0)
...
HRESULT CDrxDXGLPrivateDataContainer::SetPrivateData(REFGUID guid, UINT DataSize, const void* pData)
{
	RemovePrivateData(guid);
