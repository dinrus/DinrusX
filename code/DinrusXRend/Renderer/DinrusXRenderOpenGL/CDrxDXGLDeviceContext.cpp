...
// -------------------------------------------------------------------------
//  File name:   CDrxDXGLDeviceContext.cpp
//  Version:     v1.00
...
void CheckHazard(uint32 uRTVIndex, CDrxDXGLRenderTargetView* pRTView, CDrxDXGLResource* pRTVResource, uint32 uSRVIndex, CDrxDXGLShaderResourceView* pSRView, CDrxDXGLResource* pSRVResource, uint32 uStage)
{
...
void CheckHazard(uint32 uDSVIndex, CDrxDXGLDepthStencilView* pDSView, CDrxDXGLResource* pDSVResource, uint32 uSRVIndex, CDrxDXGLShaderResourceView* pSRView, CDrxDXGLResource* pSRVResource, uint32 uStage)
{
...
void CheckHazards(_smart_ptr<OMView>* pOMViews, uint32 uNumOMViews, _smart_ptr<CDrxDXGLShaderResourceView>* pSRViews, uint32 uNumSRViews, uint32 uStage)
{
	uint32 uOMView;
...
void CDrxDXGLDeviceContext::SetShaderResources(uint32 uStage, UINT StartSlot, UINT NumViews, ID3D11ShaderResourceView* const* ppShaderResourceViews)
{
...
void CDrxDXGLDeviceContext::SetUnorderedAccessViews(uint32 uStage, UINT StartSlot, UINT NumViews, ID3D11UnorderedAccessView* const* ppUnorderedAccessViews)
{
	CheckCurrentContext(m_pContext);
...
void CDrxDXGLDeviceContext::SetShader(uint32 uStage, CDrxDXGLShader* pShader, ID3D11ClassInstance* const* ppClassInstances, UINT NumClassInstances)
{
...
void CDrxDXGLDeviceContext::SetSamplers(uint32 uStage, UINT StartSlot, UINT NumSamplers, ID3D11SamplerState* const* ppSamplers)
{
	CheckCurrentContext(m_pContext);
...
void CDrxDXGLDeviceContext::SetConstantBuffers(uint32 uStage, UINT StartSlot, UINT NumBuffers, ID3D11Buffer* const* ppConstantBuffers, const UINT* pFirstConstant, const UINT* pNumConstants)
{
	CheckCurrentContext(m_pContext);
...
void CDrxDXGLDeviceContext::GetShaderResources(uint32 uStage, UINT StartSlot, UINT NumViews, ID3D11ShaderResourceView** ppShaderResourceViews)
{
	if (uStage >= m_kStages.size())
	{
...
void CDrxDXGLDeviceContext::GetUnorderedAccesses(uint32 uStage, UINT StartSlot, UINT NumViews, ID3D11UnorderedAccessView** ppUnorderedAccessViews)
{
	if (uStage >= m_kStages.size())
	{
...
void CDrxDXGLDeviceContext::GetShader(uint32 uStage, CDrxDXGLShader** ppShader, ID3D11ClassInstance** ppClassInstances, UINT* NumClassInstances)
{
...
void CDrxDXGLDeviceContext::GetSamplers(uint32 uStage, UINT StartSlot, UINT NumSamplers, ID3D11SamplerState** ppSamplers)
{
	if (uStage >= m_kStages.size())
	{
...
void CDrxDXGLDeviceContext::GetConstantBuffers(uint32 uStage, UINT StartSlot, UINT NumBuffers, ID3D11Buffer** ppConstantBuffers, UINT* pFirstConstant, UINT* pNumConstants)
{
	if (uStage >= m_kStages.size())
	{
...
HRESULT CDrxDXGLDeviceContext::GetData(ID3D11Asynchronous* pAsync, void* pData, UINT DataSize, UINT GetDataFlags)
{
	CheckCurrentContext(m_pContext);
#if OGL_SINGLE_CONTEXT
	NDrxOpenGL::SQuery* pQuery(CDrxDXGLQuery::FromInterface(pAsync)->GetGLQuery(m_pContext));
...
void CDrxDXGLDeviceContext::UpdateSubresource(ID3D11Resource* pDstResource, UINT DstSubresource, const D3D11_BOX* pDstBox, const void* pSrcData, UINT SrcRowPitch, UINT SrcDepthPitch)
{
	CheckCurrentContext(m_pContext);
