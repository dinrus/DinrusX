...
// -------------------------------------------------------------------------
//  File name:   CDrxDXGLShaderReflection.cpp
//  Version:     v1.00
...
#include <DinrusX/DinrusXRend/CDrxDXGLShaderReflection.hpp>
...
bool CDrxDXGLShaderReflectionVariable::Initialize(void* pvData)
{
...
bool CDrxDXGLShaderReflectionConstBuffer::Initialize(void* pvData)
{
...
bool CDrxDXGLShaderReflection::Initialize(const void* pvData)
{
