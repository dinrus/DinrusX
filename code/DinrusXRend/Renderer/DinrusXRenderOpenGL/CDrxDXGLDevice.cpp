...
#include <DinrusX/DinrusXRend/CDrxDXGLBuffer.hpp>
...
#include <DinrusX/DinrusXRend/CDrxDXGLDeviceContext.hpp>
#include <DinrusX/DinrusXRend/CDrxDXGLGIAdapter.hpp>
#include <DinrusX/DinrusXRend/CDrxDXGLInputLayout.hpp>
#include <DinrusX/DinrusXRend/CDrxDXGLQuery.hpp>
...
#include <DinrusX/DinrusXRend/CDrxDXGLSwapChain.hpp>
#include <DinrusX/DinrusXRend/CDrxDXGLShader.hpp>
#include <DinrusX/DinrusXRend/CDrxDXGLShaderResourceView.hpp>
#include <DinrusX/DinrusXRend/CDrxDXGLTexture1D.hpp>
#include <DinrusX/DinrusXRend/CDrxDXGLTexture2D.hpp>
#include <DinrusX/DinrusXRend/CDrxDXGLTexture3D.hpp>
#include <DinrusX/DinrusXRend/CDrxDXGLUnorderedAccessView.hpp>
#include <DinrusX/DinrusXRend/Implementation/GLDevice.hpp>
#include <DinrusX/DinrusXRend/Implementation/GLFormat.hpp>
...
HRESULT CDrxDXGLDevice::QueryInterface(REFIID riid, void** ppvObject)
{
...
HRESULT CDrxDXGLDevice::GetParent(REFIID riid, void** ppParent)
{
...
HRESULT CDrxDXGLDevice::CreateInputLayout(const D3D11_INPUT_ELEMENT_DESC* pInputElementDescs, UINT NumElements, const void* pShaderBytecodeWithInputSignature, SIZE_T BytecodeLength, ID3D11InputLayout** ppInputLayout)
{
...
_smart_ptr<NDrxOpenGL::SShader> CreateGLShader(const void* pShaderBytecode, SIZE_T BytecodeLength, ID3D11ClassLinkage* pClassLinkage, NDrxOpenGL::EShaderType eType, NDrxOpenGL::CContext* pContext)
{
...
HRESULT CreateShader(const void* pShaderBytecode, SIZE_T BytecodeLength, ID3D11ClassLinkage* pClassLinkage, D3DShader** ppShader, NDrxOpenGL::EShaderType eType, CDrxDXGLDevice* pDevice, NDrxOpenGL::CContext* pContext)
{
...
HRESULT CDrxDXGLDevice::CreateVertexShader(const void* pShaderBytecode, SIZE_T BytecodeLength, ID3D11ClassLinkage* pClassLinkage, ID3D11VertexShader** ppVertexShader)
{
	SAutoContext kAutoContext(m_spGLDevice);
...
HRESULT CDrxDXGLDevice::CreateGeometryShader(const void* pShaderBytecode, SIZE_T BytecodeLength, ID3D11ClassLinkage* pClassLinkage, ID3D11GeometryShader** ppGeometryShader)
{
...
HRESULT CDrxDXGLDevice::CreateGeometryShaderWithStreamOutput(const void* pShaderBytecode, SIZE_T BytecodeLength, const D3D11_SO_DECLARATION_ENTRY* pSODeclaration, UINT NumEntries, const UINT* pBufferStrides, UINT NumStrides, UINT RasterizedStream, ID3D11ClassLinkage* pClassLinkage, ID3D11GeometryShader** ppGeometryShader)
{
	DXGL_NOT_IMPLEMENTED
	return E_FAIL;
}

HRESULT CDrxDXGLDevice::CreatePixelShader(const void* pShaderBytecode, SIZE_T BytecodeLength, ID3D11ClassLinkage* pClassLinkage, ID3D11PixelShader** ppPixelShader)
{
	SAutoContext kAutoContext(m_spGLDevice);
...
HRESULT CDrxDXGLDevice::CreateHullShader(const void* pShaderBytecode, SIZE_T BytecodeLength, ID3D11ClassLinkage* pClassLinkage, ID3D11HullShader** ppHullShader)
{
...
HRESULT CDrxDXGLDevice::CreateDomainShader(const void* pShaderBytecode, SIZE_T BytecodeLength, ID3D11ClassLinkage* pClassLinkage, ID3D11DomainShader** ppDomainShader)
{
#if DXGL_SUPPORT_TESSELLATION
	SAutoContext kAutoContext(m_spGLDevice);
...
HRESULT CDrxDXGLDevice::CreateComputeShader(const void* pShaderBytecode, SIZE_T BytecodeLength, ID3D11ClassLinkage* pClassLinkage, ID3D11ComputeShader** ppComputeShader)
{
...
HRESULT CDrxDXGLDevice::OpenSharedResource(HANDLE hResource, REFIID ReturnedInterface, void** ppResource)
{
	DXGL_NOT_IMPLEMENTED
	return E_FAIL;
}
...
HRESULT CDrxDXGLDevice::CheckFeatureSupport(D3D11_FEATURE Feature, void* pFeatureSupportData, UINT FeatureSupportDataSize)
{
	switch (Feature)
	{
...
HRESULT CDrxDXGLDevice::GetPrivateData(REFGUID guid, UINT* pDataSize, void* pData)
{
	return m_kPrivateDataContainer.GetPrivateData(guid, pDataSize, pData);
}

HRESULT CDrxDXGLDevice::SetPrivateData(REFGUID guid, UINT DataSize, const void* pData)
{
