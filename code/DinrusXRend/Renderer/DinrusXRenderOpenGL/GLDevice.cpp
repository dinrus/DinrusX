...
#include <DinrusX/DinrusXRend/GLResource.hpp>
	...
	#include <DinrusX/DinrusXRend/AppleGPUInfoUtils.h>
#endif
...
void DXGL_DEBUG_CALLBACK_CONVENTION DebugCallback(GLenum eSource, GLenum eType, GLuint uId, GLenum eSeverity, GLsizei uLength, const char* szMessage, void* pUserParam)
{
	...
	NDrxOpenGL::LogMessage(eLogSeverity, "[GL_DEBUG] %s [source=0x%X, type=0x%X, id=0x%X]", szMessage, (uint32)eSource, (uint32)eType, (uint32)uId);
}
