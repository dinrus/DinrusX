...
#include <DinrusX/DinrusXRend/GLResource.hpp>
#include <DinrusX/DinrusXRend/GLContext.hpp>
#include <DinrusX/DinrusXRend/GLDevice.hpp>
#include <DinrusX/DinrusXRend/GLView.hpp>
...
struct SDynamicBufferImpl
{
	...
	static void UpdateBufferSubresource(SResource* pResource, uint32 uSubresource, const D3D11_BOX* pDstBox, const void* pSrcData, uint32, uint32, CContext* pContext)
	{
		...
		NDrxOpenGL::Memcpy(pBuffer->m_pSystemMemoryCopy, static_cast<const uint8*>(pSrcData) + uDstOffset, uDstSize);
	}
};
