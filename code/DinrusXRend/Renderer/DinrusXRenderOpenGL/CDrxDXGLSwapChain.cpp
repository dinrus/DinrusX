...
// -------------------------------------------------------------------------
//  File name:   CDrxDXGLSwapChain.cpp
//  Version:     v1.00
...
#include <DinrusX/DinrusXRend/Implementation/GLContext.hpp>
...
HRESULT CDrxDXGLSwapChain::GetBuffer(UINT Buffer, REFIID riid, void** ppSurface)
{
