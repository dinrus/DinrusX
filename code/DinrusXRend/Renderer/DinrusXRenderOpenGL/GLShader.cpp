...
#include <DinrusX/DinrusXRend/GLShader.hpp>
#include <DinrusX/DinrusXRend/GLDevice.hpp>

#if DXGL_INPUT_GLSL && DXGL_GLSL_FROM_HLSLCROSSCOMPILER
	#include <DinrusX/DinrusXRend/hlslcc.hpp>
#endif //DXGL_INPUT_GLSL && DXGL_GLSL_FROM_HLSLCROSSCOMPILER
#include <DinrusX/DinrusXRend/hlslcc_bin.hpp>
...
// Shaders generated with HLSL2GLSL are simplified using glslOptimizer to exploit its function inlining and simplify instrumentation.
	#include <DinrusX/DinrusXRend/Tools/glslOptimizer/src/glsl/glsl_optimizer.h>
struct SSimplifiedShader
{
	...
	const char* Simplify(const char* szSource, NDrxOpenGL::EShaderType eType)
	{
		struct SAutoContext
		{
