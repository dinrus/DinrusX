...
#include <DinrusX/DinrusXRend/DeviceObjects_D3D11.h>
#include <DinrusX/DinrusXRend/DevicePSO_D3D11.h>
#include <DinrusX/DinrusXRend/DeviceResourceSet_D3D11.h>
#include <DinrusX/DinrusXRend/DeviceCommandList_D3D11.h>
#include <DinrusX/DinrusXRend/DeviceRenderPass_D3D11.h>
...
void CDeviceStatesUprDX11::ReleaseUnusedStates(uint32 currentFrameID) {
...
uint32 CDeviceStatesUprDX11::GetOrCreateBlendState(const D3D11_BLEND_DESC& desc)
{
	uint32 i;
	HRESULT hr = S_OK;
...
uint32 CDeviceStatesUprDX11::GetOrCreateRasterState(const D3D11_RASTERIZER_DESC& rasterizerDec, const bool bAllowMSAA)
{
	uint32 i;
	HRESULT hr = S_OK;
...
uint32 CDeviceStatesUprDX11::GetOrCreateDepthState(const D3D11_DEPTH_STENCIL_DESC& desc)
{
	uint32 i;
	HRESULT hr = S_OK;
