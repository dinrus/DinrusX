...
#include <DinrusX/DinrusXRend/DeviceWrapper_D3D11_MemReplay.h>
...
///////////////////////////////////////////////////////////////////////////////
const char* CDrxDeviceMemReplayHook::Name() const
{
...
void CDrxDeviceMemReplayHook::CreatePlacementBuffer_PostCallHook(HRESULT hr, const D3D11_BUFFER_DESC* pDesc, void* pCpuVirtualAddress, ID3D11Buffer** ppBuffer)
{
	if (FAILED(hr))
		return;
...
///////////////////////////////////////////////////////////////////////////////
void CDrxDeviceMemReplayHook::CreatePlacementTexture1D_PostCallHook(HRESULT hr, const D3D11_TEXTURE1D_DESC* pDesc, UINT TileModeIndex, UINT Pitch, void* pCpuVirtualAddress, ID3D11Texture1D** ppTexture1D)
{
...
///////////////////////////////////////////////////////////////////////////////
void CDrxDeviceMemReplayHook::CreatePlacementTexture2D_PostCallHook(HRESULT hr, const D3D11_TEXTURE2D_DESC* pDesc, UINT TileModeIndex, UINT Pitch, void* pCpuVirtualAddress, ID3D11Texture2D** ppTexture2D)
{
		#if !defined(MEMREPLAY_INSTRUMENT_TEXTUREPOOL)
	if (FAILED(hr))
		return;
...
///////////////////////////////////////////////////////////////////////////////
void CDrxDeviceMemReplayHook::CreatePlacementTexture3D_PostCallHook(HRESULT hr, const D3D11_TEXTURE3D_DESC* pDesc, UINT TileModeIndex, UINT Pitch, void* pCpuVirtualAddress, ID3D11Texture3D** ppTexture3D)
{
		#if !defined(MEMREPLAY_INSTRUMENT_TEXTUREPOOL)
	if (FAILED(hr))
		return;
