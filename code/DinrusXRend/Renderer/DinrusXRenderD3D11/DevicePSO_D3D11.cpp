...
CDeviceGraphicsPSO::EInitResult CDeviceGraphicsPSO_DX11::Init(const CDeviceGraphicsPSODesc& psoDesc)
{
	...
	uint32 rasterStateIndex = CDeviceStatesUprDX11::GetInstance()->GetOrCreateRasterState(rasterizerDesc);
	uint32 blendStateIndex = CDeviceStatesUprDX11::GetInstance()->GetOrCreateBlendState(blendDesc);
	uint32 depthStateIndex = CDeviceStatesUprDX11::GetInstance()->GetOrCreateDepthState(depthStencilDesc);
