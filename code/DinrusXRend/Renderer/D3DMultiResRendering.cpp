...
void CVrProjectionUpr::GetProjectionSize(int flattenedWidth, int flattenedHeight, int & projectionWidth, int & projectionHeight)
{
...
CConstantBufferPtr CVrProjectionUpr::GetProjectionConstantBuffer(int flattenedWidth, int flattenedHeight)
{
