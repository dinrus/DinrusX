...
#endif
#include <DinrusX/DinrusXRend/D3DRender/GraphicsPipeline/VolumetricClouds.h>
#include <DinrusX/DinrusXRend/D3DRender/GraphicsPipeline/VolumetricFog.h>
#include <DinrusX/DinrusXRend/D3DRender/GraphicsPipeline/WaterRipples.h>
#include <DinrusX/DinrusXRend/D3DRender/GraphicsPipeline/Water.h>
...
std::vector<uint32, stl::STLGlobalAllocator<uint32>> CGParamUpr::s_FreeGroups;
...
int CGParamUpr::GetParametersGroup(SParamsGroup& InGr, int nId)
{
...
bool CGParamUpr::FreeParametersGroup(int nIDGroup)
{
...
SCGParamPool* CGParamUpr::NewPool(int nEntries)
{
