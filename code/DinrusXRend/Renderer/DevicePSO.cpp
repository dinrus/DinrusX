...
#include <DinrusX/DinrusXRend/DevicePSO.h>
...
CDeviceComputePSODesc::CDeviceComputePSODesc(CDeviceResourceLayoutPtr pResourceLayout, ::CShader* pShader, const CDrxNameTSCRC& technique, uint64 rtFlags, uint32 mdFlags, uint32 mdvFlags)
{
	InitWithDefaults();
