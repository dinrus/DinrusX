...
#include <DinrusX/DinrusXRend/DeviceObjectHelpers.h>

#include <DinrusX/DinrusXRend/D3DRender/DriverD3D.h>   // CD3D9Renderer

extern CD3D9Renderer gcpRendD3D;

#include <DinrusX/DinrusXRend/D3DRender/D3DHWShader.h> // CHWShader_D3D

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
EShaderStage SDeviceObjectHelpers::GetShaderInstanceInfo(THwShaderInfo& result, ::CShader* pShader, const CDrxNameTSCRC& technique, uint64 rtFlags, uint32 mdFlags, uint32 mdvFlags, const UPipelineState pipelineState[eHWSC_Num], bool bAllowTesselation)
{
...
bool SDeviceObjectHelpers::CShaderConstantUpr::IsBufferUsedForReflection(int bufferIndex) const
{
	if (m_pShaderReflection)
	{
...
bool SDeviceObjectHelpers::CShaderConstantUpr::SetNamedConstantArray(const CDrxNameR& paramName, const Vec4 params[], uint32 numParams, EHWShaderClass shaderClass)
{
