...
#include <DinrusX/DinrusXRend/StdAfx.h>
	...
	#include <DinrusX/DinrusXRend/SmartGlassContext.h>
	...
	#include <DinrusX/DinrusXRend/inspectable.h>
...
void CSmartGlassContext::CreateSwapChain()
{
	...
	m_pDrxTexture = CTexture::GetOrCreateTextureObject("$SmartGlass", (uint32)m_viewport.Width, (uint32)m_viewport.Height, 1, eTT_2D, FT_DONT_RELEASE | FT_DONT_STREAM | FT_USAGE_RENDERTARGET, eTF_Unknown, TO_SMARTGLASS);
