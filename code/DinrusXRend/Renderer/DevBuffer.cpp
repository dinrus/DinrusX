...
public:
	...
	void* BeginRead   (CDeviceBuffer* buffer, buffer_size_t size, buffer_size_t offset) { DrxFatalError("Attempting to use unimplemented CDefaultUpdater"); return nullptr; }
	void* BeginWrite  (CDeviceBuffer* buffer, buffer_size_t size, buffer_size_t offset) { DrxFatalError("Attempting to use unimplemented CDefaultUpdater"); return nullptr; }
	...
	void  Read (CDeviceBuffer* buffer, buffer_size_t size, buffer_size_t offset,       void* dst) { DrxFatalError("Attempting to use unimplemented CDefaultUpdater"); }
	void  Write(CDeviceBuffer* buffer, buffer_size_t size, buffer_size_t offset, const void* src) { DrxFatalError("Attempting to use unimplemented CDefaultUpdater"); }
...
//////////////////////////////////////////////////////////////////////////////////////
void CDeviceBufferUpr::Sync(uint32 frameId)
{
	FUNCTION_PROFILER_RENDERER();
	MEMORY_SCOPE_CHECK_HEAP();
	SREC_AUTO_LOCK(s_PoolUpr.m_lock);
...
//////////////////////////////////////////////////////////////////////////////////////
void CDeviceBufferUpr::ReleaseEmptyBanks(uint32 frameId)
{
	FUNCTION_PROFILER_RENDERER();
	MEMORY_SCOPE_CHECK_HEAP();
	SREC_AUTO_LOCK(s_PoolUpr.m_lock);
...
//////////////////////////////////////////////////////////////////////////////////////
void CDeviceBufferUpr::Update(uint32 frameId, bool called_during_loading)
{
	FUNCTION_PROFILER_RENDERER();
...
//////////////////////////////////////////////////////////////////////////////////////
void* CDeviceBufferUpr::BeginRead_Locked(buffer_handle_t handle)
{
...
void* CDeviceBufferUpr::BeginRead(buffer_handle_t handle)
{
	DRX_PROFILE_FUNCTION(PROFILE_RENDERER);
#if DRX_PLATFORM_WINDOWS
	SRecursiveSpinLocker __lock(&s_PoolUpr.m_lock);
...
//////////////////////////////////////////////////////////////////////////////////////
void* CDeviceBufferUpr::BeginWrite_Locked(buffer_handle_t handle)
{
	STATOSCOPE_TIMER(s_PoolUpr.m_sdata[0].m_io_time);
...
void* CDeviceBufferUpr::BeginWrite(buffer_handle_t handle)
{
#if DRX_PLATFORM_WINDOWS
	SRecursiveSpinLocker __lock(&s_PoolUpr.m_lock);
#endif
