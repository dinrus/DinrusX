...
#include <DinrusX/DinrusXRend/D3DRender/DeviceUpr/DeviceResources.h>
	...
	#include <DinrusX/DinrusXRend/D3D12/DeviceResources_D3D12.inl"

	#if DRX_PLATFORM_DURANGO
		#include <DinrusX/DinrusXRend/D3D12/DeviceResources_D3D12_Durango.inl"
	#endif

#elif (DRX_RENDERER_DIRECT3D >= 110)
	#include <DinrusX/DinrusXRend/D3D11/DeviceResources_D3D11.inl"

	#if DRX_PLATFORM_DURANGO
		#include <DinrusX/DinrusXRend/D3D11/DeviceResources_D3D11_Durango.inl"
	#endif

	#if defined(USE_NV_API)
		#include <DinrusX/DinrusXRend/D3D11/DeviceResources_D3D11_NVAPI.inl"
	#endif
#elif (DRX_RENDERER_VULKAN >= 10)
	#include <DinrusX/DinrusXRend/D3DRender/Vulkan/DeviceResources_Vulkan.inl"
#endif
