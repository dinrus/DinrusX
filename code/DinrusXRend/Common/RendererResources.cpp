...
#include <DinrusX/DinrusXRend/D3DRender/D3DDeferredShading.h>          // CDeferredShading
#include <DinrusX/DinrusXRend/D3DRender/D3DPostProcess.h>              // SD3DPostEffectsUtils

#include <DinrusX/DinrusXRend/RendElements/FlareSoftOcclusionQuery.h>       // CFlareSoftOcclusionQuery
...
void CRendererResources::LoadDefaultSystemTextures()
{
	...
	if (!m_bLoadedSystem)
	{
		...
		for (int t = 0; t < DRX_ARRAY_COUNT(texturesFromFile); ++t)
		{
