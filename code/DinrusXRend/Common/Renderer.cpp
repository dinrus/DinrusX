...
#include <DinrusX/DinrusX3dEng/IStatObj.h>
...
#include <DinrusX/DinrusXRend/Textures/TextureCompiler.h>                 // CTextureCompiler

#include <DinrusX/DinrusXRend/PostProcess/PostEffects.h>
#include <DinrusX/DinrusXRend/RendElements/CRELensOptics.h>

#include <DinrusX/DinrusXRend/RendElements/OpticsFactory.h>
#include <DinrusX/DinrusXRend/IntroMovieRenderer.h>

#include <DinrusX/DinrusX3dEng/IGeomCache.h>
...
#include <DinrusX/DinrusXRend/Shaders/ShaderPublicParams.h>
...
//#include <DinrusX/DinrusXRend/FrameProfilers-list.h>
//#undef PROFILER
...
//#include <DinrusX/DinrusXRend/Character/DrxModel.h>
...
#include <DinrusX/DinrusXRend/../SDKs/squish-ccr/squish.h>
#include <DinrusX/DinrusXRend/../SDKs/squish-ccr/squish.inl"
...
{
	const int currentPoolIndex  =  m_nPoolIndex %  DRX_ARRAY_COUNT(m_SkinningDataPool);
	const int previousPoolIndex = (m_nPoolIndex + (DRX_ARRAY_COUNT(m_SkinningDataPool) - 1)) % DRX_ARRAY_COUNT(m_SkinningDataPool);
