...
#include <DinrusX/DinrusXAI/MovementBlock_InstallPipeUserInCover.h>
#include <DinrusX/DinrusXAI/MovementBlock_SetupPipeUserCoverInformation.h>
#include <DinrusX/DinrusXAI/MovementBlock_UninstallPipeUserFromCover.h>
...
CAIObject* CPipeUser::GetOrCreateSpecialAIObject(ESpecialAIObjects type)
{
	...
	default:
		{
			char buf[64];
			drx_sprintf(buf, "_*Special%02d", (int)type);
			name += buf;
			break;
		}
	}
