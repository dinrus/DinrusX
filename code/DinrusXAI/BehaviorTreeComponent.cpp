...
void CEntityAIBehaviorTreeComponent::Register(Schematyc::IEnvRegistrar& registrar)
{
	Schematyc::CEnvRegistrationScope entityScope = registrar.Scope(IEntity::GetEntityScopeGUID());
	{
		Schematyc::CEnvRegistrationScope componentScope = entityScope.Register(SCHEMATYC_MAKE_ENV_COMPONENT(CEntityAIBehaviorTreeComponent));
		{
			...
			{
				auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CEntityAIBehaviorTreeComponent::SchematycFunction_SendEvent, "4fd411d7-4af7-45b3-8a33-992e12ac5f53"_drx_guid, "SendEvent");
			...
			{
				auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CEntityAIBehaviorTreeComponent::SchematycFunction_SetBBKeyValue<Vec3>, "ea9a42e2-5c48-48e3-8678-4513f9794e19"_drx_guid, "SetBBVec3");
