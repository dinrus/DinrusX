...
#include <DinrusX/DinrusXAI/TacticalPointQuery.h>
#include <DinrusX/DinrusXAI/TacticalPointQueryEnum.h>
...
#include <DinrusX/DinrusXAI/CoverSurface.h>
...
void CTacticalPointSystem::Update(const float fBudgetSeconds)
{
	...
	int nPreviousAsyncInFrame = (int) gAIEnv.pStatsUpr->GetStat(eStat_AsyncTPSQueries);   // If this is our only call to Update, this will always be 0
