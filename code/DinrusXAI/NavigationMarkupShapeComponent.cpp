...
#include <DinrusX/DinrusXAI/NavigationMarkupShapeComponent.h>
...
void CAINavigationMarkupShapeComponent::Register(Schematyc::IEnvRegistrar& registrar)
{
	Schematyc::CEnvRegistrationScope entityScope = registrar.Scope(IEntity::GetEntityScopeGUID());
	{
		Schematyc::CEnvRegistrationScope componentScope = entityScope.Register(SCHEMATYC_MAKE_ENV_COMPONENT(CAINavigationMarkupShapeComponent));
		{
			// Functions
			{
				auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CAINavigationMarkupShapeComponent::SetAnnotationFlag, "299851E7-89E1-431B-A9E0-E085361F674D"_drx_guid, "SetAnnotationFlag");
			...
			{
				auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CAINavigationMarkupShapeComponent::ToggleAnnotationFlags, "9E1F9DCE-58D4-4A11-B5B3-3D9D2578DDDE"_drx_guid, "ToggleAnnotationFlags");
			...
			{
				auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CAINavigationMarkupShapeComponent::ResetAnotations, "2BDD2A21-25EE-4C07-A851-7CCA758EAE0C"_drx_guid, "ResetAnotation");
