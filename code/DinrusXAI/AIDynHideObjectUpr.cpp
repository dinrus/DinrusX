...
/********************************************************************
   -------------------------------------------------------------------------
   File name:   AIDynHideObjectUpr.cpp
   $Id$
...
#include <DinrusX/DinrusXAI/AIHash.h>
#include <float.h>
...
//===================================================================
void CAIDynHideObjectUpr::FreeCacheItem(int i)
{
...
//===================================================================
int CAIDynHideObjectUpr::GetNewCacheItem()
{
...
//===================================================================
unsigned int CAIDynHideObjectUpr::GetPositionHashFromEntity(IEntity* pEntity)
{
