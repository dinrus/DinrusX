...
PostureUpr::PostureID PostureUpr::GetPostureID(const char* postureName) const
{
...
bool PostureUpr::GetPostureByName(const char* postureName, PostureInfo* posture) const
{
	for (uint32 i = 0; i < m_postureInfos.size(); ++i)
	{
