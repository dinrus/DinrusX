...
void CEntityAICoverUserComponent::Register(Schematyc::IEnvRegistrar& registrar)
{
	Schematyc::CEnvRegistrationScope scope = registrar.Scope(IEntity::GetEntityScopeGUID());
	{
		...
		// Functions
		{
			auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CEntityAICoverUserComponent::GetRandomCoverId, "07C39B63-5D8F-4C7B-8730-4BA189E20461"_drx_guid, "GetRandomCover");
		...
		{
			auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CEntityAICoverUserComponent::MoveToCover, "04B97008-7145-43F8-9099-947D376770B1"_drx_guid, "MoveToCover");
			pFunction->SetDescription("Starts move to cover movement request.");
			pFunction->BindInput(1, 'cid', "CoverId", "Cover Id");
			componentScope.Register(pFunction);
		}
		{
			auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CEntityAICoverUserComponent::IsInCover, "53E71E95-48DB-4A77-A31D-409E65624D0B"_drx_guid, "IsInCover");
		...
		{
			auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CEntityAICoverUserComponent::IsMovingToCover, "5D5CDA5F-EB09-4C47-A563-CF983129EB06"_drx_guid, "IsMovingToCover");
		...
		{
			auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CEntityAICoverUserComponent::IsCoverCompromised, "AA5E2D2B-9208-4AF9-91BD-B4820F9A4F94"_drx_guid, "IsCoverCompromised");
		...
		{
			auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CEntityAICoverUserComponent::GetCurrentCoverPosition, "D53E7DD9-F0C9-454A-AE95-AEA78B3ADA92"_drx_guid, "GetCurrentCoverPosition");
		...
		{
			auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CEntityAICoverUserComponent::GetCurrentCoverNormal, "293BB9B6-5EDD-4A01-A53B-388521776FB1"_drx_guid, "GetCurrentCoverNormal");
		...
		{
			auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CEntityAICoverUserComponent::AddCoverEye, "E512537F-A637-4210-96AC-DED9FE506DB0"_drx_guid, "AddCoverEye");
