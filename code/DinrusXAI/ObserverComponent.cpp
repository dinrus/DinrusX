...
void CEntityAIObserverComponent::Register(Schematyc::IEnvRegistrar& registrar)
{
	Schematyc::CEnvRegistrationScope scope = registrar.Scope(IEntity::GetEntityScopeGUID());
	{
		...
		// Functions
		{
			auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CEntityAIObserverComponent::ObserverUserConditionResult, "0a8b5ff0-ee54-473b-b59c-f56e08c26dcd"_drx_guid, "ReturnUserConditionResult");
		...
		{
			auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CEntityAIObserverComponent::CanSeeSchematyc, "e6b5e92d-397a-474d-b322-6998c31f5b74"_drx_guid, "CanSee");
