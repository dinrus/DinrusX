...
#include <DinrusX/DinrusXAI/TargetTrackGroup.h>
#include <DinrusX/DinrusXAI/TargetTrack.h>
#include <DinrusX/DinrusXAI/TargetTrackModifiers.h>
#include <DinrusX/DinrusXAI/ObjectContainer.h>

#include <DinrusX/DinrusXAI/IAgent.h>
#include <DinrusX/DinrusXAI/Puppet.h>
...
//////////////////////////////////////////////////////////////////////////
bool CTargetTrackUpr::RegisterAgent(tAIObjectID aiObjectId, uint32 uConfigHash, int nTargetLimit)
{
	DRX_PROFILE_FUNCTION(PROFILE_AI);
...
//////////////////////////////////////////////////////////////////////////
bool CTargetTrackUpr::RegisterAgent(tAIObjectID aiObjectId, const char* szConfig, int nTargetLimit)
{
...
//////////////////////////////////////////////////////////////////////////
int CTargetTrackUpr::GetTargetLimit(tAIObjectID aiObjectId) const
{
	assert(aiObjectId > 0);
...
//////////////////////////////////////////////////////////////////////////
bool CTargetTrackUpr::HandleStimulusEventInRange(tAIObjectID aiTargetId, const char* szStimulusName, const TargetTrackHelpers::SStimulusEvent& eventInfo, float fRadius)
{
	DRX_PROFILE_FUNCTION(PROFILE_AI);
...
//////////////////////////////////////////////////////////////////////////
bool CTargetTrackUpr::HandleStimulusEventForAgent(tAIObjectID aiAgentId, tAIObjectID aiTargetId, const char* szStimulusName, const TargetTrackHelpers::SStimulusEvent& eventInfo)
{
	DRX_PROFILE_FUNCTION(PROFILE_AI);
...
//////////////////////////////////////////////////////////////////////////
bool CTargetTrackUpr::TriggerPulse(tAIObjectID aiObjectId, tAIObjectID targetId, const char* szStimulusName,
...
//////////////////////////////////////////////////////////////////////////
bool CTargetTrackUpr::CheckConfigUsesStimulus(uint32 uConfigHash, uint32 uStimulusNameHash) const
{
	assert(uConfigHash > 0);
...
//////////////////////////////////////////////////////////////////////////
bool CTargetTrackUpr::CheckStimulusHostile(tAIObjectID aiObjectId, tAIObjectID aiTargetId, uint32 uConfigHash, uint32 uStimulusNameHash) const
{
	assert(aiObjectId > 0);
	assert(uStimulusNameHash > 0);
...
//////////////////////////////////////////////////////////////////////////
bool CTargetTrackUpr::GetDesiredTarget(tAIObjectID aiObjectId, uint32 uDesiredTargetMethod, CWeakRef<CAIObject>& outTarget, SAIPotentialTarget*& pOutTargetInfo)
{
	DRX_PROFILE_FUNCTION(PROFILE_AI);
...
//////////////////////////////////////////////////////////////////////////
uint32 CTargetTrackUpr::GetBestTargets(tAIObjectID aiObjectId, uint32 uDesiredTargetMethod,
...
//////////////////////////////////////////////////////////////////////////
int CTargetTrackUpr::GetDesiredTargetCount(tAIObjectID aiTargetId, tAIObjectID aiIgnoreId) const
{
	assert(aiTargetId > 0);
...
//////////////////////////////////////////////////////////////////////////
int CTargetTrackUpr::GetPotentialTargetCount(tAIObjectID aiTargetId, tAIObjectID aiIgnoreId) const
{
	assert(aiTargetId > 0);
...
//////////////////////////////////////////////////////////////////////////
int CTargetTrackUpr::GetPotentialTargetCountFromFaction(tAIObjectID aiTargetId, const char* factionName, tAIObjectID aiIgnoreId) const
{
	assert(aiTargetId > 0);
...
//////////////////////////////////////////////////////////////////////////
bool CTargetTrackUpr::GetTargetTrackConfig(uint32 uNameHash, TargetTrackHelpers::STargetTrackConfig const*& pOutConfig) const
{
	assert(uNameHash > 0);
...
//////////////////////////////////////////////////////////////////////////
bool CTargetTrackUpr::GetTargetTrackStimulusConfig(uint32 uNameHash, uint32 uStimulusHash, TargetTrackHelpers::STargetTrackStimulusConfig const*& pOutConfig) const
{
	assert(uNameHash > 0);
...
//////////////////////////////////////////////////////////////////////////
const ITargetTrackModifier* CTargetTrackUpr::GetTargetTrackModifier(uint32 uId) const
{
...
//////////////////////////////////////////////////////////////////////////
uint32 CTargetTrackUpr::GetConfigNameHash(const char* sName)
{
	DRX_PROFILE_FUNCTION(PROFILE_AI);
...
//////////////////////////////////////////////////////////////////////////
uint32 CTargetTrackUpr::GetStimulusNameHash(const char* sStimulusName)
{
	DRX_PROFILE_FUNCTION(PROFILE_AI);
...
//////////////////////////////////////////////////////////////////////////
uint32 CTargetTrackUpr::GetPulseNameHash(const char* sPulseName)
{
	DRX_PROFILE_FUNCTION(PROFILE_AI);
...
#ifdef TARGET_TRACK_DEBUG
//////////////////////////////////////////////////////////////////////////
void CTargetTrackUpr::DebugDrawConfig(int nMode)
{
	if (nMode <= 0)
		return;
...
//////////////////////////////////////////////////////////////////////////
void CTargetTrackUpr::DebugDrawTargets(int nMode, char const* szAgentName)
{
	if (nMode <= 0)
		return;
