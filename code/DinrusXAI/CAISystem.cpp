...
#include <DinrusX/DinrusXAI/ScriptBind_AI.h>

#include <DinrusX/DinrusXAI/AIVehicle.h>
#include <DinrusX/DinrusXAI/AIPlayer.h>
#include <DinrusX/DinrusXAI/ObjectContainer.h>
#include <DinrusX/DinrusXAI/IVisionMap.h>
#include <DinrusX/DinrusXAI/HidespotQueryContext.h>
#include <DinrusX/DinrusXAI/IAISystemComponent.h>
#include <DinrusX/DinrusXAI/AuditionMap.h>
#include <DinrusX/DinrusXAI/SmartObjects.h>
#include <DinrusX/DinrusXAI/CalculationStopper.h>
#include <DinrusX/DinrusXAI/AIRadialOcclusion.h>
#include <DinrusX/DinrusXAI/AIActions.h>
#include <DinrusX/DinrusXAI/FireCommand.h>
#include <DinrusX/DinrusXAI/CentralInterestUpr.h>
...
#include <DinrusX/DinrusXAI/PathfinderNavigationSystemUser.h>
#include <DinrusX/DinrusXAI/BehaviorTreeUpr.h>
#include <DinrusX/DinrusXAI/BehaviorTreeNodeRegistration.h>
#include <DinrusX/DinrusXAI/CollisionAvoidanceSystem.h>
#include <DinrusX/DinrusXAI/BehaviorTreeGraft.h>
#include <DinrusX/DinrusXAI/IMovementSystem.h>
#include <DinrusX/DinrusXAI/MovementSystemCreator.h>
#include <DinrusX/DinrusXAI/GroupUpr.h>
#include <DinrusX/DinrusXAI/FactionSystem.h>
#include <DinrusX/DinrusXAI/DebugDrawContext.h>
#include <DinrusX/DinrusXAI/SequenceUpr.h>
#include <DinrusX/DinrusXAI/ClusterDetector.h>
#include <DinrusX/DinrusXAI/FormationUpr.h>
#include <DinrusX/DinrusXAI/SmartPathFollower.h>

#include <DinrusX/DinrusXAI/AIObjectIterators.h>

#include <DinrusX/DinrusXSys/DrxBufferedFileReader.h>

#include <DinrusX/DinrusXAI/GoalOpFactory.h>
#include <DinrusX/DinrusXAI/StatsUpr.h>
#include <DinrusX/DinrusXAI/GoalOp_G02.h>     //TODO move these out of AISystem
#include <DinrusX/DinrusXAI/GoalOp_G04.h>     //TODO move these out of AISystem
#include <DinrusX/DinrusXAI/GoalOp_Drxsis2.h> //TODO move these out of AISystem

#ifdef DRXAISYS_DEBUG
    #include <DinrusX/DinrusXAI/AIBubblesSystemImpl.h>
#endif

#include <DinrusX/DinrusXAI/SequenceFlowNodes.h>
#include <DinrusX/DinrusXAI/FlyHelpers_TacticalPointLanguageExtender.h>

#include <DinrusX/DinrusXAI/NavigationSystemSchematyc.h>
...
#include <DinrusX/DinrusXAI/BehaviorTreeComponent.h>
    ...
    case ESYSTEM_EVENT_GAME_POST_INIT_DONE: //= ESYSTEM_EVENT_REGISTER_SCHEMATYC_ENV
    {
        ...
        gEnv->pSchematyc->GetEnvRegistry().RegisterPackage(
            SCHEMATYC_MAKE_ENV_PACKAGE(
                ...
                "AISystem", Schematyc::g_szDinrus, "AI System",
...
IAIObject* CAISystem::GetRandomObjectInRange(IAIObject* pRef, unsigned short nType, float fRadiusMin, float fRadiusMax, bool bFaceAttTarget)
{
    ...
    {
        int choice = drx_random(0, (int)lstObjectsInRange.size() - 1);
