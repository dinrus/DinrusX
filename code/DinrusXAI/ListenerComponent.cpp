...
void CEntityAIListenerComponent::Register(Schematyc::IEnvRegistrar& registrar)
{
	Schematyc::CEnvRegistrationScope scope = registrar.Scope(IEntity::GetEntityScopeGUID());
	{
		...
		// Functions
		{
			auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CEntityAIListenerComponent::ListenerUserConditionResult, "554468AD-C27D-4D58-8145-33060E6B1929"_drx_guid, "ReturnUserConditionResult");
