...
bool CCentralInterestUpr::RegisterInterestingEntity(IEntity* pEntity, float fRadius, float fBaseInterest, const char* szActionName, const Vec3& vOffset, float fPause, int nbShared)
{
...
void CCentralInterestUpr::ChangeInterestingEntityProperties(IEntity* pEntity, float fRadius, float fBaseInterest, const char* szActionName, const Vec3& vOffset, float fPause, int nbShared)
{
	assert(pEntity);
...
void CCentralInterestUpr::AddDebugTag(EntityId entityId, const char* szString, float fTime)
{
