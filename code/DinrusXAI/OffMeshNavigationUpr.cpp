...
OffMeshNavigationUpr::OffMeshNavigationUpr(const int offMeshMapSize)
...
bool OffMeshNavigationUpr::AddCustomLink(const NavigationMeshID& meshID, MNM::OffMeshLinkPtr& pLinkData, MNM::OffMeshLinkID& linkID, MNM::TriangleID* pOutStartTriangleID, MNM::TriangleID* pOutEndTriangleID, const bool bCloneLinkData)
{
	...
	DRX_ASSERT_TRACE(m_offMeshMap.validate(meshID), ("Trying to add offmesh link to invalid mesh! (meshID = %u)", (uint32)meshID));
...
void OffMeshNavigationUpr::RegisterListener(IOffMeshNavigationListener* pListener, const char* listenerName)
{
