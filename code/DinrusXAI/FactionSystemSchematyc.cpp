...
namespace FactionSystemSchematyc
{
	...
	void Register(Schematyc::IEnvRegistrar& registrar, Schematyc::CEnvRegistrationScope& parentScope)
	{
		...
		//GetEntityFaction
		{
			auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&GetEntityFaction, "99d2c416-7110-46e8-899b-bc9d887d6acf"_drx_guid, "GetEntityFaction");
		...
		//ChangeReaction
		{
			auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&ChangeReaction, "de2f6f1a-dafc-439d-886f-d21e26c6babc"_drx_guid, "ChangeReaction");
		...
		factionsScope.Register(SCHEMATYC_MAKE_ENV_DATA_TYPE(SFactionID));
		{
			...
			//CompareFactions
			{
				auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CompareFactions, "04565f27-d18e-4dd6-ae67-c0f85677d398"_drx_guid, "Compare");
