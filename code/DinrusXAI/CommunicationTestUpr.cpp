...
#include <DinrusX/DinrusXAI/CommunicationTestUpr.h>
...
void CommunicationTestUpr::StartFor(EntityId actorID, const char* commName, int variationNumber)
{
...
void CommunicationTestUpr::OnCommunicationFinished(const CommPlayID& playID, uint8 stateFlags)
{
...
void CommunicationTestUpr::Report(EntityId actorID, const PlayingActor& playingActor, const char* configName)
{
	IEntity* entity = gEnv->pEntitySystem->GetEntity(actorID);
