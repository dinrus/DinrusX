...
//-----------------------------------------------------------------------------------------------------------
void CFormationUpr::EnumerateFormationNames(unsigned int maxNames, const char** outNames, uint32* outNameCount) const
{
	DRX_ASSERT(outNames);
...
//-----------------------------------------------------------------------------------------------------------
CFormation* CFormationUpr::CreateFormation(CWeakRef<CAIObject> refOwner, const char* szFormationName, Vec3 vTargetPos)
{
...
//-----------------------------------------------------------------------------------------------------------
string CFormationUpr::GetFormationNameFromCRC32(uint32 nCrc32ForFormationName) const
{
...
//-----------------------------------------------------------------------------------------------------------
bool CFormationUpr::ChangeFormation(IAIObject* pOwner, const char* szFormationName, float fScale)
{
	if (pOwner)
	{
...
//-----------------------------------------------------------------------------------------------------------
void CFormationUpr::CreateFormationDescriptor(const char* name)
{
...
//-----------------------------------------------------------------------------------------------------------
bool CFormationUpr::IsFormationDescriptorExistent(const char* name) const
{
	return m_mapFormationDescriptors.find(name) != m_mapFormationDescriptors.end();
}

//-----------------------------------------------------------------------------------------------------------
void CFormationUpr::AddFormationPoint(const char* name, const FormationNode& nodeDescriptor)
{
	auto it = m_mapFormationDescriptors.find(name);
	if (it != m_mapFormationDescriptors.end())
	{
...
//-----------------------------------------------------------------------------------------------------------
int CFormationUpr::GetFormationPointClass(const char* descriptorName, int position) const
{
