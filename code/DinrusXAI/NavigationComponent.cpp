...
void CEntityAINavigationComponent::Register(Schematyc::IEnvRegistrar& registrar)
{
	Schematyc::CEnvRegistrationScope scope = registrar.Scope(IEntity::GetEntityScopeGUID());
	{
		...
		// Functions
		{
			auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CEntityAINavigationComponent::SetRequestedVelocity, "e99ce354-1c57-404f-926e-b56b0254a12d"_drx_guid, "SetRequestedVelocity");
		...
		{
			auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CEntityAINavigationComponent::GetRequestedVelocity, "d6e2454f-fb39-4c7e-bec4-615e33c23322"_drx_guid, "GetRequestedVelocity");
		...
		{
			auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CEntityAINavigationComponent::NavigateTo, "d7ef4d30-dc99-41df-a0b5-eb21760b84a3"_drx_guid, "NavigateTo");
		...
		{
			auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CEntityAINavigationComponent::IsDestinationReachable, "86b5dd4d-518d-4baa-b3e6-c3bae725bb88"_drx_guid, "IsDestinationReachable");
		...
		{
			auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CEntityAINavigationComponent::StopMovement, "c4c3fc49-5884-48c6-9d71-bbd30ad7dced"_drx_guid, "Stop");
			pFunction->SetDescription("Stops current navigation");
			componentScope.Register(pFunction);
		}
		{
			auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CEntityAINavigationComponent::TestRaycastHit, "3b354256-7197-4fce-9d37-4ff37bc07c76"_drx_guid, "TestRaycastHit");
		...
		{
			auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CEntityAINavigationComponent::IsRayObstructed, "3813108c-e614-46ec-a029-f5ab0b85500c"_drx_guid, "IsRayObstructed");
