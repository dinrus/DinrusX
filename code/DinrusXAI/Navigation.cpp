...
#include <DinrusX/DinrusXAI/Polygon2d.h>
...
// ReadPolygonArea
//====================================================================
bool ReadPolygonArea(CDrxBufferedFileReader& file, int version, string& name, ListPositions& pts)
{
...
void CNavigation::ReadAreasFromFile(CDrxBufferedFileReader& file, int fileVersion)
{
	FlushAllAreas();
