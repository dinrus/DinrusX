...
#include <DinrusX/DinrusXAI/AIObjectUpr.h>
...
#include <DinrusX/DinrusXAI/AIFlyingVehicle.h>
#include <DinrusX/DinrusXAI/AIPlayer.h>
#include <DinrusX/DinrusXAI/AIObjectIterators.h>//TODO get rid of this file totally!
#include <DinrusX/DinrusXAI/ObjectContainer.h>
#include <DinrusX/DinrusXAI/TargetTrackUpr.h>
#include <DinrusX/DinrusXAI/AIEntityComponent.h>
...
void CAIObjectUpr::CreateDummyObject(CCountedRef<CAIObject>& ref, const char* name, CAIObject::ESubType type, tAIObjectID requiredID /*= INVALID_AIOBJECTID*/)
{
...
void CAIObjectUpr::CreateDummyObject(CStrongRef<CAIObject>& ref, const char* name /*=""*/, CAIObject::ESubType type /*= CAIObject::STP_NONE*/, tAIObjectID requiredID /*= INVALID_AIOBJECTID*/)
{
...
IAIObject* CAIObjectUpr::GetAIObjectByName(unsigned short type, const char* pName) const
{
...
CAIObject* CAIObjectUpr::GetAIObjectByName(const char* pName) const
{
...
//
//-----------------------------------------------------------------------------------------------------------
void CAIObjectUpr::RemoveObjectFromAllOfType(int nType, CAIObject* pRemovedObject)
{
