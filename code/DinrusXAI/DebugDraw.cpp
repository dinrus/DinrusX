...
#include <DinrusX/DinrusXAI/Leader.h>
#include <DinrusX/DinrusXAI/SmartObjects.h>
#include <DinrusX/DinrusXAI/PathFollower.h>
...
#include <DinrusX/DinrusXAI/PersonalInterestUpr.h>
...
void CAISystem::DebugDrawAgent(CAIObject* pAgentObj) const
{
	...
	const uint32 flagCount = DRX_ARRAY_COUNT(flagMap);
