...
uint32 CGroupUpr::GetGroupMemberCount(const GroupID& groupID) const
{
	Groups::const_iterator git = m_groups.find(groupID);
...
Group::NotificationID CGroupUpr::NotifyGroup(const GroupID& groupID, tAIObjectID senderID, const char* name)
{
	if (groupID > 0)
	{
