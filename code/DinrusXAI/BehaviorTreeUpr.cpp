...
BehaviorTreeInstancePtr BehaviorTreeUpr::CreateBehaviorTreeInstanceFromDiskCache(const char* behaviorTreeName)
{
...
BehaviorTreeInstancePtr BehaviorTreeUpr::CreateBehaviorTreeInstanceFromXml(const char* behaviorTreeName, XmlNodeRef behaviorTreeXmlNode)
{
...
BehaviorTreeInstancePtr BehaviorTreeUpr::LoadFromCache(const char* behaviorTreeName)
{
...
bool BehaviorTreeUpr::LoadBehaviorTreeTemplate(const char* behaviorTreeName, XmlNodeRef behaviorTreeXmlNode, BehaviorTreeTemplate& behaviorTreeTemplate)
{
...
void BehaviorTreeUpr::LoadFromDiskIntoCache(const char* behaviorTreeName)
{
	BehaviorTreeCache::iterator findResult = m_behaviorTreeCache.find(behaviorTreeName);
	if (findResult != m_behaviorTreeCache.end())
		return;
...
bool BehaviorTreeUpr::StartModularBehaviorTree(const EntityId entityId, const char* treeName)
{
...
bool BehaviorTreeUpr::StartModularBehaviorTreeFromXml(const EntityId entityId, const char* treeName, XmlNodeRef treeXml)
{
	BehaviorTreeInstancePtr instance = CreateBehaviorTreeInstanceFromXml(treeName, treeXml);
	return StartBehaviorInstance(entityId, instance, treeName);
}

bool BehaviorTreeUpr::StartBehaviorInstance(const EntityId entityId, BehaviorTreeInstancePtr instance, const char* treeName)
{
