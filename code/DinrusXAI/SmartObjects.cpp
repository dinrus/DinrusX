...
#include <DinrusX/DinrusXAI/DebugDrawContext.h>

#include <DinrusX/DinrusXAI/AIActions.h>
#include <DinrusX/DinrusXAI/SmartObjects.h>

#include <DinrusX/DinrusXAI/NavigationSystem.h>
#include <DinrusX/DinrusXAI/MNM.h>
...
void CSmartObjectUpr::SerializePointer(TSerialize ser, const char* name, CSmartObject*& pSmartObject)
{
	if (ser.IsWriting())
	{
...
void CSmartObjectUpr::SerializePointer(TSerialize ser, const char* name, CCondition*& pRule)
{
	if (ser.IsWriting())
	{
		if (pRule)
...
void CSmartObjectUpr::String2States(const char* listStates, CSmartObject::DoubleVectorStates& states)
{
...
void CSmartObjectUpr::String2StatePattern(const char* sPattern, CSmartObject::CStatePattern& pattern)
{
	pattern.clear();
	string item;
...
CSmartObjectClass* CSmartObjectUpr::GetSmartObjectClass(const char* className)
{
	AIAssert(className);
...
int CSmartObjectUpr::TriggerEvent(const char* sEventName, IEntity*& pUser, IEntity*& pObject, QueryEventMap* pQueryEvents /*= NULL*/, const Vec3* pExtraPoint /*= NULL*/, bool bHighPriority /*= false*/)
{
	if (!IsInitialized())
		return 0;
...
int CSmartObjectUpr::TriggerEventUserObject(const char* sEventName, CSmartObject* pUser, CSmartObject* pObject, QueryEventMap* pQueryEvents, const Vec3* pExtraPoint, bool bHighPriority /*=false*/)
{
	float minDelay = FLT_MAX;
	CCondition* pMinRule = NULL;
	CEvent* pEvent = String2Event(sEventName);
...
int CSmartObjectUpr::TriggerEventUser(const char* sEventName, CSmartObject* pUser, QueryEventMap* pQueryEvents, IEntity** ppObjectEntity, const Vec3* pExtraPoint, bool bHighPriority /*=false*/)
{
	*ppObjectEntity = NULL;
...
int CSmartObjectUpr::TriggerEventObject(const char* sEventName, CSmartObject* pObject, QueryEventMap* pQueryEvents, IEntity** ppUserEntity, const Vec3* pExtraPoint, bool bHighPriority /*=false*/)
{
...
int CSmartObjectUpr::Process(CSmartObject* pSmartObjectUser, CSmartObjectClass* pClass)
{
	DRX_PROFILE_FUNCTION(PROFILE_AI);
...
void CSmartObjectUpr::UseSmartObject(CSmartObject* pSmartObjectUser, CSmartObject* pSmartObject, CCondition* pCondition, int eventId /*=0*/, bool bForceHighPriority /*=false*/)
{
	AIAssert(pSmartObject);
...
bool CSmartObjectUpr::CheckSmartObjectStates(const IEntity* pEntity, const char* patternStates) const
{
	if (!IsInitialized())
		return false;
	AIAssert(pEntity);
...
void CSmartObjectUpr::ModifySmartObjectStates(IEntity* pEntity, const char* listStates)
{
...
void CSmartObjectUpr::SetSmartObjectState(IEntity* pEntity, const char* sStateName)
{
	if (!GetAISystem()->IsEnabled())
		return;
...
void CSmartObjectUpr::AddSmartObjectState(IEntity* pEntity, const char* sState)
{
...
void CSmartObjectUpr::RemoveSmartObjectState(IEntity* pEntity, const char* sState)
{
	if (IsInitialized() && sState && *sState)
	{
		CSmartObject::CState state(sState);
...
bool CSmartObjectUpr::ValidateTemplate(IEntity* pEntity, bool bStaticOnly, IEntity* pUserEntity /*=NULL*/, int fromTemplateHelperIdx /*=-1*/, int toTemplateHelperIdx /*=-1*/)
{
	if (!IsInitialized())
		return false;
	CSmartObject* pSmartObject = GetSmartObject(pEntity->GetId());
...
bool CSmartObjectUpr::ValidateTemplate(CSmartObject* pSmartObject, bool bStaticOnly, IEntity* pUserEntity /*=NULL*/, int fromTemplateHelperIdx /*=-1*/, int toTemplateHelperIdx /*=-1*/)
{
...
const char* CSmartObjectUpr::GetSmartObjectStateName(int id) const
{
	AIAssert(IsInitialized());
	return CSmartObject::CState::GetStateName(id);
}

void CSmartObjectUpr::RegisterSmartObjectState(const char* sStateName)
{
	if (*sStateName)
	{
...
uint32 CSmartObjectUpr::GetSOClassTemplateIStatObj(IEntity* pEntity, IStatObjPtr* ppStatObjectPtrs, uint32& numAllocStatObjects)
{
	if (!IsInitialized())
		return 0;
...
int CSmartObjectUpr::SmartObjectEvent(const char* sEventName, IEntity*& pUser, IEntity*& pObject, const Vec3* pExtraPoint /*= NULL*/, bool bHighPriority /*= false */)
{
...
SmartObjectHelper* CSmartObjectUpr::GetSmartObjectHelper(const char* className, const char* helperName) const
{
	AIAssert(IsInitialized());
	CSmartObjectClass* pClass = CSmartObjectClass::find(className);
	if (pClass)
...
int CSmartObjectUpr::GetNavigationalSmartObjectActionTypeForMNM(CPipeUser* pPipeUser, CSmartObject* pSmartObject, CSmartObjectClass* pSmartObjectClass, SmartObjectHelper* pFromHelper, SmartObjectHelper* pToHelper)
{
...
int CSmartObjectUpr::FindSmartObjectLinks(const CPipeUser* pPipeUser, CSmartObject* pObject, CSmartObjectClass* pObjectClass, SmartObjectHelper* pFromHelper, SmartObjectHelper* pToHelper, CSmartObjectClass::HelperLink** pvHelperLinks, int iCount /*= 1*/, const IEntity* pAdditionalEntity /*= NULL */, const CSmartObject::SetStates* pStatesExcludedFromMatchingTheObjectState /*= NULL*/) const
{
	AIAssert(IsInitialized());
