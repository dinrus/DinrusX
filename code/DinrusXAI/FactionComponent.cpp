...
#include <DinrusX/DinrusXAI/FactionComponent.h>
...
void CEntityAIFactionComponent::Register(Schematyc::IEnvRegistrar& registrar)
{
	Schematyc::CEnvRegistrationScope scope = registrar.Scope(IEntity::GetEntityScopeGUID());
	{
		...
		// Functions
		{
			auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CEntityAIFactionComponent::SetFactionIdSchematyc, "504e4eee-1633-4e17-92e8-0967edb4a3ae"_drx_guid, "SetFaction");
		...
		{
			auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CEntityAIFactionComponent::GetFactionIdSchematyc, "d700b459-bada-4c65-9287-8a9e2feed7ff"_drx_guid, "GetFaction");
		...
		{
			auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CEntityAIFactionComponent::IsReactionEqual, "aafa3f76-a304-4eb7-b6ad-7d8e52698969"_drx_guid, "CompareReactionWithEntity");
		...
		{
			auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CEntityAIFactionComponent::GetFactionMaskByReaction, "5dcb72d4-ec97-43d4-843d-fd74b9088568"_drx_guid, "GetFactionMaskByReaction");
