...
SRuntimeClassStateMachine::SRuntimeClassStateMachine(const DrxGUID& _guid, const char* _szName)
	: guid(_guid)
	, name(_szName)
{}

SRuntimeClassStateTimer::SRuntimeClassStateTimer(const DrxGUID& _guid, const char* _szName, const STimerParams& _params)
	: guid(_guid)
	, name(_szName)
	, params(_params)
{}

SRuntimeClassStateSignalReceiver::SRuntimeClassStateSignalReceiver(const DrxGUID& _signalGUID, const DrxGUID& _senderGUID, uint32 _graphIdx, const SRuntimeActivationParams& _activationParams)
	: SRuntimeFunction(_graphIdx, _activationParams)
	, signalGUID(_signalGUID)
	, senderGUID(_senderGUID)
{}

SRuntimeClassStateTransition::SRuntimeClassStateTransition(const DrxGUID& _signalGUID, uint32 _graphIdx, const SRuntimeActivationParams& _activationParams)
	: SRuntimeFunction(_graphIdx, _activationParams)
	, signalGUID(_signalGUID)
{}
...
SRuntimeClassState::SRuntimeClassState(const DrxGUID& _guid, const char* _szName)
	: guid(_guid)
	, name(_szName)
{}

SRuntimeClassVariable::SRuntimeClassVariable(const DrxGUID& _guid, const char* _szName, bool _bPublic, uint32 _pos)
	: guid(_guid)
	, name(_szName)
	, bPublic(_bPublic)
	, pos(_pos)
...
SRuntimeClassTimer::SRuntimeClassTimer(const DrxGUID& _guid, const char* _szName, const STimerParams& _params)
	: guid(_guid)
	, name(_szName)
	, params(_params)
{}

SRuntimeClassComponentInstance::SRuntimeClassComponentInstance(const DrxGUID& _guid, const char* _szName, bool _bPublic, const DrxGUID& _componentTypeGUID, const CTransformPtr& _transform, const CClassProperties& _properties, uint32 _parentIdx)
	: guid(_guid)
	, name(_szName)
	, bPublic(_bPublic)
...
SRuntimeClassSignalReceiver::SRuntimeClassSignalReceiver(const DrxGUID& _signalGUID, const DrxGUID& _senderGUID, uint32 _graphIdx, const SRuntimeActivationParams& _activationParams)
	: SRuntimeFunction(_graphIdx, _activationParams)
	, signalGUID(_signalGUID)
	, senderGUID(_senderGUID)
{}

CRuntimeClass::CRuntimeClass(time_t timeStamp, const DrxGUID& guid, const char* szName, const DrxGUID& envClassGUID, const CAnyConstPtr& pEnvClassProperties)
...
uint32 CRuntimeClass::AddGraph(const DrxGUID& guid, const char* szName)
{
	m_graphs.reserve(20);
...
uint32 CRuntimeClass::FindGraph(const DrxGUID& guid) const
{
...
uint32 CRuntimeClass::AddFunction(const DrxGUID& guid, uint32 graphIdx, const SRuntimeActivationParams& activationParams)
{
...
uint32 CRuntimeClass::FindOrReserveFunction(const DrxGUID& guid)
{
...
uint32 CRuntimeClass::AddStateMachine(const DrxGUID& guid, const char* szName)
{
...
uint32 CRuntimeClass::FindStateMachine(const DrxGUID& guid) const
{
...
uint32 CRuntimeClass::AddState(const DrxGUID& guid, const char* szName)
{
	m_states.reserve(20);
...
uint32 CRuntimeClass::FindState(const DrxGUID& guid) const
{
...
void CRuntimeClass::AddStateTimer(uint32 stateIdx, const DrxGUID& guid, const char* szName, const STimerParams& params)
{
...
void CRuntimeClass::AddStateSignalReceiver(uint32 stateIdx, const DrxGUID& signalGUID, const DrxGUID& senderGUID, uint32 graphIdx, const SRuntimeActivationParams& activationParams)
{
	SCHEMATYC_CORE_ASSERT(stateIdx < m_states.size());
	if (stateIdx < m_states.size())
	{
...
uint32 CRuntimeClass::AddStateAction(uint32 stateIdx, const DrxGUID& guid, const DrxGUID& typeGUID)
{
	SCHEMATYC_CORE_ASSERT(stateIdx < m_states.size());
	if (stateIdx < m_states.size())
	{
...
void CRuntimeClass::AddStateTransition(uint32 stateIdx, const DrxGUID& signalGUID, uint32 graphIdx, const SRuntimeActivationParams& activationParams)
{
	SCHEMATYC_CORE_ASSERT(stateIdx < m_states.size());
	if (stateIdx < m_states.size())
	{
...
uint32 CRuntimeClass::AddVariable(const DrxGUID& guid, const char* szName, bool bPublic, const CAnyConstRef& value)
{
	if (bPublic)
	{
...
uint32 CRuntimeClass::GetVariablePos(const DrxGUID& guid) const
{
...
uint32 CRuntimeClass::AddTimer(const DrxGUID& guid, const char* szName, const STimerParams& params)
{
	m_timers.reserve(20);
...
uint32 CRuntimeClass::AddComponentInstance(const DrxGUID& guid, const char* szName, bool bPublic, const DrxGUID& componentTypeGUID, const CTransformPtr& transform, const CClassProperties& properties, uint32 parentIdx)
{
	if (bPublic)
	{
...
uint32 CRuntimeClass::FindComponentInstance(const DrxGUID& guid) const
{
...
uint32 CRuntimeClass::AddSignalReceiver(const DrxGUID& signalGUID, const DrxGUID& senderGUID, uint32 graphIdx, const SRuntimeActivationParams& activationParams)
{
...
uint32 CRuntimeClass::AddAction(const DrxGUID& guid, const DrxGUID& typeGUID)
{
...
uint32 CRuntimeClass::CountSignalReceviers(const DrxGUID& signalGUID) const
{
	uint32 count = 0;
