...
#include <DinrusX/DinrusXSchema/ScriptGraphFunctionNode.h>
...
void CScriptGraphFunctionNode::Register(CScriptGraphNodeFactory& factory)
{
	...
	private:
		...
		public:
			...
			CCreationCommand(const char* szSubject, const char* szDescription, const SElementId& functionId, const DrxGUID& objectGUID = DrxGUID())
				: m_subject(szSubject)
	...
	public:
		...
		virtual void PopulateNodeCreationMenu(IScriptGraphNodeCreationMenu& nodeCreationMenu, const IScriptView& scriptView, const IScriptGraph& graph) override
		{
			struct SObject
			{
				inline SObject(const DrxGUID& _guid, const DrxGUID& _typeGUID, const char* szName)
					: guid(_guid)
					, typeGUID(_typeGUID)
					, name(szName)
				{}
