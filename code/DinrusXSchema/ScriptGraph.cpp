...
#include <DinrusX/DinrusXSchema/ScriptGraphNodeFactory.h> // #SchematycTODO : Where should the script graph node factory live?
...
CScriptGraphLink::CScriptGraphLink(const DrxGUID& srcNodeGUID, const char* szSrcOutputName, const DrxGUID& dstNodeGUID, const char* szDstInputName)
...
uint32 CScriptGraph::FindLink(const DrxGUID& srcNodeGUID, const CUniqueId& srcOutputId, const DrxGUID& dstNodeGUID, const CUniqueId& dstInputId) const
{
