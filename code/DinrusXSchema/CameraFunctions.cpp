...
static void RegisterFunctions(IEnvRegistrar& registrar)
{
	...
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&GetCurrentCamera, "{0723F8E5-E515-4718-BD7E-8070AD33A5B4}"_drx_guid, "GetCurrentCamera");
		pFunction->BindOutput(0, 'cam', "Camera");
		pFunction->SetDescription("Gets the currently active view camera");
		scope.Register(pFunction);
	}
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&GetRotation, "{9FDA79CF-2095-4DDB-8F42-7D7ACFBDED42}"_drx_guid, "GetRotation");
	...
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&GetTransform, "{CB91E621-B12A-44A6-901B-DE6FFB7528BC}"_drx_guid, "GetTransform");
		pFunction->BindInput(1, 'cam', "Camera");
	...
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(ScreenToWorld, "{4BE156A0-10C2-422E-94E4-7530813FC2A7}"_drx_guid, "ScreenToWorld");
...
namespace Raycast
{
	...
	static void RegisterFunctions(IEnvRegistrar& registrar)
	{
		...
		{
			auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&RayCast, "{9875B6AE-7547-483E-A368-91BE0634FA62}"_drx_guid, "RayCast");
		...
		{
			auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&RayCastFromScreen, "{ABAAC2E4-895F-44E0-A4FD-4674D9637041}"_drx_guid, "RayCastFromScreen");
...
DRX_STATIC_AUTO_REGISTER_FUNCTION(&Schematyc::RegisterCameraFunctions)
