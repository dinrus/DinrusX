...
#include <DinrusX/DinrusXSchema/ScriptGraphStateNode.h>
...
SERIALIZATION_ENUM_BEGIN_NESTED2(Schematyc, CScriptGraphStateNode, EOutputType, "DrxSchematyc Script Graph State Node Output Type")
...
void CScriptGraphStateNode::Register(CScriptGraphNodeFactory& factory)
{
	...
	private:
		...
		public:
			...
			CCreationCommand(const char* szSubject, const DrxGUID& stateGUID)
				: m_subject(szSubject)
				, m_stateGUID(stateGUID)
			{}
