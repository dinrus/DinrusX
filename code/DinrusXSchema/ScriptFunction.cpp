...
CScriptFunction::CScriptFunction(const DrxGUID& guid, const char* szName)
...
DrxGUID CScriptFunction::GetInputGUID(uint32 inputIdx) const
{
...
DrxGUID CScriptFunction::GetOutputGUID(uint32 outputIdx) const
{
