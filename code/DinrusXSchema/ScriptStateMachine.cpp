...
SERIALIZATION_ENUM_BEGIN_NESTED(Schematyc, EScriptStateMachineLifetime, "DrxSchematyc Script State Machine Lifetime")
...
CScriptStateMachine::CScriptStateMachine(const DrxGUID& guid, const char* szName, EScriptStateMachineLifetime lifetime, const DrxGUID& contextGUID, const DrxGUID& partnerGUID)
