...
#include <DinrusX/DinrusXSchema/ScriptGraphFormatStringNode.h>
...
SERIALIZATION_ENUM_BEGIN_NESTED2(Schematyc, CScriptGraphFormatStringNode, EElementForm, "DrxSchematyc Script Graph Format String Node Element Form")
