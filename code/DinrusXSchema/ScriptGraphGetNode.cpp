...
#include <DinrusX/DinrusXSchema/ScriptGraphGetNode.h>
...
CScriptGraphGetNode::CScriptGraphGetNode(const DrxGUID& referenceGUID,uint32 componentMemberId)
...
void CScriptGraphGetNode::Register(CScriptGraphNodeFactory& factory)
{
	...
	private:
		...
		public:
			...
			CCreationCommand(const char* szSubject, const DrxGUID& referenceGUID,uint32 componentMemberId=0)
				: m_subject(szSubject)
				, m_referenceGUID(referenceGUID)
				, m_componentMemberId(componentMemberId)
			{}
