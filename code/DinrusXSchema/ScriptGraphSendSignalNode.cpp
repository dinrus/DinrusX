...
#include <DinrusX/DinrusXSchema/ScriptGraphSendSignalNode.h>
...
SERIALIZATION_ENUM_BEGIN_NESTED2(Schematyc, CScriptGraphSendSignalNode, ETarget, "DrxSchematyc Script Graph Send Signal Node Target")
...
void CScriptGraphSendSignalNode::Register(CScriptGraphNodeFactory& factory)
{
	...
	private:
		...
		public:
			...
			CCreationCommand(const char* szSubject, const DrxGUID& signalGUID)
				: m_subject(szSubject)
				, m_signalGUID(signalGUID)
			{}
