...
#include <DinrusX/DinrusXGame/GameAudio.h>
#include <DinrusX/DinrusXGame/GameAudioUtils.h>
#include <DinrusX/DinrusXGame/Game.h>
#include <DinrusX/DinrusXGame/GameRules.h>
#include <DinrusX/DinrusXGame/Scriptbind_GameAudio.h>
...
uint32 CGameAudio::CAudioSignal::GetSignalFlagsFromXML(const XmlNodeRef& currentCommandNode)
{
	...
	const uint32 flagCount = DRX_ARRAY_COUNT(SoundFlagTable);
