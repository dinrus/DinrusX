...
#include <DinrusX/DinrusXGame/BodyDestruction.h>
...
/*static */void	CBodyDamageUpr::Warning(const char* szFormat, ...)
{
#ifndef _RELEASE
...
TBodyDamageProfileId CBodyDamageUpr::GetBodyDamage(IEntity& characterEntity, const char* damageTable /* = NULL */ )
{
...
bool CBodyDamageUpr::CacheBodyDamage(SmartScriptTable pProperties, const char* damageTable /*= NULL*/)
{
...
uint32 CBodyDamageUpr::GetPartFlags(TBodyDamageProfileId profileId, IEntity& characterEntity, const HitInfo& hitInfo ) const
{
	uint32 partFlags = 0;
...
bool CBodyDamageUpr::GetBodyDamageDef(IEntity& characterEntity, SBodyDamageDef &outDef, const char* damageTable)
{
	bool result = false;
...
bool CBodyDamageUpr::GetBodyDamageDef(SmartScriptTable pProperties, SBodyDamageDef &outDef, const char* damageTable)
{
	assert(pProperties.GetPtr());
...
void CBodyDamageUpr::GetBodyDamageDef( const char *pBodyDamageFile, const char *pBodyPartsFile, SBodyDamageDef &outDef )
{
...
TBodyDestructibilityProfileId CBodyDamageUpr::GetBodyDestructibility( IEntity& characterEntity, CBodyDestrutibilityInstance& instance, const char* damageTable /* = NULL */ )
{
...
bool CBodyDamageUpr::CacheBodyDestruction( SmartScriptTable pProperties, const char* damageTable /*= NULL*/ )
{
...
bool CBodyDamageUpr::GetBodyDestructibilityDef(IEntity& characterEntity, SBodyDestructibilityDef &outDef, float& maxHealth, const char* damageTable)
{
	bool result = false;
...
bool CBodyDamageUpr::GetBodyDestructibilityDef(SmartScriptTable pProperties, SBodyDestructibilityDef &outDef, float& maxHealth, const char* damageTable)
{
	DRX_ASSERT(pProperties.GetPtr());
...
void CBodyDamageUpr::GetBodyDestructibilityDef( const char *pBodyDestructibilityFile, SBodyDestructibilityDef &outDef )
{
...
void CBodyDamageUpr::ProcessDestructionEventByName( const char* eventName, const char* referenceBone, IEntity& characterEntity, CBodyDestrutibilityInstance& instance, const HitInfo& hitInfo )
{
	const TBodyDestructibilityProfileId profileId = instance.GetProfileId();
