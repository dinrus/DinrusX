...
void CMPPathFollowingUpr::RegisterClassFollower(uint16 classId, IMPPathFollower* pFollower)
{
#ifndef _RELEASE
...
void CMPPathFollowingUpr::UnregisterClassFollower(uint16 classId)
{
	PathFollowers::iterator iter = m_PathFollowers.find(classId);
...
void CMPPathFollowingUpr::RequestUpdateSpeed(uint16 classId, EntityId attachEntityId, float newSpeed)
{
