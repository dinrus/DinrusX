...
#include <DinrusX/DinrusXGame/InteractiveObject.h>
#include <DinrusX/DinrusXGame/InteractiveObjectRegistry.h>
#include <DinrusX/DinrusXGame/ScriptBind_InteractiveObject.h>

#include #include <DinrusX/DinrusXGame/Game.h>
#include #include <DinrusX/DinrusXGame/Actor.h>
#include #include <DinrusX/DinrusXGame/Player.h>
...
int CInteractiveObjectEx::CalculateSelectedInteractionIndex( const EntityId entityId ) const
{
	...
	{
		DrxFixedArray<int, 8> interactionCandidates; // Should be more than enough
