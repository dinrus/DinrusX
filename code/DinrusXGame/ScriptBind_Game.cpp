...
#include <DinrusX/DinrusXGame/ICheckPointSystem.h>
#include <DinrusX/CoreX/Game/IGameFramework.h>
#include <DinrusX/DinrusXGame/AI/Agent.h>
...
//------------------------------------------------------------------------
int CScriptBind_Game::RegisterWithAutoAimUpr(IFunctionHandler *pH, ScriptHandle entityId, float innerRadiusFactor, float outerRadiusFactor, float snapRadiusFactor)
{
...
//------------------------------------------------------------------------
int CScriptBind_Game::UnregisterFromAutoAimUpr(IFunctionHandler *pH, ScriptHandle entityId)
{
