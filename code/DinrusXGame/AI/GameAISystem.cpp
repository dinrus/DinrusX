...
#include <DinrusX/DinrusXGame/AIBattleFront.h>
#include <DinrusX/DinrusXGame/SearchModule.h>
#include <DinrusX/DinrusXGame/StalkerModule.h>
#include <DinrusX/DinrusXGame/RangeModule.h>
#include <DinrusX/DinrusXGame/AloneDetectorModule.h>
#include <DinrusX/DinrusXGame/HazardModule/HazardModule.h>
#include <DinrusX/DinrusXGame/RadioChatter/RadioChatterModule.h>
#include <DinrusX/DinrusXAI/IBehaviorTree.h>
#include <DinrusX/DinrusXGame/BehaviorTree/BehaviorTreeNodes_Game.h>
#include <DinrusX/DinrusXGame/GameAIEnv.h>
...
void CGameAISystem::InformContentCreatorOfError(string logMessage) const
{
	...
	if (g_gameAISystemAssertsAllowed)
	{
		...
		int messageBoxResult = DrxMessageBox(dialogMessage.c_str(), dialogCaption, MB_ICONERROR | MB_YESNOCANCEL);
