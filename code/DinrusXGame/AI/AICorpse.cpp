...
void CAICorpse::SetupFromSource( IEntity& sourceEntity, ICharacterInstance& characterInstance, const uint32 priority)
{
	...
	const uint32 attachmentCount = (uint32)pAttachmentUpr->GetAttachmentCount();
...
void CAICorpseUpr::RegisterAICorpse( const EntityId corpseId, const uint32 priority )
{
...
void CAICorpseUpr::RemoveAllCorpses( const char* requester )
{
