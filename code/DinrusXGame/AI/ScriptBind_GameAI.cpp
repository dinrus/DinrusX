...
#include <DinrusX/DinrusXGame/ScriptBind_GameAI.h>
...
#include <DinrusX/DinrusXGame/Assignment.h>
...
/* 
	Squad Upr	
*/
int CScriptBind_GameAI::RegisterEntityForAISquadUpr(IFunctionHandler* pH, ScriptHandle entityID)
{
...
int CScriptBind_GameAI::RemoveEntityForAISquadUpr(IFunctionHandler* pH, ScriptHandle entityID)
{
	EntityId entID = static_cast<EntityId>(entityID.n);
	if(entID)
	{
