...
#include <DinrusX/DinrusXGame/RuntimePrefab.h>
...
//////////////////////////////////////////////////////////////////////////
CPrefab *CPrefabUpr::GetRandomPrefab(CPrefabLib *pLib,const lstPrefabIt &it,uint32 nSeed)
{
	return NULL;
}
...
//////////////////////////////////////////////////////////////////////////
void CPrefabUpr::SpawnPrefab(const string &sLibraryFilename,const string &sFullName,EntityId id,uint32 nSeed,uint32 nMaxSpawn)
{
	// check if the library exists
...
//////////////////////////////////////////////////////////////////////////
void CPrefabUpr::CallOnSpawn(IEntity *pEntity,int nSeed)
{
