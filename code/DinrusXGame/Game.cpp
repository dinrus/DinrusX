...
#include <DinrusX/DinrusXGame/UI/Menu3dModels/FrontEndModelCache.h>
#include <DinrusX/DinrusXGame/UI/HUD/HUDEventDispatcher.h>
#include <DinrusX/DinrusXGame/UI/UICVars.h>
#include <DinrusX/DinrusXGame/UI/HUD/HUDMissionObjectiveSystem.h>
#include <DinrusX/DinrusXGame/UI/HUD/HUDEventWrapper.h>
#include <DinrusX/DinrusXGame/UI/Utils/ScreenLayoutUpr.h>
#include <DinrusX/DinrusXGame/UI/UIInput.h>
#include <DinrusX/DinrusXGame/ScreenResolution.h>
...
#include <DinrusX/DinrusXGame/GameCache.h>
#include <DinrusX/DinrusXGame/ItemScheduler.h>
#include <DinrusX/DinrusXGame/Utility/DrxWatch.h>

#include <DinrusX/DinrusXSys/File/IDrxPak.h>
...
#include <DinrusX/DinrusXSys/ILocalizationUpr.h>
#include <DinrusX/DinrusXEntity/IEntityPoolUpr.h>
#include <DinrusX/DinrusXSys/File/IResourceUpr.h>
#include <DinrusX/DinrusXAct/ICustomActions.h>

#include <DinrusX/DinrusXGame/ScriptBind_Actor.h>
#include <DinrusX/DinrusXGame/ScriptBind_Item.h>
#include <DinrusX/DinrusXGame/ScriptBind_Weapon.h>
#include <DinrusX/DinrusXGame/ScriptBind_GameRules.h>
#include <DinrusX/DinrusXGame/ScriptBind_Game.h>
#include <DinrusX/DinrusXGame/ScriptBind_HitDeathReactions.h>
#include <DinrusX/DinrusXGame/Boids/ScriptBind_Boids.h>
#include <DinrusX/DinrusXGame/AI/ScriptBind_GameAI.h>
#include <DinrusX/DinrusXGame/UI/HUD/ScriptBind_HUD.h>
#include <DinrusX/DinrusXGame/Environment/ScriptBind_InteractiveObject.h>
#include <DinrusX/DinrusXGame/Network/Lobby/ScriptBind_MatchMaking.h>
#include <DinrusX/DinrusXGame/Turret/Turret/ScriptBind_Turret.h>
#include <DinrusX/DinrusXGame/ScriptBind_ProtectedBinds.h>
#include <DinrusX/DinrusXGame/Environment/ScriptBind_LightningArc.h>
#include <DinrusX/DinrusXGame/DLCUpr.h>
#include <DinrusX/DinrusXGame/CornerSmoother.h>
#include <DinrusX/DinrusXInput/IHardwareMouse.h>

#ifdef USE_LAPTOPUTIL
#include <DinrusX/DinrusXGame/LaptopUtil.h>
#endif

#include <DinrusX/DinrusXGame/GameFactory.h>

#include <DinrusX/DinrusXGame/Player.h>

#include <DinrusX/DinrusXGame/GameParameters.h>
#include <DinrusX/DinrusXGame/WeaponSharedParams.h>
#include <DinrusX/DinrusXGame/ItemResourceCache.h>
#include <DinrusX/DinrusXGame/ActorUpr.h>

#include <DinrusX/DinrusXGame/Nodes/G2FlowBaseNode.h>

#include <DinrusX/DinrusXGame/ISaveGame.h>
#include <DinrusX/DinrusXGame/ILoadGame.h>
#include <DinrusX/CoreX/String/DrxPath.h>
#include <DinrusX/DinrusXGame/GameStateRecorder.h>
#include <DinrusX/DinrusXGame/GodMode.h>
#include <DinrusX/DinrusXGame/SmokeUpr.h>
#include <DinrusX/DinrusXGame/RecordingSystem.h>
#include <DinrusX/DinrusXGame/StatsRecordingMgr.h>
#include <DinrusX/DinrusXGame/PatchPakUpr.h>
#include <DinrusX/DinrusXGame/DataPatchDownloader.h>
#include <DinrusX/DinrusXGame/LagOMeter.h>
#include <DinrusX/DinrusXGame/TelemetryCollector.h>
#include <DinrusX/DinrusXGame/TacticalUpr.h>

#include <DinrusX/DinrusXGame/Environment/LedgeUpr.h>
#include <DinrusX/DinrusXGame/Environment/WaterPuddle.h>

#include <DinrusX/DinrusXGame/Graphics/ColorGradientUpr.h>
#include <DinrusX/DinrusXGame/VehicleClient.h>
#include <DinrusX/DinrusXGame/AI/TacticalPointLanguageExtender.h>
#include <DinrusX/DinrusXGame/AI/GameAISystem.h>
#include <DinrusX/DinrusXGame/AI/GameAIEnv.h>
#include <DinrusX/DinrusXGame/AI/AICorpse.h>

#include <DinrusX/DinrusXGame/Network/Lobby/GameUserPackets.h>
#include <DinrusX/DinrusXGame/Network/Lobby/GameAchievements.h>
#include <DinrusX/DinrusXGame/Network/Lobby/GameBrowser.h>
#include <DinrusX/DinrusXGame/Network/Lobby/GameLobbyUpr.h>
#include <DinrusX/DinrusXGame/Network/Lobby/DrxLobbySessionHandler.h>
#include <DinrusX/DinrusXGame/Network/Lobby/GameServerLists.h>
#include <DinrusX/DinrusXGame/Network/Squad/SquadUpr.h>
#include <DinrusX/DinrusXGame/Network/Lobby/PlaylistActivityTracker.h>

#include <DinrusX/DinrusXGame/Utility/ManualFrameStep.h>
...
#include <DinrusX/DinrusXGame/CodeCheckpointDebugMgr.h>

#include <DinrusX/DinrusXGame/AutoAimUpr.h>
#include <DinrusX/DinrusXGame/HitDeathReactionsSystem.h>
#include <DinrusX/DinrusXGame/MovementTransitionsSystem.h>
#include <DinrusX/DinrusXGame/CheckpointGame.h>
#include <DinrusX/DinrusXGame/BodyUpr.h>
#include <DinrusX/DinrusXGame/StealthKill.h>
...
#include <DinrusX/DinrusXGame/GamePhysicsSettings.h>

#include <DinrusX/DinrusXGame/EquipmentLoadout.h>
#include <DinrusX/DinrusXGame/UI/Menu3dModels/MenuRender3DModelMgr.h>

#include <DinrusX/DinrusXGame/MikeBullet.h>
#include <DinrusX/DinrusXGame/PlaylistUpr.h>
#include <DinrusX/DinrusXGame/DownloadMgr.h>
#include <DinrusX/DinrusXGame/Effects/GameEffects/HudInterferenceGameEffect.h>
#include <DinrusX/DinrusXGame/Effects/GameEffects/SceneBlurGameEffect.h>
#include <DinrusX/DinrusXGame/Effects/GameEffects/LightningGameEffect.h>
#include <DinrusX/DinrusXGame/Effects/GameEffects/ParameterGameEffect.h>

#include <DinrusX/DinrusXGame/Stereo3D/StereoFramework.h>

#include <DinrusX/DinrusXGame/GameMechanismUpr.h>
#include <DinrusX/CoreX/Platform/IPlatformOS.h>

#if !defined(_RELEASE)
#include <DinrusX/DinrusXGame/Editor/GameRealtimeRemoteUpdate.h>
#endif 

#include <DinrusX/DinrusXGame/GodMode.h>
#include <DinrusX/DinrusXGame/PlayerVisTable.h>
#include <DinrusX/DinrusXGame/Network/GameNetworkUtils.h>

#include <DinrusX/DinrusXGame/SlideController.h>

#include <DinrusX/DinrusXSys/IStatoscope.h>

#include <DinrusX/DinrusXGame/GameLocalizationUpr.h>

#include <DinrusX/DinrusXGame/RevertibleConfigLoader.h>

#include <DinrusX/DinrusXGame/StatsEntityIdRegistry.h>

#include <DinrusX/DinrusXGame/MovingPlatforms/MovingPlatformMgr.h>

#include <DinrusX/CoreX/Game/IGameVolumes.h>

#include <DrxLiveCreate/ILiveCreateHost.h>
#include <DinrusX/CoreX/SFunctor.h>

#include <DinrusX/DinrusXGame/WorldBuilder.h>

#include <DrxDynamicResponseSystem/IDynamicResponseSystem.h>
#include <DinrusX/DinrusXGame/DynamicResponseSystem/ConditionDistanceToEntity.h>
#include <DinrusX/DinrusXGame/DynamicResponseSystem/GameTokenToDrsTranslator.h>
#include <DinrusX/DinrusXGame/DynamicResponseSystem/ActionExecuteAudioTrigger.h>
#include <DinrusX/DinrusXGame/DynamicResponseSystem/ActionSpeakLineBasedOnVariable.h>
...
#include <DinrusX/DinrusXGame/XboxOneLive/XboxLiveGameEvents.h>
#include <DinrusX/DinrusXGame/Network/MatchMakingUtils.h>
#endif
...
void CGame::SetInviteData(EDrxLobbyService service, uint32 user, DrxInviteID id, EDrxLobbyError error, EDrxLobbyInviteType inviteType)
{
...
void CGame::OnSaveGame(ISaveGame* pSaveGame)
{
	...
	if(m_pPlayerProfileUpr)
	{
		const char* saveGameFolder = m_pPlayerProfileUpr->GetSharedSaveGameFolder();
...
{
	DrxLog("CGame::SetHostMigrationState() state changing to '%i' (from '%i')", int(newState), int(m_hostMigrationState));
...
void CGame::LoginUser(unsigned int user)
{
	...
	if (m_pPlayerProfileUpr)
	{
		...
		if (ok)
		{
			...
			int profileCount = m_pPlayerProfileUpr->GetProfileCount(userName);
			if (profileCount > 0)
			{
				if(gEnv->IsDedicated())
				{
			...
			if(signedIn)
			{
				...
				{
					const char *currentUser = pPlayerProfileUpr->GetCurrentUser();
					IPlayerProfile* pProfile = pPlayerProfileUpr->GetCurrentProfile(currentUser);
					if (currentUser && pProfile)
					{
						const char*	curUserName = pPlayerProfileUpr->GetCurrentProfile(currentUser)->GetUserId();
						const char*	profileName = pPlayerProfileUpr->GetCurrentProfile(currentUser)->GetName();
					...
					if(pLanguageCVar)
					{
						...
						{
							int shouldCheck = m_pUIUpr->GetOptions()->GetOptionValueAsInt("NonLocalizedAudioSubtitleCheck");
							if(shouldCheck==0)
							{
			...
			{
				const char* currentUserName = pPlayerProfileUpr->GetCurrentUser();
...
/* static */
void CGame::SetRichPresenceCallback(DrxLobbyTaskID taskID, EDrxLobbyError error, void* pArg)
{
...
//static---------------------------------------
void CGame::PartyMembersCallback(UDrxLobbyEventData eventData, void *arg)
{
	DrxLogAlways("CGame::PartyMembersCallback(UDrxLobbyEventData eventData, void *arg)");
...
//static---------------------------------------
void CGame::UserProfileChangedCallback(UDrxLobbyEventData eventData, void *arg)
{
...
//static---------------------------------------
void CGame::InviteAcceptedCallback(UDrxLobbyEventData eventData, void *arg)
{
...
//static---------------------------------------
void CGame::OnlineStateCallback(UDrxLobbyEventData eventData, void *arg)
{
...
//static---------------------------------------
void CGame::EthernetStateCallback(UDrxLobbyEventData eventData, void *arg)
{
