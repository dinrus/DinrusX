...
#include <DinrusX/DinrusXAct/IGameObjectSystem.h>
...
#include <DinrusX/DinrusXGame/WeaponStats.h>
...
//--------------------------------------------------------------------------
void CWeapon::GetAttachmentsAtHelper(const char *helper, CDrxFixedStringListT<5, 30> &attachments)
{
	CPlayer *pPlayer = static_cast<CPlayer *>(m_pGameFramework->GetClientActor());
	if(pPlayer)
	{
