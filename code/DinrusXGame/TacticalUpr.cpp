...
void CTacticalUpr::SetEntityOverrideIcon(const EntityId id, const uint8 overrideIconType)
{
	bool bKeepSearching = true;
...
uint8 CTacticalUpr::GetEntityOverrideIcon(const EntityId id) const
{
...
uint8 CTacticalUpr::GetOverrideIconType(const char* szOverrideIconName) const
{
