...
#include <DinrusX/DinrusXGame/IPlayerInput.h>
...
#include <DinrusX/DinrusXGame/CustomReactionFunctions.h>
...
#include <DinrusX/DinrusXGame/Effects/GameEffects/ExplosionGameEffect.h>
...
#include <DinrusX/DinrusXGame/GameRulesModules/IGameRulesScoringModule.h>
#include <DinrusX/DinrusXGame/GameRulesModules/IGameRulesSpawningModule.h>
#include <DinrusX/DinrusXGame/GameRulesModules/IGameRulesActorActionModule.h>
#include <DinrusX/DinrusXGame/GameRulesModules/IGameRulesAssistScoringModule.h>
#include <DinrusX/DinrusXGame/GameRulesModules/IGameRulesDamageHandlingModule.h>
#include <DinrusX/DinrusXGame/GameRulesModules/IGameRulesPlayerStatsModule.h>
#include <DinrusX/DinrusXGame/GameRulesModules/IGameRulesSpectatorModule.h>
#include <DinrusX/DinrusXGame/GameRulesModules/IGameRulesVictoryConditionsModule.h>
#include <DinrusX/DinrusXGame/GameRulesModules/IGameRulesObjectivesModule.h>
#include <DinrusX/DinrusXGame/GameRulesModules/IGameRulesRoundsModule.h>
#include <DinrusX/DinrusXGame/GameRulesModules/IGameRulesStatsRecording.h>
...
#include <DinrusX/DinrusXGame/GameRulesModules/IGameRulesSurvivorCountListener.h>
#include <DinrusX/DinrusXGame/GameRulesModules/IGameRulesKillListener.h>
#include <DinrusX/DinrusXGame/GameRulesModules/IGameRulesPlayerStatsListener.h>
#include <DinrusX/DinrusXGame/GameRulesModules/IGameRulesRoundsListener.h>
#include <DinrusX/DinrusXGame/GameRulesModules/IGameRulesClientScoreListener.h>
#include <DinrusX/DinrusXGame/GameRulesModules/IGameRulesActorActionListener.h>
#include <DinrusX/DinrusXGame/GameRulesModules/GameRulesObjective_Predator.h>

#if USE_PC_PREMATCH
#include <DinrusX/DinrusXGame/GameRulesModules/IGameRulesPrematchListener.h>
...
#include <DinrusX/DinrusXGame/PersistantStats.h>
#include <DinrusX/DinrusXGame/Battlechatter.h>
#include <DinrusX/DinrusXSys/IPerfHud.h>
#include <DinrusX/DinrusXGame/Audio/AreaAnnouncer.h>
#include <DinrusX/DinrusXGame/Audio/MiscAnnouncer.h>
...
#include <DinrusX/DinrusXGame/SkillKill.h>
#include <DinrusX/DinrusXGame/CorpseUpr.h>
...
#include <DinrusX/DinrusXGame/EntityUtility/EntityEffectsCloak.h>
#include <DinrusX/DinrusXGame/ClientHitEffectsMP.h>

#include <DinrusX/DinrusXPhys/IDeferredCollisionEvent.h>

#include <DinrusX/DinrusXGame/MPTrackViewUpr.h>
#include <DinrusX/DinrusXGame/MPPathFollowingUpr.h>
#include <DinrusX/DinrusXGame/VTOLVehicleUpr/VTOLVehicleUpr.h>
#include <DinrusX/DinrusXGame/TeamVisualizationUpr.h>
#include <DinrusX/DinrusXGame/Audio/Announcer.h>

#include <DinrusX/DinrusXGame/MultiplayerEntities/CarryEntity.h>

#include <DinrusX/DinrusXGame/PlayerMovementController.h>
#include <DinrusX/DinrusXGame/PlayerPlugin_InteractiveEntityMonitor.h>
...
bool CGameRules::Init( IGameObject * pGameObject )
{
	...
	const char *xmlPath = CGameRulesModulesUpr::GetInstance()->GetXmlPath(gameRulesName);
...
void CGameRules::OnClientDisconnect(int channelId, EDisconnectionCause cause, const char *desc, bool keepClient)
{
	...
	DrxLog("CGameRules::OnClientDisconnect(channelId=%d, cause=%d, desc='%s', keepClient=%d): actor='%s'", channelId, (int)cause, desc, (keepClient?1:0), ((pActor&&pActor->GetEntity())?pActor->GetEntity()->GetName():"[null]"));
	INDENT_LOG_DURING_SCOPE();
...
void CGameRules::StoreMigratingPlayer(IActor* pActor)
{
	...
	if (pGameLobby)
	{
		SDrxMatchMakingConnectionUID conId = pGameLobby->GetConnectionUIDFromChannelID((int) channelId);
	...
	if (pGameLobby)
	{
		...
		while (pActor = actorIt->Next())
		{
			if (pActor->IsPlayer())
			{
				...
				SDrxMatchMakingConnectionUID conId = pGameLobby->GetConnectionUIDFromChannelID((int) pActor->GetChannelId());
				if (pGameLobby->GetSessionNames().Find(conId) == SSessionNames::k_unableToFind)
				{
