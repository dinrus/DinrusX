...
const int k_num_collision_classes = DRX_ARRAY_COUNT(s_collision_class_names);
const int k_num_game_collision_classes = DRX_ARRAY_COUNT(s_game_collision_class_names);;
