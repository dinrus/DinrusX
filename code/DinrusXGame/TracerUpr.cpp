...
//------------------------------------------------------------------------
int CTracerUpr::EmitTracer(const STracerParams &params, const EntityId bulletId)
{
	if(!gEnv->IsClient())
		return -1;
...
//------------------------------------------------------------------------
void CTracerUpr::OnBoundProjectileDestroyed( const int tracerIdx, const EntityId projectileId, const Vec3& newEndTracerPosition )
{
