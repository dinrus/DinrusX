...
#include <DinrusX/DinrusXGame/UI/HUD/HUDSilhouettes.h>
...
#include <DinrusX/DinrusXGame/IUIDraw.h>

#include <DinrusX/DinrusXGame/EntityUtility/EntityScriptCalls.h>
#include <DinrusX/DinrusXGame/PlayerEntityInteraction.h>
...
bool CPlayerInput::IsItemPickUpScriptAction(const ActionId& actionId) const
{
	...
	const int numEvents = DRX_ARRAY_COUNT(itemPickUpEvents);
