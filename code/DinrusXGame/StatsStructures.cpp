...
#include <DinrusX/DinrusXGame/StatsStructures.h>
...
void SSessionStats::Clear()
{
	...
	const int mapCount = DRX_ARRAY_COUNT(m_mapStats);
...
//----------------------------------------------------------
float SSessionStats::GetStatStrings(const char* name, EDerivedIntMapPersistantStats stat, DrxFixedStringT<64>& valueString)
{
...
//----------------------------------------------------------
float SSessionStats::GetStatStrings(const char* name, EDerivedFloatMapPersistantStats stat, DrxFixedStringT<64>& valueString)
{
...
//----------------------------------------------------------
float SSessionStats::GetStatStrings(const char* name, EMapPersistantStats stat, DrxFixedStringT<64>& valueString)
{
...
//----------------------------------------------------------
float SSessionStats::GetStatStringsFromValue( EMapPersistantStats stat, int statValue, DrxFixedStringT<64>& valueString )
{
	switch (stat)
	{
