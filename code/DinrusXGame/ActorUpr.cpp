...
size_t CActorUpr::GetMemoryRequiredForNActors(int iNumActors)
{
...
void CActorUpr::ReallocateMemoryForNActors(int iNumActorsRequired)
{
...
void CActorUpr::WriteCachedActorData(int from, int to)
{
...
float CActorUpr::GetLocalPlayerDistanceSqClosestHostileActor(const Vec3& posn, int teamId) const
{
