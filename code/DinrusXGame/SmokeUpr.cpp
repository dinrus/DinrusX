...
const uint32 CSmokeUpr::kMaxSmokeEffectsInSameArea = 1;
...
void CSmokeUpr::CreateSmokeObstructionObject( SSmokeInstance& smokeInstance )
{
	...
	if (smokeInstance.pObstructObject)
	{
		...
		int obstructID = gEnv->p3DEngine->GetMaterialUpr()->GetSurfaceTypeIdByName("mat_obstruct");
