...
CBurnEffectUpr::TBurnPoints::iterator CBurnEffectUpr::FindBurnPointOnEntity(EntityId entityId, const uint8 shooterFactionID)
{
...
CBurnEffectUpr::TBurnPoints::iterator CBurnEffectUpr::FindClosestBurnPoint(const Vec3& point, int surfaceType, const uint8 shooterFactionID)
{
	if (m_burnPoints.empty())
		return m_burnPoints.end();
...
void CBurnEffectUpr::SpawnImpactEffect(const EventPhysCollision& pCollision, const char* effectName)
{
