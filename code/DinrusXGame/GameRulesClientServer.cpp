...
#include <DrxRenderer/IRenderMesh.h>
		...
		if (pLobby)
		{
			...
			if (pMatchMaking)
			{
				...
				if (pGameLobby)
				{
					...
					{
						DrxLog("CGameRules::UpdateNetLimbo() GameState:%d timing out server connection, actual timeSinceReceived=%" PRIi64, (int)(GetStateModule()->GetGameState()), packetFromServerTime.GetMilliSecondsAsInt64());
					...
					else if (packetFromServerTime > 5.0f)
					{
						...
						{
							DrxLog("CGameRules::UpdateNetLimbo() GameState:%d 5.0f seconds timing out server connection, actual timeSinceReceived=%" PRIi64, (int)(GetStateModule()->GetGameState()), packetFromServerTime.GetMilliSecondsAsInt64());
						}
					}
					else if (packetFromServerTime > 3.0f)
					{
						...
						{
							DrxLog("CGameRules::UpdateNetLimbo() GameState:%d 3.0f seconds timing out server connection, actual timeSinceReceived=%" PRIi64, (int)(GetStateModule()->GetGameState()), packetFromServerTime.GetMilliSecondsAsInt64());
						}
					}
					else if (packetFromServerTime > 2.0f)
					{
						...
						{
							DrxLog("CGameRules::UpdateNetLimbo() GameState:%d 2.0f seconds timing out server connection, actual timeSinceReceived=%" PRIi64, (int)(GetStateModule()->GetGameState()), packetFromServerTime.GetMilliSecondsAsInt64());
						}
					}
