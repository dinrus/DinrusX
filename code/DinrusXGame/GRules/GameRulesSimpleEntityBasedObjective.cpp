...
#include <DinrusX/DinrusXGame/GameRulesSimpleEntityBasedObjective.h>
...
#include <DinrusX/DinrusXGame/GameRulesModules/GameRulesCombiCaptureObjective.h>
#include <DinrusX/DinrusXGame/GameRulesModules/GameRulesKingOfTheHillObjective.h>
...
{
	DRX_ASSERT(entityType < (int)m_entityDetails.size());
	SEntityDetails *pEntityDetails = &m_entityDetails[entityType];
