...
#include <DinrusX/DinrusXGame/GameRulesModulesUpr.h>
...
#define GAMERULES_MODULE_LIST_FUNC(type, name, lowerCase, useInEditor)	\
	void CGameRulesModulesUpr::Register##name##Module( const char *moduleName, type *(*func)(), bool isAI )	\
	{	\
		m_##name##Classes.insert(TModuleClassMap_##name::value_type(moduleName, func));	\
	}	\
	type *CGameRulesModulesUpr::Create##name##Module(const char *moduleName)	\
	{	\
...
//------------------------------------------------------------------------
const char * CGameRulesModulesUpr::GetXmlPath( const char *gameRulesName ) const
{
...
//------------------------------------------------------------------------
const char * CGameRulesModulesUpr::GetDefaultHud( const char *gameRulesName ) const
{
	TDataMap::const_iterator it = m_rulesData.find(gameRulesName);
	if (it == m_rulesData.end())
	{
...
//------------------------------------------------------------------------
int CGameRulesModulesUpr::GetRulesCount()
{
	return m_rulesData.size();
}

//------------------------------------------------------------------------
const char* CGameRulesModulesUpr::GetRules(int index)
{
...
//------------------------------------------------------------------------
bool CGameRulesModulesUpr::IsTeamGame( const char *gameRulesName) const
{
	TDataMap::const_iterator it = m_rulesData.find(gameRulesName);
	if (it == m_rulesData.end())
	{
...
//------------------------------------------------------------------------
bool CGameRulesModulesUpr::UsesLobbyTeamBalancing( const char *gameRulesName ) const
{
	TDataMap::const_iterator it = m_rulesData.find(gameRulesName);
	if (it == m_rulesData.end())
	{
...
//------------------------------------------------------------------------
bool CGameRulesModulesUpr::UsesPlayerTeamVisualization( const char *gameRulesName ) const
{
	TDataMap::const_iterator it = m_rulesData.find(gameRulesName);
	if (it == m_rulesData.end())
	{
...
//------------------------------------------------------------------------
bool CGameRulesModulesUpr::IsValidGameRules(const char *gameRulesName) const
{
	TDataMap::const_iterator it = m_rulesData.find(gameRulesName);
	if (it == m_rulesData.end())
	{
