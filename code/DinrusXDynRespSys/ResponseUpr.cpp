...
#include <DinrusX/DinrusXDynRespSys/ResponseSystemDebugDataProvider.h>
...
#include <DinrusX/DinrusXDynRespSys/ResponseSystemDataImportHelper.h>
...
bool Serialize(Serialization::IArchive& ar, DrxDRS::ResponsePair& pair, const char* szName, const char* szLabel)
{
...
bool Serialize(Serialization::IArchive& ar, DrxDRS::ResponsePairSorted& pair, const char* szName, const char* szLabel)
{
	ResponsePairSortedSerializer keyValue(pair);
	return ar(keyValue, szName, szLabel);
}

bool Serialize(Serialization::IArchive& ar, DrxDRS::ResponsePtr& ptr, const char* szName, const char* szLabel)
{
	if (!ptr.get())
	{
...
//--------------------------------------------------------------------------------------------------
bool CResponseUpr::LoadFromFiles(const char* szDataPath)
{
...
//--------------------------------------------------------------------------------------------------
bool CResponseUpr::SaveToFiles(const char* szDataPath)
{
...
//--------------------------------------------------------------------------------------------------
DynArray<const char*> CResponseUpr::GetRecentSignals(DRS::IResponseUpr::eSignalFilter filter /* = DRS::IResponseUpr::eSF_All */)
{
...
//--------------------------------------------------------------------------------------------------
void CResponseUpr::SerializeRecentResponse(Serialization::IArchive& ar, const DynArray<stack_string>& signalNames, int maxElemets /* = -1 */)
{
...
//--------------------------------------------------------------------------------------------------
void CResponseUpr::SerializeVariableChanges(Serialization::IArchive& ar, const stack_string& variableName /*= "ALL"*/, int maxElemets /*= -1*/)
{
