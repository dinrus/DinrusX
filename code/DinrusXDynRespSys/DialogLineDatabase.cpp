...
bool Serialize(Serialization::IArchive& ar, DrxDRS::DialogLinePair& pair, const char* name, const char* label)
{
	DialogLinePairSerializer keyValue(pair);
	return ar(keyValue, name, label);
}
bool Serialize(Serialization::IArchive& ar, DrxDRS::SortedDialogLinePair& pair, const char* name, const char* label)
{
