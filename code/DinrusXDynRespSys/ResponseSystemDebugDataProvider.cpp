...
const char* GetStringFromEnum(CResponseSystemDebugDataProvider::EStatus valueToConvert)
{
	...
	return DrxStringUtils::toString(static_cast<int>(valueToConvert));
}
...
bool CResponseSystemDebugDataProvider::AddConditionChecked(const CConditionsCollection::SConditionInfo* pCondition, bool result)
{
	...
	{
		DrxLogAlways("<DRS> <%.3f> Condition checked: '%s', Met: %i", CResponseSystem::GetInstance()->GetCurrentDrsTime(), newCondition.conditionDesc.c_str(), (int)newCondition.bMet);
	}
...
//////////////////////////////////////////////////////////////////////////
void CResponseSystemDebugDataProvider::GetRecentSignals(DynArray<const char*>& outResults, DRS::IResponseUpr::eSignalFilter filter /* = eSF_All */)
{
