...
#include <DinrusX/DinrusXSys/ZipDirFind.h>
...
ZipDir::ErrorEnum ZipDir::Cache::DecompressFile(FileEntry* pFileEntry, void* pCompressed, void* pUncompressed, DrxCriticalSection& csDecmopressLock)
{
