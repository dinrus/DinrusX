...
#include <DinrusX/DinrusXSys/ICmdLine.h>
	...
	#include <DinrusX/DinrusXSys/StatsAgentPipe.h>
	#include <DinrusX/CoreX/Thread/MultiThread_Containers.h>
...
class CStatsAgentImpl
{
	...
	template<int Length>
	static const char* TryParse(const DrxStringLocal& str, const char(&szSubstr)[Length])
	{
