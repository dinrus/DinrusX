...
//////////////////////////////////////////////////////////////////////////
LONG WINAPI DinrusXExceptionFilterMiniDump(struct _EXCEPTION_POINTERS* pExceptionPointers, const char* szDumpPath, MINIDUMP_TYPE mdumpValue)
{
...
LONG WINAPI DinrusXExceptionFilterWER(struct _EXCEPTION_POINTERS* pExceptionPointers)
{
	...
	if (g_cvars.sys_WER > 1)
	{
		...
		const char* szDumpPath = gEnv->pDrxPak->AdjustFileName("%USER%/CE2Dump.dmp", szScratch, 0);
