...
#include <DinrusX/DinrusXSys/System.h> // to access InitLocalization()
...
#if !defined(_RELEASE)
	#include <DinrusX/DinrusXSys/DrxSizerImpl.h>
...
static const char* PLATFORM_INDEPENDENT_LANGUAGE_NAMES[ILocalizationUpr::ePILID_MAX_OR_INVALID] =
{
	"japanese",
	"english",
	"french",
	...
	if (pPak)
	{
		...
		if (handle > -1)
		{
			...
			do
			{
				...
				for (int i = 0; i < ILocalizationUpr::ePILID_MAX_OR_INVALID; i++)
				{
...
//////////////////////////////////////////////////////////////////////////
const char* CLocalizedStringsUpr::LangNameFromPILID(const ILocalizationUpr::EPlatformIndependentLanguageID id)
{
...
//////////////////////////////////////////////////////////////////////
const char* CLocalizedStringsUpr::GetLanguage()
{
	if (m_pLanguage == 0)
		return "";
...
//////////////////////////////////////////////////////////////////////
bool CLocalizedStringsUpr::SetLanguage(const char* sLanguage)
{
	if (m_cvarLocalizationDebug >= 2)
...
//////////////////////////////////////////////////////////////////////////
void CLocalizedStringsUpr::AddControl(int nKey)
{
...
//////////////////////////////////////////////////////////////////////////
void CLocalizedStringsUpr::ParseFirstLine(IXmlTableReader* pXmlTableReader, char* nCellIndexToType, std::map<int, string>& SoundMoodIndex, std::map<int, string>& EventParameterIndex)
{
	string sCellContent;
	...
	for (;; )
	{
		...
		for (int i = 0; i < DRX_ARRAY_COUNT(sLocalizedColumnNames); ++i)
		{
...
bool CLocalizedStringsUpr::RequestLoadLocalizationDataByTag(const char* sTag)
{
...
bool CLocalizedStringsUpr::LoadExcelXmlSpreadsheet(const char* sFileName, bool bReload)
{
...
bool CLocalizedStringsUpr::DoLoadExcelXmlSpreadsheet(const char* sFileName, uint8 nTagID, bool bReload)
{
...

		{
			...
			for (size_t stringToCompress = startOfStringsToCompress; stringToCompress < m_pLanguage->m_vLocalizedStrings.size(); stringToCompress++)
			{
				...
				if (pStringToCompress->TranslatedText.szCompressed != NULL)
				{
					...
					pEncoder->AddRef();
					//DrxLogAlways("Compressed %s (%u) to %s (%u)", pStringToCompress->szCompressedTranslatedText, strlen((const char*)pStringToCompress->szCompressedTranslatedText), compressionBuffer, compBufSize);
...
//////////////////////////////////////////////////////////////////////////
void CLocalizedStringsUpr::AddLocalizedString(SLanguage* pLanguage, SLocalizedStringEntry* pEntry, const uint32 keyCRC32)
{
	{
...
//////////////////////////////////////////////////////////////////////////
bool CLocalizedStringsUpr::LocalizeString(const char* sString, string& outLocalizedString, bool bEnglish)
{
...
//////////////////////////////////////////////////////////////////////////
bool CLocalizedStringsUpr::LocalizeStringInternal(const char* pStr, size_t len, string& outLocalizedString, bool bEnglish)
{
	assert(m_pLanguage);
	if (m_pLanguage == 0)
	{
...
#ifndef _RELEASE
//////////////////////////////////////////////////////////////////////////
void CLocalizedStringsUpr::LocalizedStringsUprWarning(const char* label, const char* message)
{
...
//////////////////////////////////////////////////////////////////////////
bool CLocalizedStringsUpr::LocalizeLabel(const char* sLabel, string& outLocalString, bool bEnglish)
{
	assert(sLabel);
...
//////////////////////////////////////////////////////////////////////////
bool CLocalizedStringsUpr::GetEnglishString(const char* sKey, string& sLocalizedString)
{
	assert(sKey);
	if (!m_pLanguage || !sKey)
		return false;
...
//////////////////////////////////////////////////////////////////////////
bool CLocalizedStringsUpr::GetLocalizedInfoByKey(const char* sKey, SLocalizedInfoGame& outGameInfo)
{
	if (!m_pLanguage)
		return false;
...
//////////////////////////////////////////////////////////////////////////
bool CLocalizedStringsUpr::GetLocalizedInfoByKey(const char* sKey, SLocalizedSoundInfoGame* pOutSoundInfo)
{
	assert(sKey);
...
//////////////////////////////////////////////////////////////////////////
int CLocalizedStringsUpr::GetLocalizedStringCount()
{
	if (!m_pLanguage)
		return 0;
...
//////////////////////////////////////////////////////////////////////////
bool CLocalizedStringsUpr::GetLocalizedInfoByIndex(int nIndex, SLocalizedInfoGame& outGameInfo)
{
	if (!m_pLanguage)
		return false;
...
//////////////////////////////////////////////////////////////////////////
bool CLocalizedStringsUpr::GetLocalizedInfoByIndex(int nIndex, SLocalizedInfoEditor& outEditorInfo)
{
	if (!m_pLanguage)
		return false;
	const std::vector<SLocalizedStringEntry*>& entryVec = m_pLanguage->m_vLocalizedStrings;
...
//////////////////////////////////////////////////////////////////////////
bool CLocalizedStringsUpr::GetSubtitle(const char* sKeyOrLabel, string& outSubtitle, bool bForceSubtitle)
{
	assert(sKeyOrLabel);
				...
				if (nArg >= 0 && nArg <= 9)
				{
					...
					else
					{
						...
						if (sizeof(*tmp.c_str()) == sizeof(char))
							DrxWarning(VALIDATOR_MODULE_SYSTEM, VALIDATOR_WARNING, "Parameter for argument %d is missing. [%s]", nArg + 1, (const char*)tmp.c_str());
						else
...
//////////////////////////////////////////////////////////////////////////
void CLocalizedStringsUpr::FormatStringMessage(string& outString, const string& sString, const char** sParams, int nParams)
{
	_InternalFormatStringMessage(outString, sString, sParams, nParams);
}

//////////////////////////////////////////////////////////////////////////
void CLocalizedStringsUpr::FormatStringMessage(string& outString, const string& sString, const char* param1, const char* param2, const char* param3, const char* param4)
{
	_InternalFormatStringMessage(outString, sString, param1, param2, param3, param4);
}

//////////////////////////////////////////////////////////////////////////
int CLocalizedStringsUpr::GetMemoryUsage(IDrxSizer* pSizer)
{
...
void CLocalizedStringsUpr::LocalizeDuration(int seconds, string& outDurationString)
{
	int s = seconds;
	int d, h, m;
	d = s / 86400;
...
void CLocalizedStringsUpr::LocalizeNumber(int number, string& outNumberString)
{
	if (number == 0)
	{
...
void CLocalizedStringsUpr::LocalizeNumber(float number, int decimals, string& outNumberString)
{
	if (number == 0.0f)
	{
		DrxFixedStringT<64> tmp;
