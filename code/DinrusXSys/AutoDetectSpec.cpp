...
#include <DinrusX/DinrusXSys/StdAfx.h>
    ...
    #include <DinrusX/DinrusXSys/AutoDetectCPUTestSuit.h>
...
static size_t SafeReadLine(IDrxPak* pPak, FILE* f, char* buffer, size_t bufferSize)
{
...
{
    DrxLogAlways("Running machine spec auto detect (%d bit)...", sizeof(void*) << 3);
