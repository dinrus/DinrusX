...
///////////////////////////////////////////////////////////////////////////////
bool JobUpr::ThreadBackEnd::CThreadBackEnd::Init(uint32 nSysMaxWorker)
{
	...
	do
	{
		...
		else
		{
...

			{
				...
				const char* jobName = pJobUpr->GetJobName(infoBlock.jobInvoker);
...
///////////////////////////////////////////////////////////////////////////////
JobUpr::ThreadBackEnd::CThreadBackEndWorkerThread::CThreadBackEndWorkerThread(CThreadBackEnd* pThreadBackend, detail::CWaitForJobObject& rSemaphore, JobUpr::SJobQueue_ThreadBackEnd& rJobQueue, uint32 nId) :
