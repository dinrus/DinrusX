...
#include <DinrusX/DinrusXSys/XConsoleVariable.h>
...
#include <DinrusX/CoreX/String/StringUtils.h>
#include <DinrusX/DinrusXSys/ConsoleHelpGen.h>     // CConsoleHelpGen
...
void CXConsole::Paste()
{
	...
	{
		temp = DrxStringUtils::ANSIToUTF8((const char*)pGlobal);
	}
