...
void DrxSizerImpl::Push(const char* szComponentName)
{
...
void DrxSizerImpl::PushSubcomponent(const char* szSubcomponentName)
{
...
size_t DrxSizerImpl::getNameIndex(size_t nParent, const char* szComponentName)
{
...
//          and calculated
bool DrxSizerImpl::AddObject(const void* pIdentifier, size_t sizeBytes, int nCount)
{
...
unsigned DrxSizerImpl::getHash(const void* pId)
{
