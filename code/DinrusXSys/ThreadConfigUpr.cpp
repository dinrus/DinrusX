...
//////////////////////////////////////////////////////////////////////////
const SThreadConfig* CThreadConfigUpr::GetThreadConfig(const char* szThreadName, ...)
{
	va_list args;
	...
	{
		DrxWarning(VALIDATOR_MODULE_SYSTEM, VALIDATOR_WARNING, "<ThreadInfo>: ThreadName \"%s\" has been truncated to \"%s\". Max characters allowed: %i. ", szThreadName, strThreadName, (int)sizeof(strThreadName) - 1);
	}
...
//////////////////////////////////////////////////////////////////////////
const SThreadConfig* CThreadConfigUpr::GetThreadConfigImpl(const char* szThreadName)
{
...
//////////////////////////////////////////////////////////////////////////
bool CThreadConfigUpr::LoadConfig(const char* pcPath)
{
...
//////////////////////////////////////////////////////////////////////////
bool CThreadConfigUpr::LoadPlatformConfig(const XmlNodeRef& rXmlRoot, const char* sPlatformId)
{
...
//////////////////////////////////////////////////////////////////////////
void CThreadConfigUpr::LoadAffinity(const XmlNodeRef& rXmlThreadRef, uint32& rAffinity, SThreadConfig::TThreadParamFlag& rParamActivityFlag)
{
...
//////////////////////////////////////////////////////////////////////////
void CThreadConfigUpr::LoadPriority(const XmlNodeRef& rXmlThreadRef, int32& rPriority, SThreadConfig::TThreadParamFlag& rParamActivityFlag)
{
	const char* szValidCharacters = "-,0123456789";
...
//////////////////////////////////////////////////////////////////////////
void CThreadConfigUpr::LoadStackSize(const XmlNodeRef& rXmlThreadRef, uint32& rStackSize, SThreadConfig::TThreadParamFlag& rParamActivityFlag)
{
	const char* sValidCharacters = "0123456789";
...
//////////////////////////////////////////////////////////////////////////
const char* CThreadConfigUpr::IdentifyPlatform()
{
#if defined(DURANGO)
	return "durango";
#elif defined(ORBIS)
