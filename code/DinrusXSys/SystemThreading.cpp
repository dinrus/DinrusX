...
#define INCLUDED_FROM_SYSTEM_THREADING_CPP
	...
	#include <DinrusX/DinrusXSys/DrxThreadUtil_win32.h>
#elif DRX_PLATFORM_POSIX
	#if DRX_PLATFORM_ORBIS
		#include <DinrusX/DinrusXSys/DrxThreadUtil_sce.h>
	#else
		#include <DinrusX/DinrusXSys/DrxThreadUtil_posix.h>
	#endif
#else
...
public:
	...
	virtual void          ForEachOtherThread(IThreadUpr::ThreadModifFunction fpThreadModiFunction, void* pFuncData = 0) override;
...
private:
	...
	bool     RegisterThirdPartyThreadImpl(DrxThreadUtil::TThreadHandle pThreadHandle, const char* sThreadName);
...
//////////////////////////////////////////////////////////////////////////
#if DRX_PLATFORM_POSIX
void*              CThreadUpr::RunThread(void* thisPtr)
#elif DRX_PLATFORM_WINAPI
unsigned __stdcall CThreadUpr::RunThread(void* thisPtr)
#else
	#error "Unsupported platform"
#endif
{
...
//////////////////////////////////////////////////////////////////////////
const char* CThreadUpr::GetThreadName(threadID nThreadId)
{
...
//////////////////////////////////////////////////////////////////////////
void CThreadUpr::ForEachOtherThread(IThreadUpr::ThreadModifFunction fpThreadModiFunction, void* pFuncData)
{
...
//////////////////////////////////////////////////////////////////////////
bool CThreadUpr::SpawnThread(IThread* pThreadTask, const char* sThreadName, ...)
{
	va_list args;
	...
	{
		DrxWarning(VALIDATOR_MODULE_SYSTEM, VALIDATOR_WARNING, "<ThreadInfo>: ThreadName \"%s\" has been truncated to \"%s\". Max characters allowed: %i.", sThreadName, strThreadName, (int)sizeof(strThreadName) - 1);
	}
...
//////////////////////////////////////////////////////////////////////////
bool CThreadUpr::SpawnThreadImpl(IThread* pThreadTask, const char* sThreadName)
{
	if (pThreadTask == NULL)
	{
...
//////////////////////////////////////////////////////////////////////////
bool CThreadUpr::RegisterThirdPartyThread(void* pThreadHandle, const char* sThreadName, ...)
{
	if (!pThreadHandle)
	{
		pThreadHandle = reinterpret_cast<void*>(DrxThreadUtil::DrxGetCurrentThreadHandle());
	}
...
//////////////////////////////////////////////////////////////////////////
bool CThreadUpr::RegisterThirdPartyThreadImpl(DrxThreadUtil::TThreadHandle threadHandle, const char* sThreadName)
{
...
//////////////////////////////////////////////////////////////////////////
bool CThreadUpr::UnRegisterThirdPartyThread(const char* sThreadName, ...)
{
	va_list args;
	va_start(args, sThreadName);
...
//////////////////////////////////////////////////////////////////////////
bool CThreadUpr::UnRegisterThirdPartyThreadImpl(const char* sThreadName)
{
	AUTO_LOCK(m_spawnedThirdPartyThreadsLock);
...
//////////////////////////////////////////////////////////////////////////
threadID CThreadUpr::GetThreadId(const char* sThreadName, ...)
{
	va_list args;
	va_start(args, sThreadName);
...
//////////////////////////////////////////////////////////////////////////
threadID CThreadUpr::GetThreadIdImpl(const char* sThreadName)
{
	// Loop over internally spawned threads
	{
		AUTO_LOCK(m_spawnedThreadsLock);
