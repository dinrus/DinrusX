...
#include <DinrusX/DinrusXSys/SystemInit.h>
#if defined(MAP_LOADING_SLICING)
	#include <DinrusX/DinrusXSys/SystemScheduler.h>
...
#include <DinrusX/DinrusXSys/NullInput.h>
#include <DinrusX/DinrusXSys/NullLiveCreate.h>
#include <DinrusX/DinrusXSys/NullResponseSystem.h>
#include <DinrusX/DinrusXSys/NULLRenderAuxGeom.h>
#include <DinrusX/DinrusXSys/MemoryUpr.h>
#include <DinrusX/DinrusXSys/ImeUpr.h>
...
#include <DinrusX/CoreX/Mono/IMonoRuntime.h>
...
#include <DinrusX/DinrusXSys/Log.h>
#include <DinrusX/DinrusXSys/xml.h>
#include <DinrusX/DinrusXSys/StreamEngine.h>
#include <DinrusX/DinrusXSys/BudgetingSystem.h>
#include <DinrusX/DinrusXSys/PhysRenderer.h>
#include <DinrusX/DinrusXSys/LocalizedStringUpr.h>
#include <DinrusX/DinrusXSys/SystemEventDispatcher.h>
#include <DinrusX/DinrusXSys/Statistics.h>
#include <DinrusX/DinrusXSys/LocalMemoryUsage.h>
#include <DinrusX/DinrusXSys/ThreadProfiler.h>
#include <DinrusX/DinrusXSys/ThreadConfigUpr.h>
#include <DinrusX/DinrusXSys/HardwareMouse.h>
#include <DinrusX/DinrusXSys/Validator.h>
#include <DinrusX/DinrusXSys/ServerThrottle.h>
#include <DinrusX/DinrusXSys/SystemCFG.h>
#include <DinrusX/DinrusXSys/AutoDetectSpec.h>
#include <DinrusX/DinrusXSys/ResourceUpr.h>
#include <DinrusX/DinrusXSys/LoadingProfiler.h>
#include <DinrusX/DinrusXSys/BootProfiler.h>
#include <DinrusX/DinrusXSys/DiskProfiler.h>
#include <DinrusX/DinrusXSys/Watchdog.h>
#include <DinrusX/DinrusXSys/Statoscope.h>
#include <DinrusX/DinrusXSys/TestSystemLegacy.h>
#include <DinrusX/DinrusXSys/VisRegTest.h>
#include <DinrusX/DinrusXSys/MTSafeAllocator.h>
#include <DinrusX/DinrusXSys/NotificationNetwork.h>
#include <DinrusX/DinrusXSys/HotUpdate.h>
#include <DinrusX/DinrusXSys/DrxPluginUpr.h>
#include <DinrusX/DinrusXSys/DrxFactoryRegistryImpl.h>
#include <DinrusX/DinrusXSys/TestExtensions.h>
#include <DinrusX/DinrusXSys/ProfileLogSystem.h>
#include <DinrusX/DinrusXSys/CodeCheckpointMgr.h>
#include <DinrusX/DinrusXSys/ZLibCompressor.h>
#include <DinrusX/DinrusXSys/ZLibDecompressor.h>
#include <DinrusX/DinrusXSys/LZ4Decompressor.h>
#include <DinrusX/DinrusXSys/OverloadSceneUpr.h>
#include <DinrusX/DinrusXSys/ServiceNetwork.h>
#include <DinrusX/DinrusXSys/RemoteCommand.h>
#include <DinrusX/DinrusXSys/NULLAudioSystems.h>
#include <DinrusX/DinrusXSys/StatsAgent.h>
#include <DinrusX/DinrusXNetwork/ISimpleHttpServer.h>

#include <DinrusX/DinrusXSys/ProjectUpr.h>

#include <DinrusX/CoreX/Platform/IPlatformOS.h>
#include <DinrusX/DinrusXSys/PerfHUD.h>
#include <DinrusX/DinrusXSys/MiniGUI.h>

#include <DinrusX/CoreX/Game/IGameFramework.h>

#include <DinrusX/DinrusXSys/Stroboscope.h>

#include <DinrusX/DinrusXSys/HMDUpr.h>

#include <DinrusX/DinrusXSys/ArchiveHost.h>

#include <DinrusX/DinrusXSchema/ICore.h>
#include <DinrusX/DinrusXSchema2/IFramework.h>
#include <DinrusX/DinrusXSys/ManualFrameStep.h>
...
#include <DinrusX/DinrusXSys/WindowsConsole.h>
...
static void CmdCrashTest(IConsoleCmdArgs* pArgs)
{
	...
	#pragma warning(disable:4723) // potential divide by 0
		...
		case 5:
			while (true)
			{
				char* element = new char[128];   //testing the crash handler an exception in the drx memory allocation occurred
				// cppcheck-suppress memleak
			}
...
static void CmdDumpCvars(IConsoleCmdArgs* pArgs)
{
	struct CCVarSink : public ICVarDumpSink
	{
		...
		void LogToFile()
		{
			...
			{
				char path[_MAX_PATH];
				const char* szAdjustedPath = gEnv->pDrxPak->AdjustFileName(file_path, path, 0);
...
static void CmdIgnoreAssertsFromModule(IConsoleCmdArgs* pArgs)
{
	if (gEnv && gEnv->pSystem && pArgs->GetArgCount() == 2)
	{
		...
		DrxWarning(VALIDATOR_MODULE_SYSTEM, VALIDATOR_ERROR, "Tried to ignore assertions for unknown module %s", pArgs->GetArg(1));
	}
}
#endif
...
WIN_HMODULE CSystem::LoadDynamicLibrary(const char* szModulePath, bool bQuitIfNotFound, bool bLogLoadingInfo)
{
	...
	if (handle == nullptr)
	{
		if (bQuitIfNotFound)
		{
			...
			DrxFatalError("Error loading dynamic library: %s, error :  %s\n", modulePath.c_str(), dlerror());
#else
			DrxFatalError("Error loading dynamic library: %s, error code %d", modulePath.c_str(), GetLastError());
#endif
...
IDrxFactory* CSystem::LoadModuleWithFactory(const char* dllName, const DrxInterfaceID& moduleInterfaceId)
{
...
//////////////////////////////////////////////////////////////////////////
bool CSystem::InitializeEngineModule(const SSystemInitParams& startupParams, const char* dllName, const DrxInterfaceID& moduleInterfaceId, bool bQuitIfNotFound)
{
	...
	if (GetIMemoryUpr())
	{
		...
		DrxLog("Initializing %s done, MemUsage=%uKb", dllName, uint32(memUsed / 1024));
	}
...
bool CSystem::OpenRenderLibrary(const SSystemInitParams& startupParams, const char* t_rend)
{
	...
	DrxFatalError("Unknown renderer type: %s", t_rend);
	return false;
}
...
bool CSystem::InitSchematyc(const SSystemInitParams& startupParams)
{
	...
	{
		if (!InitializeEngineModule(startupParams, "DrxSchematyc2", drxiidof<Schematyc2::IFramework>(), true))
			return false;

		if (m_env.pSchematyc2 == nullptr)
		{
			DrxFatalError("Error initializing Schematyc!");
			return false;
		}
	}
	...
	if (sys_SchematycPlugin == 0 || sys_SchematycPlugin == 2)
	{
		...
		{
			DrxFatalError("Error initializing experimental Schematyc!");
			return false;
		}
	}
...
#if DRX_PLATFORM_ANDROID && defined(ANDROID_OBB)
	{
		uint32 nFlags = IDrxPak::FLAGS_NEVER_IN_PAK;
...
void CSystem::OpenBasicPaks(bool bLoadGamePaks)
{
	...
	if (!s_bEnginePakLoaded)
	{
		...
		{
			const char* szBindRoot = m_env.pDrxPak->GetAlias("%ENGINE%", false);
			string paksFolder = PathUtil::Make(buildFolder.empty() ? "%ENGINEROOT%" : buildFolder, "Engine");

			const unsigned int numOpenPacksBeforeEngine = m_env.pDrxPak->GetPakInfo()->numOpenPaks;
...
bool CSystem::Initialize(SSystemInitParams& startupParams)
{
...

	{
		...
		int crc = gEnv->pDrxPak->ComputeCachedPakCDR_CRC(filename, false);
		...
		if (!startupParams.bPreview && !startupParams.bShaderCacheGen)
		{
			...
			{
				DrxLogAlways("Schematyc initialization");
				INDENT_LOG_DURING_SCOPE();
...
static void _LvlRes_export_IResourceList(FILE* hFile, const IDrxPak::ERecordFileOpenList& eList)
{
	...
	for (const char* filename = pResList->GetFirst(); filename; filename = pResList->GetNext())
	{
		...
		const char* szAbsPath = gEnv->pDrxPak->AdjustFileName(filename, szAbsPathBuf, 0);
...
public:
	...
	void RegisterPak(const string& sPath, const char* szFile)
	{
		...
		const char* szAbsPath = gEnv->pDrxPak->AdjustFileName(sPak, szAbsPathBuf, 0);
	...
	{
		const char* szPak = gEnv->pDrxPak->GetFileArchivePath(hFile);
...
#undef CRASH_CMD_HELP_EXTRA
	...
	static const char* p_physics_library_default = "DinrusXPhys";
