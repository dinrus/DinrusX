...
#include <DinrusX/DinrusXSys/ITestSystem.h>
...
#include <DinrusX/DinrusXSys/IFlashPlayer.h>
#include <DinrusX/DinrusXSys/IStreamEngine.h>

// Access to some game info.
#include <DinrusX/CoreX/Game/IGameFramework.h>    // IGameFramework
#include <DinrusX/DinrusXAct/ILevelSystem.h> // ILevelSystemListener
...
/*static*/ bool QueryModuleMemoryInfo(SDinrusXStatsModuleInfo& moduleInfo, int index)
{
...
public:
	...
	void ExportToFile(SDinrusXStats& stats, const char* filename);
...
//////////////////////////////////////////////////////////////////////////
void CStatsToExcelExporter::ExportToFile(SDinrusXStats& stats, const char* filename)
{
...
void CStatsToExcelExporter::ExportMemInfo(SDinrusXStats& stats)
{
	...
	for (uint32 i = 0; i < stats.memInfo.modules.size(); i++)
	{
		...
		AddCell((uint32)(moduleInfo.memInfo.DrxString_allocated / 1024));
...
bool QueryModuleMemoryInfo(SDinrusXStatsModuleInfo& moduleInfo, int index)
{
	return false;
}
