...
#include <DinrusX/DinrusXSys/IBudgetingSystem.h>
#include <DinrusX/CoreX/Game/IGameFramework.h>
#include <DinrusX/DinrusXNetwork/INotificationNetwork.h>
#include <DinrusX/DinrusXSys/ICodeCheckpointMgr.h>
#include <DinrusX/DinrusXSys/IStatoscope.h>
#include <DinrusX/DinrusXSys/TestSystemLegacy.h>             // CTestSystem
...
#include <DinrusX/DinrusXSys/ProfileLog.h>
#include <DinrusX/CoreX/String/Path.h>

#include <DinrusX/DinrusXSys/xml.h>
#include <DinrusX/DinrusXSys/ReadWriteXMLSink.h>
...
#include <DinrusX/CoreX/Memory/ILocalMemoryUsage.h>
...
#include <DinrusX/DinrusXSys/RemoteConsole.h>
...
extern int DrxMemoryGetAllocatedSize();
				...
				case EMouseWheelOrigin::WindowSpaceClamped:
					{
						...
						x = drxmath::clamp<int>(p.x, 0, r.right - r.left);
						y = drxmath::clamp<int>(p.y, 0, r.bottom - r.top);
						break;
					}
				default:
