...
CRemoteCommandClient::Connection::Connection(CRemoteCommandUpr* pUpr, IServiceNetworkConnection* pConnection, uint32 currentCommandId)
...
bool CRemoteCommandClient::Schedule(const IRemoteCommand& command)
{
	...
	const uint32 commandId = DrxInterlockedIncrement((volatile int*) &m_commandId);
