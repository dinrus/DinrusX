...
#include <DinrusX/DinrusXSys/ZipDirTree.h>
#include <DinrusX/DinrusXSys/ZipDirCache.h>
#include <DinrusX/DinrusXSys/ZipDirCacheRW.h>
#include <DinrusX/DinrusXSys/ZipDirCacheFactory.h>
#include <DinrusX/DinrusXSys/ZipDirList.h>
...
ZipDir::CachePtr ZipDir::CacheFactory::New(const char* szFile, IDrxPak::EInMemoryPakLocation eInMemLocal)
{
	m_szFilename = szFile;
...
ZipDir::CachePtr ZipDir::CacheFactory::New(const char* szFile, IDrxPak::EInMemoryPakLocation eInMemLocale, FILE* pPakFileRef, int nAssetOffset, int nAssetLength, ZipDir::FileEntry* pPakEntry)
{
	m_szFilename = szFile;
...
ZipDir::CachePtr ZipDir::CacheFactory::New(const char* szFile, IDrxPak::EInMemoryPakLocation eInMemLocale, AAssetUpr* pAssetUpr)
{
	m_szFilename = szFile;
