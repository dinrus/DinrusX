...
#include <DinrusX/DinrusXSys/StreamReadStream.h>
...
{
	char* pFree = reinterpret_cast<char*>(DrxInterlockedPopEntrySList(s_freeRequests));
...
void CReadStream::Flush()
{
	...
	for (char* pFree = reinterpret_cast<char*>(DrxInterlockedPopEntrySList(s_freeRequests));
	     pFree;
	     pFree = reinterpret_cast<char*>(DrxInterlockedPopEntrySList(s_freeRequests)))
	{
