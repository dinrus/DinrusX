...
#include <DinrusX/DinrusXSys/ISystem.h>                      // ISystem
#include <DinrusX/DinrusXEntity/IEntity.h>                // EntityId
#include <DinrusX/DinrusXSys/ITimer.h>                       // ITimer
#include <DinrusX/DinrusXEntity/IEntitySystem.h>          // IEntityIt
#include <DinrusX/DinrusXSys/IConsole.h>                     // IConsole
#include <DinrusX/DinrusX3dEng/I3DEngine.h>                  // I3DEngine
#include <DinrusX/CoreX/Game/IGameFramework.h>                 // IGameFramework
#include <DinrusX/DinrusXSys/TestSystemLegacy.h>
#include <DinrusX/DinrusXSys/DebugCallStack.h>                 // DebugCallStack
...
{
	int nExitCode = gEnv->pSystem->GetITestSystem()->GetIUnitTestUpr()->RunAllTests(DrxUnitTest::EReporterType::Excel);
...
void CTestSystemLegacy::LogLevelStats()
{
...

	{
		...
		int memUsageInMB_Engine(DrxMemoryGetAllocatedSize());
