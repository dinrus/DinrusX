...
#include <DinrusX/DinrusXSys/SystemCFG.h>
	...
	#include <DinrusX/CoreX/Project/Version.h>
...
//////////////////////////////////////////////////////////////////////////
bool CSystemConfiguration::OpenFile(const string& filename, CDrxFile& file, int flags)
{
...
bool CSystemConfiguration::ParseSystemConfig()
{
...

	{
		...
		int flags = IDrxPak::FOPEN_HINT_QUIET | IDrxPak::FOPEN_ONDISK;
