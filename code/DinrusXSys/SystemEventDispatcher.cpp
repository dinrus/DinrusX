...
bool CSystemEventDispatcher::RegisterListener(ISystemEventListener* pListener, const char* szName)
{
	...
	{
		DrxWarning(VALIDATOR_MODULE_SYSTEM, VALIDATOR_ERROR_DBGBRK, "CSystemEventDispatcher::RegisterListener(ISystemEventListener* pListener, const char* szName) => Was called with Null listener or invalid szName! The Listner was not registered!");
		return false;
	}
