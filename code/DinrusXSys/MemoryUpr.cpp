...
#include <DinrusX/DinrusXSys/DefragAllocator.h>
...
int CDrxMemoryUpr::s_sys_MemoryDeadListSize;
...
{
	DrxInterlockedExchangeAdd((LONG volatile*)&g_TotalAllocatedMemory, (LONG)size);
}

//////////////////////////////////////////////////////////////////////////
CDrxMemoryUpr::HeapHandle CDrxMemoryUpr::TraceDefineHeap(const char* heapName, size_t size, const void* pBase)
{
	return 0;
}

//////////////////////////////////////////////////////////////////////////
void CDrxMemoryUpr::TraceHeapAlloc(HeapHandle heap, void* mem, size_t size, size_t blockSize, const char* sUsage, const char* sNameHint)
{

}

//////////////////////////////////////////////////////////////////////////
void CDrxMemoryUpr::TraceHeapFree(HeapHandle heap, void* mem, size_t blockSize)
{

}

//////////////////////////////////////////////////////////////////////////
void CDrxMemoryUpr::TraceHeapSetColor(uint32 color)
{

}

//////////////////////////////////////////////////////////////////////////
void CDrxMemoryUpr::TraceHeapSetLabel(const char* sLabel)
{

}

//////////////////////////////////////////////////////////////////////////
uint32 CDrxMemoryUpr::TraceHeapGetColor()
{
	return 0;
}
...
IGeneralMemoryHeap* CDrxMemoryUpr::CreateGeneralExpandingMemoryHeap(size_t upperLimit, size_t reserveSize, const char* sUsage)
{
	return new CGeneralMemoryHeap(static_cast<UINT_PTR>(0), upperLimit, reserveSize, sUsage);
}

IGeneralMemoryHeap* CDrxMemoryUpr::CreateGeneralMemoryHeap(void* base, size_t sz, const char* sUsage)
{
	return new CGeneralMemoryHeap(base, sz, sUsage);
}

IMemoryAddressRange* CDrxMemoryUpr::ReserveAddressRange(size_t capacity, const char* sName)
{
	return new CMemoryAddressRange(capacity, sName);
}

IPageMappingHeap* CDrxMemoryUpr::CreatePageMappingHeap(size_t addressSpace, const char* sName)
{
...
void* CDrxMemoryUpr::AllocPages(size_t size)
{
	void* ret = NULL;
...
void CDrxMemoryUpr::FreePages(void* p, size_t size)
{
