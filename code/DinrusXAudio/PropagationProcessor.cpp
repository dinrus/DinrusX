...
#include <DinrusX/DinrusXAudio/PropagationProcessor.h>
#include <DinrusX/DinrusXAudio/AudioCVars.h>
#include <DinrusX/DinrusXAudio/ATLAudioObject.h>
#include <DinrusX/DinrusXAudio/AudioSystem.h>
...
#if defined(INCLUDE_AUDIO_PRODUCTION_CODE)
	m_listenerOcclusionPlaneColor.set(drx_random<uint8>(0, 255), drx_random<uint8>(0, 255), drx_random<uint8>(0, 255), uint8(64));
#endif // INCLUDE_AUDIO_PRODUCTION_CODE
}
