...
#include <DinrusX/DinrusXAudio/FileCacheUpr.h>
...
//////////////////////////////////////////////////////////////////////////
void CFileCacheUpr::StreamAsyncOnComplete(IReadStream* pStream, unsigned int nError)
{
...
void CFileCacheUpr::DrawDebugInfo(IRenderAuxGeom& auxGeom, float const posX, float posY)
{
	if ((g_cvars.m_drawAudioDebug & EAudioDebugDrawFilter::ShowFileCacheUprInfo) > 0)
	{
		...
		auxGeom.Draw2dLabel(posX, posY, 1.5f, orange, false, "FileCacheUpr (%d of %d KiB) [Entries: %d]", static_cast<int>(m_currentByteTotal >> 10), static_cast<int>(m_maxByteTotal >> 10), static_cast<int>(m_audioFileEntries.size()));
		posY += 16.0f;
...
//////////////////////////////////////////////////////////////////////////
bool CFileCacheUpr::FinishStreamInternal(IReadStreamPtr const pStream, int unsigned const error)
{
	bool bSuccess = false;
