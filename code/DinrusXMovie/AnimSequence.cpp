...
#include <DinrusX/DinrusXMovie/AnimSequence.h>

#include <DinrusX/DinrusXMovie/EntityNode.h>
#include <DinrusX/DinrusXMovie/CVarNode.h>
#include <DinrusX/DinrusXMovie/ScriptVarNode.h>
#include <DinrusX/DinrusXMovie/AnimCameraNode.h>
#include <DinrusX/DinrusXMovie/SceneNode.h>
#include <DinrusX/CoreX/StlUtils.h>
#include <DinrusX/DinrusXMovie/MaterialNode.h>
#include <DinrusX/DinrusXMovie/EventNode.h>
#include <DinrusX/DinrusXMovie/LayerNode.h>
#include <DinrusX/DinrusXMovie/CommentNode.h>
#include <DinrusX/DinrusXMovie/AnimLightNode.h>
#include <DinrusX/DinrusXMovie/AnimPostFXNode.h>
#include <DinrusX/DinrusXMovie/AnimScreenFaderNode.h>
#include <DinrusX/DinrusXMovie/AnimGeomCacheNode.h>
#include <DinrusX/DinrusXMovie/ShadowsSetupNode.h>
#include <DinrusX/DinrusXMovie/AnimEnvironmentNode.h>
#include <DinrusX/DinrusXMovie/AudioNode.h>
...
void CAnimSequence::Serialize(XmlNodeRef& xmlNode, bool bLoading, bool bLoadEmptyTracks, uint32 overrideId, bool bResetLightAnimSet)
{
	if (bLoading)
	{
		...
		{
			// Don't load sequences from a newer version of DinrusX
			return;
		}
