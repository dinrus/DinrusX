...
#include <DinrusX/DinrusXAct/DialogSession.h>
#include <DinrusX/DinrusXAct/DialogCommon.h>
		...
		case eDAC_ScheduleSoundPlay:
			{
				...
				if (bHasSound)
				{
					if (m_bSoundScheduled == false)
					{
						...
						DrxAudio::SRequestUserData const userData(DrxAudio::ERequestFlags::DoneCallbackOnExternalThread, nullptr, (void*)CDialogActorContext::GetClassIdentifier(), reinterpret_cast<void*>(static_cast<intptr_t>(m_ContextID)));
