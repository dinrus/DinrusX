...
#include <DinrusX/plugins/DrxDefaultEntities/DefaultComponents/Audio/ListenerComponent.h>
...
void CView::Update(float frameTime, bool isActive)
{
	...
	if (pLinkedTo || pEntity)
	{
		...
		else if (pHmdDevice && bHmdTrackingEnabled)
		{
			...
			if (Drx::pHmdTrackingOrigin && Drx::pHmdTrackingOrigin->GetIVal() == (int)EHmdTrackingOrigin::Seated)
			{
