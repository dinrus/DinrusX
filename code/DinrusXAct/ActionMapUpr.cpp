...
#include <DinrusX/DinrusXAct/ActionMap.h>
#include <DinrusX/DinrusXAct/ActionFilter.h>
...
//------------------------------------------------------------------------
bool CActionMapUpr::InitActionMaps(const char* filename)
{
...
bool CActionMapUpr::LoadControllerLayoutFile(const char* szLayoutKeyName)
{
...
//------------------------------------------------------------------------
bool CActionMapUpr::AddExtraActionListener(IActionListener* pExtraActionListener, const char* actionMap)
{
...
//------------------------------------------------------------------------
bool CActionMapUpr::RemoveExtraActionListener(IActionListener* pExtraActionListener, const char* actionMap)
{
	if ((actionMap != NULL) && (actionMap[0] != '\0'))
	{
		TActionMapMap::iterator iActionMap = m_actionMaps.find(CONST_TEMP_STRING(actionMap));
...
//------------------------------------------------------------------------
bool CActionMapUpr::AddFlowgraphNodeActionListener(IActionListener* pFlowgraphNodeActionListener, const char* actionMap)
{
	if ((actionMap != NULL) && (actionMap[0] != '\0'))
	{
		TActionMapMap::iterator	iActionMap = m_actionMaps.find(CONST_TEMP_STRING(actionMap));
...
//------------------------------------------------------------------------
bool CActionMapUpr::RemoveFlowgraphNodeActionListener(IActionListener* pFlowgraphNodeActionListener, const char* actionMap)
{
	if ((actionMap != NULL) && (actionMap[0] != '\0'))
	{
		TActionMapMap::iterator	iActionMap = m_actionMaps.find(CONST_TEMP_STRING(actionMap));
...
//------------------------------------------------------------------------
IActionMap* CActionMapUpr::CreateActionMap(const char* name)
{
...
//------------------------------------------------------------------------
bool CActionMapUpr::RemoveActionMap(const char* name)
{
...
//------------------------------------------------------------------------
IActionMap* CActionMapUpr::GetActionMap(const char* name)
{
	TActionMapMap::iterator it = m_actionMaps.find(CONST_TEMP_STRING(name));
	if (it == m_actionMaps.end())
	{
...
//------------------------------------------------------------------------
const IActionMap* CActionMapUpr::GetActionMap(const char* name) const
{
...
//------------------------------------------------------------------------
IActionFilter* CActionMapUpr::CreateActionFilter(const char* name, EActionFilterType type)
{
...
//------------------------------------------------------------------------
IActionFilter* CActionMapUpr::GetActionFilter(const char* name)
{
...
//------------------------------------------------------------------------
void CActionMapUpr::EnableActionMap(const char* name, bool enable)
{
	if (name == 0 || *name == 0)
	{
		TActionMapMap::iterator it = m_actionMaps.begin();
...
//------------------------------------------------------------------------
void CActionMapUpr::EnableFilter(const char* name, bool enable)
{
	if (name == 0 || *name == 0)
	{
		TActionFilterMap::iterator it = m_actionFilters.begin();
...
//------------------------------------------------------------------------
bool CActionMapUpr::ReBindActionInput(const char* actionMapName, const ActionId& actionId, const char* szCurrentInput, const char* szNewInput)
{
	IActionMap* pActionMap = GetActionMap(actionMapName);
	if (pActionMap)
	{
...
//------------------------------------------------------------------------
const SActionInput* CActionMapUpr::GetActionInput(const char* actionMapName, const ActionId& actionId, const EActionInputDevice device, const int iByDeviceIndex) const
{
	...
	if (!pActionInput)
	{
		GameWarning("CActionMapUpr::GetActionInput: Failed to find action input with deviceid: %d and index: %d, in action:%s in actionmap: %s", (int)device, iByDeviceIndex, actionId.c_str(), actionMapName);
		return NULL;
	}
...
//------------------------------------------------------------------------
bool CActionMapUpr::IsFilterEnabled(const char* name)
{
	TActionFilterMap::iterator it = m_actionFilters.find(CONST_TEMP_STRING(name));
...
//------------------------------------------------------------------------
bool CActionMapUpr::ProcessAlwaysListeners(const ActionId& action, int activationMode, float value, const SInputEvent& inputEvent)
{
...
//------------------------------------------------------------------------
int CActionMapUpr::GetHighestPressDelayPriority() const
{
...
//------------------------------------------------------------------------
int CActionMapUpr::GetActionsCount() const
{
	int actionCount = 0;
	for (TActionMapMap::const_iterator actionMapIt = m_actionMaps.begin(); actionMapIt != m_actionMaps.end(); ++actionMapIt)
	{
...
//------------------------------------------------------------------------
bool CActionMapUpr::AddInputDeviceMapping(const EActionInputDevice deviceType, const char* szDeviceTypeStr)
{
...
//------------------------------------------------------------------------
int CActionMapUpr::GetNumInputDeviceData() const
{
	return m_inputDeviceData.size();
}

//------------------------------------------------------------------------
const SActionInputDeviceData* CActionMapUpr::GetInputDeviceDataByIndex(const int iIndex)
{
...
//------------------------------------------------------------------------
const SActionInputDeviceData* CActionMapUpr::GetInputDeviceDataByType(const char* szDeviceType)
{
	SActionInputDeviceData* pFoundInputDeviceData = NULL;
