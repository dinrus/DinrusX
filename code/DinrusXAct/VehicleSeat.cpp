...
#include <DinrusX/DinrusXAI/IPathfinder.h>
#include <DinrusX/DinrusXAI/IAIActor.h>
#include <DinrusX/DinrusXAI/IAIObject.h>

#include <DinrusX/DinrusXAct/VehicleSeatAnimActions.h>
...
bool CVehicleSeat::SitDown()
{
	...
	CDrxAction::GetDrxAction()->GetIGameplayRecorder()->Event(pActor->GetEntity(), GameplayEvent(eGE_EnteredVehicle, 0, 0, (void*)(EXPAND_PTR)m_pVehicle->GetEntityId()));
...
bool CVehicleSeat::StandUp()
{
	...
	CDrxAction::GetDrxAction()->GetIGameplayRecorder()->Event(pActor->GetEntity(), GameplayEvent(eGE_LeftVehicle, 0, 0, (void*)(EXPAND_PTR)m_pVehicle->GetEntityId()));
