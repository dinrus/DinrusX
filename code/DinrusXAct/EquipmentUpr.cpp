...
#include <DinrusX/DinrusXAct/EquipmentUpr.h>
...
void CEquipmentUpr::LoadEquipmentPacksFromPath(const char* path)
{
	MEMSTAT_CONTEXT(EMemStatContextTypes::MSC_Other, 0, "Equipment Packs");
...
bool CEquipmentUpr::GiveEquipmentPack(IActor* pActor, const char* packName, bool bAdd, bool selectPrimary)
{
	if (!pActor)
		return false;
...
CEquipmentUpr::SEquipmentPack* CEquipmentUpr::GetPack(const char* packName) const
{
...
void CEquipmentUpr::PreCacheEquipmentPackResources(const char* packName, IEquipmentPackPreCacheCallback& preCacheCallback)
{
