...
static const char* GetSoundName(const DrxAudio::ControlId soundId)
{
...
void CLipSyncProvider_TransitionQueue::FindMatchingAnim(const DrxAudio::ControlId audioTriggerId, const ELipSyncMethod lipSyncMethod, ICharacterInstance& character, int* pAnimIdOut, DrxCharAnimationParams* pAnimParamsOut) const
{
	DRX_ASSERT(audioTriggerId != DrxAudio::InvalidControlId);
