...
#include <DinrusX/DinrusXAct/GameSerializeHelpers.h>
...
#include <DinrusX/DinrusXAct/ColorGradientUpr.h>
	...
	#include <DinrusX/DinrusXAct/CopyProtection.h>
#endif
...
static const char* SAVEGAME_COLORGRADIANTMANAGER_SECTION = "ColorGradientUpr";
...
bool CGameSerialize::SaveGame(CDrxAction* pDrxAction, const char* method, const char* name, ESaveGameReason reason, const char* checkPointName)
{
...
ELoadGameResult CGameSerialize::LoadGame(CDrxAction* pDrxAction, const char* method, const char* path, SGameStartParams& startParams, bool requireQuickLoad)
{
	...
	const char* sCurrentLevel = pDrxAction->GetLevelName();
...
bool CGameSerialize::SaveMetaData(SSaveEnvironment& savEnv)
{
	...
	const char* levelName = savEnv.m_pDrxAction->GetLevelName();
	if (!levelName)
	{
...
{
	const char* sCurrentLevel = loadEnv.m_pDrxAction->GetLevelName();
