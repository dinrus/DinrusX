...
#include <DinrusX/DinrusXAct/IMetadataRecorder.h>
...
private:
	...
	static inline void WriteFccCodes(CDrxFile& file, const TFourCCSet& fccs, uint32 keyword)
	{
		uint32 fcc = keyword;
	...
	static inline bool ReadFccCodes(CDrxFile& file, TFourCCSet& fccs, uint32 keyword)
	{
		uint32 fcc = 0;
