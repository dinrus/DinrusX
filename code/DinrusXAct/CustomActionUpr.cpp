...
//------------------------------------------------------------------------------------------------------------------------
bool CCustomActionUpr::StartAction(IEntity* pObject, const char* szCustomActionGraphName, ICustomActionListener* pListener)
{
	DRX_ASSERT(pObject);
	if (!pObject)
		return false;
...
//------------------------------------------------------------------------------------------------------------------------
bool CCustomActionUpr::SucceedAction(IEntity* pObject, const char* szCustomActionGraphName, ICustomActionListener* pListener)
{
	DRX_ASSERT(pObject);
	if (!pObject)
		return false;
...
//------------------------------------------------------------------------------------------------------------------------
void CCustomActionUpr::LoadLibraryActions(const char* sPath)
{
...
//------------------------------------------------------------------------------------------------------------------------
ICustomAction* CCustomActionUpr::GetCustomActionFromLibrary(const char* szCustomActionGraphName)
{
...
//------------------------------------------------------------------------------------------------------------------------
ICustomAction* CCustomActionUpr::AddActiveCustomAction(IEntity* pObject, const char* szCustomActionGraphName, ICustomActionListener* pListener)
{
	DRX_ASSERT(pObject != NULL);
	if (!pObject)
		return NULL;
