#include <DinrusX/DinrusXAct/VehicleNoiseGenerator.h>
...
float CVehicleNoiseValue::PseudoNoise(int32 x)
{
...
float CVehicleNoiseValue::SoftNoise(int32 x)
{
	// Soft Perlin noise
...
void CVehicleNoiseValue::Setup(float amplitude, float frequency, int32 offset)
{
