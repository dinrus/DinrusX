...
#include <DinrusX/DinrusXAct/NullListener.h>
#include <DinrusX/DinrusXAct/NullStream.h>
#include <DinrusX/DinrusXAct/GenericRecordingListener.h>
#include <DinrusX/DinrusXAct/GenericPlaybackListener.h>
#include <DinrusX/DinrusXAct/ProceduralBreakingPlaybackListener.h>
#include <DinrusX/DinrusXAct/ProceduralBreakingRecordingListener.h>
...
#include <DinrusX/DinrusXAct/JointBreak.h>
#include <DinrusX/DinrusXAct/BreakReplicatorGameObject.h>
	...
	for (ListenerInfos::iterator it = m_listenerInfos.begin(); it != m_listenerInfos.end(); ++it)
	{
		if (it->pListener->AttemptAbsorb(pBT))
		{
			if (CNetworkCVars::Get().BreakageLog)
				DrxLogAlways("[brk] absorbed into listener %p", (void*)it->pListener);
			return it->pListener;
		}
	}
