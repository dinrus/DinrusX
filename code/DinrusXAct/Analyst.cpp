...
{
	const char* level = CDrxAction::GetDrxAction()->GetILevelSystem()->GetCurrentLevel()->GetName();
	const char* gamerules = CDrxAction::GetDrxAction()->GetIGameRulesSystem()->GetCurrentGameRulesEntity()->GetClass()->GetName();
