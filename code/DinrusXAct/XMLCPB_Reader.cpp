...
bool CReader::CheckFileCorruption(IPlatformOS::ISaveReaderPtr& pOSSaveReader, const SFileHeader& fileHeader, uint32 totalSize)
{
	...
	pZLib->MD5Update(&context, (const unsigned char*) pBuf, sizeToCheck);
	...
	pZLib->MD5Update(&context, (const unsigned char*)(&tempFileHeader), sizeof(tempFileHeader));
	pZLib->MD5Final(&context, (unsigned char*) MD5signature);
