...
////////////////////////////////////////////////////////////////////////////
bool CDialogQueuesUpr::IsBufferFree(uint32 queueID)
{
...
////////////////////////////////////////////////////////////////////////////
CDialogQueuesUpr::TDialogId CDialogQueuesUpr::Play(uint32 queueID, const string& name)
{
...
////////////////////////////////////////////////////////////////////////////
bool CDialogQueuesUpr::IsDialogWaiting(uint32 queueID, TDialogId dialogId)
{
	if (IsQueueIDValid(queueID))
	{
...
////////////////////////////////////////////////////////////////////////////
void CDialogQueuesUpr::NotifyDialogDone(uint32 queueID, TDialogId dialogId)
{
	if (IsQueueIDValid(queueID))
	{
		TBuffer& buffer = m_buffersList[queueID];
...
////////////////////////////////////////////////////////////////////////////
uint32 CDialogQueuesUpr::BufferEnumToId(uint32 bufferEnum) // buffer enum means the values stored in the .xml definition file
{
