...
#include <DinrusX/DinrusXAct/FlashUI.h>
#include <DinrusX/DinrusXAct/FlashUIElement.h>
#include <DinrusX/DinrusXAct/FlashUIAction.h>
#include <DinrusX/DinrusXAct/FlashUIElementNodes.h>
#include <DinrusX/DinrusXAct/FlashUIEventNodes.h>
#include <DinrusX/DinrusXAct/FlashUIActionEvents.h>
...
bool CFlashUI::DisplayVirtualKeyboard(unsigned int flags, const char* title, const char* initialInput, int maxInputLength, IVirtualKeyboardEvents* pInCallback)
{
	...
	{
		unsigned int controllerIdx = gEnv->pGameFramework->GetIPlayerProfileUpr()->GetExclusiveControllerDeviceIndex();
