...
bool CActionScope::InstallAnimation(int animID, const DrxCharAnimationParams& animParams)
{
...
void CActionScope::InitAnimationParams(const SAnimationEntry& animEntry, const uint32 sequencerLayer, const SAnimBlend& animBlend, DrxCharAnimationParams& paramsOut)
{
