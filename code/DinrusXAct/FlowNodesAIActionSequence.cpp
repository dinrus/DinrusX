...
#include <DinrusX/DinrusXAI/IAIActionSequence.h>
...
void DrxAction_AIActionSequenceFlowNodeBase::FinishSequenceActionAndActivateOutputPort(int port)
{
...
void DrxAction_AIActionSequenceFlowNodeBase::CancelSequenceAndActivateOutputPort(int port)
{
