...
#include <DinrusX/DinrusXAct/TagDefinitionXml.h>
#include <DinrusX/DinrusXAct/ProceduralClipConversion.h>
...
CAnimationDatabaseLibrary::CAnimationDatabaseLibrary()
{
	...
	const int NUM_ANIM_FLAGS = DRX_ARRAY_COUNT(ANIM_FLAGS);
	...
	const int NUM_TRANSITION_FLAGS = DRX_ARRAY_COUNT(TRANSITION_FLAGS);
	...
	: m_editorListenerSet(1)
{
	...
	const int NUM_FRAGMENT_FLAGS = DRX_ARRAY_COUNT(FRAGMENT_FLAGS);
...
const IAnimationDatabase* CAnimationDatabaseUpr::FindDatabase(uint32 crcFilename) const
{
	return stl::find_in_map(m_databases, crcFilename, NULL);
}

const IAnimationDatabase* CAnimationDatabaseUpr::Load(const char* databaseName)
{
...
IAnimationDatabase* CAnimationDatabaseUpr::Create(const char* filename, const char* defFilename)
{
	char normalizedFilename[DEF_PATH_LENGTH];
...
CTagDefinition* CAnimationDatabaseUpr::CreateTagDefinition(const char* filename)
{
	char normalizedFilename[DEF_PATH_LENGTH];
	NormalizeFilename(normalizedFilename, filename);
...
const SControllerDef* CAnimationDatabaseUpr::LoadControllerDef(const char* filename)
{
...
const SControllerDef* CAnimationDatabaseUpr::FindControllerDef(const uint32 crcFilename) const
{
	return stl::find_in_map(m_controllerDefs, crcFilename, NULL);
}

const SControllerDef* CAnimationDatabaseUpr::FindControllerDef(const char* filename) const
{
	char normalizedFilename[DEF_PATH_LENGTH];
	NormalizeFilename(normalizedFilename, filename);
...
const CTagDefinition* CAnimationDatabaseUpr::LoadTagDefs(const char* filename, bool isTags)
{
	char normalizedFilename[DEF_PATH_LENGTH];
	NormalizeFilename(normalizedFilename, filename);
...
const CTagDefinition* CAnimationDatabaseUpr::FindTagDef(const uint32 crcFilename) const
{
	return stl::find_in_map(m_tagDefs, crcFilename, NULL);
}

const CTagDefinition* CAnimationDatabaseUpr::FindTagDef(const char* filename) const
{
	char normalizedFilename[DEF_PATH_LENGTH];
	NormalizeFilename(normalizedFilename, filename);
...
void CAnimationDatabaseUpr::RevertSubADB(const char* szFilename, CAnimationDatabase* animDB, const CAnimationDatabase::SSubADB& subADB)
{
...
void CAnimationDatabaseUpr::RevertDatabase(const char* szFilename)
{
...
void CAnimationDatabaseUpr::RevertControllerDef(const char* szFilename)
{
...
void CAnimationDatabaseUpr::RevertTagDef(const char* szFilename)
{
...
void CAnimationDatabaseUpr::GetAffectedFragmentsString(const CTagDefinition* pQueryTagDef, TagID tagID, char* buffer, int bufferSize)
{
	string filename;
	string temp;
...
void CAnimationDatabaseUpr::RenameTag(const CTagDefinition* pOriginal, int32 tagCRC, const char* newName)
{
	STagDefinitionImportsInfo& originalImports = mannequin::GetDefaultImportsInfo(pOriginal->GetFilename());
...
void CAnimationDatabaseUpr::RenameTagGroup(const CTagDefinition* pOriginal, int32 tagGroupCRC, const char* newName)
{
	STagDefinitionImportsInfo& originalImports = mannequin::GetDefaultImportsInfo(pOriginal->GetFilename());
...
void CAnimationDatabaseUpr::Save(const IAnimationDatabase& iAnimDB, const char* databaseName) const
{
...
bool CAnimationDatabaseUpr::FragmentMatches(uint32 fragCRC, const TagState& tagState, const CAnimationDatabase::SSubADB& subAnimDB, bool& bTagMatchFound) const
{
...
bool CAnimationDatabaseUpr::TransitionMatches(uint32 fragCRCFrom, uint32 fragCRCTo, const TagState& tagStateFrom, const TagState& tagStateTo, const CTagDefinition& parentTagDefs, const CAnimationDatabase::SSubADB& subAnimDB, bool& bTagMatchFound) const
{
...
EModifyFragmentIdResult CAnimationDatabaseUpr::CreateFragmentID(const CTagDefinition& inFragmentIds, const char* szFragmentIdName)
{
...
EModifyFragmentIdResult CAnimationDatabaseUpr::RenameFragmentID(const CTagDefinition& fragmentIds, FragmentID fragmentID, const char* szFragmentIdName)
{
...
bool CAnimationDatabaseUpr::DeleteFragmentEntry(IAnimationDatabase* pDatabaseInterface, FragmentID fragmentID, const SFragTagState& tagState, uint32 optionIdx, bool logWarning)
{
...
uint32 CAnimationDatabaseUpr::AddFragmentEntry(IAnimationDatabase* pDatabaseInterface, FragmentID fragmentID, const SFragTagState& tagState, const CFragment& fragment)
{
	assert(pDatabaseInterface);
	CAnimationDatabase* pDatabase = static_cast<CAnimationDatabase*>(pDatabaseInterface);
...
void CAnimationDatabaseUpr::SetFragmentEntry(IAnimationDatabase* pDatabaseInterface, FragmentID fragmentID, const SFragTagState& tagState, uint32 optionIdx, const CFragment& fragment)
{
	assert(pDatabaseInterface);
	CAnimationDatabase* pDatabase = static_cast<CAnimationDatabase*>(pDatabaseInterface);
...
bool CAnimationDatabaseUpr::IsFileUsedByControllerDef(const SControllerDef& controllerDef, const char* szFilename) const
{
	char normalizedFilename[DEF_PATH_LENGTH];
...
void CAnimationDatabaseUpr::AddSubADBFragmentFilter(IAnimationDatabase* pDatabaseInterface, const char* szSubADBFilename, FragmentID fragmentID)
{
...
void CAnimationDatabaseUpr::RemoveSubADBFragmentFilter(IAnimationDatabase* pDatabaseInterface, const char* szSubADBFilename, FragmentID fragmentID)
{
	DRX_ASSERT(szSubADBFilename);
	DRX_ASSERT(pDatabaseInterface);
...
uint32 CAnimationDatabaseUpr::GetSubADBFragmentFilterCount(const IAnimationDatabase* pDatabaseInterface, const char* szSubADBFilename) const
{
	DRX_ASSERT(pDatabaseInterface);
	DRX_ASSERT(szSubADBFilename);
...
FragmentID CAnimationDatabaseUpr::GetSubADBFragmentFilter(const IAnimationDatabase* pDatabaseInterface, const char* szSubADBFilename, uint32 index) const
{
	DRX_ASSERT(pDatabaseInterface);
	DRX_ASSERT(szSubADBFilename);
...
void CAnimationDatabaseUpr::SetSubADBTagFilter(IAnimationDatabase* pDatabaseInterface, const char* szSubADBFilename, TagState tagState)
{
	DRX_ASSERT(szSubADBFilename);
	DRX_ASSERT(pDatabaseInterface);
...
TagState CAnimationDatabaseUpr::GetSubADBTagFilter(const IAnimationDatabase* pDatabaseInterface, const char* szSubADBFilename) const
{
	DRX_ASSERT(pDatabaseInterface);
	DRX_ASSERT(szSubADBFilename);
