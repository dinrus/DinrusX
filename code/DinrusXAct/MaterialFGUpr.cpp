...
#include <DinrusX/DinrusXAct/MaterialFGUpr.h>
...
//------------------------------------------------------------------------
bool CMaterialFGUpr::LoadLibs(const char* path)
{
...
//===========================================================
// CMaterialFGUpr::SetFGCustomParameter(const SMFXFlowGraphParams& fgParams, const char* customParameter, const SMFXCustomParamValue& customParameterValue)
...
//------------------------------------------------------------------------
void CMaterialFGUpr::SetFGCustomParameter(const SMFXFlowGraphParams& fgParams, const char* customParameter, const SMFXCustomParamValue& customParameterValue)
{
	SFlowGraphData* pFGData = FindFG(fgParams.fgName);
	if (pFGData == 0)
	{
...
IFlowGraphPtr CMaterialFGUpr::GetFlowGraph(int index, string* pFileName /*= NULL*/) const
{
