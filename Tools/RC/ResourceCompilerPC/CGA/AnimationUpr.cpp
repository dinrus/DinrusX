...
bool CAnimationUpr::CanBeSkipped()
{
	return m_arrGlobalAIM.empty();
}

bool CAnimationUpr::SaveAIMImage(const char* name, FILETIME timeStamp, bool bigEndianOutput)
{
...
//---------------------------------------------------------------
//---------------------------------------------------------------
bool CAnimationUpr::SaveCAFImage(const char* name, FILETIME timeStamp, bool bigEndianOutput)
{
...
bool CAnimationUpr::AddAIMHeaderOnly(const GlobalAnimationHeaderAIM& header)
{
	if (header.m_FilePathCRC32 == 0)
	{
		RCLogError("AnimationUpr: Adding GlobalAnimationHeaderAIM with m_FilePathCRC32 == 0.");
		return false;
	}
...
bool CAnimationUpr::AddCAFHeaderOnly(const GlobalAnimationHeaderCAF& header)
{
	...
	{
		RCLogError("AnimationUpr: Adding GlobalAnimationHeaderCAF with null m_FilePathCRC32.");
		return false;
	}
...
bool CAnimationUpr::HasAIMHeader(const GlobalAnimationHeaderAIM& gah) const
{
	return HasAIM(gah.m_FilePathCRC32);
}

bool CAnimationUpr::HasAIM(uint32 pathCRC) const
{
...
bool CAnimationUpr::HasCAFHeader(const GlobalAnimationHeaderCAF& gah) const
{
	return HasCAF(gah.m_FilePathCRC32);
}

bool CAnimationUpr::HasCAF(uint32 pathCRC) const
{
