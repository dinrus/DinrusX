...
//////////////////////////////////////////////////////////////////////////
SkeletonUpr::SkeletonUpr(IPakSystem* pPakSystem, IDrxXML* pXmlParser, IResourceCompiler* pRc)
...
//////////////////////////////////////////////////////////////////////////
bool SkeletonUpr::LoadSkeletonList(const string& filename, const string& rootPath, const std::set<string>& usedSkeletons)
{
	m_rootPath = rootPath;
...
//////////////////////////////////////////////////////////////////////////
const CSkeletonInfo* SkeletonUpr::LoadSkeletonInfo(const string& name, const string& file)
{
...
//////////////////////////////////////////////////////////////////////////
const CSkeletonInfo* SkeletonUpr::FindSkeleton(const string& name) const
{
	if (name.empty())
	{
		return 0;
...
//////////////////////////////////////////////////////////////////////////
const CSkeletonInfo* SkeletonUpr::LoadSkeleton(const string& name)
{
