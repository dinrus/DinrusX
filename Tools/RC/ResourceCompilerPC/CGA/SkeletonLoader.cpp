...
//////////////////////////////////////////////////////////////////////////
static XmlNodeRef LoadXml( const char *filename, IDrxXML* pXMLParser )
{
...
//////////////////////////////////////////////////////////////////////////
static uint32 LoadIKSetup( const char* pNameXML, CSkinningInfo* pModelSkeleton, IDrxXML* pXMLParser )
{
...
//////////////////////////////////////////////////////////////////////////
CSkeletonInfo* SkeletonLoader::Load(const char* filename, IPakSystem* pakSystem, IDrxXML* xml, const string& tempPath)
{
