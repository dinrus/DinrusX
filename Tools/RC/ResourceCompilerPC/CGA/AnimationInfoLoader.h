...
struct SAnimationDefinition 
{
	...
	static bool GetDescFromAnimationSettingsFile(SAnimationDesc* pDesc, bool* errorReported, bool* usesNameContains, IPakSystem* pPakSystem, IDrxXML* pXmlParser, const string& animationFilename, const std::vector<string>& jointNames);
