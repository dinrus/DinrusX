...
T AlignToPlatform(T nSize, size_t nAlign = DRX_PLATFORM_ALIGNMENT)
{
...
#if DRX_PLATFORM_SSE2 && !defined(_DEBUG)
		DrxStackAllocWithSize(Float4Storage, m_Res, AlignToPlatform);
		DrxStackAllocWithSize(Float4Storage, max, AlignToPlatform);
		DrxStackAllocWithSize(Float4Storage, range, AlignToPlatform);
