...
bool SAnimationDefinition::GetDescFromAnimationSettingsFile(SAnimationDesc* desc, bool* errorReported, bool* usesNameContains, IPakSystem* pPakSystem, IDrxXML* pXmlParser, const string& animationFilename, const std::vector<string>& jointNames)
{
