...
public:
	...
	CAnimationConverter(IDrxXML* pXMLParser, IPakSystem* pPakSystem, IResourceCompiler* pRC);
	...
	IDrxXML* GetXMLParser() { return m_pXMLParser; }
	IPakSystem* GetPakSystem() { return m_pPakSystem; }

	bool InLocalUpdateMode() const;

	std::auto_ptr<SkeletonUpr> m_skeletonUpr;
...
private:
	...
	void InitSkeletonUpr(const std::set<string>& usedSkeletons);
