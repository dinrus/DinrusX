...
#define DRXEXPORTNODE_LOWERCASE "drxexportnode_"
#define DRXEXPORTNODE_LENGTH 14
#define DRXPHYSBONESUFFIX "phys"
#define DRXPHYSBONESUFFIX_LENGTH 4
#define DRXPHYSPARENTFRAMESUFFIX "phys parentframe"
#define DRXPHYSPARENTFRAMESUFFIX_LENGTH 16
...
{
public:
	explicit ColladaScene(DrxExportNodeParams& a_nodeParams)
...
public:
	...
	NodeStackEntry(const NodeStackEntry& other)
		...
		, drxExportNode(other.drxExportNode)
	{
	}
...
{
public:
	bool Load(std::vector<ExportFile>& exportFiles, std::vector<sMaterialLibrary>& materialLibraryList, const char* szFileName, IDrxXML* pDrxXML, IPakSystem* pPakSystem, IColladaLoaderListener* pListener);

private:
	XmlNodeRef LoadXML(const char* szFileName, IPakSystem* pPakSystem, IDrxXML* pDrxXML, IColladaLoaderListener* pListener);
