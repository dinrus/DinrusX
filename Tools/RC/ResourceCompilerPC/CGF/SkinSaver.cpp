...
int CSkinSaver::SaveBoneInitialMatrices(CSaverCGF& cgfSaver, const DynArray<DrxBoneDescData>& bonesDesc, const bool bSwapEndian, const float unitSizeInCentimeters)
{
	using namespace Private_SkinSaver;
...
int CSkinSaver::SaveBoneNames(CSaverCGF& cgfSaver, const DynArray<DrxBoneDescData>& bonesDesc, const bool bSwapEndian)
{
	using namespace Private_SkinSaver;
