...
static struct ParameterMatrix
{
	...
	int flagsUniform;
	int flagsPerceptual;
	int flagsQuality[DrxTextureSquisher::EQualityProfile::eQualityProfile_Num];
 ...
 */
void DrxTextureSquisher::Compress(const DrxTextureSquisher::CompressorParameters& compress)
{
...
void DrxTextureSquisher::Decompress(const DecompressorParameters& decompress)
{
