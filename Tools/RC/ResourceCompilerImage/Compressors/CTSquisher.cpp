...
#include "DrxTextureSquisher/DrxTextureSquisher.h"

///////////////////////////////////////////////////////////////////////////////////

// callbacks for the DrxTextureSquisher

namespace 
{

struct DrxSquisherCallbackUserData
{
...
void DrxSquisherOutputCallback(const DrxTextureSquisher::CompressorParameters& compress, const void* data, uint size, uint oy, uint ox)
{
	DrxSquisherCallbackUserData* const pUserData = static_cast<DrxSquisherCallbackUserData*>(compress.userPtr);
...
void DrxSquisherInputCallback(const DrxTextureSquisher::DecompressorParameters& decompress, void* data, uint size, uint oy, uint ox)
{
	DrxSquisherCallbackUserData* const pUserData = static_cast<DrxSquisherCallbackUserData*>(decompress.userPtr);
...
{
	{
		...
		if (bEncode)
		{
			...
			for(uint32 dwMip = 0; dwMip < mipCount; ++dwMip)
			{
				...
				{
					DrxSquisherCallbackUserData userData;
					userData.m_pImageObject = pRet.get();
					userData.m_dstOffset = 0;
					userData.m_dstMem = pDstMem;

					DrxTextureSquisher::CompressorParameters compress;
					...
					compress.srcType = (CPixelFormats::IsFormatFloatingPoint(fmtSrc, true) ? DrxTextureSquisher::eBufferType_ufloat : DrxTextureSquisher::eBufferType_uint8);
					if (CPixelFormats::IsFormatSigned(fmtDst))
					{
						compress.srcType = (compress.srcType == DrxTextureSquisher::eBufferType_ufloat ? DrxTextureSquisher::eBufferType_sfloat : DrxTextureSquisher::eBufferType_sint8);
					}
					...
					compress.quality = 
						(quality == eQuality_Preview ? DrxTextureSquisher::eQualityProfile_Low : 
						(quality == eQuality_Fast    ? DrxTextureSquisher::eQualityProfile_Low : 
						(quality == eQuality_Slow    ? DrxTextureSquisher::eQualityProfile_High : 
						                               DrxTextureSquisher::eQualityProfile_Medium)));

					compress.userPtr = &userData;
					compress.userOutputFunction = DrxSquisherOutputCallback;

					switch (fmtDst)
					{
					case ePixelFormat_DXT1: 
					case ePixelFormat_BC1:
						compress.preset = DrxTextureSquisher::eCompressorPreset_BC1U;
						break;
					case ePixelFormat_DXT1a: 
					case ePixelFormat_BC1a: 
						compress.preset = DrxTextureSquisher::eCompressorPreset_BC1Ua;
						break;
					case ePixelFormat_DXT3: 
					case ePixelFormat_BC2: 
						compress.preset = DrxTextureSquisher::eCompressorPreset_BC2U;
						break;
					case ePixelFormat_DXT3t: 
					case ePixelFormat_BC2t: 
						compress.preset = DrxTextureSquisher::eCompressorPreset_BC2Ut;
						break;
					case ePixelFormat_DXT5: 
					case ePixelFormat_BC3: 
						compress.preset = DrxTextureSquisher::eCompressorPreset_BC3U;
						break;
					case ePixelFormat_DXT5t: 
					case ePixelFormat_BC3t: 
						compress.preset = DrxTextureSquisher::eCompressorPreset_BC3Ut;
						break;
					case ePixelFormat_3DCp: 
					case ePixelFormat_BC4:
						compress.preset = (CPixelFormats::IsFormatSingleChannel(fmtSrc)
							? DrxTextureSquisher::eCompressorPreset_BC4Ua    // a-channel
							: DrxTextureSquisher::eCompressorPreset_BC4U);   // r-channel
						break;
					case ePixelFormat_BC4s:
						compress.preset = (CPixelFormats::IsFormatSingleChannel(fmtSrc)
							? DrxTextureSquisher::eCompressorPreset_BC4Sa    // a-channel
							: DrxTextureSquisher::eCompressorPreset_BC4S);   // r-channel
						break;
					case ePixelFormat_3DC: 
					case ePixelFormat_BC5:
						compress.preset = DrxTextureSquisher::eCompressorPreset_BC5Un;
						break;
					case ePixelFormat_BC5s:
						compress.preset = DrxTextureSquisher::eCompressorPreset_BC5Sn;
						break;
					case ePixelFormat_BC6UH:
						compress.preset = DrxTextureSquisher::eCompressorPreset_BC6UH;
						break;
					case ePixelFormat_BC7: 
						compress.preset = DrxTextureSquisher::eCompressorPreset_BC7U;
						break;
					case ePixelFormat_BC7t: 
						compress.preset = DrxTextureSquisher::eCompressorPreset_BC7Ut;
						break;
					default:
					...
					DrxTextureSquisher::Compress(compress); 
		...
		else
		{
			...
			for (uint32 dwMip = 0; dwMip < mipCount; ++dwMip)
			{
...

				{
					...
					DrxTextureSquisher::DecompressorParameters decompress;
					...
					decompress.dstType = (CPixelFormats::IsFormatFloatingPoint(fmtDst, true) ? DrxTextureSquisher::eBufferType_ufloat : DrxTextureSquisher::eBufferType_uint8);
					if (CPixelFormats::IsFormatSigned(fmtSrc))
					{
						decompress.dstType = (decompress.dstType == DrxTextureSquisher::eBufferType_ufloat ? DrxTextureSquisher::eBufferType_sfloat : DrxTextureSquisher::eBufferType_sint8);
					}

					decompress.userPtr = &userData;
					decompress.userInputFunction = DrxSquisherInputCallback;

					switch (fmtSrc)
					{
					case ePixelFormat_DXT1: 
					case ePixelFormat_BC1:
						decompress.preset = DrxTextureSquisher::eCompressorPreset_BC1U;
						break;
					case ePixelFormat_DXT1a: 
					case ePixelFormat_BC1a: 
						decompress.preset = DrxTextureSquisher::eCompressorPreset_BC1Ua;
						break;
					case ePixelFormat_DXT3: 
					case ePixelFormat_BC2: 
						decompress.preset = DrxTextureSquisher::eCompressorPreset_BC2U;
						break;
					case ePixelFormat_DXT3t: 
					case ePixelFormat_BC2t: 
						decompress.preset = DrxTextureSquisher::eCompressorPreset_BC2Ut;
						break;
					case ePixelFormat_DXT5: 
					case ePixelFormat_BC3: 
						decompress.preset = DrxTextureSquisher::eCompressorPreset_BC3U;
						break;
					case ePixelFormat_DXT5t: 
					case ePixelFormat_BC3t: 
						decompress.preset = DrxTextureSquisher::eCompressorPreset_BC3Ut;
						break;
					case ePixelFormat_3DCp: 
					case ePixelFormat_BC4:
					...
					case ePixelFormat_3DC: 
					case ePixelFormat_BC5: 
						decompress.preset = DrxTextureSquisher::eCompressorPreset_BC5Un;
						break;
					case ePixelFormat_BC5s: 
						decompress.preset = DrxTextureSquisher::eCompressorPreset_BC5Sn;
						break;
					case ePixelFormat_BC6UH:
						decompress.preset = DrxTextureSquisher::eCompressorPreset_BC6UH;
						break;
					case ePixelFormat_BC7: 
						decompress.preset = DrxTextureSquisher::eCompressorPreset_BC7U;
						break;
					case ePixelFormat_BC7t: 
						decompress.preset = DrxTextureSquisher::eCompressorPreset_BC7Ut;
						break;
					default:
					...
					DrxTextureSquisher::Decompress(decompress); 
