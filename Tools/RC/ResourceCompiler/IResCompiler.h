...
//  Описание: IResourceCompiler interface.
// -------------------------------------------------------------------------
//  History:
//
////////////////////////////////////////////////////////////////////////////
...
struct IResourceCompiler
{
	...
	// returns pointer to IAssetUpr interface. There is only one instance. Callers should not delete it.
	virtual IAssetUpr* GetAssetUpr() const = 0;
};
