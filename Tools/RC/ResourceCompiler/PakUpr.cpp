...
//////////////////////////////////////////////////////////////////////////
PakUpr::PakUpr(IProgress* pProgress)
...
void PakUpr::RegisterKeys(IResourceCompiler* pRC)
{
...
//////////////////////////////////////////////////////////////////////////
IPakSystem* PakUpr::GetPakSystem()
{
	return &m_pPakSystem;
}

//////////////////////////////////////////////////////////////////////////
void PakUpr::SetMaxThreads(int maxThreads)
{
	m_maxThreads = maxThreads;
}

//////////////////////////////////////////////////////////////////////////
int PakUpr::GetMaxThreads() const
{
	return m_maxThreads;
}

//////////////////////////////////////////////////////////////////////////
bool PakUpr::HasPakFiles() const
{
	return m_zipFiles.size() > 0;
}

//////////////////////////////////////////////////////////////////////////
PakUpr::ECallResult PakUpr::CompileFilesIntoPaks(
...
//////////////////////////////////////////////////////////////////////////
PakUpr::ECallResult PakUpr::SplitListFileToPaks(
  const IConfig* config,
...
//////////////////////////////////////////////////////////////////////////
PakUpr::ECallResult PakUpr::DeleteFilesFromPaks(
  const IConfig* config,
...
PakUpr::ECallResult PakUpr::SynchronizePaks(
  const IConfig* config,
  const std::vector<string>& filesToDelete)
{
...
//////////////////////////////////////////////////////////////////////////
PakUpr::ECallResult PakUpr::CreatePakFile(
  const IConfig* config,
		...
		do
		{
			...
			// submit files for packing
			{
				...
				if (bSplitOnSizeOverflow)
				{
					...
					drx_sprintf(cPart, "-part%" PRISIZE_T ".$pak", currentPakPart + 0);
					drx_sprintf(nPart, "-part%" PRISIZE_T ".$pak", currentPakPart + 1);
			...
			else if (bSplitOnSizeOverflow && bMultiPartPak)
			{
				...
				for (;; )
				{
					...
					drx_sprintf(cPart, "-part%d.$pak", trailingPakPart + 0);
					drx_sprintf(nPart, "-part%d.$pak", trailingPakPart + 1);
					...
					if (fileSize <= nMinZipSize)
					{
						...
						for (int q = trailingPakPart;; q++)
						{
							...
							drx_sprintf(cPart, "-part%d.$pak", q + 0);
							drx_sprintf(nPart, "-part%d.$pak", q + 1);
