 ...
 *  DRX_RENDERER_DIRECT3D + DRX_RENDERER_OPENGL  -> DirectX-API + Opengl implementation
 *
...
enum EVerifyType
{
	...
	#include <fvec.h>
	#include <DinrusX/CoreX/Assert/DrxAssert.h> // to restore assert macro which was changed by <fvec.h>
	#define CONST_INT32_PS(N, V3, V2, V1, V0)                                   \
	  const _MM_ALIGN16 int ## N[] = { V0, V1, V2, V3 };   /*little endian!*/ \
...
//////////////////////////////////////////////////////////////////////////
	...
	#include <DinrusX/DinrusXRend/D3DRender/DXGL/DrxDXGL.hpp>
	#if DRX_PLATFORM_WINDOWS
	...
	#include <DinrusX/DinrusXRend/D3DRender/DX12/d3dx12.h>
...
// Direct3D numbers: 0xa|0?? (four hexadecimal digits)
	...
	#define DRX_RENDERER_DIRECT3D_FL (D3D_FEATURE_LEVEL)0
		...
		#include <Unknwn.h>
	#else
		#include <DinrusX/DinrusXRend/D3DRender/DX12/Unknwn_empty.h>
	#endif

	#if (DRX_RENDERER_DIRECT3D >= 120)
		#include <DinrusX/DinrusXRend/D3DRender/DX12/DrxDX12Guid.hpp>
	#elif (DRX_RENDERER_VULKAN >= 10)
		#include <DinrusX/DinrusXRend/D3DRender/Vulkan/CDrxVKGuid.hpp>
		#include <DinrusX/DinrusXRend/D3DRender/Vulkan/CDrxVKMisc.hpp>
	...
	#if !DRX_PLATFORM_DURANGO
		#include <DinrusX/DinrusXRend/D3DRender/DX12/d3d11_structs.h>
	#endif
	#include <DinrusX/DinrusXRend/D3DRender/DX12/d3d11_empty.h>
#endif
...
#define         D3DInputLayout            ID3D11InputLayout
	...
	#include <DinrusX/DinrusXRend/D3DRender/Vulkan/DrxVulkan.hpp>
	typedef uintptr_t SOCKET;
...
#include <d3d11.h>
	...
	#include <DinrusX/DinrusXRend/D3DRender/DX11/DrxDX11.hpp>
#endif
...
//////////////////////////////////////////////////////////////////////////
	...
	#include <DinrusX/DinrusXRend/D3DRender/DeviceUpr/DeviceWrapper_D3D11.h>
	#include <DinrusX/DinrusXRend/D3DRender/DeviceUpr/DeviceWrapper_D3D11_MemReplay.h>
#else
...
#include <DinrusX/DinrusXRend/DrxNameR.h>
...
//#include <DinrusX/DinrusXRend/_Malloc.h>
//#include <DinrusX/DinrusXRend/math.h>
#include <DinrusX/CoreX/StlUtils.h>
#include <DinrusX/DinrusXRend/DevBuffer.h>
#include <DinrusX/DinrusXRend/D3DRender/DeviceUpr/DeviceResources.h>
#include <DinrusX/DinrusXRend/D3DRender/DeviceUpr/D3D11/DeviceSubmissionQueue_D3D11.h>
#include <DinrusX/DinrusXRend/D3DRender/DeviceUpr/DeviceObjects.h>

#include <DinrusX/CoreX/Renderer/VertexFormats.h>

#include <DinrusX/DinrusXRend/CommonRender.h>
#include <DinrusX/CoreX/Renderer/IRenderAuxGeom.h>
#include <DinrusX/DinrusXRend/Shaders/ShaderComponents.h>
#include <DinrusX/DinrusXRend/Shaders/Shader.h>
//#include <DinrusX/DinrusXRend/XFile/File.h>
//#include <DinrusX/DinrusXRend/Image.h>
#include <DinrusX/DinrusXRend/Shaders/CShader.h>
#include <DinrusX/DinrusXRend/RenderMesh.h>
#include <DinrusX/DinrusXRend/RenderPipeline.h>
#include <DinrusX/DinrusXRend/RenderThread.h>
#include <DinrusX/DinrusXRend/Renderer.h>
#include <DinrusX/DinrusXRend/Textures/Texture.h>
#include <DinrusX/DinrusXRend/Shaders/Parser.h>
#include <DinrusX/DinrusXRend/RenderFrameProfiler.h>
#include <DinrusX/DinrusXRend/Shadow_Renderer.h>
#include <DinrusX/DinrusXRend/DeferredRenderUtils.h>
#include <DinrusX/DinrusXRend/ShadowUtils.h>
#include <DinrusX/DinrusXRend/WaterUtils.h>

#include <DinrusX/DinrusXRend/OcclQuery.h>

// All handled render elements (except common ones included in "RendElement.h>)
#include <DinrusX/DinrusXRend/RendElements/CRELensOptics.h>
#include <DinrusX/DinrusXRend/RendElements/CREMeshImpl.h>

#include <DinrusX/DinrusXRend/PostProcess/PostProcess.h>

#include <DinrusX/DinrusXRend/D3DRender/GraphicsPipeline/StandardGraphicsPipeline.h>
...
#include <DinrusX/DinrusXRend/Defs.h>

#include <DinrusX/DinrusXRend/D3DRender/DeviceUpr/DeviceCommandList.inl"
#include <DinrusX/DinrusXRend/D3DRender/DeviceUpr/D3D11/DeviceSubmissionQueue_D3D11.h>
