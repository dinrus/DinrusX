...
#include <set>
#include <atomic>
#include <DinrusX/DinrusXRend/D3DRender/DeviceUpr/DeviceFormats.h> // SPixFormat
#include <DinrusX/DinrusXRend/ResFile.h>
#include <DinrusX/DinrusXRend/CommonRender.h> // CBaseResource, SResourceView, SSamplerState
#include <DinrusX/DinrusXRend/Shaders/ShaderResources.h> // EHWShaderClass
#include <DinrusX/DinrusXRend/Shaders/CShader.h> // MAX_ENVTEXTURES

#include <DinrusX/DinrusXRend/PowerOf2BlockPacker.h>
#include <DinrusX/CoreX/Memory/STLPoolAllocator.h>

#include <DinrusX/DinrusXRend/ITextureStreamer.h>

#include <DinrusX/DinrusXRend/TextureArrayAlloc.h>
#include <DinrusX/DinrusXRend/Image/DDSImage.h>
...
#include <DinrusX/DinrusXRend/RendererCVars.h>
...
struct STexStreamingInfo
{
	...
	void GetMemoryUsage(IDrxSizer* pSizer, int nMips, int nSides) const
	{
		pSizer->AddObject(this, sizeof(*this));
...
private:
	...
	static CDrxNameTSCRC GenName(const char* name, uint32 nFlags = 0);
