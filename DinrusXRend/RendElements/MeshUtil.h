...
public:
	...
	static void GenScreenTile(float x0, float y0, float x1, float y1, ColorF clr, int rowCount, int columnCount, stl::aligned_vector<SVF_P3F_C4B_T2F, DRX_PLATFORM_ALIGNMENT>& vertOut, stl::aligned_vector<uint16, DRX_PLATFORM_ALIGNMENT>& idxOut);
};
