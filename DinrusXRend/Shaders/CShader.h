...
#include <map>
#include <DinrusX/DinrusXRend/CShaderBin.h>
#include <DinrusX/DinrusXRend/ShaderSerialize.h>
#include <DinrusX/DinrusXRend/ShaderCache.h>
#include <DinrusX/DinrusXRend/ShaderComponents.h> // ECGParam
...
public:
	...
	void              mfParseFX_Annotations_Script(char* buf, CShader* ef, std::vector<SFXStruct>& Structs, bool* bPublic, CDrxNameR techStart[2]);
	void              mfParseFX_Annotations(char* buf, CShader* ef, std::vector<SFXStruct>& Structs, bool* bPublic, CDrxNameR techStart[2]);
	...
	bool              mfParseDummyFX_Global(std::vector<SFXStruct>& Structs, char* annot, CDrxNameR techStart[2]);
	...
	void              mfGatherFilesList(const char* szPath, std::vector<CDrxNameR>& Names, int nLevel, bool bUseFilter, bool bMaterial = false);
