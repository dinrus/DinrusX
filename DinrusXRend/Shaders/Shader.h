...
#include <DinrusX/DinrusXRend/CommonRender.h> // CBaseResource
...
struct SFXParam
{
	...
	void   GetParamComp(uint32 nOffset, DrxFixedStringT<128>& param);
	uint32 GetParamFlags() { return m_nFlags; }
	void   GetCompName(uint32 nId, DrxFixedStringT<128>& name);
