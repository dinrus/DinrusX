...
#include <DinrusX/DinrusXRend/D3DRender/GraphicsPipeline/RenderPassBase.h>
...
public:
	...
	void SetConstantArray(const CDrxNameR& paramName, const Vec4 params[], uint32 numParams);
...
inline void CComputeRenderPass::SetConstantArray(const CDrxNameR& paramName, const Vec4 params[], uint32 numParams)
{
	DRX_ASSERT(m_bPendingConstantUpdate);
