...
#include <DinrusX/DinrusXRend/GraphicsPipeline.h>
...
public:
	...
	uint32 IncrementNumInvalidDrawcalls(int count) { return DrxInterlockedAdd((volatile int*)&m_numInvalidDrawcalls, count); }
