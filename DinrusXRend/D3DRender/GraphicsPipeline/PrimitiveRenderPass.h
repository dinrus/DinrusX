...
#include <DinrusX/DinrusXRend/D3DRender/DeviceUpr/DeviceObjects.h> // SDeviceObjectHelpers
#include <DinrusX/DinrusXRend/DevBuffer.h> // buffer_handle_t, CConstantBuffer, CGpuBuffer
