...
// -------------------------------------------------------------------------
//  File name:   CDrxDXGLDeviceContext.hpp
//  Version:     v1.00
...
protected:
	...
	void SetShader(uint32 uStage, CDrxDXGLShader* pShader, ID3D11ClassInstance* const* ppClassInstances, UINT NumClassInstances);
	...
	void GetShader(uint32 uStage, CDrxDXGLShader** pShader, ID3D11ClassInstance** ppClassInstances, UINT* NumClassInstances);
