...
#define CUSTOM_SCOPED_PROFILE(_Name)
	...
	#include <DinrusX/DinrusXRend/GLDrxPlatform.hpp>
#elif DRX_PLATFORM_WINDOWS
	#include <DinrusX/DinrusXRend/Standalone/GLWinPlatform.hpp>
#elif DRX_PLATFORM_LINUX || DRX_PLATFORM_ANDROID
	#include <DinrusX/DinrusXRend/Standalone/GLLinuxPlatform.hpp>
#else
