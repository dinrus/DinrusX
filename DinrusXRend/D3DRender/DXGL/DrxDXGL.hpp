...
#include <DinrusX/DinrusXRend/D3DRender/DXGL/Definitions/DrxDXGLMisc.hpp>

#if DXGL_FULL_EMULATION
	#include <DinrusX/DinrusXRend/D3DRender/DXGL/Definitions/DXGL_IDXGISwapChain.h>
	#include <DinrusX/DinrusXRend/D3DRender/DXGL/Definitions/DXGL_IDXGIFactory1.h>
#endif

#if !DXGL_FULL_EMULATION
	#include <DinrusX/DinrusXRend/Interfaces/CDrxDXGLBlob.hpp>
	#include <DinrusX/DinrusXRend/Interfaces/CDrxDXGLSwapChain.hpp>
	#include <DinrusX/DinrusXRend/Interfaces/CDrxDXGLQuery.hpp>
	#include <DinrusX/DinrusXRend/Interfaces/CDrxDXGLSwitchToRef.hpp>

	#include <DinrusX/DinrusXRend/Interfaces/CDrxDXGLBuffer.hpp>
	#include <DinrusX/DinrusXRend/Interfaces/CDrxDXGLDepthStencilView.hpp>
	#include <DinrusX/DinrusXRend/Interfaces/CDrxDXGLInputLayout.hpp>
	#include <DinrusX/DinrusXRend/Interfaces/CDrxDXGLRenderTargetView.hpp>
	#include <DinrusX/DinrusXRend/Interfaces/CDrxDXGLShader.hpp>
	#include <DinrusX/DinrusXRend/Interfaces/CDrxDXGLShaderReflection.hpp>
	#include <DinrusX/DinrusXRend/Interfaces/CDrxDXGLDepthStencilView.hpp>
	#include <DinrusX/DinrusXRend/Interfaces/CDrxDXGLShaderResourceView.hpp>
	#include <DinrusX/DinrusXRend/Interfaces/CDrxDXGLUnorderedAccessView.hpp>
	#include <DinrusX/DinrusXRend/Interfaces/CDrxDXGLView.hpp>
	#include <DinrusX/DinrusXRend/Interfaces/CDrxDXGLBlendState.hpp>
	#include <DinrusX/DinrusXRend/Interfaces/CDrxDXGLDepthStencilState.hpp>
	#include <DinrusX/DinrusXRend/Interfaces/CDrxDXGLRasterizerState.hpp>
	#include <DinrusX/DinrusXRend/Interfaces/CDrxDXGLSamplerState.hpp>
	#include <DinrusX/DinrusXRend/Interfaces/CDrxDXGLTexture1D.hpp>
	#include <DinrusX/DinrusXRend/Interfaces/CDrxDXGLTexture2D.hpp>
	#include <DinrusX/DinrusXRend/Interfaces/CDrxDXGLTexture3D.hpp>
	#include <DinrusX/DinrusXRend/Interfaces/CDrxDXGLGIAdapter.hpp>
	#include <DinrusX/DinrusXRend/Interfaces/CDrxDXGLGIFactory.hpp>
	#include <DinrusX/DinrusXRend/Interfaces/CDrxDXGLGIOutput.hpp>
#endif //!DXGL_FULL_EMULATION

#if DXGL_VIRTUAL_DEVICE_AND_CONTEXT || DXGL_FULL_EMULATION
	#include <DinrusX/DinrusXRend/D3DRender/DXGL/Definitions/DXGL_ID3D11Device.h>
	#include <DinrusX/DinrusXRend/D3DRender/DXGL/Definitions/DXGL_ID3D11DeviceContext.h>
#else
	#include <DinrusX/DinrusXRend/Interfaces/CDrxDXGLDevice.hpp>
	#include <DinrusX/DinrusXRend/Interfaces/CDrxDXGLDeviceContext.hpp>
#endif
