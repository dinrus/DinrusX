...
#define __GLFEATURES__
	...
	#include <DinrusX/DinrusXRend/GLInstrument.hpp>
#else
	...
	#define DXGL_EXTENSION_LOADER 1
		...
		#include <DinrusX/DinrusXRend/Specification/glad_gles2.h>
	#else
		#include <DinrusX/DinrusXRend/Specification/glad_gl.h>
	#endif
	#define DXGL_GL_EXTENSION_SUPPORTED(_Extension) (GLAD_GL_ ## _Extension == 1)
	#if DRX_PLATFORM_WINDOWS
		#include <DinrusX/DinrusXRend/Specification/glad_wgl.h>
		#define DXGL_WGL_EXTENSION_SUPPORTED(_Extension) (GLAD_WGL_ ## _Extension == 1)
	#elif DRX_PLATFORM_ANDROID
		#include <DinrusX/DinrusXRend/Specification/glad_egl.h>
	#elif DRX_PLATFORM_LINUX
		#include <DinrusX/DinrusXRend/Specification/glad_glx.h>
	#endif
#else
