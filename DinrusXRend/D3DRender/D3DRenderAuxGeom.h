...
#include <DinrusX/DinrusXRend/Renderer.h>     // CRenderer
#include <DinrusX/DinrusXRend/CommonRender.h> // gRenDev
#include <DinrusX/DinrusXRend/RenderAuxGeom.h>
#include <DinrusX/DinrusXRend/Shaders/Shader.h> // CShader
