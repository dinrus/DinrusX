...
struct SDeviceObjectHelpers
{
	...
	public:
		...
		bool SetNamedConstantArray(const CDrxNameR& paramName, const Vec4 params[], uint32 numParams, EHWShaderClass shaderClass = eHWSC_Pixel);
	...
	static EShaderStage GetShaderInstanceInfo(THwShaderInfo& result, ::CShader* pShader, const CDrxNameTSCRC& technique, uint64 rtFlags, uint32 mdFlags, uint32 mdvFlags, const UPipelineState pipelineState[eHWSC_Num], bool bAllowTesselation);
