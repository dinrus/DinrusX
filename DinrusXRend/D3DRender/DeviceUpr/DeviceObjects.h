...
#include <DinrusX/CoreX/Containers/VectorMap.h>   // VectorMap
#include <DinrusX/CoreX/Renderer/VertexFormats.h>
#include <DinrusX/CoreX/Renderer/ITexture.h>
#include <array>
#include <bitset>
#include <atomic>

#include <DinrusX/DinrusXRend/D3DRender/DeviceUpr/DeviceResources.h>                // CDeviceBuffer, CDeviceTexture, CDeviceInputStream
#include <DinrusX/DinrusXRend/CommonRender.h>            // SResourceView, SSamplerState, SInputLayout
#include <DinrusX/DinrusXRend/Shaders/ShaderCache.h>     // UPipelineState
...
#include <DinrusX/DinrusXRend/D3DRender/DeviceUpr/DeviceCommandListCommon.h>
#include <DinrusX/DinrusXRend/D3DRender/DeviceUpr/DeviceRenderPass.h>


////////////////////////////////////////////////////////////////////////////
// Device Object Factory

#include <DinrusX/DinrusXRend/DeviceObjectHelpers.h>            // CStaticDeviceObjectStorage

#if (DRX_RENDERER_DIRECT3D >= 110) && (DRX_RENDERER_DIRECT3D < 120)
	#if DRX_PLATFORM_DURANGO
		#include <DinrusX/DinrusXRend/D3D11/DeviceObjects_D3D11_Durango.h>
	#endif
#endif
...
#define SKIP_ESRAM	-1
	...
	static void                    SelectStagingLayout(const NDrxVulkan::CImageResource* pImage, uint32 subResource, SResourceMemoryMapping& result);
...
////////////////////////////////////////////////////////////////////////////
#include <DinrusX/DinrusXRend/DeviceObjects.inl"

#if (DRX_RENDERER_DIRECT3D >= 110) && (DRX_RENDERER_DIRECT3D < 120)
	#include <DinrusX/DinrusXRend/D3D11/DeviceObjects_D3D11.inl"
	#if DRX_PLATFORM_DURANGO
		#include <DinrusX/DinrusXRend/D3D11/DeviceObjects_D3D11_Durango.inl"
	#endif
#endif
#if (DRX_RENDERER_DIRECT3D >= 120)
	#include <DinrusX/DinrusXRend/D3D12/DeviceObjects_D3D12.inl"
	#if DRX_PLATFORM_DURANGO
		#include <DinrusX/DinrusXRend/D3D12/DeviceObjects_D3D12_Durango.inl"
	#endif
#endif
#if DRX_PLATFORM_ORBIS
	#include <DinrusX/DinrusXRend/GNM/DeviceObjects_GNM.inl"
#endif
#if (DRX_RENDERER_VULKAN >= 10)
	#include <DinrusX/DinrusXRend/D3DRender/Vulkan/DeviceObjects_Vulkan.inl"
#endif
