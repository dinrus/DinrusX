...
#include <DinrusX/DinrusXRend/DeviceUpr/DeviceCommandList_Vulkan.h>
#elif (DRX_RENDERER_DIRECT3D >= 120)
#include <DinrusX/DinrusXRend/DeviceUpr/DeviceCommandList_D3D12.h>
#elif (DRX_RENDERER_DIRECT3D >= 110)
#include <DinrusX/DinrusXRend/DeviceUpr/DeviceCommandList_D3D11.h>
#endif
