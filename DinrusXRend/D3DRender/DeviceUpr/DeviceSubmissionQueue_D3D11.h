...
private:
	...
	DRX_ALIGN(64) uint32 m_nPush;
	DRX_ALIGN(64) uint32 m_nPull;
...
#include <DinrusX/DinrusXRend/DeviceSubmissionQueue_D3D11.inl"

#if (DRX_RENDERER_DIRECT3D >= 110) && (DRX_RENDERER_DIRECT3D < 120) && DRX_PLATFORM_DURANGO
	#include <DinrusX/DinrusXRend/DeviceSubmissionQueue_D3D11_Durango.inl"
#endif
