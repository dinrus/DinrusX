...
public:
	...
	bool         mfAddCacheItem(SDiskShaderCache* pCache, SShaderCacheHeaderItem* pItem, const byte* pData, int nLen, bool bFlush, CDrxNameTSCRC Name);
	...
	bool          AddResourceLayoutToScriptHeader(SHWSInstance* pInst, const char* szProfile, const char* pFunCDrxName, TArray<char>& Scr);
