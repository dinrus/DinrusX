...
struct phys_geometry_refcnt : phys_geometry {
	...
	int AddRef() { return DrxInterlockedIncrement((volatile int*)&nRefCount); }
	int Release();
};
...
public:
	...
	virtual int AddRef() { return DrxInterlockedIncrement(&m_nRefCount); }
	virtual int Release() { return DrxInterlockedDecrement(&m_nRefCount); }
