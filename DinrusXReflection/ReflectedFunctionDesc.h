...
{
public:
	CReflectedFunctionDesc(const ITypeDesc* pReturnType, const CFunction& func, const ParamArray& params, const char* szLabel, const DrxGUID& guid);
	CReflectedFunctionDesc(const ITypeDesc* pObjectType, DrxTypeId returnTypeId, const CFunction& func, const ParamArray& params, const char* szLabel, const DrxGUID& guid);
...
inline CReflectedFunctionDesc::CReflectedFunctionDesc(const ITypeDesc* pReturnType, const CFunction& func, const ParamArray& params, const char* szLabel, const DrxGUID& guid)
	: m_function(func)
	, m_label(szLabel)
...
inline CReflectedFunctionDesc::CReflectedFunctionDesc(const ITypeDesc* pObjectType, DrxTypeId returnTypeId, const CFunction& func, const ParamArray& params, const char* szLabel, const DrxGUID& guid)
