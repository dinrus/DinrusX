...
{
public:
	CSystemTypeRegistry(const char* szLabel, const DrxTypeDesc& typeDesc, const DrxGUID& guid);
...
CSystemTypeRegistry<REGISTRY_INTERFACE_TYPE>::CSystemTypeRegistry(const char* szLabel, const DrxTypeDesc& typeDesc, const DrxGUID& guid)
	: m_label(szLabel)
	, m_typeDesc(typeDesc)
	, m_guid(guid)
{
