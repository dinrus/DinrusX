...
#include <DinrusX/DinrusX3dEng/VisibleRenderNodeUpr.h>
#include <DinrusX/DinrusX3dEng/LightVolumeUpr.h>
...
public:
	...
	// Chunk file writer.
	//////////////////////////////////////////////////////////////////////////
	virtual ChunkFile::IChunkFileWriter* CreateChunkFileWriter(EChunkFileFormat eFormat, IDrxPak* pPak, const char* filename) const;
	...
	virtual void   GetLayerMemoryUsage(uint16 nLayerId, IDrxSizer* pSizer, int* pNumBrushes, int* pNumDecals) const;
...
public:
	...
	virtual int  GetSvoCompiledData(IDrxArchive* pArchive);
#endif
	// LiveCreate
