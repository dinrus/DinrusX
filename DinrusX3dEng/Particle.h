...
//////////////////////////////////////////////////////////////////////////
class DRX_ALIGN(16) CParticleSource: public DinrusX3dEngBase, public _plain_reference_target<int>, public SParticleState, public GeomRef
{
public:
...
private:
	...
	struct SHitInfo
	{
		...
		_smart_ptr<IPhysicalEntity>
		      pEntity;                // Удар физической сущности.
		int   nSurfaceIdx;            // Индекс поверхности удара; -1, если удара не было.
