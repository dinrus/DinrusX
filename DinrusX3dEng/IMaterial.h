...
#include <DinrusX/CoreX/Renderer/IShader.h> // EEfResTextures
...
#include <DinrusX/DinrusX3dEng/DrxHeaders.h>  // MAX_SUB_MATERIALS
...
struct IMaterial
{
	...
	virtual int GetTextureMemoryUsage(IDrxSizer* pSizer, int nMatID = -1) = 0;
