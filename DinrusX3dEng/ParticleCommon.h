...
{
	TParticleGroupId() {}
	explicit TParticleGroupId(uint32 i) { id = i; DRX_PFX2_DEBUG_ASSERT(IsAligned(i, DRX_PFX2_PARTICLESGROUP_STRIDE)); }
...
inline int ThreadMode() { return DinrusX3dEngBase::GetCVars()->e_ParticlesThread; }
