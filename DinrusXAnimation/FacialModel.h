...
#include <DinrusX/DinrusXAnimation/FaceEffector.h>
...
public:
	...
	{
		DrxPrefetch((void*)&m_displaceInfo[i]);
		return (m_used[i] == 1);
	}
...
private:
	...
	void        PushMorphEffectors(int i, const MorphTargetsInfo& morphTargets, f32 fWeight, f32 fBalance, DynArray<DrxModEffMorph>& arrMorphEffectors);
