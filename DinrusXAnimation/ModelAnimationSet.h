...
public:
	...
	int  LoadFileANM(const char* szFileName, const char* szAnimName, DynArray<CControllerTCB>& m_LoadCurrAnimation, DrxCGALoader* pCGA, const IDefaultSkeleton* pIDefaultSkeleton);
