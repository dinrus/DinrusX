...
#include <DinrusX/DinrusXAnimation/Skeleton.h>
...
struct CSimulation : public SimulationParams
{
	...
	void PostUpdate(const CAttachmentUpr* pAttachmentUpr, const char* pJointName);
	void UpdateSimulation(const CAttachmentUpr* pAttachmentUpr, Skeleton::CPoseData& rPoseData, int32 nRedirectionID, const QuatT& rAttModelRelative, QuatT& raddTransformation, const char* pAttName);
	void UpdatePendulumSimulation(const CAttachmentUpr* pAttachmentUpr, Skeleton::CPoseData& rPoseData, int32 nRedirectionID, const QuatT& rAttModelRelative, QuatT& raddTransformation, const char* pAttName);
	void UpdateSpringSimulation(const CAttachmentUpr* pAttachmentUpr, Skeleton::CPoseData& rPoseData, int32 nRedirectionID, const QuatT& rAttModelRelative, Vec3& raddTranslation, const char* pAttName);
	void ProjectJointOutOfLozenge(const CAttachmentUpr* pAttachmentUpr, Skeleton::CPoseData& rPoseData, int32 nRedirectionID, const QuatT& rAttModelRelative, const char* pAttName);
