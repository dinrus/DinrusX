...
#include <DinrusX/DinrusXAnimation/ModelAnimationSet.h> //embedded
#include <DinrusX/DinrusXAnimation/ModelMesh.h>         //embedded
...
public:
	...
	virtual DrxBonePhysics* GetJointPhysInfo(uint32 jointIndex)
	{
	...
	static DynArray<SJointProperty> GetPhysInfoProperties_ROPE(const DrxBonePhysics& pi, int32 nRopeOrGrid);
...
public:
	...
	virtual uint32       GetTextureMemoryUsage2(IDrxSizer* pSizer = 0) const;
	virtual uint32       GetMeshMemoryUsage(IDrxSizer* pSizer = 0) const;
