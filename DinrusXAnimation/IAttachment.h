...
struct IAttachmentObject
{
	...
	virtual bool                PhysicalizeAttachment(IAttachmentUpr* pUpr, int idx, int nLod, IPhysicalEntity* pent, const Vec3& offset) { return false; }
	virtual bool                UpdatePhysicalizedAttachment(IAttachmentUpr* pUpr, int idx, IPhysicalEntity* pent, const QuatT& offset)   { return false; }
	...
	virtual void       OnRemoveAttachment(IAttachmentUpr* pUpr, int idx) {}
	virtual void       Release() = 0;
	// </interfuscator:shuffle>
};
