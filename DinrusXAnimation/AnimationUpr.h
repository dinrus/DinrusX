...
#include <DinrusX/DinrusXAnimation/GlobalAnimationHeaderLMG.h>
#include <DinrusX/DinrusXAnimation/GlobalAnimationHeaderCAF.h>
#include <DinrusX/DinrusXAnimation/GlobalAnimationHeaderAIM.h>
...
public:
	...
	bool LoadAnimationTCB(int nGlobalAnimId, DynArray<CControllerTCB>& m_LoadCurrAnimation, DrxCGALoader* pCGA, const IDefaultSkeleton* pIDefaultSkeleton);
