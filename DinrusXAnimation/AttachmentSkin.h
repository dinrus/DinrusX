...
public:
	...
	virtual void         TriggerMeshStreaming(uint32 nDesiredRenderLOD, const SRenderingPassInfo& passInfo) override;
...
public:
	...
	void DrawWireframeStatic(const Matrix34& m34, int nLOD, uint32 color) override;
