...
public:
	...
	bool             DBA_PreLoad(const char* filepath, ICharacterUpr::EStreamingDBAPriority priority);
	bool             DBA_LockStatus(const char* filepath, uint32 status, ICharacterUpr::EStreamingDBAPriority priority);
