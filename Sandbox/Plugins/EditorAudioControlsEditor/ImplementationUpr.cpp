...
CImplementationUpr::CImplementationUpr()
...
bool CImplementationUpr::LoadImplementation()
{
...
void CImplementationUpr::Release()
{
	if (ms_hMiddlewarePlugin)
	{
		FreeLibrary(ms_hMiddlewarePlugin);
...
ACE::IAudioSystemEditor* CImplementationUpr::GetImplementation()
{
