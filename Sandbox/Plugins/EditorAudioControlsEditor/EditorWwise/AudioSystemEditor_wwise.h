...
public:
	CImplementationSettings_wwise()
		: m_projectPath(PathUtil::GetGameFolder() + DRX_NATIVE_PATH_SEPSTR AUDIO_SYSTEM_DATA_ROOT DRX_NATIVE_PATH_SEPSTR "wwise_project") {}
	virtual const char* GetSoundBanksPath() const { return PathUtil::GetGameFolder() + DRX_NATIVE_PATH_SEPSTR AUDIO_SYSTEM_DATA_ROOT DRX_NATIVE_PATH_SEPSTR "wwise"; }
