...
public:
	CImplementationSettings_fmod()
		: m_projectPath(PathUtil::GetGameFolder() + DRX_NATIVE_PATH_SEPSTR AUDIO_SYSTEM_DATA_ROOT DRX_NATIVE_PATH_SEPSTR "fmod_project") {}
	virtual const char* GetSoundBanksPath() const { return PathUtil::GetGameFolder() + DRX_NATIVE_PATH_SEPSTR AUDIO_SYSTEM_DATA_ROOT DRX_NATIVE_PATH_SEPSTR "fmod"; }
