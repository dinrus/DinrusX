...
public:
	CImplementationSettings_sdlmixer()
		: m_projectPath(PathUtil::GetGameFolder() + DRX_NATIVE_PATH_SEPSTR AUDIO_SYSTEM_DATA_ROOT DRX_NATIVE_PATH_SEPSTR "sdlmixer") {}
	virtual const char* GetSoundBanksPath() const { return PathUtil::GetGameFolder() + DRX_NATIVE_PATH_SEPSTR AUDIO_SYSTEM_DATA_ROOT DRX_NATIVE_PATH_SEPSTR "sdlmixer"; }
