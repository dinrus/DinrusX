...
#include <DinrusX/DinrusXAI/ITacticalPointSystem.h>
#include <DinrusX/DinrusXSys/TimeValue.h>
#include <DinrusX/DinrusXSys/XMLAttrReader.h>
...
class COPLookAround : public CGoalOp
{
	...
	{
		m_scanTimeOutMs = (int)((m_fScanIntervalRange + drx_random(0.2f, 1.0f)) * 1000.0f);
	}

	ILINE void RandomizeTimeout()
	{
		m_timeOutMs = (int)(drx_random(m_fIntervalMin, m_fIntervalMax) * 1000.0f);
	}
