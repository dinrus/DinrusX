...
#define SCHEMATYC2_LOG_METAINFO(drxLinkCommand, ...)       Schematyc2::CLogMessageMetaInfo((drxLinkCommand), Schematyc2::SLogMetaFunction(__FUNCTION__), __VA_ARGS__)
#define SCHEMATYC2_LOG_METAINFO_DEFAULT(drxLinkCommand)    Schematyc2::CLogMessageMetaInfo((drxLinkCommand), Schematyc2::SLogMetaFunction(__FUNCTION__))

#define SCHEMATYC2_COMMENT(streamId, ...)                  gEnv->pSchematyc2->GetLog().Comment(streamId, SCHEMATYC2_LOG_METAINFO_DEFAULT(Schematyc2::EDrxLinkCommand::None), __VA_ARGS__)
#define SCHEMATYC2_ENTITY_COMMENT(streamId, entityId, ...) gEnv->pSchematyc2->GetLog().Comment(streamId, SCHEMATYC2_LOG_METAINFO(Schematyc2::EDrxLinkCommand::None, Schematyc2::SLogMetaEntityId(entityId)), __VA_ARGS__)
#define SCHEMATYC2_WARNING(streamId, ...)                  gEnv->pSchematyc2->GetLog().Warning(streamId, SCHEMATYC2_LOG_METAINFO_DEFAULT(Schematyc2::EDrxLinkCommand::None), __VA_ARGS__)
#define SCHEMATYC2_ENTITY_WARNING(streamId, entityId, ...) gEnv->pSchematyc2->GetLog().Warning(streamId, SCHEMATYC2_LOG_METAINFO(Schematyc2::EDrxLinkCommand::None, Schematyc2::SLogMetaEntityId(entityId)), __VA_ARGS__)
#define SCHEMATYC2_ERROR(streamId, ...)                    gEnv->pSchematyc2->GetLog().Error(streamId, SCHEMATYC2_LOG_METAINFO_DEFAULT(Schematyc2::EDrxLinkCommand::None), __VA_ARGS__)
#define SCHEMATYC2_ENTITY_ERROR(streamId, entityId, ...)   gEnv->pSchematyc2->GetLog().Error(streamId, SCHEMATYC2_LOG_METAINFO(Schematyc2::EDrxLinkCommand::None, Schematyc2::SLogMetaEntityId(entityId)), __VA_ARGS__)
#define SCHEMATYC2_FATAL_ERROR(streamId, ...)              gEnv->pSchematyc2->GetLog().FatalError(streamId, SCHEMATYC2_LOG_METAINFO_DEFAULT(Schematyc2::EDrxLinkCommand::None), __VA_ARGS__); DrxFatalError(__VA_ARGS__)
...
#define SCHEMATYC2_CRITICAL_ERROR(streamId, ...)                                                                                                    \
  {                                                                                                                                                 \
    ...
    if (!bIgnore)                                                                                                                                   \
    {                                                                                                                                               \
      switch (gEnv->pSchematyc2->GetLog().CriticalError(streamId, SCHEMATYC2_LOG_METAINFO_DEFAULT(Schematyc2::EDrxLinkCommand::None), __VA_ARGS__)) \
      {                                                                                                                                             \
...
#define SCHEMATYC2_METAINFO_FATAL_ERROR(streamId, metaInfo, ...) gEnv->pSchematyc2->GetLog().FatalError(streamId, (metaInfo), __VA_ARGS__); DrxFatalError(__VA_ARGS__)
