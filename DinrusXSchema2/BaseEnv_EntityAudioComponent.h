...
//#include <DinrusX/DinrusXSchema2/EntityInterface.h>

//#include <DinrusX/DinrusXSchema2/GameAudio/GameAudioEntityController.h>
	...
	namespace Entity
	{
		...
		public:
			...
			struct SAudioSwitchSetting
			{
				...
				Schematyc2::SAudioSwitchName switchName;
				Schematyc2::SAudioSwitchStateName switchStateName;
			...
			void SetSwitchState(const Schematyc2::SAudioSwitchName& switchName, const Schematyc2::SAudioSwitchStateName& switchStateName);
			void SetRtpc(const char* szAuxProxyName, const Schematyc2::SRtpcName& rtpcName, const float rtpcValue);
