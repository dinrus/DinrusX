...
#include <DinrusX/CoreX/Renderer/IShader_info.h>
#include <DinrusX/DinrusX3dEng/I3DEngine_info.h>
...
struct TCurve<S >::CCustomInfo : CTypeInfo
{
	...
	virtual void GetMemoryUsage(IDrxSizer* pSizer, const void* data) const
	{
