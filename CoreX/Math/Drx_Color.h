...
#ifndef DRXTEK_DRXCOLOR_H
#define DRXTEK_DRXCOLOR_H
...
template<class T> struct Color_tpl
{
	...
	ILINE T&         operator[](int index)         { DRX_MATH_ASSERT(index >= 0 && index <= 3); return ((T*)this)[index]; }
	ILINE T          operator[](int index) const   { DRX_MATH_ASSERT(index >= 0 && index <= 3); return ((T*)this)[index]; }
