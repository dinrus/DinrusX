...
namespace Serialization {
	...
	bool Serialize(Serialization::IArchive& ar, Serialization::DrxExtensionPointer<TPointer, TSerializable>& ptr, const char* name, const char* label)
	{
