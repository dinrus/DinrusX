...
enum class EDrxXmlVersion : uint32
{
...
struct IArchiveHost
{
	...
	virtual bool       LoadXmlFile(const SStruct& outObj, const char* filename, EDrxXmlVersion forceVersion = EDrxXmlVersion::Auto) = 0;
	virtual bool       SaveXmlFile(const char* filename, const SStruct& obj, const char* rootNodeName, EDrxXmlVersion forceVersion = EDrxXmlVersion::Auto) = 0;
	virtual bool       LoadXmlNode(const SStruct& outObj, const XmlNodeRef& node, EDrxXmlVersion forceVersion = EDrxXmlVersion::Auto) = 0;
	virtual XmlNodeRef SaveXmlNode(const SStruct& obj, const char* nodeName, EDrxXmlVersion forceVersion = EDrxXmlVersion::Auto) = 0;
...
template<class T> bool LoadXmlFile(T& outInstance, const char* filename, EDrxXmlVersion forceVersion = EDrxXmlVersion::Auto)
{
	return gEnv->pSystem->GetArchiveHost()->LoadXmlFile(Serialization::SStruct(outInstance), filename, forceVersion);
}

template<class T> bool SaveXmlFile(const char* filename, const T& instance, const char* rootNodeName, EDrxXmlVersion forceVersion = EDrxXmlVersion::Auto)
{
...
template<class T> XmlNodeRef SaveXmlNode(const T& instance, const char* nodeName, EDrxXmlVersion forceVersion = EDrxXmlVersion::Auto)
{
