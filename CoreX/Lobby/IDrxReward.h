...
typedef void (* DrxRewardCallback)(DrxLobbyTaskID taskID, uint32 playerID, uint32 awardID, EDrxLobbyError error, bool alreadyAwarded, void* pArg);
...
struct IDrxReward
{
	...
	virtual EDrxRewardError Award(uint32 playerID, uint32 awardID, DrxLobbyTaskID* pTaskID, DrxRewardCallback cb, void* pCbArg) = 0;
	// </interfuscator:shuffle>
};
