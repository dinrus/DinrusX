...
struct IDrxVoice
{
	...
	virtual void Mute(uint32 localUser, DrxUserID remoteUser, bool mute) = 0;
	...
	virtual bool IsMuted(uint32 localUser, DrxUserID remoteUser) = 0;
	...
	//! \param remoteUser   The DrxUserID of the remote user.
	//! \param mute			   Mute on/off
	virtual void MuteExternally(uint32 localUser, DrxUserID remoteUser, bool mute) = 0;
	...
	virtual bool IsMutedExternally(uint32 localUser, DrxUserID remoteUser) = 0;
	...
	virtual bool IsSpeaking(uint32 localUser, DrxUserID remoteUser) = 0;
