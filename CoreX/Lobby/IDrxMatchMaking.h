...
<DinrusX/CommonIDrxMatchMaking.h>
...
struct SDrxMatchMakingConnectionUID
{
	...
	int operator-(const SDrxMatchMakingConnectionUID& other) const
	{
		if (*this < other)
			return -1;
		if (*this == other)
...
typedef void* DrxSessionRequesterID;
...
typedef void (* DrxMatchmakingCallback)(DrxLobbyTaskID taskID, EDrxLobbyError error, void* arg);
...
//! \param arg         Pointer to application-specified data.
typedef void (* DrxMatchmakingFlagsCallback)(DrxLobbyTaskID taskID, EDrxLobbyError error, DrxSessionHandle h, uint32 flags, void* arg);

//! \param taskID      Task ID allocated when the function was executed.
//! \param error       Error code - eCLE_Success if the function succeeded or an error that occurred while processing the function.
//! \param h           If successful a handle to the session created used to identify the session in other matchmaking functions.
//! \param arg         Pointer to application-specified data.
typedef void (* DrxMatchmakingSessionCreateCallback)(DrxLobbyTaskID taskID, EDrxLobbyError error, DrxSessionHandle h, void* arg);
...
//! \param arg         Pointer to application-specified data.
typedef void (* DrxMatchmakingSessionSearchCallback)(DrxLobbyTaskID taskID, EDrxLobbyError error, SDrxSessionSearchResult* session, void* arg);
...
//! \param session     Pointer to a session search result if error was eCLE_SuccessContinue.
//! \param arg         Pointer to application-specified data.
typedef void (* DrxMatchmakingSessionQueryCallback)(DrxLobbyTaskID taskID, EDrxLobbyError error, SDrxSessionSearchResult* session, void* arg);

//! \param taskID      Task ID allocated when the function was executed.
//! \param error       Error code. eCLE_Success if session contains a valid result.
//! \param arg         Pointer to application-specified data.
typedef void (* DrxMatchmakingSessionGetUsersCallback)(DrxLobbyTaskID taskID, EDrxLobbyError error, SDrxUserInfoResult* session, void* arg);
...
//! \param arg         Pointer to application-specified data.
typedef void (* DrxMatchmakingSessionJoinCallback)(DrxLobbyTaskID taskID, EDrxLobbyError error, DrxSessionHandle h, uint32 ip, uint16 port, void* arg);
...
typedef void (* DrxMatchmakingSessionSetupDedicatedServerCallback)(DrxLobbyTaskID taskID, EDrxLobbyError error, uint32 ip, uint16 port, void* pArg);

//! \param taskID      Task ID allocated when the function was executed.
//! \param error       Error code - eCLE_Success if the function succeeded or an error that occurred while processing the function.
//! \param packet      If error is eCLE_Success the packet sent back from the host of the session. NULL otherwise.
//! \param pArg        Pointer to application-specified data.
typedef void (* DrxMatchmakingSessionSendRequestInfoCallback)(DrxLobbyTaskID taskID, EDrxLobbyError error, CDrxLobbyPacket* pPacket, void* pArg);
...
//! \param arg         Pointer to application-specified data.
typedef void (* DrxMatchmakingSessionGetAdvertisementDataCallback)(DrxLobbyTaskID taskID, EDrxLobbyError error, uint8* pData, uint32 dataSize, void* arg);
...
public:
	...
	virtual EDrxLobbyError SessionRegisterUserData(SDrxLobbyUserData* data, uint32 numData, DrxLobbyTaskID* taskID, DrxMatchmakingCallback cb, void* cbArg) = 0;
	...
	//! \param pCbArg		   Pointer to application-specified data that is passed to the callback.
	//! \return		   eCLE_Success if function successfully started or an error code if function failed to start.
	virtual EDrxLobbyError SessionCreate(uint32* users, int numUsers, uint32 flags, SDrxSessionData* data, DrxLobbyTaskID* taskID, DrxMatchmakingSessionCreateCallback cb, void* cbArg) = 0;
	...
	//! \param pCbArg		   Pointer to application-specified data that is passed to the callback.
	//! \return		   eCLE_Success if function successfully started or an error code if function failed to start.
	virtual EDrxLobbyError SessionMigrate(DrxSessionHandle h, uint32* pUsers, int numUsers, uint32 flags, SDrxSessionData* pData, DrxLobbyTaskID* pTaskID, DrxMatchmakingSessionCreateCallback pCB, void* pCBArg) = 0;
	...
	//! \param pCbArg		   Pointer to application-specified data that is passed to the callback.
	//! \return		   eCLE_Success if function successfully started or an error code if function failed to start.
	virtual EDrxLobbyError SessionUpdate(DrxSessionHandle h, SDrxLobbyUserData* data, uint32 numData, DrxLobbyTaskID* taskID, DrxMatchmakingCallback cb, void* cbArg) = 0;
	...
	//! \param pCBArg		   Pointer to application-specified data that is passed to the callback.
	//! \return		   eCLE_Success if function successfully started or an error code if function failed to start.
	virtual EDrxLobbyError SessionUpdateSlots(DrxSessionHandle h, uint32 numPublic, uint32 numPrivate, DrxLobbyTaskID* pTaskID, DrxMatchmakingCallback pCB, void* pCBArg) = 0;
	...
	//! \param pCbArg		   Pointer to application-specified data that is passed to the callback.
	//! \return		   eCLE_Success if function successfully started or an error code if function failed to start.
	virtual EDrxLobbyError SessionQuery(DrxSessionHandle h, DrxLobbyTaskID* taskID, DrxMatchmakingSessionQueryCallback cb, void* cbArg) = 0;
	...
	//! \param pCbArg		   Pointer to application-specified data that is passed to the callback.
	//! \return		   eCLE_Success if function successfully started or an error code if function failed to start.
	virtual EDrxLobbyError SessionGetUsers(DrxSessionHandle h, DrxLobbyTaskID* taskID, DrxMatchmakingSessionGetUsersCallback cb, void* cbArg) = 0;
	...
	//! \param pCbArg		   Pointer to application-specified data that is passed to the callback.
	//! \return		   eCLE_Success if function successfully started or an error code if function failed to start.
	virtual EDrxLobbyError SessionStart(DrxSessionHandle h, DrxLobbyTaskID* taskID, DrxMatchmakingCallback cb, void* cbArg) = 0;
	...
	//! \param pCbArg		   Pointer to application-specified data that is passed to the callback.
	//! \return		   eCLE_Success if function successfully started or an error code if function failed to start.
	virtual EDrxLobbyError SessionEnd(DrxSessionHandle h, DrxLobbyTaskID* taskID, DrxMatchmakingCallback cb, void* cbArg) = 0;
	...
	//! \param cb				   Callback function that is called when function completes.
	//! \param pCbArg		   Pointer to application-specified data that is passed to the callback.
	virtual EDrxLobbyError SessionSetLocalUserData(DrxSessionHandle h, DrxLobbyTaskID* pTaskID, uint32 user, uint8* pData, uint32 dataSize, DrxMatchmakingCallback pCB, void* pCBArg) = 0;
	...
	//! \param pCbArg		   Pointer to application-specified data that is passed to the callback.
	//! \return		   eCLE_Success if function successfully started or an error code if function failed to start.
	virtual EDrxLobbyError SessionDelete(DrxSessionHandle h, DrxLobbyTaskID* taskID, DrxMatchmakingCallback cb, void* cbArg) = 0;
	...
	//! \param pCbArg		   Pointer to application-specified data that is passed to the callback.
	//! \return		   eCLE_Success if function successfully started or an error code if function failed to start.
	virtual EDrxLobbyError SessionSearch(uint32 user, SDrxSessionSearchParam* param, DrxLobbyTaskID* taskID, DrxMatchmakingSessionSearchCallback cb, void* cbArg) = 0;
	...
	//! \param pCbArg		   Pointer to application-specified data that is passed to the callback.
	//! \return		   eCLE_Success if function successfully started or an error code if function failed to start.
	virtual EDrxLobbyError SessionJoin(uint32* users, int numUsers, uint32 flags, DrxSessionID id, DrxLobbyTaskID* taskID, DrxMatchmakingSessionJoinCallback cb, void* cbArg) = 0;
	...
	//! \param pCBArg		   Pointer to application-specified data that is passed to the callback.
	//! \return		   eCLE_Success if function successfully started or an error code if function failed to start.
	virtual EDrxLobbyError SessionSetupDedicatedServer(DrxSessionHandle h, CDrxLobbyPacket* pPacket, DrxLobbyTaskID* pTaskID, DrxMatchmakingSessionSetupDedicatedServerCallback pCB, void* pCBArg) = 0;
	...
	//! \param pCBArg		   Pointer to application-specified data that is passed to the callback.
	//! \return		   eCLE_Success if function successfully started or an error code if function failed to start.
	virtual EDrxLobbyError SessionReleaseDedicatedServer(DrxSessionHandle h, DrxLobbyTaskID* pTaskID, DrxMatchmakingCallback pCB, void* pCBArg) = 0;
	...
	//! \param pCbArg		   Pointer to application-specified data that is passed to the callback.
	//! \return		   eCLE_Success if function successfully started or an error code if function failed to start.
	virtual EDrxLobbyError SessionSendRequestInfo(CDrxLobbyPacket* pPacket, DrxSessionID id, DrxLobbyTaskID* pTaskID, DrxMatchmakingSessionSendRequestInfoCallback pCB, void* pCBArg) = 0;
	...
	//! \param pCBArg				   Pointer to application-specified data that is passed to the callback.
	//! \return				   eCLE_Success if function successfully started or an error code if function failed to start.
	virtual EDrxLobbyError SessionTerminateHostHintingForGroup(DrxSessionHandle gh, SDrxMatchMakingConnectionUID* pConnections, uint32 numConnections, DrxLobbyTaskID* pTaskID, DrxMatchmakingCallback pCB, void* pCBArg) = 0;
	...
	//! \param pCBArg				   Pointer to application-specified data that is passed to the callback.
	//! \return				   eCLE_Success if function successfully started or an error code if function failed to start.
	virtual EDrxLobbyError SessionSetLocalFlags(DrxSessionHandle gh, uint32 flags, DrxLobbyTaskID* pTaskID, DrxMatchmakingFlagsCallback pCB, void* pCBArg) = 0;
	...
	//! \param pCBArg				   Pointer to application-specified data that is passed to the callback.
	//! \return				   eCLE_Success if function successfully started or an error code if function failed to start.
	virtual EDrxLobbyError SessionClearLocalFlags(DrxSessionHandle gh, uint32 flags, DrxLobbyTaskID* pTaskID, DrxMatchmakingFlagsCallback pCB, void* pCBArg) = 0;
	...
	//! \param pCBArg				   Pointer to application-specified data that is passed to the callback.
	//! \return				   eCLE_Success if function successfully started or an error code if function failed to start.
	virtual EDrxLobbyError SessionGetLocalFlags(DrxSessionHandle gh, DrxLobbyTaskID* pTaskID, DrxMatchmakingFlagsCallback pCB, void* pCBArg) = 0;
	...
	//! \param pCbArg					 Pointer to application-specified data that is passed to the callback.
	//! \return				   eCLE_Success if function successfully started or an error code if function failed to start.
	virtual EDrxLobbyError SessionSetAdvertisementData(DrxSessionHandle gh, uint8* pData, uint32 dataSize, DrxLobbyTaskID* pTaskID, DrxMatchmakingCallback pCb, void* pCbArg) = 0;
	...
	//! \param pCbArg					 Pointer to application-specified data that is passed to the callback.
	//! \return				   eCLE_Success if function successfully started or an error code if function failed to start.
	virtual EDrxLobbyError SessionGetAdvertisementData(DrxSessionID sessionId, DrxLobbyTaskID* pTaskID, DrxMatchmakingSessionGetAdvertisementDataCallback pCb, void* pCbArg) = 0;
	...
	virtual EDrxLobbyError GetSessionAddressFromSessionID(DrxSessionID sessionID, uint32& hostIP, uint16& hostPort) = 0;
	...
	virtual SDrxMatchMakingConnectionUID GetConnectionUIDFromGameSessionHandleAndChannelID(DrxSessionHandle gh, uint16 channelID) = 0;
	...
	//! \return			 eCLE_Success if successful, otherwise an error.
	virtual EDrxLobbyError GetSessionIDFromSessionURL(const char* const pSessionURL, DrxSessionID* const pSessionID) = 0;

	//! Get a DrxSessionID from an ASCII IP address.
	//! \param pAddr			 IP address.
	//! \param pSessionID	 Session ID.
	//! \return			 eCLE_Success if successful, otherwise an error.
	virtual EDrxLobbyError GetSessionIDFromIP(const char* const pAddr, DrxSessionID* const pSessionID) = 0;
	...
	virtual uint32 GetTimeSincePacketFromServerMS(DrxSessionHandle gh) = 0;
	...
	//! \param gh Game session handle.
	virtual const char* GetNameFromGameSessionHandle(DrxSessionHandle gh) = 0;
