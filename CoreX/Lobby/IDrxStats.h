...
typedef uint32 DrxStatsLeaderBoardID;
...
typedef void(*DrxStatsCallback)(DrxLobbyTaskID taskID, EDrxLobbyError error, void* pArg);
...
//! \param pArg			 Pointer to application-specified data
typedef void(*DrxStatsReadLeaderBoardCallback)(DrxLobbyTaskID taskID, EDrxLobbyError error, SDrxStatsLeaderBoardReadResult* pResult, void* pArg);
...
//! \param pArg			 Pointer to application-specified data
typedef void(*DrxStatsReadUserDataCallback)(DrxLobbyTaskID taskID, EDrxLobbyError error, SDrxLobbyUserData* pData, uint32 numData, void* pArg);
...
struct IDrxStats
{
	...
	virtual EDrxLobbyError StatsRegisterLeaderBoards(SDrxStatsLeaderBoardWrite* pBoards, uint32 numBoards, DrxLobbyTaskID* pTaskID, DrxStatsCallback cb, void* pCbArg) = 0;
	...
	//! \param pCbArg			   Pointer to application-specified data that is passed to the callback.
	//! \return			   eCLE_Success if function successfully started or an error code if function failed to start.
	virtual EDrxLobbyError StatsWriteLeaderBoards(DrxSessionHandle session, uint32 user, SDrxStatsLeaderBoardWrite* pBoards, uint32 numBoards, DrxLobbyTaskID* pTaskID, DrxStatsCallback cb, void* pCbArg) = 0;
	...
	//! \param pCbArg			   Pointer to application-specified data that is passed to the callback.
	//! \return			   eCLE_Success if function successfully started or an error code if function failed to start.
	virtual EDrxLobbyError StatsWriteLeaderBoards(DrxSessionHandle session, DrxUserID* pUserIDs, SDrxStatsLeaderBoardWrite** ppBoards, uint32* pNumBoards, uint32 numUserIDs, DrxLobbyTaskID* pTaskID, DrxStatsCallback cb, void* pCbArg) = 0;
	...
	//! \param pCbArg			   Pointer to application-specified data that is passed to the callback.
	//! \return			   eCLE_Success if function successfully started or an error code if function failed to start.
	virtual EDrxLobbyError StatsReadLeaderBoardByRankForRange(DrxStatsLeaderBoardID board, uint32 startRank, uint32 num, DrxLobbyTaskID* pTaskID, DrxStatsReadLeaderBoardCallback cb, void* pCbArg) = 0;
	...
	//! \param pCbArg			   Pointer to application-specified data that is passed to the callback.
	//! \return			   eCLE_Success if function successfully started or an error code if function failed to start.
	virtual EDrxLobbyError StatsReadLeaderBoardByRankForUser(DrxStatsLeaderBoardID board, uint32 user, uint32 num, DrxLobbyTaskID* pTaskID, DrxStatsReadLeaderBoardCallback cb, void* pCbArg) = 0;
	...
	//! \param pCbArg			   Pointer to application-specified data that is passed to the callback.
	//! \return			   eCLE_Success if function successfully started or an error code if function failed to start.
	virtual EDrxLobbyError StatsReadLeaderBoardByUserID(DrxStatsLeaderBoardID board, DrxUserID* pUserIDs, uint32 numUserIDs, DrxLobbyTaskID* pTaskID, DrxStatsReadLeaderBoardCallback cb, void* pCbArg) = 0;
	...
	//! \param pCbArg			   Pointer to application-specified data that is passed to the callback.
	//! \return			   eCLE_Success if function successfully started or an error code if function failed to start.
	virtual EDrxLobbyError StatsRegisterUserData(SDrxLobbyUserData* pData, uint32 numData, DrxLobbyTaskID* pTaskID, DrxStatsCallback cb, void* pCbArg) = 0;
	...
	//! \param pCbArg			   Pointer to application-specified data that is passed to the callback.
	//! \return			   eCLE_Success if function successfully started or an error code if function failed to start.
	virtual EDrxLobbyError StatsWriteUserData(uint32 user, SDrxLobbyUserData* pData, uint32 numData, DrxLobbyTaskID* pTaskID, DrxStatsCallback cb, void* pCbArg) = 0;
	...
	//! \param pCbArg			   Pointer to application-specified data that is passed to the callback.
	//! \return			   eCLE_Success if function successfully started or an error code if function failed to start.
	virtual EDrxLobbyError StatsWriteUserData(DrxUserID* pUserIDs, SDrxLobbyUserData** ppData, uint32* pNumData, uint32 numUserIDs, DrxLobbyTaskID* pTaskID, DrxStatsCallback cb, void* pCbArg) = 0;
	...
	//! \param pCbArg			   Pointer to application-specified data that is passed to the callback.
	//! \return			   eCLE_Success if function successfully started or an error code if function failed to start.
	virtual EDrxLobbyError StatsReadUserData(uint32 user, DrxLobbyTaskID* pTaskID, DrxStatsReadUserDataCallback cb, void* pCbArg) = 0;
	...
	//! \param pCbArg			   Pointer to application-specified data that is passed to the callback.
	//! \return			   eCLE_Success if function successfully started or an error code if function failed to start.
	virtual EDrxLobbyError StatsReadUserData(uint32 user, DrxUserID userID, DrxLobbyTaskID* pTaskID, DrxStatsReadUserDataCallback cb, void* pCbArg) = 0;
