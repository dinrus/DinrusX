...
typedef void (* DrxTCPServiceCallback)(EDrxTCPServiceResult res, void* pArg);
...
typedef bool (* DrxTCPServiceReplyCallback)(EDrxTCPServiceResult res, void* pArg, STCPServiceDataPtr pUploadData, const char* pReplyData, size_t replyDataLen, bool endOfStream);
