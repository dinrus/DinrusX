// Разработка 2018-2023 Dinrus GmbH / Dinrus Group. РНЦП Динрус.
...
struct DRX_ALIGN(128) SInfoBlock
{
	...
	DRX_ALIGN(16) unsigned char paramData[scAvailParamSize];    //!< is 16 byte aligned, make sure it is kept aligned.
...
public:
	...
	ILINE void RegisterJobState(JobUpr::SJobState* __restrict pJobState) volatile
	{
		((CJobBase*)this)->m_JobDelegator.RegisterJobState(pJobState);
	}

	ILINE void RegisterQueue(const JobUpr::SProdConsQueueBase* const cpQueue) volatile
	{
...
struct IJobUpr
{
	...
	virtual void AddLambdaJob(const char* jobName, const std::function<void()>& lambdaCallback, TPriorityLevel priority = JobUpr::eRegularPriority, SJobState* pJobState = nullptr) = 0;
	...
	virtual const JobUpr::TJobHandle GetJobHandle(const char* cpJobName, const unsigned int cStrLen, JobUpr::Invoker pInvoker) = 0;

	//! Obtain job handle from name.
	virtual const JobUpr::TJobHandle GetJobHandle(const char* cpJobName, JobUpr::Invoker pInvoker) = 0;
	...
	virtual JobUpr::SJobProfilingData* GetProfilingData(uint16 nProfilerIndex) = 0;
	...
	virtual JobUpr::TSemaphoreHandle AllocateSemaphore(volatile const void* pOwner) = 0;

	//! Return a semaphore handle to the Job Upr pool.
	virtual void DeallocateSemaphore(JobUpr::TSemaphoreHandle nSemaphoreHandle, volatile const void* pOwner) = 0;

	//! Increase the refcounter of a semaphore, but only if it is > 0, else returns false.
	virtual bool AddRefSemaphore(JobUpr::TSemaphoreHandle nSemaphoreHandle, volatile const void* pOwner) = 0;

	//! Get the actual semaphore object for aquire/release calls.
	virtual SJobFinishedConditionVariable* GetSemaphore(JobUpr::TSemaphoreHandle nSemaphoreHandle, volatile const void* pOwner) = 0;
...
{
	uint32 nWorkerThreadID = gEnv->GetJobUpr()->GetWorkerThreadId();
...
struct SProdConsQueueBase
{
	...
	DRX_ALIGN(16) uint32 m_PullIncrement;                   //!< Increment of pull.
...
private:
	...
	//! The ring buffer.
	DRX_ALIGN(128) void* m_pRingBuffer;
...
///////////////////////////////////////////////////////////////////////////////
template<class TJobType, unsigned int Size>
ILINE void JobUpr::CProdConsQueue<TJobType, Size >::Init(const uint32 cPacketSize)
{
...
///////////////////////////////////////////////////////////////////////////////
template<class TJobType, unsigned int Size>
ILINE void* const JobUpr::CProdConsQueue<TJobType, Size >::GetIncrementedPointer()
{
...
)
{
	...
	IF ((cpCurPush == m_pPull) && (curQueueRunningState.IsRunning()), 0)
	{
		...
		DrxInterlockedCompareExchange128((volatile int64*)this, (int64)markedPushPtr, *alias_cast<int64*>(&curQueueRunningState), compareValue);
		...
		resultValue.doubleWord = DrxInterlockedCompareExchange64((volatile int64*)this, exchangeValue.doubleWord, compareValue.doubleWord);
	...
	DrxInterlockedCompareExchange128((volatile int64*)this, (int64)cpNextPushPtr, *alias_cast<int64*>(&newSyncVar), compareValue);
	// make sure nobody set the state to stopped in the meantime
...
///////////////////////////////////////////////////////////////////////////////
inline void JobUpr::CCommonDMABase::SetJobParamData(void* pParamData)
{
	m_pParamData = pParamData;
}

///////////////////////////////////////////////////////////////////////////////
inline const void* JobUpr::CCommonDMABase::GetJobParamData() const
{
	return m_pParamData;
}

///////////////////////////////////////////////////////////////////////////////
inline uint16 JobUpr::CCommonDMABase::GetProfilingDataIndex() const
{
...
///////////////////////////////////////////////////////////////////////////////
ILINE void JobUpr::CJobDelegator::SetParamDataSize(const unsigned int cParamDataSize)
{
	m_ParamDataSize = cParamDataSize;
}

///////////////////////////////////////////////////////////////////////////////
ILINE const unsigned int JobUpr::CJobDelegator::GetParamDataSize() const
{
...
/////////////////////////////////////////////////////////////////////////////////
inline bool JobUpr::SJobSyncVariable::IsRunning() const volatile
{
	return syncVar.nRunningCounter != 0;
}

/////////////////////////////////////////////////////////////////////////////////
inline void JobUpr::SJobSyncVariable::Wait() volatile
{
...
retry:
	...
	if (currentValue.wordValue != 0)
	{
		...
		else // no semaphore found
		{
			...
			resValue.wordValue = DrxInterlockedCompareExchange((volatile LONG*)&syncVar.wordValue, newValue.wordValue, currentValue.wordValue);
...
/////////////////////////////////////////////////////////////////////////////////
inline void JobUpr::SJobSyncVariable::SetRunning(uint16 count) volatile
{
	SyncVar currentValue;
	SyncVar newValue;
	...
	while (DrxInterlockedCompareExchange((volatile LONG*)&syncVar.wordValue, newValue.wordValue, currentValue.wordValue) != currentValue.wordValue);
}

/////////////////////////////////////////////////////////////////////////////////
inline bool JobUpr::SJobSyncVariable::SetStopped(SJobStateBase* pPostCallback, uint16 count) volatile
{
	SyncVar currentValue;
	SyncVar newValue;
	SyncVar resValue;
...
inline void JobUpr::SInfoBlock::Release(uint32 nMaxValue)
{
	...
	do
	{
		...
		resultInfoBlockState.nValue = DrxInterlockedCompareExchange((volatile LONG*)&jobState.nValue, newInfoBlockState.nValue, currentInfoBlockState.nValue);
	}
...
/////////////////////////////////////////////////////////////////////////////////
inline void JobUpr::SInfoBlock::Wait(uint32 nRoundID, uint32 nMaxValue)
{
	bool bWait = false;
	bool bRetry = false;
