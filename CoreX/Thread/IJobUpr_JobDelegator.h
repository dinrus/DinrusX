...
#define DECLARE_JOB_INVOKER_CLASS(name, type, function)                                                                                                                  \
  ...
  private:                                                                                                                                                               \
    ...
    /*****************/                                                                                                                                                  \
    /* class members */                                                                                                                                                  \
    unsigned char m_ParameterStorage[JobUpr::SInfoBlock::scAvailParamSize]; /* Storage for job parameter */                                                          \
  ...
  public:                                                                                                                                                                \
    ...
    const JobUpr::TJobHandle GetProgramHandle()  const volatile;                                                                                                     \
    uint32 GetJobID();                                                                                                                                                   \
    ...
    void* operator new(size_t nSize)        { return DrxModuleMemalign(nSize, 128); }                                                                                    \
    void  operator delete(void* pPtr)       { DrxModuleMemalignFree(pPtr); }                                                                                             \
                                                                                                                                                                         \
  ...
  private:                                                                                                                                                               \
    ...
    /***************************************************************************/                                                                                        \
    /* class members */                                                                                                                                                  \
    DRX_ALIGN(128) unsigned char m_ParameterStorage[JobUpr::SInfoBlock::scAvailParamSize]; /* memory to store serialized parameters */                               \
  ...
  inline const JobUpr::TJobHandle SGenericJob ## type::GetProgramHandle() const volatile                                                                             \
  {                                                                                                                                                                      \
