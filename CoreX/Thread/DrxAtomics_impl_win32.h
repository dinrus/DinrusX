...
//////////////////////////////////////////////////////////////////////////
void DrxInterlockedPushListSList(SLockFreeSingleLinkedListHeader& list, SLockFreeSingleLinkedListEntry& first, SLockFreeSingleLinkedListEntry& last, uint32 count)
{
	static_assert(sizeof(SLockFreeSingleLinkedListHeader) == sizeof(SLIST_HEADER), "DRX_INTERLOCKED_SLIST_HEADER_HAS_WRONG_SIZE");
	static_assert(sizeof(SLockFreeSingleLinkedListEntry) >= sizeof(SLIST_ENTRY), "DRX_INTERLOCKED_SLIST_ENTRY_HAS_WRONG_SIZE");
...
//////////////////////////////////////////////////////////////////////////
void* DrxInterlockedPopEntrySList(SLockFreeSingleLinkedListHeader& list)
{
	static_assert(sizeof(SLockFreeSingleLinkedListHeader) == sizeof(SLIST_HEADER), "DRX_INTERLOCKED_SLIST_HEADER_HAS_WRONG_SIZE");
...
//////////////////////////////////////////////////////////////////////////
void* DrxRtlFirstEntrySList(SLockFreeSingleLinkedListHeader& list)
{
	static_assert(sizeof(SLockFreeSingleLinkedListHeader) == sizeof(SLIST_HEADER), "DRX_INTERLOCKED_SLIST_HEADER_HAS_WRONG_SIZE");
	static_assert(sizeof(SLockFreeSingleLinkedListEntry) >= sizeof(SLIST_ENTRY), "DRX_INTERLOCKED_SLIST_ENTRY_HAS_WRONG_SIZE");
...
//////////////////////////////////////////////////////////////////////////
void* DrxInterlockedFlushSList(SLockFreeSingleLinkedListHeader& list)
{
	DRX_ASSERT_MESSAGE(IsAligned(&list, MEMORY_ALLOCATION_ALIGNMENT), "LockFree SingleLink List Header has wrong Alignment");
