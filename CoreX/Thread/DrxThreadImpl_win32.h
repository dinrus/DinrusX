...
//////////////////////////////////////////////////////////////////////////
bool DrxEvent::Wait(const uint32 timeoutMillis) const
{
...
//////////////////////////////////////////////////////////////////////////
bool DrxConditionVariable::TimedWait(DrxMutex& lock, uint32 millis)
{
...
//////////////////////////////////////////////////////////////////////////
bool DrxConditionVariable::TimedWait(DrxMutexFast& lock, uint32 millis)
{
	if (lock.s_value == DrxMT::detail::eLockType_SRW)
	{
...
//////////////////////////////////////////////////////////////////////////
DrxSemaphore::DrxSemaphore(int nMaximumCount, int nInitialCount)
{
...
//////////////////////////////////////////////////////////////////////////
DrxFastSemaphore::DrxFastSemaphore(int nMaximumCount, int nInitialCount) :
