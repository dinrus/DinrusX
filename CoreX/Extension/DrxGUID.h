...
#include <DinrusX/CoreX/Serialization/TypeID.h>
...
struct DrxGUID
{
	...
	constexpr static DrxGUID Construct(uint32 d1, uint16 d2, uint16 d3, uint8 d4[8])
	{
		return DrxGUID(
	...
	constexpr static DrxGUID Construct(uint32 d1, uint16 d2, uint16 d3,
	...
	struct StringUtils
	{
		...
		struct SGuidStringSerializer : public Serialization::IString
		{
			...
			void        set(const char* value) { drx_strcpy(buffer,value); }
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	constexpr static DrxGUID FromStringInternal(const char* szInput)
	{
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	static DrxGUID FromString(const char* szGuidAsString)
	{
	...
	static bool SerializeAsString(Serialization::IArchive& archive, DrxGUID& guid, const char* szName, const char* szLabel)
	{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
constexpr DrxGUID operator"" _drx_guid(const char* szInput, size_t)
{
...
inline bool Serialize(Serialization::IArchive& ar, DrxGUID &guid,const char* szName, const char* szLabel = nullptr)
{
...
inline bool Serialize(Serialization::IArchive& ar, DrxGUID::StringUtils::SGuidStringSerializer& value, const char* name, const char* label)
{
