...
inline const char* DrxGetSharedLibraryStoragePath()
{
...
inline const char* DrxGetUserStoragePath()
{
	// Could be JNI
...
inline const char* DrxGetProjectStoragePath()
{
	// Could be JNI
...
inline void* DrxGetLauncherModuleHandle()
{
