...
public:
	...
	bool GetInstalledBuildPathUtf16(const int index, SettingsUprHelpers::CWCharBuffer name, SettingsUprHelpers::CWCharBuffer path);
	bool GetInstalledBuildPathAscii(const int index, SettingsUprHelpers::CCharBuffer name, SettingsUprHelpers::CCharBuffer path);

	void CallSettingsUprExe(void* hParent);
};
