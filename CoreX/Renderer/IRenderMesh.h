...
#include <DinrusX/CoreX/Renderer/IRenderer.h>  // PublicRenderPrimitiveType
...
struct IRenderMesh
{
	...
	virtual int   GetTextureMemoryUsage(const IMaterial* pMaterial, IDrxSizer* pSizer = NULL, bool bStreamedIn = true) const = 0;
