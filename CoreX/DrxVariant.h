...
static_assert(get_index<bool, DrxVariant<bool, char, short, int>>::value == 0, "Wrong variant index found.");
static_assert(get_index<char, DrxVariant<bool, char, short, int>>::value == 1, "Wrong variant index found.");
static_assert(get_index<short, DrxVariant<bool, char, short, int>>::value == 2, "Wrong variant index found.");
static_assert(get_index<int, DrxVariant<bool, char, short, int>>::value == 3, "Wrong variant index found.");
}
...
static_assert(variant_size<DrxVariant<bool, char, short, int>>::value == 4, "Wrong variant size.");
...
static_assert(std::is_same<variant_alternative<0, DrxVariant<bool, char, short, int>>::type, bool>::value, "Wrong variant alternative found.");
static_assert(std::is_same<variant_alternative<1, DrxVariant<bool, char, short, int>>::type, char>::value, "Wrong variant alternative found.");
static_assert(std::is_same<variant_alternative<2, DrxVariant<bool, char, short, int>>::type, short>::value, "Wrong variant alternative found.");
static_assert(std::is_same<variant_alternative<3, DrxVariant<bool, char, short, int>>::type, int>::value, "Wrong variant alternative found.");
