...
#else
	#define PrefetchLine(ptr, off) drxPrefetchT0SSE((void*)((uint8*)(ptr) + off))
	#define ResetLine128(ptr, off) (void)(0)
	#define FlushLine128(ptr, off) (void)(0)
#endif
...
ILINE void drxPrefetchT0SSE(const void* src)
{
...
inline void drxMemcpy(void* Dst, const void* Src, int Count )
{
#if DRX_PLATFORM_SSE2
  {
	  __asm
...
inline void drxMemcpy(void* Dst, const void* Src, int Count, int nFlags)
{
...
ILINE void drxMemcpy(void* Dst, const void* Src, int n)
{
	char* dst = (char*)Dst;
	char* src = (char*)Src;
...
ILINE void drxMemcpy(void* Dst, const void* Src, int n, int nFlags)
{
	char* dst = (char*)Dst;
	char* src = (char*)Src;
	while (n > PREFNTA_BLOCK)
...
ILINE void DrxPrefetch(const void* const cpSrc) {}
#else
