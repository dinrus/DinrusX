...
#include <DinrusX/CoreX/Memory/IDefragAllocator.h>   // <> required for Interfuscator
#include <DinrusX/CoreX/Memory/IGeneralMemoryHeap.h> // <> required for Interfuscator
