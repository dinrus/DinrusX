...
#include <DinrusX/CoreX/Renderer/Tarray.h>
#include <DinrusX/DinrusX3dEng/DrxPodArray.h>
...
#include <DinrusX/DinrusXSys/IResourceCollector.h>       // <> required for Interfuscator. IResourceCollector
...
public:
	...
	DrxSizerComponentNameHelper(IDrxSizer* pSizer, const char* szComponentName, bool bSubcomponent) :
		m_pSizer(pSizer)
	{
		if (bSubcomponent)
