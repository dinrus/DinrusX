...
struct SyncPolicyLocked
{
	...
	{
		DrxInterlockedPushListSList(list, *reinterpret_cast<SLockFreeSingleLinkedListEntry*>(head), *reinterpret_cast<SLockFreeSingleLinkedListEntry*>(tail), (uint32)count);
	}
