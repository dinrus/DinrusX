...
public:
	...
	template<typename Object, typename MemberFunction, typename std::enable_if<DrxMemFunTraits<MemberFunction>::isMemberFunction, int>::type* = 0>
...
template<typename Signature>
template<typename Object, typename MemberFunction, typename std::enable_if<DrxMemFunTraits<MemberFunction>::isMemberFunction, int>::type*>
...
template<typename Signature>
void CDrxSignal<Signature >::DisconnectObject(void* pObject)
{
