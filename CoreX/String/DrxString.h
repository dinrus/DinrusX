...
//extern void DrxDebugStr( const char *format,... );
...
//////////////////////////////////////////////////////////////////////////
template<class T>
inline int DrxStringT<T >::compare(const DrxStringT<T>& _Str) const
{
	return compare(_Str.m_str);
}

template<class T>
inline int DrxStringT<T >::compare(size_type _Pos1, size_type _Num1, const DrxStringT<T>& _Str) const
{
	return compare(_Pos1, _Num1, _Str.m_str, npos);
}

template<class T>
inline int DrxStringT<T >::compare(size_type _Pos1, size_type _Num1, const DrxStringT<T>& _Str, size_type nOff, size_type nCount) const
{
...
template<class T>
inline int DrxStringT<T >::compare(const char* _Ptr) const
{
	return strcmp(m_str, _Ptr);
}

template<class T>
inline int DrxStringT<T >::compare(const wchar_t* _Ptr) const
{
	return wcscmp(m_str, _Ptr);
}

template<class T>
inline int DrxStringT<T >::compare(size_type _Pos1, size_type _Num1, const value_type* _Ptr, size_type _Num2) const
{
	assert(_Pos1 < length());
...
//////////////////////////////////////////////////////////////////////////
template<class T>
inline int DrxStringT<T >::compareNoCase(const DrxStringT<T>& _Str) const
{
	return stricmp(m_str, _Str.m_str);
}

template<class T>
inline int DrxStringT<T >::compareNoCase(size_type _Pos1, size_type _Num1, const DrxStringT<T>& _Str) const
{
	return compareNoCase(_Pos1, _Num1, _Str.m_str, npos);
}

template<class T>
inline int DrxStringT<T >::compareNoCase(size_type _Pos1, size_type _Num1, const DrxStringT<T>& _Str, size_type nOff, size_type nCount) const
{
	assert(nOff < _Str.length());
...
template<class T>
inline int DrxStringT<T >::compareNoCase(const value_type* _Ptr) const
{
	return stricmp(m_str, _Ptr);
}

template<class T>
inline int DrxStringT<T >::compareNoCase(size_type _Pos1, size_type _Num1, const value_type* _Ptr, size_type _Num2) const
{
	assert(_Pos1 < length());
	if (length() - _Pos1 < _Num1)
		_Num1 = length() - _Pos1; // trim to size
...
//////////////////////////////////////////////////////////////////////////
template<class T>
inline DrxStringT<T> DrxStringT<T >::Tokenize(const_str charSet, int& nStart) const
{
	if (nStart < 0)
	{
		return DrxStringT<T>();
