...
inline bool drx_strcpy(_Out_writes_z_(dst_size_in_bytes) char* const dst, size_t const dst_size_in_bytes, const char* const src)
{
	return DrxStringUtils_Internal::strcpy_with_clamp<char>(dst, dst_size_in_bytes, src, (size_t)-1);
}

inline bool drx_strcpy(_Out_writes_z_(dst_size_in_bytes) char* const dst, size_t const dst_size_in_bytes, const char* const src, size_t const src_size_in_bytes)
{
...
inline bool drx_strcpy(_Out_writes_z_(SIZE_IN_CHARS) char (&dst)[SIZE_IN_CHARS], const char* const src)
{
	return DrxStringUtils_Internal::strcpy_with_clamp<char>(dst, SIZE_IN_CHARS, src, (size_t)-1);
}

template<size_t SIZE_IN_CHARS>
inline bool drx_strcpy(_Out_writes_z_(SIZE_IN_CHARS) char (&dst)[SIZE_IN_CHARS], const char* const src, size_t const src_size_in_bytes)
{
...
inline bool drx_strcat( _Inout_updates_z_(dst_size_in_bytes) char* const dst, size_t const dst_size_in_bytes, const char* const src)
{
	return DrxStringUtils_Internal::strcat_with_clamp<char>(dst, dst_size_in_bytes, src, (size_t)-1);
}

template<size_t SIZE_IN_CHARS>
inline bool drx_strcat( _Inout_updates_z_(SIZE_IN_CHARS) char (&dst)[SIZE_IN_CHARS], const char* const src)
{
	return DrxStringUtils_Internal::strcat_with_clamp<char>(dst, SIZE_IN_CHARS, src, (size_t)-1);
}

inline bool drx_strcat( _Inout_updates_z_(dst_size_in_bytes) char* const dst, size_t const dst_size_in_bytes, const char* const src, size_t const src_size_in_bytes)
{
	return DrxStringUtils_Internal::strcat_with_clamp<char>(dst, dst_size_in_bytes, src, src_size_in_bytes);
}

template<size_t SIZE_IN_CHARS>
inline bool drx_strcat( _Inout_updates_z_(SIZE_IN_CHARS) char (&dst)[SIZE_IN_CHARS], const char* const src, size_t const src_size_in_bytes)
{
...
inline bool drx_vsprintf(_Out_writes_z_(dst_size_in_bytes) char* const dst, size_t const dst_size_in_bytes, const char* const format, va_list args)
{
	return DrxStringUtils_Internal::vsprintf_with_clamp(dst, dst_size_in_bytes, format, args);
}

template<size_t SIZE_IN_CHARS>
inline bool drx_vsprintf(_Out_writes_z_(SIZE_IN_CHARS) char (&dst)[SIZE_IN_CHARS], const char* const format, va_list args)
{
	return DrxStringUtils_Internal::vsprintf_with_clamp(dst, SIZE_IN_CHARS, format, args);
}

inline bool drx_sprintf(_Out_writes_z_(dst_size_in_bytes) char* const dst, size_t const dst_size_in_bytes, const char* const format, ...)
{
	va_list args;
	va_start(args, format);
...
template<size_t SIZE_IN_CHARS>
inline bool drx_sprintf(_Out_writes_z_(SIZE_IN_CHARS) char (&dst)[SIZE_IN_CHARS], const char* const format, ...)
{
	va_list args;
	va_start(args, format);
...
inline int drx_strcmp(const char* string1, const char* string2)
{
	return strcmp(string1, string2);
}

inline int drx_stricmp(const char* string1, const char* string2)
{
...
inline int drx_strncmp(const char* string1, const char* string2, size_t count)
{
	return strncmp(string1, string2, count);
}

template<size_t STRING2_CHAR_COUNT> inline int drx_strncmp(const char* string1, const char(&string2)[STRING2_CHAR_COUNT])
{
	return strncmp(string1, string2, STRING2_CHAR_COUNT - 1);
}

inline int drx_strnicmp(const char* string1, const char* string2, size_t count)
{
#if DRX_PLATFORM_WINDOWS
