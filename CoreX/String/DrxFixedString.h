...
//////////////////////////////////////////////////////////////////////////
template<class T, size_t S>
inline int DrxStackStringT<T, S >::compare(const DrxStackStringT<T, S>& _Str) const
{
	return CharTraits<T>::_strcmp(m_str, _Str.m_str);
}

template<class T, size_t S>
inline int DrxStackStringT<T, S >::compare(size_type _Pos1, size_type _Num1, const DrxStackStringT<T, S>& _Str) const
{
	return compare(_Pos1, _Num1, _Str.m_str, npos);
}

template<class T, size_t S>
inline int DrxStackStringT<T, S >::compare(size_type _Pos1, size_type _Num1, const DrxStackStringT<T, S>& _Str, size_type nOff, size_type nCount) const
{
...
template<class T, size_t S>
inline int DrxStackStringT<T, S >::compare(const value_type* _Ptr) const
{
	return CharTraits<T>::_strcmp(m_str, _Ptr);
}

template<class T, size_t S>
inline int DrxStackStringT<T, S >::compare(size_type _Pos1, size_type _Num1, const value_type* _Ptr, size_type _Num2) const
{
	assert(_Pos1 < length());
...
//////////////////////////////////////////////////////////////////////////
template<class T, size_t S>
inline int DrxStackStringT<T, S >::compareNoCase(const DrxStackStringT<T, S>& _Str) const
{
	return CharTraits<T>::_stricmp(m_str, _Str.m_str);
}

template<class T, size_t S>
inline int DrxStackStringT<T, S >::compareNoCase(size_type _Pos1, size_type _Num1, const DrxStackStringT<T, S>& _Str) const
{
	return compareNoCase(_Pos1, _Num1, _Str.m_str, npos);
}

template<class T, size_t S>
inline int DrxStackStringT<T, S >::compareNoCase(size_type _Pos1, size_type _Num1, const DrxStackStringT<T, S>& _Str, size_type nOff, size_type nCount) const
{
	assert(nOff < _Str.length());
...
template<class T, size_t S>
inline int DrxStackStringT<T, S >::compareNoCase(const value_type* _Ptr) const
{
	return CharTraits<T>::_stricmp(m_str, _Ptr);
}

template<class T, size_t S>
inline int DrxStackStringT<T, S >::compareNoCase(size_type _Pos1, size_type _Num1, const value_type* _Ptr, size_type _Num2) const
{
	assert(_Pos1 < length());
	if (length() - _Pos1 < _Num1)
		_Num1 = length() - _Pos1; // trim to size
...
inline DrxStackStringT<T, S>& DrxStackStringT<T, S >::FormatV(const T* format, va_list args)
{
	...
	const int n = DrxStringUtils_Internal::compute_length_formatted_va(format, args);
#else
	va_list argsCopy;
	va_copy(argsCopy, args);
	const int n = DrxStringUtils_Internal::compute_length_formatted_va(format, argsCopy);
	va_end(argsCopy);
#endif
...
//////////////////////////////////////////////////////////////////////////
template<class T, size_t S>
inline DrxStackStringT<T, S> DrxStackStringT<T, S >::Tokenize(const_str charSet, int& nStart) const
{
	if (nStart < 0)
	{
		return DrxStackStringT<T, S>();
...
public:
	...
	DrxFixedStringT<32>* GetData(int& amount)
	{
