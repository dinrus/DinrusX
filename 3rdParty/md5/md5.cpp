...
static void Encode (unsigned char *, const uint32 *, unsigned int);
...
//unsigned int inputLen;                     /* length of input block */
{
	...
	if ((context->bits[0] += ((uint32)inputLen << 3)) < ((uint32)inputLen << 3))
		context->bits[1]++;
	context->bits[1] += ((uint32)inputLen >> 29);
...
///////////////////////////////////////////////////////////
 ...
 void MD5Init (SMD5Context *context){Upp::MD5Init( context);}

 void MD5Update (SMD5Context *context, const unsigned char *input, unsigned int inputLen)
                                         {	Upp::MD5Update( context, input, inputLen);}
                                         
 void MD5Final (unsigned char *digest, SMD5Context *context)
                                         { Upp::MD5Final(digest, context);}
