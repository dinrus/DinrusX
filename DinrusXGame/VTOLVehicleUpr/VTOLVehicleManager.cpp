...
#include <StdAfx.h>
#include <DinrusX/DinrusXGame/VTOLVehicleUpr.h>
...
const char * CVTOLVehicleUpr::s_explosionEffectName = "vehicles.MH60_BlackHawk.Damage.Destroyed";
const char * CVTOLVehicleUpr::s_VTOLClassName		= "US_VTOL_GunShip";
...
void CVTOLVehicleUpr::InitClient(int channelID)
{
	int numVehicles=0;
