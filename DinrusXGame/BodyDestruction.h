...
private:
	...
	typedef std::map<DrxHash, int>	TNameHashToIdxMap;
...
private:
	...
	void ProcessDestructionEvent(IEntity& characterEntity, CBodyDestrutibilityInstance& instance, const HitInfo& hitInfo, const TDestructionEventId destructionEventId, IAttachmentUpr* pAttachmentUpr, const char* targetEffectBone, const Vec3& noAttachEffectPos = ZERO);
	...
	void HideAttachment(IAttachmentUpr* pAttachmentUpr, const char* attachmentName, uint32 hide);
