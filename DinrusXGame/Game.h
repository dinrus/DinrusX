...
#include <DinrusX/DinrusXGame/Network/GameNetworkDefines.h>
#include <DinrusX/DinrusXGame/Network/Lobby/MatchMakingTelemetry.h>
...
public:
  ...
  CDLCUpr*		GetDLCUpr()			{ return m_pDLCUpr; }
	...
	void SetInviteData(EDrxLobbyService service, uint32 user, DrxInviteID id, EDrxLobbyError error, EDrxLobbyInviteType inviteType);
...
protected:
  ...
  static void CmdVote(IConsoleCmdArgs* pArgs);
	...
	static void PartyMembersCallback(UDrxLobbyEventData eventData, void *userParam);
	static void UserProfileChangedCallback(UDrxLobbyEventData eventData, void *arg);
	static void InviteAcceptedCallback(UDrxLobbyEventData eventData, void *arg);
	static void OnlineStateCallback(UDrxLobbyEventData eventData, void *arg);
	static void EthernetStateCallback(UDrxLobbyEventData eventData, void *arg);
