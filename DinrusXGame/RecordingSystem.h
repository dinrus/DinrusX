...
#include <DinrusX/DinrusXGame/TracerUpr.h>
#include <DinrusX/DinrusXGame/PlayerPlugin.h>
#include <DinrusX/CoreX/Containers/DrxFixedArray.h>
#include <DinrusX/DinrusXGame/Effects/GameEffects/KillCamGameEffect.h>
...
#include <DinrusX/DinrusXGame/RecordingSystemPackets.h>
#include <DinrusX/DinrusXGame/Actor.h>
#include <DinrusX/DinrusXGame/RecordingSystemClientSender.h>
#include <DinrusX/DinrusXGame/RecordingSystemServerForwarder.h>
#include <DinrusX/DinrusXGame/RecordingSystemDefines.h>
...
public:
	...
	void OnPlayAnimation(IEntity *entity, int animId, const DrxCharAnimationParams& Params, float speedMultiplier);
	void OnPlayUpperAnimation(IEntity *entity, int animId, const DrxCharAnimationParams& Params, float speedMultiplier);
...
#define REPLAY_EVENT_GUARD CRecordingSystem::SStackGuard __ReplayEventGuard__(CRecordingSystem::m_replayEventGuard);
	...
	std::vector<uint16> m_breakEventIndicies;		//A list of indices into the broken objects array in DrxAction
