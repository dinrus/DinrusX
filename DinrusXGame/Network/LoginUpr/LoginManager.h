...
private:
	...
	static void Crysis3LobbyPasswordCallback( DrxLobbyTaskID taskID, EDrxLobbyError error, SPasswordRules *pRules, void *pArg );
	static void OnlineStateChangedCallback(UDrxLobbyEventData eventData, void *pArg);
	static void LoginProcessCallback(DrxLobbyTaskID taskID, EDrxLobbyError error, void *pArg);
	static void LogoutProcessCallback(DrxLobbyTaskID taskID, EDrxLobbyError error, void *pArg);
