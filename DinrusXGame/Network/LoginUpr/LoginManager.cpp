...
#include <DinrusX/DinrusXGame/Network/LoginUpr/LoginUpr.h>
#include <DinrusX/DinrusXGame/ICrysis3Lobby.h>
...
#include <DinrusX/DinrusXGame/Network/RecentPlayers/RecentPlayersMgr.h>
...
//-------------------------------------------------------------------------
    ...
    const char* const   CLoginUpr::s_pEmailLegal = "%+_-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";
    const char* const   CLoginUpr::s_pEmailPartEnd = "@";
...
#ifndef _RELEASE
//-------------------------------------------------------------------------
const char* CLoginUpr::Debug_GetEmail()
{
#ifdef DEDICATED_SERVER
    return "";
#else
...
//-------------------------------------------------------------------------
const char* CLoginUpr::Debug_GetPassword()
{
#ifdef DEDICATED_SERVER
    return "";
#else
...
//-------------------------------------------------------------------------
const char* CLoginUpr::Debug_GetPersona()
{
#ifdef DEDICATED_SERVER
    return "";
#else
...
//-------------------------------------------------------------------------
void CLoginUpr::OnlineStateChangedCallback( UDrxLobbyEventData eventData, void *pArg )
{
...
//-------------------------------------------------------------------------
void CLoginUpr::OnDisplayLegalDocs( const char *pTermsOfServiceText, const char *pPrivacyText )
{
}
...
//-------------------------------------------------------------------------
void CLoginUpr::OnDisplayPersonas( const SPersona *pPersonas, const int numPersonas )
{
    if(numPersonas > 0)
    {
...
////////////
//-------------------------------------------------------------------------
void CLoginUpr::OnCreateAccountError( EAuthenticationError errorCode, const SValidationError *pErrors, const int numErrors )
{
...
//-------------------------------------------------------------------------
bool CLoginUpr::OnWarningReturn( THUDWarningId id, const char* pReturnValue )
{
...
//-------------------------------------------------------------------------
bool CLoginUpr::Menu_GoToPage( const char *pPage )
{
...
//-------------------------------------------------------------------------
void CLoginUpr::Crysis3LobbyPasswordCallback( DrxLobbyTaskID taskID, EDrxLobbyError error, SPasswordRules *pRules, void *pArg )
{
...
//-------------------------------------------------------------------------
void CLoginUpr::LoginProcessCallback( DrxLobbyTaskID taskID, EDrxLobbyError error, void *pArg )
{
    CLoginUpr *pThis = (CLoginUpr*)pArg;
    ...
    if (error == eCLE_Success)
    {
        ...
        {
            const char *user = pPlayerProfileUpr->GetCurrentUser();
...
//-------------------------------------------------------------------------
void CLoginUpr::LogoutProcessCallback( DrxLobbyTaskID taskID, EDrxLobbyError error, void *pArg )
{
...
//-------------------------------------------------------------------------
void CLoginUpr::ForgotPassword( const char *pEmail)
{
    Menu_GoBack();
...
//-------------------------------------------------------------------------
void CLoginUpr::StoreLoginDetails(const char* pEmail, const char* pPassword, const bool bRememberCheck)
{
    m_loginEmail = pEmail;
...
//-------------------------------------------------------------------------
CLoginUpr::ELocalFieldValidateResult CLoginUpr::ValidatePersona(const char *pPersona, int* pOutRequired/*=NULL*/)
{
...
//-------------------------------------------------------------------------
CLoginUpr::ELocalFieldValidateResult CLoginUpr::ValidatePassword(const char *pPassword, int* pOutRequired/*=NULL*/)
{
...
//-------------------------------------------------------------------------
const char* CLoginUpr::GetValidationError(CLoginUpr::ELocalFieldValidateResult validationResult, const char* pFieldName, const int required)
{
...
//-------------------------------------------------------------------------
/*static*/bool CLoginUpr::ValidateEmail(const char* pEmail)
{
    uint32 validParts = 0;
