...
#include <DinrusX/DinrusXGame/RecentPlayersMgr.h>
...
#include <DinrusX/DinrusXGame/Network/FriendUpr/GameFriendsMgr.h>
...
void CRecentPlayersMgr::InsertedUser(DrxUserID userId, const char *userName)
{
...
void CRecentPlayersMgr::AddOrUpdatePlayer(DrxUserID &inUserId, const char *inUserName)
{
	bool bUpdated=false;
