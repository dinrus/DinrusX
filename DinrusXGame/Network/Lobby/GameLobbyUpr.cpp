...
#include <DinrusX/CoreX/Lobby/IDrxSignIn.h>
...
void CGameLobbyUpr::OnlineCallback(UDrxLobbyEventData eventData, void *arg)
{
...
void CGameLobbyUpr::EthernetStateCallback(UDrxLobbyEventData eventData, void *arg)
{
...
void CGameLobbyUpr::ChatRestrictedCallback(UDrxLobbyEventData eventData, void *arg)
{
...
{
	DrxLog("CGameLobbyUpr::LeaveGameSession() reason=%i multiplayer %d", (int) reason, gEnv->bMultiplayer);
...
// static
void CGameLobbyUpr::UserSignoutCallback(DrxLobbyTaskID taskID, EDrxLobbyError error, uint32 user, void *pArg)
{
