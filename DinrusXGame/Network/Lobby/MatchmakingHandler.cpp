...
//------------------------------------------------------------------------
void CMatchMakingHandler::Search( int freeSlots, int maxResults, SDrxSessionSearchData* searchParameters, int numSearchParameters )
{
...
//------------------------------------------------------------------------
void CMatchMakingHandler::SearchCallback( DrxLobbyTaskID taskID, EDrxLobbyError error, SDrxSessionSearchResult* session, void* arg )
{
...
//------------------------------------------------------------------------
DrxSessionID CMatchMakingHandler::GetSessionId( int sessionIndex )
{
...
void CMatchMakingHandler::AdjustCreateSessionData( SDrxSessionData* pData, uint32 maxDataItems )
{
	if( !m_bActive )
		return;
