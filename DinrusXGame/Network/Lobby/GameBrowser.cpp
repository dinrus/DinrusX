...
//-------------------------------------------------------------------------
EDrxLobbyError CGameBrowser::StartSearchingForServers(SDrxSessionSearchParam* param, DrxMatchmakingSessionSearchCallback cb, void* cbArg, const bool bFavouriteIdSearch)
{
...
/* static */
void CGameBrowser::LocalisePresenceString(DrxFixedStringT<MAX_PRESENCE_STRING_SIZE> &out, const char* stringId)
{
...
/*static*/
void CGameBrowser::LocaliseInGamePresenceString(DrxFixedStringT<MAX_PRESENCE_STRING_SIZE> &out, const char* stringId, const int32 gameModeId, const int32 mapId)
{
	out = CHUDUtils::LocalizeString("@mp_rp_gameplay", GetGameModeStringFromId(gameModeId), GetMapStringFromId(mapId));
}

/* static */
bool CGameBrowser::CreatePresenceString(DrxFixedStringT<MAX_PRESENCE_STRING_SIZE> &out, SDrxLobbyUserData *pData, uint32 numData)
{
	bool result = true;
...
void CGameBrowser::ConfigurationCallback(EDrxLobbyService service, SConfigurationParams *requestedParams, uint32 paramCount)
{
	uint32 a;
...
void CGameBrowser::GetNatTypeCallback(UDrxLobbyEventData eventData, void *arg)
{
...
void CGameBrowser::InitialiseCallback(EDrxLobbyService service, EDrxLobbyError error, void* arg)
{
...
void CGameBrowser::MatchmakingSessionSearchCallback(DrxLobbyTaskID taskID, EDrxLobbyError error, SDrxSessionSearchResult* session, void* arg)
{
#if 0 // old frontend
	...
	{
		DrxLogAlways("CGameBrowser search for sessions error %d", (int)error);
