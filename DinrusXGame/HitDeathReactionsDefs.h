...
#include <DrxScriptSystem/ScriptHelpers.h>							// SmartScriptTable
#include <DinrusX/DinrusXAI/IAgent.h>											// EStance enumeration
#include <DinrusX/DinrusXAnimation/DrxCharAnimationParams.h>			// anim flags
