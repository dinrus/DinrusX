...
#include <DinrusX/DinrusXGame/AutoTester.h>

#if ENABLE_AUTO_TESTER

#include <DinrusX/DinrusXGame/FeatureTester.h>
		...
		case ATEST_STATE_TEST_NUM_CLIENTS_LEVEL_ROTATE:
			{
				...
				{
					DrxLogAlways("no timeToRunFirstLevel set, setting to timeToRunEachLevel=%d", (int)m_stateData.testNumClientsRotate.m_levelTimeOut);
