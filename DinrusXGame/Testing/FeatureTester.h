...
#include <DinrusX/DinrusXGame/Utility/SingleAllocTextBlock.h>
...
#include <DinrusX/DinrusXGame/FeatureTestMgr.h>
...
#endif
{
	...
	const char * GetActorInfoString(IActor * iActor, DrxFixedStringT<256> & reply);
