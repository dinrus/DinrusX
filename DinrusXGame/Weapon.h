...
#include <DinrusX/DinrusXGame/ScopeReticule.h>
...
#include <DinrusX/DinrusXGame/ShotDebug.h>
#include <DinrusX/DinrusXGame/UI/UITypes.h>
...
protected:
	typedef VectorMap<DrxHashStringId, int>					TFireModeIdMap;
	typedef std::vector<CFireMode *>						TFireModeVector;
	typedef VectorMap<DrxHashStringId, int>					TZoomModeIdMap;
...
public:
  ...
  virtual void OnDestroyed() override;
	...
	virtual void GetAttachmentsAtHelper(const char *helper, CDrxFixedStringListT<5, 30> &attachments) override;
