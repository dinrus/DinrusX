...
#include #include <DinrusX/DinrusXGame/State.h>
#include #include <DinrusX/DinrusXGame/EntityUtility/EntityEffects.h>
...
public:
	...
	ILINE EntityId GetTrackedEntityId( const uint32 idx ) const { DRX_ASSERT( idx < m_trackedEntities.size() ); return m_trackedEntities[idx]; }
