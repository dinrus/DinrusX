...
protected:
	...
	int RegisterWithAutoAimUpr(IFunctionHandler *pH, ScriptHandle entityId, float innerRadiusFactor, float outerRadiusFactor, float snapRadiusFactor);
	int UnregisterFromAutoAimUpr(IFunctionHandler *pH, ScriptHandle entityId);
