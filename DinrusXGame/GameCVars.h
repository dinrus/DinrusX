...
#include <DinrusX/DinrusXGame/GameConstantCVars.h>
...
#ifndef _RELEASE
	int g_VTOLVehicleUprDebugEnabled; 
	int g_VTOLVehicleUprDebugPathingEnabled;
	int g_VTOLVehicleUprDebugSimulatePath;
