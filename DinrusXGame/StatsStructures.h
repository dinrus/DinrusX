...
struct SSessionStats
{
	...
	struct SMap
	{
		typedef VectorMap<DrxFixedStringT<64>, int, std::less<DrxFixedStringT<64> >, stl::STLGlobalAllocator<std::pair<DrxFixedStringT<64>, int > > > MapNameToCount;
	...
	float GetStatStrings(const char* name, EDerivedIntMapPersistantStats stat, DrxFixedStringT<64>& valueString);
	float GetStatStrings(const char* name, EDerivedFloatMapPersistantStats stat, DrxFixedStringT<64>& valueString);
	float GetStatStrings(const char* name, EMapPersistantStats stat, DrxFixedStringT<64>& valueString);
	float GetStatStrings(EMapPersistantStats stat, DrxFixedStringT<64>& valueString);

	float GetStatStringsFromValue(EMapPersistantStats stat, int statValue, DrxFixedStringT<64>& valueString);
