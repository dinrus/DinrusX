...
#include <DinrusX/DinrusXGame/FrontEndModelCache.h>
...
#include <DinrusX/DinrusXGame/MenuRender3DModelMgr.h>
...
CFrontEndModelCache::CFrontEndModelCache()
{
	...
	if(pRootNode)
	{
		...
		// Pak
		const char* const pGameFolder = gEnv->pDrxPak->GetGameFolder();
