...
#include <DinrusX/DinrusXGame/Option.h>
...
void CCVarOption::GetWriteToConfigString(DrxFixedStringT<128> &outString, ICVar* pCVar, const char* param) const
{
	if(!param || !pCVar)
		return;
...
void CScreenResolutionOption::GetWriteToConfigString(DrxFixedStringT<128> &outString, ICVar* pCVar, const char* param) const
{
	if(!param)
		return;
