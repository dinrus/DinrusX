...
#include <DinrusX/DinrusXGame/WarningsUpr.h>
#include <DinrusX/DinrusXGame/UIUpr.h>
...
////////////////////////////////////////////////////////////////////////////
THUDWarningId CWarningsUpr::AddGameWarning(const char* stringId, const char* paramMessage, IGameWarningsListener* pListener)
{
...
////////////////////////////////////////////////////////////////////////////
void CWarningsUpr::AddGameWarning(THUDWarningId id, const char* paramMessage, IGameWarningsListener* pListener)
{
...
////////////////////////////////////////////////////////////////////////////
void CWarningsUpr::AddGameWarning(const SWarningDefinition* pWarningDef, const char* paramMessage, IGameWarningsListener* pListener)
{
...
////////////////////////////////////////////////////////////////////////////
void CWarningsUpr::RemoveGameWarning(const char* stringId)
{
	const SWarningDefinition* pWarningDef = GetWarningDefinition(stringId);
	if(pWarningDef)
	{
...
////////////////////////////////////////////////////////////////////////////
THUDWarningId CWarningsUpr::GetWarningId(const char* stringId) const
{
...
////////////////////////////////////////////////////////////////////////////
bool CWarningsUpr::IsWarningActive(const char* stringId) const
{
	const SWarningDefinition* pWarningDef = GetWarningDefinition(stringId);
	if (pWarningDef)
...
////////////////////////////////////////////////////////////////////////////
void CWarningsUpr::DialogCallback(uint32 dialogId, EDialogResponse response, const char* param)
{
...
////////////////////////////////////////////////////////////////////////////
CWarningsUpr::SGameWarning* CWarningsUpr::GetWarningForDialog(uint32 dialogId)
{
...
////////////////////////////////////////////////////////////////////////////
const SWarningDefinition* CWarningsUpr::GetWarningDefinition(const char* stringId) const
{
	for (TWarningDefMap::const_iterator it = m_WarningDefinitions.begin(), end = m_WarningDefinitions.end(); it != end; ++it)
	{
