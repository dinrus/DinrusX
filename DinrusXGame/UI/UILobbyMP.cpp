...
#include <DinrusX/DinrusXGame/UILobbyMP.h>
...
#include <DinrusX/CoreX/Lobby/IDrxReward.h>
...
static std::map<int, std::vector<DrxUserID> > m_FriendsMap; // containerId -> friendList with userID's for invites
...
////////////////////////////////////////////////////////////////////////////
void CUILobbyMP::MatchmakingSessionSearchCallback(DrxLobbyTaskID taskID, EDrxLobbyError error, SDrxSessionSearchResult* session, void* arg)
{
	int breakhere = 0;
...
////////////////////////////////////////////////////////////////////////////
void CUILobbyMP::GetFriendsCB(DrxLobbyTaskID taskID, EDrxLobbyError error, SFriendInfo* pFriendInfo, uint32 numFriends, void* pArg)
{
...
////////////////////////////////////////////////////////////////////////////
void CUILobbyMP::InviteFriendsCB(DrxLobbyTaskID taskID, EDrxLobbyError error, void* pArg)
{
	DrxLog("UILobbyMP: Sending friend invite callback error: %d", error);
}

////////////////////////////////////////////////////////////////////////////
void CUILobbyMP::RegisterLeaderboardCB(DrxLobbyTaskID TaskID, EDrxLobbyError Error, void *Arg)
{
...
////////////////////////////////////////////////////////////////////////////
void CUILobbyMP::WriteLeaderboardCallback(DrxLobbyTaskID TaskID, EDrxLobbyError Error, void *Arg)
{
	if (Error > eCLE_SuccessContinue)
...
////////////////////////////////////////////////////////////////////////////
void CUILobbyMP::ReadLeaderBoardCB(DrxLobbyTaskID TaskID, EDrxLobbyError Error, SDrxStatsLeaderBoardReadResult *Result, void *Arg)
{
	if(Error != eCLE_Success)
	{
	...
	for (int i = 0; i < Result->numRows; i++)
	{
		...
		switch(Result->pRows[i].data.score.score.m_type)
		{
			...
			default:
				{
					DrxWarning( VALIDATOR_MODULE_GAME, VALIDATOR_ERROR, "CUILobbyMP: Leaderboard read fail, column type not supported (only int32/int64)");
				}
		}
...
void CUILobbyMP::ReadUserDataCallback(DrxLobbyTaskID taskID, EDrxLobbyError error, SDrxLobbyUserData* pData, uint32 numData, void* pArg)
{
