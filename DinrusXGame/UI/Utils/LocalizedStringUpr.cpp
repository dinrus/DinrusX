...
#include <DinrusX/DinrusXGame/LocalizedStringUpr.h>
#include <DinrusX/DinrusXSys/ILocalizationUpr.h>
#include <DinrusX/CoreX/DrxCrc32.h>

//-----------------------------------------------------------------------------------------------------

int CLocalizedStringUpr::s_maxAge = -1;
...
const wchar_t* CLocalizedStringUpr::add(const wchar_t* finalStr, const char* label, 
...
const wchar_t* CLocalizedStringUpr::find(const char* label, 
																						 bool bAdjustActions, bool bPreferXI,
																						 const char* param1, const char* param2, 
																						 const char* param3, const char* param4)
{
...
void CLocalizedStringUpr::tick()
{
	...
	const char* language = gEnv->pSystem->GetLocalizationUpr()->GetLanguage();
