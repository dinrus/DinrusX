...
public:
	...
	void PlayAnimation(int animId, const DrxCharAnimationParams& Params, float speedMultiplier, float animTime);
	void PlayUpperAnimation(int animId, const DrxCharAnimationParams& Params, float speedMultiplier, float animTime);
...
private:
	bool GetAdjustedLayerTime(ICharacterInstance* pCharacterInstance, int animId, const DrxCharAnimationParams& params, float speedMultiplier, float animTime, float &adjustedLayerTime);
