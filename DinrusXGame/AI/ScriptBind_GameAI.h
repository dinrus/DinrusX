...
#include <DinrusX/DinrusXGame/RangeModule.h> // For RangeID
...
private:
	...
	int RegisterEntityForAISquadUpr(IFunctionHandler* pH, ScriptHandle entityId);
	int RemoveEntityForAISquadUpr(IFunctionHandler* pH, ScriptHandle entityId);
