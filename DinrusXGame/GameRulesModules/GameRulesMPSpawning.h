...
#include <DinrusX/DinrusXGame/SpawningVisTable.h>
...
#include <DinrusX/DinrusXGame/GameRules.h>	// only needed for DrxLog below
...
protected:
	...
	DrxFixedArray<uint32, MAX_PLAYER_LIMIT> m_initialChannelIDs;
