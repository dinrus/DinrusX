...
//   struct SMyStruct
//   {
//     static DrxGUID ReflectType(Schematyc::CTypeDesc<SMyStruct>& desc); // Intrusive
//   };
//
//   static inline DrxGUID ReflectType(Schematyc::CTypeDesc<SMyStruct>& desc); // Non-intrusive
//
...
#include <DinrusX/CoreX/Memory/AddressHelpers.h>
...
#include <DinrusX/DinrusXSchema/TypeDesc.inl>
#include <DinrusX/DinrusXSchema/DefaultTypeReflection.inl>
