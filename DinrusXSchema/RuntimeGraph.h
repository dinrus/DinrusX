...
public:
	...
	inline CRuntimeGraphNode(const DrxGUID& guid, const char* szName, RuntimeGraphNodeCallbackPtr pCallback, RuntimeGraphPortIdx inputCount, RuntimeGraphPortIdx outputCount)
		: m_guid(guid)
		, m_name(szName)
...
public:
	...
	inline CRuntimeGraph(const DrxGUID& guid, const char* szName)
		: m_guid(guid)
		, m_name(szName)
	{}
	...
	inline bool AddNode(const DrxGUID& guid, const char* szName, RuntimeGraphNodeCallbackPtr pCallback, RuntimeGraphPortIdx inputCount, RuntimeGraphPortIdx outputCount)
	{
