...
public:
	...
	inline CEnvInterface(const DrxGUID& guid, const char* szName, const SSourceFileInfo& sourceFileInfo)
...
public:
	...
	inline CEnvInterfaceFunction(const DrxGUID& guid, const char* szName, const SSourceFileInfo& sourceFileInfo)
		: CEnvElementBase(guid, szName, sourceFileInfo)
	{}
...
inline std::shared_ptr<CEnvInterface> MakeShared(const DrxGUID& guid, const char* szName, const SSourceFileInfo& sourceFileInfo)
{
...
inline std::shared_ptr<CEnvInterfaceFunction> MakeShared(const DrxGUID& guid, const char* szName, const SSourceFileInfo& sourceFileInfo)
{
