...
public:
	...
	template<typename FUNCTION_PTR_TYPE> inline CEnvFunction(FUNCTION_PTR_TYPE pFunction, const DrxGUID& guid, const char* szName, const SSourceFileInfo& sourceFileInfo)
...
template<typename FUNCTION_PTR_TYPE> inline std::shared_ptr<CEnvFunction> MakeShared(FUNCTION_PTR_TYPE pFunction, const DrxGUID& guid, const char* szName, const SSourceFileInfo& sourceFileInfo)
{
