...
#include <DinrusX/DinrusXSchema/Signal.h>
    ...
    #define SCHEMATYC_FATAL_ERROR(streamId, ...) gEnv->pSchematyc->GetLog().FatalError(streamId, __VA_ARGS__); DrxFatalError(__VA_ARGS__)
    ...
    #define SCHEMATYC_CRITICAL_ERROR(streamId, ...)                                \
      {                                                                            \
        ...
        {                                                                          \
          ...
          case Schematyc::ECriticalErrorStatus::Continue:                          \
             {                                                                     \
                        bIgnore = false;                                           \
              break;                                                               \
             }                                                                     \
