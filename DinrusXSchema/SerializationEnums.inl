...
SERIALIZATION_ENUM_BEGIN_NESTED(Schematyc, EDomain, "DrxSchematyc Domain")
SERIALIZATION_ENUM(Schematyc::EDomain::Env, "Env", "Environment")
SERIALIZATION_ENUM(Schematyc::EDomain::Script, "Script", "Script")
SERIALIZATION_ENUM_END()

SERIALIZATION_ENUM_BEGIN_NESTED(Schematyc, EOverridePolicy, "DrxSchematyc Override Policy")
...
SERIALIZATION_ENUM_BEGIN_NESTED(Schematyc, ETimerUnits, "DrxSchematyc Timer Units")
...
SERIALIZATION_ENUM_BEGIN_NESTED(Schematyc, ETimerFlags, "DrxSchematyc Timer Flags")
...
SERIALIZATION_ENUM_BEGIN_NESTED2(Schematyc, CUniqueId, EType, "DrxSchematyc Unique Port Id Type")
...
SERIALIZATION_ENUM_BEGIN_NESTED(Schematyc, EScriptElementType, "DrxSchematyc Script Element Type")
...
SERIALIZATION_ENUM_BEGIN_NESTED(Schematyc, EScriptElementAccessor, "DrxSchematyc Script Element Accessor")
...
SERIALIZATION_ENUM_BEGIN_NESTED(Schematyc, EScriptSignalReceiverType, "DrxSchematyc Script Signal Receiver Type")
