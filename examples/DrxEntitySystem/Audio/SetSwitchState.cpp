...
void SetSwitchState(IEntity& entity)
{
	...
	constexpr DrxAudio::ControlId switchIdentifier = DrxAudio::StringToId("MySwitch");
	...
	constexpr DrxAudio::SwitchStateId switchStateIdentifier = DrxAudio::StringToId("MySwitchState");
