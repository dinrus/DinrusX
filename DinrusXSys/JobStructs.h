...
struct SJobQueue
{
	...
	JobUpr::detail::EAddJobRes GetJobSlot(uint32& rJobSlot, uint32 nPriorityLevel, bool bWaitForFreeJobSlot);
...
///////////////////////////////////////////////////////////////////////////////
template<int nMaxWorkQueueJobsHighPriority, int nMaxWorkQueueJobsRegularPriority, int nMaxWorkQueueJobsLowPriority, int nMaxWorkQueueJobsStreamPriority>
inline JobUpr::detail::EAddJobRes JobUpr::SJobQueue<nMaxWorkQueueJobsHighPriority, nMaxWorkQueueJobsRegularPriority, nMaxWorkQueueJobsLowPriority, nMaxWorkQueueJobsStreamPriority >::GetJobSlot(uint32& rJobSlot, uint32 nPriorityLevel, bool bWaitForFreeJobSlot)
{
	...
	do
	{
		...
		currentIndex = DrxInterlockedCompareExchange64(alias_cast<volatile int64*>(&curPushEntry.index), 0, 0);
#else
		...
		nExtractedIndex = static_cast<uint32>(JobUpr::SJobQueuePos::ExtractIndex(currentIndex, nPriorityLevel));
		...
		if (DrxInterlockedCompareExchange64(alias_cast<volatile int64*>(&curPushEntry.index), nextIndex, currentIndex) == currentIndex)
			break;
...
///////////////////////////////////////////////////////////////////////////////
template<int nMaxWorkQueueJobsHighPriority, int nMaxWorkQueueJobsRegularPriority, int nMaxWorkQueueJobsLowPriority, int nMaxWorkQueueJobsStreamPriority>
ILINE uint32 JobUpr::SJobQueue<nMaxWorkQueueJobsHighPriority, nMaxWorkQueueJobsRegularPriority, nMaxWorkQueueJobsLowPriority, nMaxWorkQueueJobsStreamPriority >::GetMaxWorkerQueueJobs(uint32 nPriorityLevel)
{
...
template<int nMaxWorkQueueJobsHighPriority, int nMaxWorkQueueJobsRegularPriority, int nMaxWorkQueueJobsLowPriority, int nMaxWorkQueueJobsStreamPriority>
ILINE const char* JobUpr::SJobQueue<nMaxWorkQueueJobsHighPriority, nMaxWorkQueueJobsRegularPriority, nMaxWorkQueueJobsLowPriority, nMaxWorkQueueJobsStreamPriority>::PrioToString(uint32 nPriorityLevel)
{
	switch (nPriorityLevel)
	{
	case eHighPriority:
