...
public:
	...
	CDrxPluginUpr(const SSystemInitParams& initParams);
	...
	virtual void OnPluginUpdateFlagsChanged(Drx::IEnginePlugin& plugin, uint8 newFlags, uint8 changedStep) override;
	// ~Drx::IPluginUpr
...
protected:
	...
	std::vector<Drx::IEnginePlugin*>& GetUpdatedPluginsForStep(Drx::IEnginePlugin::EUpdateStep step) { return m_updatedPlugins[IntegerLog2(static_cast<uint8>(step))]; }
