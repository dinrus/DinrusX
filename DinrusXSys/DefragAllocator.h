...
#include <DinrusX/CoreX/Memory/IDefragAllocator.h>
...
public:
	...
	ILINE UINT_PTR Pin(Hdl hdl)
	{
		...
		while (DrxInterlockedCompareExchange(alias_cast<volatile LONG*>(&chunk.attr.ui), newAttr.ui, attr.ui) != attr.ui);
...
private:
	...
	void MarkAsMoving(SDefragAllocChunk& src)
	{
		...
		while (DrxInterlockedCompareExchange(alias_cast<volatile LONG*>(&src.attr.ui), srcNewAttr.ui, srcAttr.ui) != srcAttr.ui);
	}
