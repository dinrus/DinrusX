...
#include <DinrusX/DinrusXSys/IWindowMessageHandler.h>

#include <DinrusX/CoreX/Math/Random.h>
#include <DinrusX/CoreX/Platform/DrxLibrary.h>

#include <DinrusX/DinrusXSys/Timer.h>
...
#include <DinrusX/DinrusXSys/MemoryFragmentationProfiler.h>  // CMemoryFragmentationProfiler
...
struct IHost;
	...
	#include <DinrusX/DinrusXSys/DownloadUpr.h>
...
DRX_ASYNC_MEMCPY_API void drxAsyncMemcpy(void* dst, const void* src, size_t size, int nFlags, volatile int* sync);
#else
DRX_ASYNC_MEMCPY_API void _drxAsyncMemcpy(void* dst, const void* src, size_t size, int nFlags, volatile int* sync);
#endif
...
public:
	...
	virtual IDrxFactory* LoadModuleWithFactory(const char* dllName, const DrxInterfaceID& moduleInterfaceId) override;
...
private:
	...
	bool InitializeEngineModule(const SSystemInitParams& startupParams, const char* dllName, const DrxInterfaceID& moduleInterfaceId, bool bQuitIfNotFound);
...
/*extern static */ bool QueryModuleMemoryInfo(SDinrusXStatsModuleInfo& moduleInfo, int index);
