...
inline const char* DrxGetExt(const char* filepath)
{
...
{
	const char* ext = DrxGetExt(filename);
...
public:
	...
	CDrxFile(const char* filename, const char* mode, int nOpenFlagsEx = 0);
	~CDrxFile();
...
//////////////////////////////////////////////////////////////////////////
inline CDrxFile::CDrxFile(const char* filename, const char* mode, int nOpenFlagsEx)
{
	m_file = 0;
	m_pIPak = gEnv ? gEnv->pDrxPak : NULL;
...
inline bool CDrxFile::Open(const char* filename, const char* mode, int nOpenFlagsEx)
{
...
//////////////////////////////////////////////////////////////////////////
inline size_t CDrxFile::Write(const void* lpBuf, size_t nSize)
{
	assert(m_file);
...
//////////////////////////////////////////////////////////////////////////
inline size_t CDrxFile::ReadRaw(void* lpBuf, size_t nSize)
{
	assert(m_file);
...
//////////////////////////////////////////////////////////////////////////
inline size_t CDrxFile::Seek(size_t seek, int mode)
{
	assert(m_file);
...
//////////////////////////////////////////////////////////////////////////
inline const char* CDrxFile::GetPakPath() const
{
	if (m_file && m_pIPak)
	{
...
//////////////////////////////////////////////////////////////////////////
inline const char* CDrxFile::GetAdjustedFilename() const
{
