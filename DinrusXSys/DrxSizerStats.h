...
{
public:
	DrxSizerStatsBuilder(DrxSizerImpl* pSizer, int nMinSubcomponentBytes = 0);
...
public:
	// constructor
	DrxSizerStatsRenderer(ISystem* pSystem, DrxSizerStats* pStats, unsigned nMaxDepth = 2, int nMinSubcomponentBytes = -1);
