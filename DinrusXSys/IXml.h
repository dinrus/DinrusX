...
#include <DinrusX/CoreX/ToolsHelpers/GuidUtil.h>
#endif
...
public:
	...
	virtual void setAttr(const char* key, const DrxGUID& value) = 0;

	virtual bool getAttr(const char* key, DrxGUID& value) const = 0;
