...
#include <DinrusX/DinrusXSys/Huffman.h>
...
public:
	...
	// ILocalizationUpr
	virtual const char*                                 LangNameFromPILID(const ILocalizationUpr::EPlatformIndependentLanguageID id);
	...
	int  GetMemoryUsage(IDrxSizer* pSizer);
...
private:
	...
	void        LocalizedStringsUprWarning(const char* label, const char* message);
