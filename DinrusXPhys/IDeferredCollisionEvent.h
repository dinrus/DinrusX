...
//! Upr class  for deferred physics events.
struct IDeferredPhysicsEventUpr
{
	...
	virtual int HandleEvent(const EventPhys* pEvent, IDeferredPhysicsEventUpr::CreateEventFunc, IDeferredPhysicsEvent::DeferredEventType) = 0;
