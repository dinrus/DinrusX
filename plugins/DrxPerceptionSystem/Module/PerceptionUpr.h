...
#include "../Interface/IPerceptionUpr.h"
#include "PerceptionActor.h"

<DinrusX/DinrusXAI/IAISystem.h>
<DinrusX/DinrusXAI/ValueHistory.h>
<DinrusX/DinrusXAI/IAISystemComponent.h>

struct IAIActor;
struct IAIObject;

class CScriptBind_PerceptionUpr;

class CPerceptionUpr : public IPerceptionUpr, public IAISystemComponent, public ISystemEventListener
{
public:
	CPerceptionUpr();
	virtual ~CPerceptionUpr() override;

	static CPerceptionUpr* GetInstance() { return s_pInstance; }
...
private:
	...
	CScriptBind_PerceptionUpr* m_pScriptBind;
	...
	struct CVars
	{
		...
		DeclareConstIntCVar(DebugPerceptionUpr, 0);
	...
	bool m_bRegistered;
	static CPerceptionUpr* s_pInstance;
};
