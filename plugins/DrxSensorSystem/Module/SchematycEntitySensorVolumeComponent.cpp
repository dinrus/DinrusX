...
<DinrusX/CoreX/Serialization/DynArray.h>
...
namespace Drx
{
	namespace SensorSystem
	{
		...
		{
			desc.SetGUID("{351924F1-EF4F-47E6-8E2E-05F0643F6A1A}"_drx_guid);
		...
		{
			desc.SetGUID("{0C6ACF7E-9123-4DFE-AFA9-9FCE8AFBDA03}"_drx_guid);
		...
		{
			desc.SetGUID("ed2add7d-d063-4371-9a91-b6c13e0c2751"_drx_guid);
		...
		{
			desc.SetGUID("6f03eddc-71ff-467e-9d8d-ad7e57438aad"_drx_guid);
			desc.SetLabel("Tags");
		...
		{
			desc.SetGUID("19cb7f01-1921-441c-b90e-64f940f38e80"_drx_guid);
		...
		{
			desc.SetGUID("474cc5fe-d7f0-4606-a06c-72cc0b3080cb"_drx_guid);
		...
		{
			desc.SetGUID("5F0322C0-2EB0-46C7-B3E3-56AB5F200E74"_drx_guid);
		...
		void CSchematycEntitySensorVolumeComponent::Register(Schematyc::IEnvRegistrar& registrar)
		{
			Schematyc::CEnvRegistrationScope scope = registrar.Scope(IEntity::GetEntityScopeGUID());
			{
				...
				// Functions
				{
					auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CSchematycEntitySensorVolumeComponent::SetVolumeSize, "C926DA55-97A2-4C97-A7E6-C1416DD6284A"_drx_guid, "SetVolumeSize");
				...
				{
					auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CSchematycEntitySensorVolumeComponent::GetVolumeSize, "E8E87E86-C96B-4948-A298-0FE010E04F2E"_drx_guid, "GetVolumeSize");
				...
				{
					auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CSchematycEntitySensorVolumeComponent::SetVolumeRadius, "17FB678F-2256-4F7B-AB46-E8EAACD2497C"_drx_guid, "SetVolumeRadius");
				...
				{
					auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CSchematycEntitySensorVolumeComponent::GetVolumeRadius, "3950621F-8D47-4BE7-836C-35F211B41FBB"_drx_guid, "GetVolumeRadius");
		...
		CSensorBounds CSchematycEntitySensorVolumeComponent::CreateBounds(const Matrix34& worldTM, const DrxTransform::CTransformPtr& transform) const
		{
