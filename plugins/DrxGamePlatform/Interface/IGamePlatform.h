...
namespace Drx
{
	namespace GamePlatform
	{
		...
		//! This can be queried via gEnv->pSystem->GetIPluginUpr()->QueryPlugin<IGamePlatform>();
		struct IPlugin : public Drx::IEnginePlugin
		{
			...
			DRXINTERFACE_DECLARE_GUID(IPlugin, "{7A7D908B-D12F-4827-B410-F50386018036}"_drx_guid);
