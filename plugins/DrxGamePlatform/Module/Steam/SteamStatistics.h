	...
	namespace GamePlatform
	{
		namespace Steam
		{
			...
			public:
				...
				virtual IAchievement* GetAchievement(int identifier) override { DRX_ASSERT_MESSAGE(false, "Steam only provides support for retrieving achievements by name!"); return nullptr; }
