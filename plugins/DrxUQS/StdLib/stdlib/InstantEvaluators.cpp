...
namespace UQS
{
	namespace StdLib
	{
		...
		{
			{
				...
				ctorParams.guid = "1913cd53-ba27-4285-a901-fa83997c681f"_drx_guid;
...

			{
				...
				ctorParams.guid = "46cb5dcd-aacf-4b6c-b30f-5e678dbac707"_drx_guid;
...

			{
				...
				ctorParams.guid = "1c62cf8c-09f1-4ee8-a0e5-bd2a6c6c44e3"_drx_guid;
...

			{
				...
				ctorParams.guid = "fc41cc13-3967-462a-b464-b61af028f613"_drx_guid;
...

			{
				...
				ctorParams.guid = "78a52467-32a0-4bcd-918a-df7db9d2b715"_drx_guid;
...

			{
				...
				ctorParams.guid = "ff8bd552-db0d-47a2-9238-14f5e1eeedbf"_drx_guid;
		...
		{
			runContext.evaluationResult.score = drx_random(0.0f, 1.0f);
			return ERunStatus::Finished;
		}
