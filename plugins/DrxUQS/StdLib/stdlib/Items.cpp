	...
	namespace StdLib
	{
		...
		void CStdLibRegistration::InstantiateItemFactoriesForRegistration()
		{
			// std::EntityId
			{
				...
				ctorParams.guid = "1ad38a1e-1fd6-469e-a03a-4d600b334e62"_drx_guid;
...
#if UQS_SCHEMATYC_SUPPORT
				ctorParams.callbacks.itemConverters.AddFromForeignTypeConverter<EntityId, &ConvertEntityIdToEntityIdWrapper>("EntityId", "std::EntityIdWrapper", "345ae48a-ad37-4458-94b9-64806c2df087"_drx_guid);
				ctorParams.callbacks.itemConverters.AddToForeignTypeConverter<EntityId, &ConvertEntityIdWrapperToEntityId>("std::EntityIdWrapper", "EntityId", "82bd2238-dd8e-44ae-af30-a58e36f3b9a3"_drx_guid);
#endif
			...
			// std::int
			{
				...
				ctorParams.guid = "da2d5ee0-ad34-4cfd-88bb-a4111701a648"_drx_guid;
			...
			// std::bool
			{
				...
				ctorParams.guid = "9605e7fe-d519-49e9-8ded-3e60170df1df"_drx_guid;
			...
			// std::float
			{
				...
				ctorParams.guid = "73bcca90-c7c2-47be-94ac-6f306e82e257"_drx_guid;
			...
			// std::Pos3
			{
				...
				ctorParams.guid = "1b363d0a-dc71-45d4-9a8d-0fdb7d9e228c"_drx_guid;
...
#if UQS_SCHEMATYC_SUPPORT
				ctorParams.callbacks.itemConverters.AddFromForeignTypeConverter<Vec3, &ConvertVec3ToVec3BasedWrapper<Pos3>>("Vec3", "std::Pos3", "30aca024-1fff-4fb5-8956-cf54085c46dd"_drx_guid);
				ctorParams.callbacks.itemConverters.AddToForeignTypeConverter<Vec3, &ConvertVec3BasedWrapperToVec3<Pos3>>("std::Pos3", "Vec3", "9c90027d-0a4e-4420-9069-8797e69d37bc"_drx_guid);
#endif
			...
			// std::Ofs3
			{
				...
				ctorParams.guid = "41e2adc2-8318-43c4-b6f0-9bd549586dcf"_drx_guid;
...
#if UQS_SCHEMATYC_SUPPORT
				ctorParams.callbacks.itemConverters.AddFromForeignTypeConverter<Vec3, &ConvertVec3ToVec3BasedWrapper<Ofs3>>("Vec3", "std::Ofs3", "f36a4dde-2995-4f96-bda4-f8546b0074a9"_drx_guid);
				ctorParams.callbacks.itemConverters.AddToForeignTypeConverter<Vec3, &ConvertVec3BasedWrapperToVec3<Ofs3>>("std::Ofs3", "Vec3", "5ff51b20-affa-4bf1-9bed-ec478a3c4f8c"_drx_guid);
#endif
			...
			// std::Dir3
			{
				...
				ctorParams.guid = "eca80817-8631-48ba-9a1b-37d187ec92a2"_drx_guid;
...
#if UQS_SCHEMATYC_SUPPORT
				ctorParams.callbacks.itemConverters.AddFromForeignTypeConverter<Vec3, &ConvertVec3ToVec3BasedWrapper<Dir3>>("Vec3", "std::Dir3", "95e16187-ac55-4dd7-80dd-0ffa42edbcdc"_drx_guid);
				ctorParams.callbacks.itemConverters.AddToForeignTypeConverter<Vec3, &ConvertVec3BasedWrapperToVec3<Dir3>>("std::Dir3", "Vec3", "f525d01e-272e-4f38-a480-ab119d12b766"_drx_guid);
#endif
			...
			// std::NavigationAgentTypeID
			{
				...
				ctorParams.guid = "4338dd81-718a-4365-a21a-65d5b5d08bd3"_drx_guid;
