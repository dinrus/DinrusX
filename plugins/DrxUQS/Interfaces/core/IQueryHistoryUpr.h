...
namespace UQS
{
	namespace Core
	{
		...
		inline IQueryHistoryUpr::SEvaluatorDrawMasks::SEvaluatorDrawMasks(evaluatorsBitfield_t _maskInstantEvaluators, evaluatorsBitfield_t _maskDeferredEvaluators)
			: maskInstantEvaluators(_maskInstantEvaluators)
			, maskDeferredEvaluators(_maskDeferredEvaluators)
		{}

		inline IQueryHistoryUpr::SEvaluatorDrawMasks IQueryHistoryUpr::SEvaluatorDrawMasks::CreateAllBitsSet()
		{
			return SEvaluatorDrawMasks(std::numeric_limits<evaluatorsBitfield_t>::max(), std::numeric_limits<evaluatorsBitfield_t>::max());
		}

		inline IQueryHistoryUpr::SEvaluatorDrawMasks IQueryHistoryUpr::SEvaluatorDrawMasks::CreateNoBitSet()
		{
