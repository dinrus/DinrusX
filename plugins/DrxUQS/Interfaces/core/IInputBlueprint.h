...
namespace UQS
{
	namespace Core
	{
		...
		struct ITextualInputBlueprint
		{
			...
			virtual const DrxGUID&                        GetFuncGUID() const = 0;
			...
			virtual void                                  SetFuncGUID(const DrxGUID& funcGUID) = 0;
			...
			virtual ITextualInputBlueprint&               AddChild(const char* szParamName, const Client::CInputParameterID& paramID, const char* szFuncName, const DrxGUID& funcGUID, const char* szFuncReturnValueLiteral, bool bAddReturnValueToDebugRenderWorldUponExecution) = 0;
