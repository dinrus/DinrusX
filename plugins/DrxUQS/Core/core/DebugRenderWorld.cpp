...
namespace UQS
{
	namespace Core
	{
		...
		void CDebugRenderWorldPersistent::DrawAllAddedPrimitivesAssociatedWithItem(size_t indexOfItemToDrawPrimitivesOf, const IQueryHistoryUpr::SEvaluatorDrawMasks& evaluatorDrawMasks, const ColorF& colorToOverridePrimitivesWithIfPartOfTheItem, bool bHighlight) const
		{
