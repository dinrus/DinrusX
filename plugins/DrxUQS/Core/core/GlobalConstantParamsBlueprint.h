...
namespace UQS
{
	namespace Core
	{
		...
		public:
			...
			virtual void                                  AddParameter(const char* szName, const char* szTypeName, const DrxGUID& typeGUID, const char* szValue, bool bAddToDebugRenderWorld, DataSource::SyntaxErrorCollectorUniquePtr pSyntaxErrorCollector) override;
		...
		private:
			...
			{
				explicit                                  SStoredParameterInfo(const char* _szName, const char* _szTypeName, const DrxGUID& _typeGUID, const char* _szValue, bool _bAddToDebugRenderWorld, DataSource::SyntaxErrorCollectorUniquePtr _pSyntaxErrorCollector);
		...
		inline CTextualGlobalConstantParamsBlueprint::SStoredParameterInfo::SStoredParameterInfo(const char* _szName, const char* _szTypeName, const DrxGUID& _typeGUID, const char* _szValue, bool _bAddToDebugRenderWorld, DataSource::SyntaxErrorCollectorUniquePtr _pSyntaxErrorCollector)
			: name(_szName)
