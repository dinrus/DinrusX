...
namespace UQS
{
	...
	namespace Core
	{
		...
		public:
			...
			virtual CQueryUpr&                                     GetQueryUpr() override;
			virtual CQueryHistoryUpr&                              GetQueryHistoryUpr() override;
			...
			virtual CSettingsUpr&                                  GetSettingsUpr() override;
			...
			static DrxGUID                                             GetSchematycPackageGUID() { return "5ee1079d-1b49-41c0-856d-6521d8758bd6"_drx_guid; }
#endif
