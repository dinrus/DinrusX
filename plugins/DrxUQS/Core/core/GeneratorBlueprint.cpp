...
namespace UQS
{
	namespace Core
	{
		...
		void CTextualGeneratorBlueprint::SetGeneratorGUID(const DrxGUID& generatorGUID)
		{
		...
		const DrxGUID& CTextualGeneratorBlueprint::GetGeneratorGUID() const
		{
		...
		{
			const DrxGUID& generatorGUID = source.GetGeneratorGUID();
