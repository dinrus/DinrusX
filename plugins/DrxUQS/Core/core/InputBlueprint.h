...
namespace UQS
{
	...
	namespace Core
	{
		...
		public:
			...
			virtual const DrxGUID&                      GetFuncGUID() const override;
			...
			virtual void                                SetFuncGUID(const DrxGUID& funcGUID) override;
			...
			virtual ITextualInputBlueprint&             AddChild(const char* szParamName, const Client::CInputParameterID& paramID, const char* szFuncName, const DrxGUID& funcGUID, const char* szFuncReturnValueLiteral, bool bAddReturnValueToDebugRenderWorldUponExecution) override;
		...
		private:
			explicit                                    CTextualInputBlueprint(const char* szParamName, const Client::CInputParameterID& paramID, const char* szFuncName, const DrxGUID& funcGUID, const char* szFuncReturnValueLiteral, bool bAddReturnValueToDebugRenderWorldUponExecution);
