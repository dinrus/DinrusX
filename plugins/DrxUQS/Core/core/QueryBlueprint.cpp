...
namespace UQS
{
	namespace Core
	{
		...
		CTextualQueryBlueprint::CTextualQueryBlueprint()
			: m_queryFactoryGUID(DrxGUID::Null())
		...
		void CTextualQueryBlueprint::SetQueryFactoryGUID(const DrxGUID& factoryGUID)
		{
		...
		const DrxGUID& CTextualQueryBlueprint::GetQueryFactoryGUID() const
		{
		...
		bool CQueryBlueprint::Resolve(const ITextualQueryBlueprint& source)
		{
			...
			{
				const DrxGUID& queryFactoryGUID = source.GetQueryFactoryGUID();
