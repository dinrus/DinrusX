...
namespace UQS
{
	namespace Core
	{
		...
		protected:
			explicit                            CQueryFactoryBase(const char* szName, const DrxGUID& guid, const char* szDescription, bool bSupportsParameters, bool bRequiresGenerator, bool bSupportsEvaluators, size_t minRequiredChildren, size_t maxAllowedChildren);
		...
		{
		public:
			explicit                            CQueryFactory(const char* szName, const DrxGUID& guid, const char* szDescription, bool bSupportsParameters, bool bRequiresGenerator, bool bSupportsEvaluators, size_t minRequiredChildren, size_t maxAllowedChildren);
		...
		template <class TQuery>
		CQueryFactory<TQuery>::CQueryFactory(const char* szName, const DrxGUID& guid, const char* szDescription, bool bSupportsParameters, bool bRequiresGenerator, bool bSupportsEvaluators, size_t minRequiredChildren, size_t maxAllowedChildren)
