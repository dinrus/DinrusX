...
namespace UQS
{
	namespace Core
	{
		...
		CScoreTransformFactory::CScoreTransformFactory(const char* szName, const DrxGUID& guid, const char* szDescription, EScoreTransformType scoreTransformType)
		...
		const DrxGUID& CScoreTransformFactory::GetGUID() const
		{
		...
		void CScoreTransformFactory::InstantiateFactories()
		{
			...
			static const CScoreTransformFactory scoreTransformFactory_linear("Linear", "a4782c62-101b-4039-a68d-c115b65493b1"_drx_guid, szDescription_linear, EScoreTransformType::Linear);
			static const CScoreTransformFactory scoreTransformFactory_linearInverse("LinearInverse", "92bb5c1d-f6a3-4477-a24d-adb04b4b6828"_drx_guid, szDescription_linearInverse, EScoreTransformType::LinearInverse);
			static const CScoreTransformFactory scoreTransformFactory_sine180("Sine180", "c1593038-fc89-43cc-ac1f-6d2ef563fe14"_drx_guid, szDescription_sine180, EScoreTransformType::Sine180);
			static const CScoreTransformFactory scoreTransformFactory_sine180inverse("Sine180Inverse", "8b81091c-6de7-45b6-a58c-12d03cbf2dad"_drx_guid, szDescription_sine180inverse, EScoreTransformType::Sine180Inverse);
			static const CScoreTransformFactory scoreTransformFactory_square("Square", "b52a94b5-3322-4b02-a9d8-c388d6b6cf31"_drx_guid, szDescription_square, EScoreTransformType::Square);
			static const CScoreTransformFactory scoreTransformFactory_squareInverse("SquareInverse", "752ad11d-8cf4-42e8-b6ae-8d8fb6ccc7a8"_drx_guid, szDescription_squareInverse, EScoreTransformType::SquareInverse);
