...
namespace UQS
{
	namespace Core
	{
		...
		private:
			...
			void                    CheckItemConvertersConsistency(const Client::IItemConverterCollection& itemConverters, const char* szItemFactoryNameForErrorMessages, std::set<DrxGUID>& guidsInUse);
#endif
