...
namespace UQS
{
	namespace Core
	{
		...
		CTextualInputBlueprint::CTextualInputBlueprint(const char* szParamName, const Client::CInputParameterID& paramID, const char* szFuncName, const DrxGUID& funcGUID, const char* szFuncReturnValueLiteral, bool bAddReturnValueToDebugRenderWorldUponExecution)
		...
		const DrxGUID& CTextualInputBlueprint::GetFuncGUID() const
		{
			return m_funcGUID;
		}
		...
		void CTextualInputBlueprint::SetFuncGUID(const DrxGUID& funcGUID)
		{
			m_funcGUID = funcGUID;
		}
		...
		ITextualInputBlueprint& CTextualInputBlueprint::AddChild(const char* szParamName, const Client::CInputParameterID& paramID, const char* szFuncName, const DrxGUID& funcGUID, const char* szFuncReturnValueLiteral, bool bAddReturnValueToDebugRenderWorldUponExecution)
		{
		...
		bool CInputBlueprint::Resolve(const ITextualInputBlueprint& sourceParent, const Client::IInputParameterRegistry& inputParamsReg, const CQueryBlueprint& queryBlueprintForGlobalParamChecking, bool bResolvingForAGenerator)
		{
			...
			for (size_t i = 0; i < numParamsExpected; ++i)
			{
				...
				const DrxGUID& funcGUID = pSourceChild->GetFuncGUID();
