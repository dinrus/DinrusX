...
namespace UQS
{
	namespace Core
	{
		...
		void CTextualGlobalRuntimeParamsBlueprint::AddParameter(const char* szName, const char* szTypeName, const DrxGUID& typeGUID, bool bAddToDebugRenderWorld, DataSource::SyntaxErrorCollectorUniquePtr pSyntaxErrorCollector)
		{
