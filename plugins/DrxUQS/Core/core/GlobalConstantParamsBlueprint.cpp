...
namespace UQS
{
	namespace Core
	{
		...
		void CTextualGlobalConstantParamsBlueprint::AddParameter(const char* szName, const char* szTypeName, const DrxGUID& typeGUID, const char* szValue, bool bAddToDebugRenderWorld, DataSource::SyntaxErrorCollectorUniquePtr pSyntaxErrorCollector)
		{
