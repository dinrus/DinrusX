...
namespace UQS
{
	namespace Core
	{
		...
		public:
			...
			explicit                                            CHistoricQuery(const CQueryID& queryID, const char* szQuerierName, const CQueryID& parentQueryID, CQueryHistoryUpr* pOwningHistoryUpr);
			...
			void                                                DrawDebugPrimitivesInWorld(size_t indexOfItemCurrentlyBeingFocused, const IQueryHistoryUpr::SEvaluatorDrawMasks& evaluatorDrawMasks) const;
		...
		private:
			...
			static EItemAnalyzeStatus                           AnalyzeItemStatus(const SHistoricItem& itemToAnalyze, const IQueryHistoryUpr::SEvaluatorDrawMasks& evaluatorDrawMasks, float& outAccumulatedAndWeightedScoreOfMaskedEvaluators, bool& outFoundScoreOutsideValidRange);
			CTimeValue                                          ComputeElapsedTimeFromQueryCreationToDestruction() const;

		private:

			CQueryHistoryUpr*                               m_pOwningHistoryUpr;
			CQueryID                                            m_queryID;
		...
		public:
			...
			HistoricQuerySharedPtr                         AddNewHistoryEntry(const CQueryID& queryID, const char* szQuerierName, const CQueryID& parentQueryID, CQueryHistoryUpr* pOwningHistoryUpr);
			void                                           Clear();
