...
namespace UQS
{
	namespace Core
	{
		...
		public:
			...
			explicit                                     CQueryHistoryInGameGUI(IQueryHistoryUpr& queryHistoryUpr);
			                                             ~CQueryHistoryInGameGUI();
		...
		private:
			...
			int                                          DrawQueryHistoryOverview(IQueryHistoryUpr::EHistoryOrigin whichHistory, const char* szDescriptiveHistoryName, float xPos, int row) const;
		...
		private:
			...
			IQueryHistoryUpr&                        m_queryHistoryUpr;
