...
namespace UQS
{
	namespace Core
	{
		...
		public:
			...
			virtual void                                    AddParameter(const char* szName, const char* szTypeName, const DrxGUID& typeGUID, bool bAddToDebugRenderWorld, DataSource::SyntaxErrorCollectorUniquePtr pSyntaxErrorCollector) override;
		...
		private:
			...
			{
				explicit                                    SStoredParameterInfo(const char* _szName, const char* _szTypeName, const DrxGUID& _typeGUID, bool _bAddToDebugRenderWorld, DataSource::SyntaxErrorCollectorUniquePtr _pSyntaxErrorCollector);
		...
		inline CTextualGlobalRuntimeParamsBlueprint::SStoredParameterInfo::SStoredParameterInfo(const char* _szName, const char* _szTypeName, const DrxGUID& _typeGUID, bool _bAddToDebugRenderWorld, DataSource::SyntaxErrorCollectorUniquePtr _pSyntaxErrorCollector)
			: name(_szName)
