...
namespace UQS
{
	namespace Core
	{
		...
		public:
			...
			void                                                    DrawAllAddedPrimitivesAssociatedWithItem(size_t indexOfItemToDrawPrimitivesOf, const IQueryHistoryUpr::SEvaluatorDrawMasks& evaluatorDrawMasks, const ColorF& colorToOverridePrimitivesWithIfPartOfTheItem, bool bHighlight) const;
