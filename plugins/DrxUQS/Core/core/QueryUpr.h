...
namespace UQS
{
	namespace Core
	{
		...
		class CQueryUpr : public IQueryUpr
		{
		private:
		...
		public:
			explicit                                                   CQueryUpr(CQueryHistoryUpr& queryHistoryUpr);
		...
		private:
			...
			CQueryHistoryUpr&                                      m_queryHistoryUpr;        // for allocating new historic queries each time a query blueprint gets instantiated and runs
