...
namespace UQS
{
	namespace Core
	{
		...
		CQuery_Regular::CQuery_Regular(const SCtorContext& ctorContext)
			: CQueryBase(ctorContext, true)  // true = yes, we need some time budget from CQueryUpr for some potentially complex computations
		...
		{
			DRX_PROFILE_FUNCTION_ARG(UQS_PROFILED_SUBSYSTEM_TO_USE, m_pQueryBlueprint->GetName());
