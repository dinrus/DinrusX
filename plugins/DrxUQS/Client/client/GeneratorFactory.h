...
namespace UQS
{
	namespace Client
	{
		namespace Internal
		{
			...
			protected:
				explicit                                  CGeneratorFactoryBase(const char* szGeneratorName, const DrxGUID& guid, const char* szDescription);
			...
			inline CGeneratorFactoryBase::CGeneratorFactoryBase(const char* szGeneratorName, const DrxGUID& guid, const char* szDescription)
			...
			inline const DrxGUID& CGeneratorFactoryBase::GetGUID() const
			{
