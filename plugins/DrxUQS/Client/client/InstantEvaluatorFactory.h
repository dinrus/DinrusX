...
namespace UQS
{
	namespace Client
	{
		namespace Internal
		{
			...
			protected:
				explicit                                 CInstantEvaluatorFactoryBase(const char* szEvaluatorName, const DrxGUID& guid, const char* szDescription);
			...
			inline CInstantEvaluatorFactoryBase::CInstantEvaluatorFactoryBase(const char* szEvaluatorName, const DrxGUID& guid, const char* szDescription)
			...
			inline const DrxGUID& CInstantEvaluatorFactoryBase::GetGUID() const
			{
