...
namespace UQS
{
	namespace Client
	{
		namespace Internal
		{
			...
			protected:
				explicit                                  CFunctionFactoryBase(const char* szFunctionName, const DrxGUID& guid, const char* szDescription);
			...
			inline CFunctionFactoryBase::CFunctionFactoryBase(const char* szFunctionName, const DrxGUID& guid, const char* szDescription)
			...
			inline const DrxGUID& CFunctionFactoryBase::GetGUID() const
			{
