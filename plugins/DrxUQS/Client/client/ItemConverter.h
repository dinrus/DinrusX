	...
	namespace Client
	{
		namespace Internal
		{
			...
			public:
				...
				explicit                            CItemConverter(const char* szFromName, const char* szToName, const DrxGUID& guid, CItemConverterCollection& convertersToAddSelfTo);
			...
			template <class TFromType, class TToType, void(*pConvertFunc)(const TFromType&, TToType&)>
			CItemConverter<TFromType, TToType, pConvertFunc>::CItemConverter(const char* szFromName, const char* szToName, const DrxGUID& guid, CItemConverterCollection& convertersToAddSelfTo)
			...
			template <class TFromType, class TToType, void(*pConvertFunc)(const TFromType&, TToType&)>
			const DrxGUID& CItemConverter<TFromType, TToType, pConvertFunc>::GetGUID() const
			{
				return m_guid;
			}
		...
		public:
			...
			void                                AddFromForeignTypeConverter(const char* szFromName, const char* szToName, const DrxGUID& guid);

			template <class TToForeignType, void(*pConvertFunc)(const TItem&, TToForeignType&)>
			void                                AddToForeignTypeConverter(const char* szFromName, const char* szToName, const DrxGUID& guid);
		...
		template <class TItem>
		template <class TFromForeignType, void(*pConvertFunc)(const TFromForeignType&, TItem&)>
		void CItemConverterCollectionMgr<TItem>::AddFromForeignTypeConverter(const char* szFromName, const char* szToName, const DrxGUID& guid)
		{
		...
		template <class TItem>
		template <class TToForeignType, void(*pConvertFunc)(const TItem&, TToForeignType&)>
		void CItemConverterCollectionMgr<TItem>::AddToForeignTypeConverter(const char* szFromName, const char* szToName, const DrxGUID& guid)
		{
