...
namespace UQS
{
	namespace Client
	{
		namespace Internal
		{
			...
			protected:
				explicit                                 CDeferredEvaluatorFactoryBase(const char* szEvaluatorName, const DrxGUID& guid, const char* szDescription);
			...
			inline CDeferredEvaluatorFactoryBase::CDeferredEvaluatorFactoryBase(const char* szEvaluatorName, const DrxGUID& guid, const char* szDescription)
			...
			inline const DrxGUID& CDeferredEvaluatorFactoryBase::GetGUID() const
			{
