...
<DinrusX/CoreX/Serialization/IArchive.h>
<DinrusX/CoreX/Serialization/IArchiveHost.h>
<DinrusX/Serialization/Qt.h>

<DinrusX/Explorer/ExplorerPanel.h>
<DinrusX/Explorer/Explorer.h>
<DinrusX/Explorer/ExplorerFileList.h>
<DinrusX/Explorer/ExplorerModel.h>
	...
	, m_pSimulatorRunModeCheckBox(nullptr)
{
	...
	CCentralEventUpr::QueryBlueprintRuntimeParamsChanged.Connect(this, &CMainEditorWindow::OnQueryBlueprintRuntimeParamsChanged);
	CCentralEventUpr::QuerySimulatorRunningStateChanged.Connect(this, &CMainEditorWindow::OnQuerySimulatorRunningStateChanged);
...
CMainEditorWindow::~CMainEditorWindow()
{
	...
	CCentralEventUpr::QueryBlueprintRuntimeParamsChanged.DisconnectObject(this);
	CCentralEventUpr::QuerySimulatorRunningStateChanged.DisconnectObject(this);
...
void CMainEditorWindow::OnMenuActionHelpOnlineDocumentation()
{
	...
	const char* szURL = "http://docs.drxengine.com/display/CEMANUAL/Sandbox+Plugin%3A+Query+Editor";
...
void CMainEditorWindow::OnQueryBlueprintRuntimeParamsChanged(const CCentralEventUpr::SQueryBlueprintRuntimeParamsChangedEventArgs& args)
{
	RebuildRuntimeParamsListForSimulation();
}

void CMainEditorWindow::OnQuerySimulatorRunningStateChanged(const CCentralEventUpr::SQuerySimulatorRunningStateChangedEventArgs& args)
{
...
void CMainEditorWindow::OnSimulatorButtonClicked(bool checked)
{
	...
	CCentralEventUpr::StartOrStopQuerySimulator(CCentralEventUpr::SStartOrStopQuerySimulatorEventArgs(m_pCurrentDocument->GetQueryBlueprintPtr()->GetName().c_str(), serializableParams, m_pSimulatorRunModeCheckBox->checkState() != Qt::Unchecked));
}
...
void CMainEditorWindow::OnSingleStepOnceButtonClicked(bool checked)
{
	...
	CCentralEventUpr::SingleStepQuerySimulatorOnce(CCentralEventUpr::SSingleStepQuerySimulatorOnceEventArgs(m_pCurrentDocument->GetQueryBlueprintPtr()->GetName().c_str(), serializableParams, m_pSimulatorRunModeCheckBox->checkState() != Qt::Unchecked));
}
