...
bool SerializeGUIDWithSetter(Serialization::IArchive& archive, const char* szName, const char* szLabel, const DrxGUID& oldValue, TSetFunc setFunc)
{
	DrxGUID guid = oldValue;
