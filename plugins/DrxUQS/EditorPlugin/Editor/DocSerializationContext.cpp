...
{
	DRX_ASSERT(!m_paramListContextStack.empty() && m_paramListContextStack.top() == pContext);
...
{
	DRX_ASSERT(!m_selectedGeneratorContextStack.empty() && m_selectedGeneratorContextStack.top() == pContext);
