...
void CPlugin_OculusVR::OnSystemEvent(ESystemEvent event, UINT_PTR wparam, UINT_PTR lparam)
{
	...
	case ESYSTEM_EVENT_FULL_SHUTDOWN:
		{
			gEnv->pSystem->GetHmdUpr()->UnregisterDevice(GetName());

			DrxVR::Oculus::Resources::Shutdown();
		}
		break;
	}
}
...
{
	return DrxVR::Oculus::Resources::GetAssociatedDevice();
}

DRXREGISTER_SINGLETON_CLASS(CPlugin_OculusVR)
