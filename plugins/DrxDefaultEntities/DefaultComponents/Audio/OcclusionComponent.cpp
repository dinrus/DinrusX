...
static void ReflectType(Schematyc::CTypeDesc<EOcclusionType>& desc)
{
	...
	desc.SetGUID("8CF304D8-4E83-4EFD-BA66-34DE91E9FECE"_drx_guid);
...
{
	desc.SetGUID("F079E52E-FCDD-45AE-8860-FD4F292B0A1A"_drx_guid);
	...
	desc.AddMember(&COcclusionComponent::m_occlusionType, 'occl', "occlusionType", "Occlusion Type", "The occlusion type to be used by this object.", DrxAudio::EOcclusionType::Ignore);
}
...
{
	{
		auto const pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&COcclusionComponent::SetOcclusionType, "122658EB-9ED7-400D-B4AB-E2125486E172"_drx_guid, "SetOcclusionType");
...
void COcclusionComponent::Initialize()
{
	if (m_pIEntityAudioComponent == nullptr)
	{
		...
		m_pIEntityAudioComponent->SetObstructionCalcType(m_occlusionType, DrxAudio::InvalidAuxObjectId);
	}
}
...
void COcclusionComponent::OnShutDown()
{
	if (m_pIEntityAudioComponent != nullptr)
	{
		m_pIEntityAudioComponent->SetObstructionCalcType(DrxAudio::EOcclusionType::Ignore, DrxAudio::InvalidAuxObjectId);
...
//////////////////////////////////////////////////////////////////////////
void COcclusionComponent::SetOcclusionType(DrxAudio::EOcclusionType const occlusionType)
{
