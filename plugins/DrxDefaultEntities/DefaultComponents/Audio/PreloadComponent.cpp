...
{
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CPreloadComponent::Load, "A482E1A3-03C6-47D4-B775-568A4DB60352"_drx_guid, "Load");
		pFunction->SetDescription("Loads the preload request.");
		pFunction->SetFlags(Schematyc::EEnvFunctionFlags::Construction);
		componentScope.Register(pFunction);
	}
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CPreloadComponent::Unload, "1FF19168-A2EF-46E5-A673-E34C7E46EEFF"_drx_guid, "Unload");
...
{
	desc.SetGUID("C098DC62-BB9F-4EC5-80EB-79B99EE29BAB"_drx_guid);
...
{
	if (m_preload.m_id != DrxAudio::InvalidPreloadRequestId)
	{
		m_bLoaded = true;
