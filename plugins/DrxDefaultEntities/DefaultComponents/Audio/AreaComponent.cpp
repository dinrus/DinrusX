...
{
	{
		auto const pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CAreaComponent::SetActive, "AFA6F8A9-8D06-4C51-A1E0-E3D3FA3B9458"_drx_guid, "SetActive");
	...
	{
		auto const pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CAreaComponent::SetTriggeringObjects, "DB43E668-F23B-40B1-A2C8-4801CD2CFA55"_drx_guid, "SetTriggeringObjects");
...
{
	desc.SetGUID("E57B86BA-9F4D-4EDA-94D2-1E20E4CAE94F"_drx_guid);
...
{
	desc.SetGUID("D69EC5CF-FEC0-4CE7-A1CB-EC6CDC391D34"_drx_guid);
...
{
	desc.SetGUID("B8D5D205-2DAC-47FF-B25C-FC1C9ABB78F6"_drx_guid);
...
{
	desc.SetGUID("9EB663D0-8A91-48AE-AFC2-F16FFA6DB7A7"_drx_guid);
...
{
	desc.SetGUID("2E41D765-1ECC-4192-A0DB-413BAD282519"_drx_guid);
...
{
	desc.SetGUID("F094BA36-9F43-4BEC-8ED1-1141588CB872"_drx_guid);
...
{
	desc.SetGUID("F13D7D2D-DEF2-496F-BA05-939659118C8B"_drx_guid);
