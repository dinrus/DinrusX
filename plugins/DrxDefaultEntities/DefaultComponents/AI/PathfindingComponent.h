...
<DinrusX/DinrusXAI/IMovementSystem.h>

<DinrusX/DinrusXAI/MovementRequest.h>
...
namespace Drx
{
	namespace DefaultComponents
	{
		...
		public:
			...
			{
				desc.SetGUID("{470C0CD6-198F-412E-A99A-15456066162B}"_drx_guid);
			...
			{
				DRX_ASSERT_MESSAGE(m_movementRequestId.id == 0, "RequestMoveTo can not be called while another request is being handled!");
			...
			{
				DRX_ASSERT(m_movementRequestId.id != 0);
