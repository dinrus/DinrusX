...
<DinrusX/CoreX/ToolsHelpers/ResourceCompilerHelper.inl>
<DinrusX/CoreX/ToolsHelpers/EngineSettingsUpr.inl>
<DinrusX/CoreX/ToolsHelpers/SettingsUprHelpers.inl>
...
void CEnvironmentProbeComponent::Register(Schematyc::CEnvRegistrationScope& componentScope)
{
	// Functions
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CEnvironmentProbeComponent::LoadFromDisk, "122049AA-015F-4F30-933D-BF2E7C6BA0BC"_drx_guid, "LoadFromDisk");
	...
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CEnvironmentProbeComponent::SetCubemap, "F305D0C4-6AD2-4FD8-93A9-330A91206360"_drx_guid, "SetCubemap");
	...
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CEnvironmentProbeComponent::Generate, "024A11F7-8C74-493A-A0A7-3D613281BEDE"_drx_guid, "Generate");
