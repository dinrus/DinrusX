...
namespace DefaultComponents
{
	...
	{
		desc.SetGUID("{2DC20597-A17E-4306-A023-B73A6FBDBB3D}"_drx_guid);
	...
	{
		desc.SetGUID("{DBD843BC-E4E7-4950-B54D-4FD507B223FD}"_drx_guid);
	...
	{
		desc.SetGUID("{95F6EF06-2101-427C-9E55-481042117504}"_drx_guid);
	...
	{
		desc.SetGUID("{684B1333-184B-4B28-9474-BEC205FD18A0}"_drx_guid);
	}

	static void ReflectType(Schematyc::CTypeDesc<ILightComponent::SAnimations>& desc)
	{
		desc.SetGUID("{95F6EF06-2101-427C-9E55-481042117504}"_drx_guid);
		desc.AddMember(&ILightComponent::SAnimations::m_style, 'styl', "Style", "Style", "Determines the light style to load, see Shaders/HWScripts/DrxFX/Light.cfx for the full list", 0u);
