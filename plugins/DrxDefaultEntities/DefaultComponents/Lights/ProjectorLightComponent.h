...
namespace Drx
{
	namespace DefaultComponents
	{
		...
		public:
			...
			{
				desc.SetGUID("{07D0CAD1-8E79-4177-9ADD-A2464A009FA5}"_drx_guid);
			...
			struct SProjectorOptions
			{
				...
				{
					desc.SetGUID("{705FA6D1-CC00-45A5-8E51-78AF6CA14D2D}"_drx_guid);
			...
			struct SFlare
			{
				...
				{
					desc.SetGUID("{DE4B89DD-B436-47EC-861F-4A5F3E831594}"_drx_guid);
				...
				DrxTransform::CClampedAngle<5, 360> m_angle = 360.0_degrees;
			...
			virtual void SetFieldOfView(DrxTransform::CAngle angle) { m_angle = angle; }
			DrxTransform::CAngle GetFieldOfView() { return m_angle; }
			...
			virtual void SetFlareAngle(DrxTransform::CAngle angle) { m_flare.m_angle = angle; }
			DrxTransform:: CAngle GetFlareAngle() const { return m_flare.m_angle; }

		protected:
			bool m_bActive = true;
			Schematyc::Range<0, std::numeric_limits<int>::max()> m_radius = 10.f;
			DrxTransform::CClampedAngle<0, 180> m_angle = 45.0_degrees;
