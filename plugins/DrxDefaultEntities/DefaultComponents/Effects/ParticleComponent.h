...
<DinrusX/CoreX/ParticleSys/IParticlesPfx2.h>
<DinrusX/CoreX/Serialization/SmartPtr.h>
...
namespace Drx
{
	namespace DefaultComponents
	{
		...
		public:
			...
			{
				desc.SetGUID("{7925BC64-521F-4A2A-9068-C9C9A1D3499E}"_drx_guid);
			...
			{
				if (IParticleEffect* pEffect = gEnv->pParticleUpr->FindEffect(m_effectName.value, "CParticleComponent"))
				{
			...
			struct SAttributes: TParticleAttributesPtr
			{
				...
				{
					desc.SetGUID("{24AE6687-F855-4736-9C71-3419083BAECB}"_drx_guid);
			...
			struct SFeatures: pfx2::TParticleFeatures
			{
				...
				{
					desc.SetGUID("{CAB0D3B2-D3F5-4F47-AA50-32BCED2C42A7}"_drx_guid);
			...
			struct SSpawnParameters: SpawnParams
			{
				...
				{
					desc.SetGUID("{9E4544F0-3E5A-4479-B618-E9CB46905149}"_drx_guid);
