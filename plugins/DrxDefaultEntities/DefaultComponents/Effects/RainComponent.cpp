...
namespace Drx
{
	namespace DefaultComponents
	{
		...
		{
			{
				auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CRainComponent::Enable, "{DA911B91-3C7F-47A8-B18E-AAF48672F5F9}"_drx_guid, "Enable");
			...
			{
				auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CRainComponent::IsEnabled, "{C13A68AE-15B8-4C42-A35D-9118D7F7DD8F}"_drx_guid, "IsEnabled");
