...
{
	desc.SetGUID("{8556D9B6-F2D4-41DC-9C5C-897801C1D8CA}"_drx_guid);
...
namespace Drx
{
	namespace DefaultComponents
	{
		...
		public:
			...
			{
				desc.SetGUID("{26C5856F-34BC-43FE-BE36-2D276D082C96}"_drx_guid);
			...
			virtual void Spawn()
			{
				if (m_materialFileName.value.size() > 0 && gEnv->p3DEngine->GetMaterialUpr()->LoadMaterial(m_materialFileName.value) != nullptr)
				{
