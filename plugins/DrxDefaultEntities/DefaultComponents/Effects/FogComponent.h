...
{
	desc.SetGUID("{2402BB2D-F5D3-47E6-9EDE-D83CC05DC2BF}"_drx_guid);
...
namespace Drx
{
	namespace DefaultComponents
	{
		...
		public:
			...
			{
				desc.SetGUID("{5E98F483-BDF2-4497-8654-3474643AF147}"_drx_guid);
			...
			struct SOptions
			{
				...
				{
					desc.SetGUID("{7EFB4456-3395-42EE-BE30-5AB565EC7707}"_drx_guid);
