...
namespace Drx
{
	namespace DefaultComponents
	{
		...
		public:
			...
			{
				desc.SetGUID("{5F543092-53EA-46D7-9376-266E778317D7}"_drx_guid);
			...
			virtual void PlayAnimation(Schematyc::LowLevelAnimationName name, bool bLoop = false)
			{
				...
				{
					DrxCharAnimationParams animParams = m_animationParams;
					if (bLoop)
					{
		...
		protected:
			DrxCharAnimationParams m_animationParams;
