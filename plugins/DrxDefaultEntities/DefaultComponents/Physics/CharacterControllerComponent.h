...
namespace Drx
{
	namespace DefaultComponents
	{
		...
		public:
			...
			{
				desc.SetGUID("{98183F31-A685-43CD-92A9-815274F0A81C}"_drx_guid);
				...
				desc.AddComponentInteraction(SEntityComponentRequirements::EType::Incompatibility, "{912C6CE8-56F7-4FFA-9134-F98D4E307BD6}"_drx_guid);
				// Mark the Vehicle Physics component as incompatible
				desc.AddComponentInteraction(SEntityComponentRequirements::EType::Incompatibility, "{47EBC019-41CB-415E-AB57-2A3A99B918C2}}"_drx_guid);
				// Mark the Area component as incompatible
				desc.AddComponentInteraction(SEntityComponentRequirements::EType::Incompatibility, "{EC7F145B-D48F-4863-B9C2-3D3E2C8DCC61}"_drx_guid);
			...
			struct SPhysics
			{
				...
				{
					desc.SetGUID("{3341F1DC-0753-466E-BC7A-FA77A49D3CB4}"_drx_guid);
			...
			struct SMovement
			{
				...
				{
					desc.SetGUID("{71D2F72F-1AAF-4368-A356-FC07938837EB}"_drx_guid);
				...
				DrxTransform::CClampedAngle<0, 90> m_maxClimbAngle = 50.0_degrees;
				DrxTransform::CClampedAngle<0, 90> m_maxJumpAngle = 50.0_degrees;
				DrxTransform::CClampedAngle<0, 90> m_minFallAngle = 80.0_degrees;
				DrxTransform::CClampedAngle<0, 90> m_minSlideAngle = 70.0_degrees;
		...
		{
			desc.SetGUID("{D6B8165A-5BF5-431F-9268-4811DBED4760}"_drx_guid);
