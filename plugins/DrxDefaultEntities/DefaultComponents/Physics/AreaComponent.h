	...
	namespace DefaultComponents
	{
		...
		public:
			...
			struct SShapeParameters
			{
				...
				{
					desc.SetGUID("{8A493322-1DCD-442B-BA5A-9C41133AE911}"_drx_guid);
			...
			struct SBuoyancyParameters
			{
				...
				{
					desc.SetGUID("{A7270990-667F-4D27-B277-CF7ACFF3343C}"_drx_guid);
			...
			{
				desc.SetGUID("{EC7F145B-D48F-4863-B9C2-3D3E2C8DCC61}"_drx_guid);
		...
		{
			desc.SetGUID("{C42A564A-0024-4030-9381-1BC9004EA0E1}"_drx_guid);
		...
		{
			desc.SetGUID("{ABBCDB1B-75CD-4B9B-B4F7-D6C43DF38AAE}"_drx_guid);
