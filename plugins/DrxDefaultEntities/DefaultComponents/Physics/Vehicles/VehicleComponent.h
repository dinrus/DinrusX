	...
	namespace DefaultComponents
	{
		...
		public:
			...
			struct SEngineParams
			{
				...
				{
					desc.SetGUID("{8B051D30-2D75-48CE-8649-9D9920CAFBB7}"_drx_guid);
			...
			struct SGearParams
			{
				...
				struct SGear
				{
					...
					{
						desc.SetGUID("{C1D4377F-D3CD-438F-B8FD-576E8FA2A3EF}"_drx_guid);
						desc.SetLabel("Gear");
				...
				{
					desc.SetGUID("{C632BB61-DAE8-4270-B759-114F01F55517}"_drx_guid);
			...
			{
				desc.SetGUID("{47EBC019-41CB-415E-AB57-2A3A99B918C2}}"_drx_guid);
				...
				desc.AddComponentInteraction(SEntityComponentRequirements::EType::Incompatibility, "{98183F31-A685-43CD-92A9-815274F0A81C}"_drx_guid);
			...
			virtual void SetSteeringAngle(DrxTransform::CAngle angle) 
			{
				pe_action_drive driveAction;
				driveAction.steer = angle.ToRadians();
				m_pEntity->GetPhysicalEntity()->Action(&driveAction);
			}
			DrxTransform::CAngle GetSteeringAngle() const { return DrxTransform::CAngle::FromRadians(m_vehicleStatus.steer); }
