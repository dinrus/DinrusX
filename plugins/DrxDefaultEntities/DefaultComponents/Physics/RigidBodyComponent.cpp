...
void CRigidBodyComponent::Register(Schematyc::CEnvRegistrationScope& componentScope)
{
	// Functions
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CRigidBodyComponent::Enable, "{4F1AB9D4-8FB9-4488-9D9A-26B3DDE50C35}"_drx_guid, "Enable");
	...
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CRigidBodyComponent::IsEnabled, "{CAC21F92-74BE-4F29-9337-96C80B88F1AC}"_drx_guid, "IsEnabled");
	...
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CRigidBodyComponent::SetVelocity, "{FC7012F5-2FD2-4E06-BFA2-30A3C44C2AAB}"_drx_guid, "SetVelocity");
	...
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CRigidBodyComponent::GetVelocity, "{1E8C3D8F-404E-452D-B6BE-C5B8EF996FFC}"_drx_guid, "GetVelocity");
	...
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CRigidBodyComponent::SetAngularVelocity, "{33590792-AD99-4C20-B4D9-DA7C4E40B255}"_drx_guid, "SetAngularVelocity");
	...
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CRigidBodyComponent::GetAngularVelocity, "{AEEF2373-B1E3-4334-9D39-CB3376C3C6B3}"_drx_guid, "GetAngularVelocity");
	...
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CRigidBodyComponent::ApplyImpulse, "FB7197A9-9545-46BD-8748-1B5829CA3AFA"_drx_guid, "ApplyImpulse");
	...
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CRigidBodyComponent::ApplyAngularImpulse, "22926748-513F-4566-AE40-455A51600A3D"_drx_guid, "ApplyAngularImpulse");
...
{
	desc.SetGUID("{3E2E1015-0B63-44EC-9993-21E568295CB4}"_drx_guid);
	...
	case ENTITY_EVENT_COLLISION:
		{
			...
			ISurfaceType* pSurfaceType = pSurfaceTypeUpr->GetSurfaceType(physCollision->idmat[0]);

			if (pOtherEntity == m_pEntity || pOtherEntity == nullptr)
			{
				pSurfaceType = pSurfaceTypeUpr->GetSurfaceType(physCollision->idmat[1]);
