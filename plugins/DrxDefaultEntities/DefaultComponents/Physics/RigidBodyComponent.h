	...
	namespace DefaultComponents
	{
		...
		public:
			struct SBuoyancyParameters
			{
				...
				{
					desc.SetGUID("{2C5EFA87-F7D0-43F1-90B8-576EEB60FC37}"_drx_guid);
			...
			{
				desc.SetGUID("{912C6CE8-56F7-4FFA-9134-F98D4E307BD6}"_drx_guid);
				...
				desc.AddComponentInteraction(SEntityComponentRequirements::EType::SoftDependency, "{6DDD0033-6AAA-4B71-B8EA-108258205E29}"_drx_guid);
		...
		{
			desc.SetGUID("{C8B86CC7-E86D-46BA-9110-7FEA8052FABC}"_drx_guid);
