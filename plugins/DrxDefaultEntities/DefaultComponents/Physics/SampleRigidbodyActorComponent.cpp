...
void CSampleActorComponent::Register(Schematyc::CEnvRegistrationScope& componentScope)
{
	// Functions
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CSampleActorComponent::SetMoveVel, "{5DA08668-046F-4ced-B2A4-FC53E6F33F77}"_drx_guid, "SetMoveVel");
		pFunction->SetDescription("Sets the desired movement velocity");
		pFunction->BindInput(1, 'vel', "Velocity", nullptr, Vec3(ZERO));
		componentScope.Register(pFunction);
	}
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CSampleActorComponent::GetMoveVel, "{D7716491-E3E0-4257-9810-FA56E0332363}"_drx_guid, "GetMoveVel");
		pFunction->SetDescription("Get the desired movement velocity");
		pFunction->BindOutput(0, 'vel', "velocity");
		componentScope.Register(pFunction);
	}
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CSampleActorComponent::Jump, "{D2CF8D00-19FD-4e89-B792-85010B1A3530}"_drx_guid, "Jump");
