...
{
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CDebugDrawComponent::DrawSphere, "{96281FF5-B032-409C-8128-D02800D6876E}"_drx_guid, "DrawSphere");
	...
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CDebugDrawComponent::DrawDirection, "{8ED2D2BD-BD20-4A28-AE8B-9948EFE45E12}"_drx_guid, "DrawDirection");
	...
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CDebugDrawComponent::DrawLine, "{ECBDFE43-7518-43CA-9C81-227BC3BB849D}"_drx_guid, "DrawLine");
	...
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CDebugDrawComponent::DrawPlanarDisc, "{34F062B4-018B-4CE1-84ED-92005C042C3D}"_drx_guid, "DrawPlanarDisc");
	...
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CDebugDrawComponent::DrawCone, "{7E4FAF6E-A664-49B9-909F-90B91AEEEBE9}"_drx_guid, "DrawCone");
	...
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CDebugDrawComponent::DrawCylinder, "{0C851E60-9798-4DF5-BE36-7F671D685D83}"_drx_guid, "DrawCylinder");
	...
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CDebugDrawComponent::Draw2DText, "{6E62F8B7-E52A-47F5-BD08-3B78E9EEE634}"_drx_guid, "Draw2DText");
	...
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CDebugDrawComponent::DrawText, "{DCC8C877-5970-4D29-B8D7-3C01A2DA8ECA}"_drx_guid, "DrawText");
	...
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CDebugDrawComponent::DrawText3D, "{A462ACC5-0BB0-45A4-8FC0-3EC14778934B}"_drx_guid, "DrawText3D");
	...
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&CDebugDrawComponent::Draw2DLine, "{1DB96257-4C86-4A52-84A1-81F5FF9505B5}"_drx_guid, "Draw2DLine");
