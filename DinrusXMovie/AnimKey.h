...
#include <DinrusX/DinrusXSys/IConsole.h>     // <> required for Interfuscator
#include <DinrusX/DinrusXSys/IDrxPak.h> // <> required for Interfuscator
#include <DinrusX/DinrusXSys/ILocalizationUpr.h>
#include <DinrusX/CoreX/Math/Bezier.h>
#include <DinrusX/CoreX/Audio/IAudioSystem.h>
#include <DinrusX/DinrusXMovie/AnimTime.h>
...
#include <DinrusX/CoreX/Serialization/Decorators/Resources.h>
#include <DinrusX/CoreX/Serialization/Decorators/ResourceFolderPath.h>
#include <DinrusX/CoreX/Serialization/Decorators/ResourceFilePath.h>
#include <DinrusX/CoreX/Serialization/Decorators/ResourcesAudio.h>
...
struct SAudioFileKey : public STrackDurationKey
{
	...
	void               Serialize(Serialization::IArchive& ar)
	{
		...
		else
		{
			if (m_bIsLocalized)
			{
				const char* szLanguage = gEnv->pSystem->GetLocalizationUpr()->GetLanguage();
