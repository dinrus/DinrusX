...
#include <DinrusX/DinrusXMovie/AnimKey.h>
...
//! If you want to expand DinrusXMovie to control new stuff this is probably the enum you want to change.
...
struct SAnimContext
{
	...
	EntityId       m_activeCameraEntity; //!< Used for editor to pass viewport camera to DinrusXMovie.
