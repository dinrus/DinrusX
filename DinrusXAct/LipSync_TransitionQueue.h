...
private:
	...
	void                FindMatchingAnim(const DrxAudio::ControlId audioTriggerId, const ELipSyncMethod lipSyncMethod, ICharacterInstance& character, int* pAnimIdOut, DrxCharAnimationParams* pAnimParamsOut) const;
