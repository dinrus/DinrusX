...
public:
	...
	virtual bool StartAnimation(IEntity* entity, const char* szAnimName0, const DrxCharAnimationParams& Params, float speedMultiplier = 1.0f)
	{
	...
	virtual bool StartAnimationById(IEntity* entity, int animId, const DrxCharAnimationParams& Params, float speedMultiplier = 1.0f)
	{
		ICharacterInstance* pICharacter = entity->GetCharacter(0);
		if (pICharacter)
		{
