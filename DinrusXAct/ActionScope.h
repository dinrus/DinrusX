...
public:
	...
	bool  InstallAnimation(int animID, const DrxCharAnimationParams& animParams);
...
private:
	void InitAnimationParams(const SAnimationEntry& animEntry, const uint32 sequencerLayer, const SAnimBlend& animBlend, DrxCharAnimationParams& paramsOut);
