...
public:
	...
	virtual ESerializeChunkResult SerializeChunk(ChunkID chunk, uint8 profile, TMemHdl* phData, CTimeValue* pTimeInfo, CMementoMemoryUpr& mmm) = 0;
...
public:
	...
	virtual ESerializeChunkResult SerializeChunk(ChunkID chunk, uint8 profile, TMemHdl* phData, CTimeValue* pTimeInfo, CMementoMemoryUpr& mmm);
