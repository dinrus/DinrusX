...
#include <DinrusX/DinrusXNetwork/StatsCollector.h>
#include <DinrusX/DinrusXNetwork/FrameTypes.h>
#include <DinrusX/DinrusXNetwork/Errors.h>
#include <DinrusX/DinrusXNetwork/NetResolver.h>
#include <DinrusX/DinrusXNetwork/INetworkPrivate.h>
...
#include <DinrusX/CoreX/Memory/STLGlobalAllocator.h>
	...
	#include <DinrusX/DinrusXNetwork/NewMessageQueue.h>
#else
	#include <DinrusX/DinrusXNetwork/MessageQueue.h>
#endif // NEW_BANDWIDTH_MANAGEMENT
#include <DinrusX/DinrusXNetwork/IStreamSocket.h>
...
#include <DinrusX/DinrusXNetwork/ExponentialKeyExchange.h>
...
public:
	...
	virtual bool             ConvertAddr(const TNetAddress& addrIn, DRXSOCKADDR* pSockAddr, int* addrLen);
...
private:
	...
	std::auto_ptr<CServiceUpr> m_pServiceUpr;
