...
public:
	...
	static void RecvPacket(void* privateRef, uint8* recvBuffer, uint32 recvSize, DRXSOCKET recvSocket, TNetAddress& recvAddr);

	SSocketID   RegisterSocket(DRXSOCKET sock, int protocol) override;
