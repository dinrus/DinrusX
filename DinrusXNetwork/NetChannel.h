...
#include <DinrusX/DinrusXNetwork/CTPEndpoint.h>
...
{
public:
	CNetChannel(const TNetAddress& ipRemote, const CExponentialKeyExchange::KEY_TYPE& key, uint32 remoteSocketCaps, DrxSessionHandle session);
	~CNetChannel();
