...
struct IBreakableUpr
{
	...
	virtual void                 GetPlaneMemoryStatistics(void* pPlane, IDrxSizer* pSizer) = 0;
	...
	virtual const IBreakableUpr::SBrokenObjRec* GetPartBrokenObjects(int& brokenObjectCount) = 0;
