...
void SpawnEntity(ExplicitEntityId& entityIdOut, Schematyc::EntityClassName className, const DrxTransform::CTransform& transform)
{
...
static void RegisterUtilFunctions(IEnvRegistrar& registrar)
{
	...
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&GetEntityName, "955ca6c4-5b0a-4150-aaba-79e2939e85f7"_drx_guid, "GetName");
	...
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&GetEntityObjectId, "cdd011ac-14a1-403b-af21-28d9e77e562d"_drx_guid, "GetObjectId");
	...
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&FindEntityByName, "{823518D1-6FE9-49DA-A522-C1483385B70D}"_drx_guid, "FindByName");
	...
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&Hide, "abc4938d-a631-4a36-9f10-22cf6dc9dabd"_drx_guid, "Hide");
	...
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&IsHidden, "5aa5e8f0-b4f4-491d-8074-d8b129500d09"_drx_guid, "IsHidden");
	...
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&SetTransform, "FA08CEA0-A0C5-4340-9F8A-E38D74488BAF"_drx_guid, "SetTransform");
	...
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&GetTransform, "8A99E1BA-A5CD-4DE8-A19F-D07DF5D3B245"_drx_guid, "GetTransform");
	...
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&SetRotation, "{53FDFFFB-A216-4001-BA26-9E81A7D2160D}"_drx_guid, "SetRotation");
	...
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&GetRotation, "{B03F7198-583E-4C9C-BDC7-92D904920D2C}"_drx_guid, "GetRotation");
	...
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&SetPosition, "{1FD3B799-D029-480A-8D7B-F4EDFFF3D5F9}"_drx_guid, "SetPosition");
	...
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&SpawnEntity, "{7689D503-263E-4FE2-8BF5-3875DEFB7F3C}"_drx_guid, "Spawn");
	...
	{
		auto pFunction = SCHEMATYC_MAKE_ENV_FUNCTION(&RemoveEntity, "{0A8D243F-01BB-4E28-A26E-1D7A83A61603}"_drx_guid, "Remove");
