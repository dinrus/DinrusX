...
#include <DinrusX/DinrusXEntity/IEntityBasicTypes.h>
...
struct SChildAttachParams
{
  ...
  && eDrxModule != eDrxM_MonoBridge)
	#define DRX_DEPRECATED_ENTTIY_ARCHETYPE DRX_DEPRECATED("(v5.4) Entity archetypes are deprecated in favour of Schematyc usage")
#else
	#define DRX_DEPRECATED_ENTTIY_ARCHETYPE
#endif
  ...
  && eDrxModule != eDrxM_EntitySystem && eDrxModule != eDrxM_AISystem && eDrxModule != eDrxM_MonoBridge)
	#define DRX_DEPRECATED_ENTTIY_LUA DRX_DEPRECATED("(v5.5) Lua has been deprecated in favor of C# and Schematyc")
#else
	#define DRX_DEPRECATED_ENTTIY_LUA
#endif
...
struct SEntitySpawnParams
{
	...
	/*DRX_DEPRECATED_ENTTIY_LUA*/ IScriptTable*           pPropertiesTable = nullptr;
	/*DRX_DEPRECATED_ENTTIY_LUA*/ IScriptTable*           pPropertiesInstanceTable = nullptr;
	/*DRX_DEPRECATED_ENTTIY_ARCHETYPE*/ IEntityArchetype* pArchetype = nullptr;
};
...
public:
	...
	DRX_DEPRECATED_ENTTIY_ARCHETYPE virtual IEntityArchetype* GetArchetype() const = 0;
	...
	struct SComponentType<ComponentType, typename std::enable_if<IsComponentReflected<ComponentType>::value&& std::is_convertible<ComponentType, IEntityComponent>::value>::type>
	{
		...
		{
			static const DrxGUID s_guid = Schematyc::GetTypeGUID<ComponentType>();
			return s_guid;
		}
		...
		static ComponentType* CreateInEntity(IEntity* pEntity, TArgs&& ... args)
		{
			...
			IEntityComponent::SInitParams initParams = IEntityComponent::SInitParams { pEntity, DrxGUID::Create(), "", &Schematyc::GetTypeDesc<ComponentType>(), EEntityComponentFlags::None, nullptr, nullptr };
	...
	DRX_DEPRECATED_ENTTIY_LUA virtual IScriptTable* GetScriptTable() const = 0;
