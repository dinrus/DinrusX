...
class CEngineModule_DrxLiveCreate : public ILiveCreateEngineModule
{
	...
	DRXGENERATE_SINGLETONCLASS_GUID(CEngineModule_DrxLiveCreate, "EngineModule_DrxLiveCreate", "dc126bee-bdc6-411f-a111-b42839f2dd1b"_drx_guid)

	virtual ~CEngineModule_DrxLiveCreate() {}

	//////////////////////////////////////////////////////////////////////////
	virtual const char* GetName() const override { return "DrxLiveCreate"; };
